...
export default defineDoc({
  id: "image",
  name: "Image",
  packageName: "willa/Image",
  description: "响应式图片组件，支持可选说明和灯箱预览。",
  imports: [{ name: "Image", from: "willa/Image" }],
  css: "willa/Image.css",
  demo: {
    name: "Image",
    component: Image,
  ...
  props: [
    ...
    },
    {
      ...
      description: "透传给内部 img，例如 width、height、loading、className。",
    },
  ],
});
