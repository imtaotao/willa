...
const mediaStyle = {
  aspectRatio: "16 / 9",
  background:
    "linear-gradient(135deg, rgba(37, 99, 235, 0.18), rgba(5, 150, 105, 0.12))",
} as const;
...
export default defineDoc({
  ...
  sections: [
    ...
    },
    {
      ...
      content: (
        <Card
          ...
          eyebrow={<Badge tone="success">推荐</Badge>}
          title="查看项目仓库"
          description="把整张卡片作为明确的链接入口，适合资源推荐和文章延伸阅读。"
          actions={<ArrowRightIcon />}
        />
      ),
    },
    {
    ...
    },
    {
      ...
      content: (
        <Card
          padding="lg"
          media={<div style={mediaStyle} />}
          eyebrow={<Badge tone="warning">Preview</Badge>}
          title="面向内容页的组合卡片"
          description="Card 可以和 Badge、Button、媒体区域组合，用来承载更完整的资源信息。"
          footer="更新于今天"
          actions={
            <Button size="sm" variant="outline" trailingIcon={<BookmarkIcon />}>
              收藏
            </Button>
          }
        />
  ...
  props: [
    ...
    },
    {
      name: "href",
      type: "string",
      description: "传入后渲染为可点击链接卡片。",
    },
    {
      name: "eyebrow",
      type: "ReactNode",
      description: "标题上方的辅助信息，可组合 Badge。",
    },
    {
      name: "title",
      type: "ReactNode",
    ...
    },
    {
      name: "media",
      type: "ReactNode",
      description: "卡片顶部媒体区域。",
    },
    {
      name: "footer",
      type: "ReactNode",
      description: "卡片底部辅助信息。",
    },
    {
      name: "actions",
      type: "ReactNode",
      description: "卡片底部右侧操作区。",
    },
    {
      name: "className",
      type: "string",
