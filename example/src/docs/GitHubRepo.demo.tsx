...
export default defineDoc({
  ...
  name: "GitHubRepo",
  category: "widgets",
  packageName: "willa/GitHubRepo",
  description: "紧凑的 GitHub 仓库引用卡片。",
  imports: [{ name: "GitHubRepo", from: "willa/GitHubRepo" }],
  css: "willa/GitHubRepo.css",
  demo: {
    name: "GitHubPreview",
  ...
  props: [
    {
      ...
      type: "string",
      required: true,
      description: "形如 owner/name 的仓库名称。",
    },
    {
      name: "label",
      type: "string",
      description: "自定义展示的仓库名称。",
    },
    {
      name: "href",
      type: "string",
      description: "自定义仓库链接，未传时使用 GitHub 仓库地址。",
    },
    {
      name: "description",
      type: "string",
    ...
    },
    {
      name: "stars",
      type: "string | number",
      description: "悬浮卡片中的 star 数量。",
    },
    {
      name: "owner",
      type: "string",
      description: "自定义仓库所有者名称。",
    },
    {
      name: "ownerAvatarUrl",
      type: "string",
