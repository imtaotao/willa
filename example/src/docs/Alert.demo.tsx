  ...
  props: [
    {
      ...
      defaultValue: 'banner ? "warning" : "info"',
      description: "提示的语义类型，同时影响默认图标、颜色和默认 role。",
    },
    {
      name: "variant",
    ...
    },
    {
      name: "action",
      type: "ReactNode",
      description: "右侧操作区，常用于放置按钮或链接。",
    },
    {
      name: "banner",
      type: "boolean",
      defaultValue: "false",
      description: "使用横幅样式；未指定 type 时默认使用 warning。",
    },
    {
      name: "showIcon",
      type: "boolean",
      defaultValue: "banner 时为 true，否则为 false",
      description: "是否展示左侧语义图标。",
    },
    {
      name: "icon",
      type: "ReactNode",
      description: "自定义左侧图标，未传时按 type 使用默认图标。",
    },
    {
      name: "closable",
      type: "boolean | AlertClosableOptions",
      defaultValue: "false",
      description:
        "是否展示关闭按钮；对象形式可配置 closeIcon、closeLabel、onClose 和 afterClose。",
    },
    {
      name: "classes",
      type: 'Partial<Record<"root" | "icon" | "content" | "title" | "description" | "actions" | "close", string>>',
      description: "语义槽位 className，用于局部样式扩展。",
    },
    {
      name: "styles",
      type: 'Partial<Record<"root" | "icon" | "content" | "title" | "description" | "actions" | "close", CSSProperties>>',
      description: "语义槽位内联样式，用于局部样式扩展。",
    },
    {
      name: "role",
      type: "ComponentPropsWithoutRef<'div'>['role']",
      defaultValue: "warning/error 为 alert，其它类型为 status",
      description: "覆盖根节点可访问性语义。",
    },
  ],
});
