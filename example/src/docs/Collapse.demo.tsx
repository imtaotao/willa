...
function ControlledCollapsePreview() {
...
export default defineDoc({
  id: "collapse",
  name: "Collapse",
  packageName: "willa/Collapse",
  description:
    "用于 FAQ、配置面板和文档内容分组的折叠块；支持受控/非受控开关、提示信息、自定义头部图标和操作区。",
  imports: [
    { name: "Button", from: "willa/Button" },
    { name: "Collapse", from: "willa/Collapse" },
    { name: "Group", from: "willa/Group" },
    { name: "Stack", from: "willa/Stack" },
    { name: "InfoCircledIcon, LockClosedIcon", from: "@radix-ui/react-icons" },
  ],
  css: "willa/Collapse.css",
  demo: {
    name: "Collapse",
    component: Collapse,
    props: {
  ...
  sections: [
    ...
    },
    {
      ...
      `,
      content: <ControlledCollapsePreview />,
    },
    {
      title: "默认收起",
      code: `
      ...
      `,
      content: (
        <Collapse title="默认收起" hint="第一次进入时保持折叠">
          默认关闭时，适合让正文先保持轻量，再按需展开补充说明。
        </Collapse>
      ),
    },
  ...
  props: [
    ...
    },
    {
      ...
      type: '"sm" | "md" | "lg"',
      defaultValue: '"md"',
      description: "折叠块的视觉尺寸。",
    },
    {
      name: "icon",
      type: "ReactNode",
      description: "标题左侧的装饰图标，未传时不显示。",
    },
    {
      name: "extra",
      type: "ReactNode",
      description: "标题行右侧的附加操作区。",
    },
    {
      name: "open",
      type: "boolean",
    ...
    },
    {
      ...
      type: "string",
      description: "触发按钮的 className。",
    },
    {
      name: "bodyClassName",
      type: "string",
      description: "内容区域的 className。",
    },
    {
      name: "className",
      type: "string",
      description: "外层容器的 className。",
    },
    {
      name: "children",
      type: "ReactNode",
