...
const usageItems: Array<CodeTabsItem> = [
  {
...
const languageItems: Array<CodeTabsItem> = [
  {
    label: "C++",
    language: "c++",
    code: unindent(`
...
export default defineDoc({
  id: "code-tabs",
  name: "CodeTabs",
  packageName: "willa/CodeTabs",
  description:
    "用于在一组相关代码片段之间切换，例如安装命令、多框架示例和配置片段。",
  imports: [{ name: "CodeTabs", from: "willa/CodeTabs" }],
  css: "willa/CodeTabs.css",
  demo: {
    name: "CodeTabs",
    component: CodeTabs,
    props: {
  ...
  props: [
    ...
    },
    {
      ...
      required: true,
      group: "CodeTabsItem",
      description: "标签上展示的内容。",
    },
    {
      name: "CodeTabsItem.code",
      type: "string",
      required: true,
      group: "CodeTabsItem",
      description: "代码内容。",
    ...
    {
      name: "CodeTabsItem.language",
      type: "string",
      group: "CodeTabsItem",
      description: "代码语言，用于语法高亮和右上角语言标记。",
    },
    {
      name: "CodeTabsItem.disabled",
      type: "boolean",
      group: "CodeTabsItem",
      description: "禁用当前代码标签。",
    },
    {
      name: "CodeTabsItem.highlightLines",
