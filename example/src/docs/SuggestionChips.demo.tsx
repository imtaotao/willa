...
export default defineDoc({
  ...
  props: [
    ...
    {
      name: "SuggestionChipItem.description",
      type: "ReactNode",
      group: "SuggestionChipItem",
      description: "建议补充说明。",
    },
    {
      name: "SuggestionChipItem.icon",
      type: "ReactNode",
      group: "SuggestionChipItem",
      description: "建议图标。",
    },
    {
      name: "SuggestionChipItem.disabled",
      type: "boolean",
      defaultValue: "false",
      group: "SuggestionChipItem",
