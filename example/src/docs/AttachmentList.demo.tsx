...
export default defineDoc({
  ...
  props: [
    ...
    {
      name: "AttachmentListItem.meta",
      type: "ReactNode",
      group: "AttachmentListItem",
      description: "附件辅助信息。",
    },
    {
      name: "AttachmentListItem.href",
      type: "string",
      group: "AttachmentListItem",
      description: "附件链接地址，用于打开或下载。",
    },
    {
    ...
    {
      name: "AttachmentListItem.language",
      type: "string",
      group: "AttachmentListItem",
      description: "代码或文本附件的语言标识。",
    },
    {
      name: "AttachmentListItem.mimeType",
      type: "string",
      group: "AttachmentListItem",
      description: "附件 MIME 类型，用于辅助推断预览方式。",
    },
    {
      name: "AttachmentListItem.poster",
      type: "string",
      group: "AttachmentListItem",
      description: "视频或媒体附件的封面地址。",
    },
    {
      name: "AttachmentListItem.alt",
      type: "string",
      group: "AttachmentListItem",
      description: "图片或媒体附件的替代文本。",
    },
    {
      name: "AttachmentListItem.progress",
      type: "number",
      group: "AttachmentListItem",
      description: "上传进度，通常为 0 到 100。",
    },
    {
      name: "AttachmentListItem.actions",
      type: "ReactNode",
      group: "AttachmentListItem",
      description: "附件右侧自定义操作。",
    },
    {
      name: "AttachmentListItem.disabled",
      type: "boolean",
      group: "AttachmentListItem",
      description: "是否禁用当前附件交互。",
    },
    {
