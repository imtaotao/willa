...
export default defineDoc({
  ...
  name: "ChatMessage",
  category: "ai",
  packageName: "willa/ChatMessage",
  description: "用于 AI 对话流里的单条消息，支持角色、头像、状态和操作区。",
  imports: [{ name: "ChatMessage", from: "willa/ChatMessage" }],
  css: "willa/ChatMessage.css",
  demo: {
  ...
  props: [
    {
      ...
      required: true,
      description:
        "消息主体内容，可以放文本、段落、Markdown 渲染结果或代码块。",
    },
    {
      name: "role",
    ...
    },
    {
      ...
      type: "boolean",
      description:
        "是否展示头像；默认 assistant、developer 和 tool 展示，user 和 system 不展示。",
    },
    {
      name: "meta",
      type: "ReactNode",
      description: "时间、模型、来源等辅助信息。",
    },
    {
      name: "status",
      type: "ReactNode",
      description: "生成中、已完成、失败等状态信息。",
    },
    {
      name: "actions",
      type: "ReactNode",
      description: "复制、重试、反馈等消息操作区。",
    },
    {
      name: "footer",
      type: "ReactNode",
      description: "消息底部说明，例如来源数量、耗时或 token 信息。",
    },
    {
      name: "compact",
      type: "boolean",
