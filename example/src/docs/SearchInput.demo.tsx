...
export default defineDoc({
  ...
  name: "SearchInput",
  category: "form",
  packageName: "willa/SearchInput",
  description: "带搜索图标、清除按钮和回车搜索语义的单行输入框。",
  imports: [{ name: "SearchInput", from: "willa/SearchInput" }],
  css: "willa/SearchInput.css",
  demo: {
    name: "SearchInput",
  ...
  sections: [
    ...
    },
    {
      ...
      `,
      content: <ControlledSearchPreview />,
    },
    {
      title: "状态",
      code: `
  ...
  props: [
    ...
    },
    {
      name: "onSearch",
      type: "(value: string) => void",
      description: "按 Enter 触发搜索时回调，传入 trim 后的内容。",
    },
    {
      name: "onClear",
      type: "() => void",
