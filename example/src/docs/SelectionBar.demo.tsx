import { ArchiveIcon, DownloadIcon, TrashIcon } from "@radix-ui/react-icons";
...
export default defineDoc({
  id: "selection-bar",
  name: "SelectionBar",
  packageName: "willa/SelectionBar",
  description: "用于列表、表格、文件和卡片多选后的批量操作反馈。",
  imports: [
    { name: "Button", from: "willa/Button" },
    { name: "SelectionBar", from: "willa/SelectionBar" },
    { name: "Stack", from: "willa/Stack" },
  ],
  css: "willa/SelectionBar.css",
  demo: {
    name: "SelectionBar",
  ...
  props: [
    {
      ...
      type: "number",
      required: true,
      description: "当前选中的项目数量。",
    },
    {
      name: "totalCount",
      type: "number",
      description: "当前集合或筛选结果的总数量，用于展示选择进度。",
    },
    {
      name: "label",
      type: "ReactNode",
    ...
    },
    {
      name: "description",
      type: "ReactNode",
      description: "展示在摘要下方的辅助说明。",
    },
    {
      name: "actions",
      type: "ReactNode",
      description: "主操作区，通常放批量下载、移动、归档、删除等按钮。",
    },
    {
      name: "secondaryActions",
      type: "ReactNode",
      description: "辅助操作区，展示在内置全选和清空按钮前。",
    },
    {
      name: "onSelectAll",
      type: "() => void",
      description: "点击全选按钮时触发。传入后展示全选按钮。",
    },
    {
      name: "onClear",
      type: "() => void",
      description: "点击清空按钮时触发。传入后展示清空按钮。",
    },
    {
      name: "selectAllLabel",
      type: "ReactNode",
