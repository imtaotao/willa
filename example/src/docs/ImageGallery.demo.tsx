...
export default defineDoc({
  id: "image-gallery",
  name: "ImageGallery",
  packageName: "willa/ImageGallery",
  description: "紧凑的响应式图片画廊。",
  imports: [{ name: "ImageGallery", from: "willa/ImageGallery" }],
  css: "willa/ImageGallery.css",
  demo: {
    name: "ImageGallery",
  ...
  props: [
    {
      name: "images",
      type: "Array<string | { src: string; alt?: string; caption?: string }>",
      required: true,
      description: "画廊中渲染的图片列表。",
    },
    {
      name: "columns",
      type: "2 | 3 | 4",
    ...
    },
    {
      ...
      type: "boolean",
      defaultValue: "false",
      description: "是否在鼠标悬浮图片时轻微放大，默认关闭。",
    },
    {
