...
const demoFileHref =
  "data:text/plain;charset=utf-8,%E8%BF%99%E6%98%AF%20Willa%20Download%20%E7%BB%84%E4%BB%B6%E7%9A%84%E6%BC%94%E7%A4%BA%E6%96%87%E4%BB%B6%E3%80%82";
...
const DownloadPreview = () => (
  <div style={stackStyle}>
    <Download href={demoFileHref} name="product-brief.txt" meta="2 KB" />
    <Download
      href={demoFileHref}
      name="feedback.csv"
...
export default defineDoc({
  id: "download",
  name: "Download",
  packageName: "willa/Download",
  description: "用于附件、资料和导出结果的轻量下载入口。",
  imports: [{ name: "Download", from: "willa/Download" }],
  css: "willa/Download.css",
  demo: {
  ...
  props: [
    ...
    },
    {
      ...
      type: "ReactNode",
      required: true,
      description: "下载入口主文案，通常是文件名或动作文案。",
    },
    {
      name: "meta",
      type: "ReactNode",
      description: "文件大小、格式或补充说明。",
    },
    {
      name: "downloadName",
      type: "string",
