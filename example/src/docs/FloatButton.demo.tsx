...
export default defineDoc({
  ...
  props: [
    ...
    },
    {
      name: "className",
      type: "string",
      description: "根按钮或链接元素的 className。",
    },
    {
      name: "contentClassName",
      type: "string",
      description: "按钮内容区域的 className。",
    },
    {
      name: "href",
      type: "string",
    ...
    },
    {
      ...
      description: "原生 button 类型，仅在非链接按钮时生效。",
    },
    {
      name: "FloatButtonGroup.children",
    ...
    {
      name: "FloatButtonGroup.open",
      group: "FloatButtonGroup",
      type: "boolean",
      description: "受控展开状态。",
    },
    {
      name: "FloatButtonGroup.defaultOpen",
      group: "FloatButtonGroup",
      type: "boolean",
      defaultValue: "false",
      description: "默认展开状态。",
    ...
    {
      name: "FloatButtonGroup.onOpenChange",
      group: "FloatButtonGroup",
      type: "(open: boolean) => void",
      description: "展开状态变化回调。",
    },
    {
      name: "FloatButtonGroup.triggerIcon",
      group: "FloatButtonGroup",
      type: "ReactNode",
    ...
    {
      name: "FloatButtonGroup.triggerTooltip",
      group: "FloatButtonGroup",
      type: "ReactNode",
      description: "主触发按钮提示内容。",
    },
    {
      name: "FloatButtonGroup.triggerAriaLabel",
      group: "FloatButtonGroup",
      type: "string",
      defaultValue: '"打开悬浮操作"',
    ...
    {
      name: "FloatButtonGroup.direction",
      group: "FloatButtonGroup",
    ...
    {
      name: "FloatButtonGroup.placement",
      group: "FloatButtonGroup",
      type: '"bottom-right" | "bottom-left" | "top-right" | "top-left"',
      defaultValue: '"bottom-right"',
      description: "分组触发按钮的停靠位置。",
    },
    {
      name: "FloatButtonGroup.fixed",
      group: "FloatButtonGroup",
      type: "boolean",
      defaultValue: "true",
      description: "分组触发按钮是否使用 fixed 固定到视口。",
    },
    {
      name: "FloatButtonGroup.offset",
      group: "FloatButtonGroup",
      type: "readonly [number | string, number | string]",
      defaultValue: "[24, 24]",
      description: "分组触发按钮距离视口或容器边缘的偏移量。",
    },
    {
      name: "FloatButtonGroup.zIndex",
      group: "FloatButtonGroup",
      type: "number",
      description: "分组触发按钮固定模式下的层级。",
    },
    {
      name: "FloatButtonGroup.className",
      group: "FloatButtonGroup",
      type: "string",
      description: "分组根容器的 className。",
    },
    {
      name: "FloatButtonGroup.contentClassName",
      group: "FloatButtonGroup",
      type: "string",
      description: "分组展开内容区域的 className。",
    },
  ],
});
