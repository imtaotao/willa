...
import { ScheduleCalendar, type ScheduleCalendarEvent } from "willa/Calendar";
...
const SelectedScheduleCalendar = () => {
  const [selectedEventId, setSelectedEventId] = useState("review");
...
export default defineDoc({
  ...
  description:
    "排期查看器，用于展示周排期、月排期、全天事件和可点击的时间格；适合查看、选择和触发外部操作，不内置拖拽创建或事件编辑。",
  imports: [
  ...
  demo: {
    name: "ScheduleCalendarPreview",
    component: ScheduleCalendarPreview,
  },
  code: `
  ...
  sections: [
    ...
    },
    {
      ...
      code: `
        ...
        />;
      `,
      content: <SelectedScheduleCalendar />,
    },
    {
      title: "空态和禁用",
      code: `
  ...
  props: [
    ...
    },
    {
      ...
      type: '"week" | "month"',
      description:
        "受控排期视图；week 展示小时网格，month 展示月排期网格。两种视图都是桌面优先布局，移动端保留横向浏览。",
    },
    {
      name: "defaultView",
      type: '"week" | "month"',
      defaultValue: '"week"',
      description: "非受控默认排期视图。",
    },
    {
      name: "visibleDate",
      type: "Date",
      description: "受控当前展示日期；周视图定位周，月视图定位月份。",
    },
    {
      ...
      defaultValue: "今天所在视图",
      description:
        "非受控初始展示日期；week 锚定到所在周，month 锚定到所在月。",
    },
    {
      name: "events",
      ...
      defaultValue: "[]",
      description:
        "时段事件，start 和 end 使用 YYYY-MM-DD HH:mm；只按单日时段布局，跨天或无时间的事件会被忽略并提示。",
    },
    {
      name: "allDayEvents",
      type: "Array<ScheduleCalendarEvent>",
      defaultValue: "[]",
      description:
        "全天或日期区间事件，start 和 end 可以只传日期，end 为包含结束日。跨天排期优先放到这里表达。",
    },
    {
      name: "selectedEventId",
      type: "string",
      description: "当前选中的事件 id。",
    },
    {
      name: "selectedSlot",
      type: "string",
      description:
        "当前选中的空白时间格，格式为 YYYY-MM-DD 或 YYYY-MM-DD HH:mm。",
    },
    {
      name: "emptyText",
      type: "ReactNode",
      defaultValue: '"暂无日程"',
      description: "没有事件时展示的空态内容；不内置创建入口。",
    },
    {
      name: "disabledDate",
      type: "(value: string) => boolean",
      description: "禁用指定日期；会影响全天格和月视图日期格。",
    },
    {
      name: "disabledSlot",
      type: "(value: string) => boolean",
      description: "禁用指定时段格，value 为 YYYY-MM-DD HH:mm。",
    },
    {
      name: "slotMinutes",
      type: "number",
      defaultValue: "60",
      description: "时间格粒度；常用 15、30 或 60。",
    },
    {
      name: "startHour",
      type: "number",
      defaultValue: "8",
      description: "周排期网格的起始小时。",
    },
    {
      name: "endHour",
      type: "number",
      defaultValue: "18",
      description: "周排期网格的结束小时。",
    },
    {
      name: "renderEvent",
    ...
    },
    {
      ...
      description: "排期视图切换时触发。",
    },
    {
      name: "onVisibleDateChange",
      type: "(date: Date) => void",
      description: "排期面板翻页时触发。",
    },
    {
      name: "onSlotClick",
      type: "(value: string) => void",
      description:
        "点击空白时间格时触发，可用于打开外部创建流程；组件不内置创建交互。",
    },
    {
      name: "onEventClick",
      type: "(event: ScheduleCalendarEvent) => void",
      description:
        "点击事件块时触发，可用于打开外部详情或编辑流程；组件不内置事件编辑。",
    },
  ],
});
