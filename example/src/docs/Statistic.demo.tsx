...
export default defineDoc({
  ...
  name: "Statistic",
  category: "content",
  packageName: "willa/Statistic",
  description: "用于展示指标、趋势和轻量统计数据。",
  imports: [{ name: "Statistic", from: "willa/Statistic" }],
  css: "willa/Statistic.css",
  demo: {
    name: "Statistic",
    component: Statistic,
    props: {
  ...
  props: [
    ...
    { name: "trendLabel", type: "ReactNode", description: "趋势文案。" },
    { name: "icon", type: "ReactNode", description: "指标图标。" },
    {
      name: "tone",
