...
export default defineDoc({
  ...
  name: "Watermark",
  category: "content",
  packageName: "willa/Watermark",
  description: "用于页面、卡片、预览区和导出区域的文本或图片水印覆盖层。",
  imports: [{ name: "Watermark", from: "willa/Watermark" }],
  css: "willa/Watermark.css",
  demo: {
    name: "Watermark",
    component: Watermark,
    props: {
      content: ["Willa Components", "Internal Preview"],
      gap: [88, 72],
      offset: [16, 20],
      children: (
        ...
        >
          <Card variant="outline" style={fullAreaStyle}>
            <Stack gap="sm">
              <strong>图片或品牌型水印</strong>
              <span
                style={{ color: "var(--willa-text-soft)", fontSize: "0.92rem" }}
              >
                适合媒体资产、截图、分享面板和品牌物料区。
              </span>
            </Stack>
  ...
  props: [
    {
      name: "children",
      type: "ReactNode",
      description: "作为水印底层内容区域渲染的子节点。",
    },
    {
      name: "content",
      type: "string | Array<string>",
      description: "水印文字内容。传数组时会按多行渲染。",
    },
    {
      name: "image",
      type: "string",
      description: "水印图片地址，适合品牌标识或图形水印。",
    },
    {
      name: "width",
      type: "number",
      defaultValue: "152",
      description: "单个水印块的宽度，单位为 px。",
    },
    {
      name: "height",
      type: "number",
      defaultValue: "84",
      description: "单个水印块的高度，单位为 px。",
    },
    {
      name: "gap",
      type: "[number, number]",
      defaultValue: "[96, 88]",
      description: "水印块横向和纵向的重复间距。",
    },
    {
      name: "offset",
      type: "[number, number]",
      defaultValue: "[24, 12]",
      description: "水印背景起始偏移，用于微调排布位置。",
    },
    {
      name: "rotate",
      type: "number",
    ...
    },
    {
      ...
      type: "number",
      defaultValue: "1",
      description: "整个水印层的透明度。",
    },
    {
      name: "zIndex",
      type: "number",
      defaultValue: "1",
      description: "水印层相对内容区域的层级。",
    },
    {
      name: "fixed",
      type: "boolean",
      defaultValue: "false",
      description: "是否以 fixed 形式覆盖当前视口。",
    },
    {
      name: "font",
      type: "WatermarkFont",
      description: "文字水印的颜色、字号、字重和字距配置。",
    },
    {
      name: "className",
      type: "string",
