...
export default defineDoc({
  ...
  props: [
    ...
    {
      name: "CommentListItem.avatarSrc",
      type: "string",
      group: "CommentListItem",
      description: "评论作者头像地址。",
    },
    {
      name: "CommentListItem.avatarName",
      type: "string",
      group: "CommentListItem",
      description: "评论作者头像备用名称。",
    },
    {
      name: "CommentListItem.avatar",
      type: "ReactNode",
      group: "CommentListItem",
      description: "自定义评论作者头像节点。",
    },
    {
      name: "CommentListItem.meta",
      type: "ReactNode",
      group: "CommentListItem",
      description: "评论元信息。",
    },
    {
      name: "CommentListItem.quote",
      type: "CommentQuote",
      group: "CommentListItem",
      description: "评论引用内容。",
    },
    {
      name: "CommentListItem.actions",
      type: "ReactNode",
      group: "CommentListItem",
      description: "评论操作区。",
    },
    {
      name: "CommentListItem.footer",
      type: "ReactNode",
      group: "CommentListItem",
      description: "评论底部内容。",
    },
    {
      name: "CommentListItem.size",
      type: '"sm" | "md"',
      group: "CommentListItem",
      defaultValue: '"md"',
      description: "评论尺寸。",
    ...
    {
      name: "CommentListItem.highlighted",
      type: "boolean",
      group: "CommentListItem",
      defaultValue: "false",
      description: "是否高亮评论。",
