...
import { SourceCard, type SourceCardProps } from "willa/SourceCard";
...
const sources: Array<SourceCardProps> = [
  ...
  {
    title: "Willa 官网文档",
    description: "用于展示外部网页来源、知识库链接和引用跳转入口。",
    source: "willa.dev",
    url: "https://willa.dev/components/source-card",
    meta: "网页",
    icon: <GlobeIcon />,
    href: "#",
  },
...
export default defineDoc({
  ...
  demo: {
    name: "SourceCardPreview",
    component: SourceCardPreview,
  },
  code: `
  ...
  props: [
    ...
    },
    {
      name: "description",
      type: "ReactNode",
      description: "来源片段或摘要，最多显示两行。",
    },
    {
      name: "source",
      type: "ReactNode",
      description: "来源名称，例如文件名、知识库名或站点名。",
    },
    {
      name: "url",
      type: "string",
      description: "来源路径或链接文案。",
    },
    {
      name: "meta",
      type: "ReactNode",
      description: "右上角补充信息，例如命中率、类型或引用编号。",
    },
    {
      name: "icon",
      type: "ReactNode",
    ...
    },
    {
      ...
      description: "点击来源时触发。未传 href 但传 onOpen 时组件渲染为按钮。",
    },
  ],
});
