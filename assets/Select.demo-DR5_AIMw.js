import{aL as e}from"./index-ByRG9JfA.js";import{S as t}from"./index-CCw4MR4T.js";import{d as i}from"./defineDoc-CVYFOnv2.js";import"./index-BkqT4CVu.js";import"./useSelectablePanel-m0I6qYtr.js";import"./useFloatingPanel-CehWN5PB.js";const a={display:"grid",gap:"0.9rem",maxWidth:"42rem"},l=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],u=i({id:"select",name:"Select",category:"form",packageName:"willa/Select",description:"用于单选下拉，适合表单、筛选和配置场景。",imports:[{name:"Select",from:"willa/Select"}],css:"willa/Select.css",demo:{name:"Select",component:t,props:{options:l,defaultValue:"balanced",width:"100%"}},code:`
