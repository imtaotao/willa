import{l as e}from"./aidly.esm-bundler-DaTrP4tr.js";import{b as t,tt as n,u as r}from"./react-icons.esm-mVdwEXuX.js";import{t as i}from"./defineDoc-Cid5xIoZ.js";import{t as a}from"./style-POIZQ0ik.js";import{t as o}from"./style-Ckr7mJhn.js";var s=e(),c=`https://github.com/openai.png`,l={display:`grid`,gap:`1rem`,width:`min(100%, 58rem)`,border:`1px solid var(--willa-line)`,borderRadius:`0.9rem`,background:`var(--willa-panel-bg)`,padding:`1rem`},u=i({id:`message-actions`,name:`MessageActions`,category:`ai`,packageName:`willa/MessageActions`,description:`用于 AI 消息上的复制、重试、采纳和反馈等轻量操作。`,imports:[{name:`MessageActions`,from:`willa/MessageActions`}],css:`willa/MessageActions.css`,demo:{name:`MessageActionsPreview`,component:()=>(0,s.jsx)(`div`,{style:l,children:(0,s.jsxs)(a,{role:`assistant`,name:`Willa AI`,avatarSrc:c,meta:`已生成`,actions:(0,s.jsx)(o,{items:[{id:`copy`,label:`复制`,icon:(0,s.jsx)(t,{}),copyText:`可以先按影响面、紧急程度和实现成本拆分。
优先处理阻塞登录的问题，其次是批量导出，最后再看主题配置。`},{id:`regenerate`,label:`重试`,icon:(0,s.jsx)(n,{})},{id:`accept`,label:`采纳`,icon:(0,s.jsx)(r,{}),tone:`positive`}]}),children:[(0,s.jsx)(`p`,{children:`可以先按影响面、紧急程度和实现成本拆分。`}),(0,s.jsx)(`p`,{children:`优先处理阻塞登录的问题，其次是批量导出，最后再看主题配置。`})]})})},code:`
  ...
  `,sections:[{title:`文字标签`,code:`
        ...
        />;
      `,content:(0,s.jsx)(o,{showLabels:!0,variant:`soft`,items:[{id:`copy`,label:`复制`,icon:(0,s.jsx)(t,{}),copyText:`生成结果摘要`},{id:`retry`,label:`重新生成`,icon:(0,s.jsx)(n,{})},{id:`accept`,label:`采纳`,icon:(0,s.jsx)(r,{}),tone:`positive`}]})},{title:`状态`,code:`
        <MessageActions
          showLabels
          items={[
            {
