import{b3 as t,Y as l,h as m,b5 as n,am as u}from"./index-CX7dlnN9.js";import{A as a}from"./index-idk7e8RV.js";/* empty css              *//* empty css              */import{d as h}from"./defineDoc-DzpR41Bj.js";import"./index-CIPuiTfD.js";import"./media-Bt1qVdZv.js";import"./index-C2AOGhPo.js";import"./dom-DvRKQOia.js";import"./index-BCmVO6DV.js";const g=[{id:"feedback",name:"feedback.csv",meta:"12 KB",href:"data:text/csv;charset=utf-8,id,feedback%0A1,export%20is%20slow",downloadName:"feedback.csv",previewType:"csv",text:`id,feedback
...
- 优化文件预览
- 补充上下文附件`},{id:"screenshot",name:"screen-capture.png",meta:"428 KB",href:"https://interactive-examples.mdn.mozilla.net/media/examples/plumeria.jpg",previewType:"image",alt:"屏幕截图预览"},{id:"brief",name:"research-brief.pdf",meta:"上传中",status:"uploading",progress:64},{id:"error",name:"customer-export.xlsx",meta:"上传失败",status:"error",actions:t.jsx(m,{size:"sm",variant:"ghost",icon:t.jsx(u,{}),children:"重试"})}],A={display:"grid",gap:"0.85rem",width:"min(100%, 48rem)"},I={display:"grid",width:"min(100%, 34rem)"},L=()=>{const[s,r]=n.useState(g),[o,c]=n.useState(36);n.useEffect(()=>{const e=window.setInterval(()=>{c(i=>i>=96?12:i+12)},900);return()=>window.clearInterval(e)},[]);const d=s.map(e=>e.status==="uploading"?{...e,progress:o}:e);return t.jsx("div",{style:A,children:t.jsx(a,{items:d,onRemove:e=>r(i=>i.filter(p=>p.id!==e.id))})})},N=h({id:"attachment-list",name:"AttachmentList",category:"ai",packageName:"willa/AttachmentList",description:"用于展示 AI 输入、消息和上下文面板里的附件列表。带 href 的附件默认在当前页面弹窗预览。",imports:[{name:"AttachmentList",from:"willa/AttachmentList"}],css:"willa/AttachmentList.css",demo:{name:"AttachmentListPreview",component:L},code:`
