import{ay as e,y as r,c as s,Q as i,g as n}from"./index-DrRUehET.js";import{F as t,a}from"./index-87hoz7lD.js";import{F as c}from"./index-DvhQuW5X.js";import{F as m}from"./index-CDKqkqc4.js";import{F as o}from"./index-uHmBCy45.js";import{I as l}from"./index-DkIqrJ94.js";/* empty css              *//* empty css              */import{d}from"./defineDoc-CvDLWAkX.js";const F={display:"grid",gap:"0.85rem",maxWidth:"42rem"},y=d({id:"form-message",name:"FormMessage",category:"form",packageName:"willa/FormMessage",description:"用于表单中的辅助提示、状态反馈和提交结果说明。",imports:[{name:"FormMessage",from:"willa/FormMessage"}],css:"willa/FormMessage.css",demo:{name:"FormMessage",component:o,props:{tone:"info",icon:e.jsx(i,{})},children:"保存后会立即同步到当前工作区。"},code:`
  ...
  `,sections:[{title:"表单内使用",code:`
      ...
      `,content:e.jsx(t,{actions:e.jsxs(c,{children:[e.jsx(s,{variant:"ghost",children:"取消"}),e.jsx(s,{type:"submit",children:"保存"})]}),children:e.jsxs(a,{title:"发布配置",description:"适合展示提交前后的状态信息。",children:[e.jsx(m,{label:"配置名称",required:!0,children:e.jsx(l,{defaultValue:"模型发布策略",width:"100%"})}),e.jsx(o,{tone:"warning",icon:e.jsx(r,{}),children:"当前配置会影响线上模型，请确认灰度范围。"})]})})},{title:"状态类型",code:`
