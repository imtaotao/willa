import{aY as e,$ as i,h as t,a_ as c}from"./index-BEjXDIF1.js";import{C as s}from"./index-CLsppuiu.js";import{F as r,a as l}from"./index-X_isHRgg.js";import{F as a}from"./index-Ci1BYPaV.js";import{F as o}from"./index-BJY91pZe.js";import{F as p}from"./index-DkSqBaql.js";import{S as F}from"./index-OGMmrV0k.js";/* empty css              *//* empty css              */import{d as b}from"./defineDoc-hiznnev0.js";import"./index-C01hXrOB.js";import"./useSelectablePanel-n9hLNA3X.js";import"./floatingPanelParts-CdGfAbbM.js";import"./useFloatingPanel-zUVgG4FV.js";const f=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],h=()=>{const[n,m]=c.useState(!1),d=u=>{u.preventDefault(),m(!0),window.setTimeout(()=>m(!1),900)};return e.jsx(r,{onSubmit:d,actions:e.jsxs(a,{children:[e.jsx(t,{variant:"ghost",children:"取消"}),e.jsx(t,{type:"submit",loading:n,children:"保存"})]}),children:e.jsxs(l,{title:"创建 AI 配置",description:"用于产品后台、模型配置和轻量提交场景。",children:[e.jsx(o,{label:"配置名称",required:!0,children:e.jsx(i,{name:"name",defaultValue:"内容生成助手",width:"100%"})}),e.jsx(o,{label:"默认模式",children:e.jsx(F,{name:"mode",defaultValue:"balanced",options:f,width:"100%"})}),e.jsx(s,{name:"search",defaultChecked:!0,label:"允许联网检索",description:"回答前可以读取公开资料。"})]})})},M=b({id:"form",name:"Form",category:"form",packageName:"willa/Form",description:"统一表单语义、表单级错误、提交状态和底部操作区。",imports:[{name:"Form",from:"willa/Form"}],css:"willa/Form.css",demo:{name:"FormPreview",component:h},code:`
