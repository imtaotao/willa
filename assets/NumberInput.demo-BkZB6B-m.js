import{a$ as f,b2 as Pe,aZ as t,a0 as Ee,q as Te,n as Oe,aK as We,a8 as G,ah as U,B as $e,h as $}from"./index-aNmIUM73.js";/* empty css              */import{d as Ke}from"./defineDoc-RwdT-oK2.js";const r=f.forwardRef((e,l)=>{const{value:u,defaultValue:i=null,constraints:a,stepper:s,behavior:o,format:c,slots:p,status:q,variant:Z="outline",className:xe,disabled:_,invalid:Ne,readOnly:J,inputMode:ve="decimal",onBlur:z,onChange:R,onKeyDown:A,onValueChange:Ie,...y}=e,I=a==null?void 0:a.min,h=a==null?void 0:a.max,V=a==null?void 0:a.precision,he=(s==null?void 0:s.step)??1,ge=(s==null?void 0:s.controls)??!0,D=s==null?void 0:s.onStep,ye=(o==null?void 0:o.changeOnBlur)??!0,Ve=(o==null?void 0:o.keyboard)??!0,L=o==null?void 0:o.onPressEnter,F=c==null?void 0:c.decimalSeparator,P=c==null?void 0:c.formatter,E=c==null?void 0:c.parser,Q=p==null?void 0:p.addonBefore,X=p==null?void 0:p.addonAfter,Y=p==null?void 0:p.prefix,ee=p==null?void 0:p.suffix,we=f.useMemo(()=>H(i,{min:I,max:h,precision:V,clamp:!0}),[i,h,I,V]),[b,te]=Pe({value:u,defaultValue:we,onChange:Ie}),w=f.useMemo(()=>me(b,P),[b,P]),[ae,j]=f.useState(w),[ne,le]=f.useState(!1),N=M(I),v=M(h),d=qe(ge),je=(d==null?void 0:d.incrementLabel)??"增加数值",Se=(d==null?void 0:d.decrementLabel)??"减少数值",T=!_&&!J,Ce=!T||b!==null&&v!==null&&b>=v,Be=!T||b!==null&&N!==null&&b<=N,ke=Ze(Z),Me=Ne||q==="error",S=!!Q,C=!!X,re=!!Y,O=!!ee,se=!!d,ze=S||re,ue=O||se||C,Re=S&&C;f.useEffect(()=>{ne||j(w)},[ne,w]);const B=(n,m)=>{const x=H(n,{min:I,max:h,precision:V,clamp:m});return te(x),j(me(x,P)),x},k=(n,m=1,x)=>{if(!T)return;const oe=K(ae,E,F),ce=_e({currentValue:b,inputValue:oe.valid?oe.value:null}),W=Ue(he)*m,Fe=ce===null?Je({direction:n,max:v,min:N,stepAmount:W}):ce+n*W,pe=B(Fe,!0);pe!==null&&(D==null||D(pe,{emitter:x,offset:n*W,type:n>0?"up":"down"}))},Ae=n=>{const m=n.target.value,x=K(m,E,F);j(m),x.valid&&te(H(x.value,{min:I,max:h,precision:V,clamp:!1})),R==null||R(n)},De=n=>{le(!1);const m=K(n.target.value,E,F);m.valid?B(m.value,ye):j(w),z==null||z(n)},Le=n=>{A==null||A(n),!(n.defaultPrevented||n.nativeEvent.isComposing)&&(n.key==="Enter"&&(L==null||L(n)),Ve&&(n.key==="ArrowUp"&&(n.preventDefault(),k(1,n.shiftKey?10:1,"keyboard")),n.key==="ArrowDown"&&(n.preventDefault(),k(-1,n.shiftKey?10:1,"keyboard")),n.key==="Home"&&N!==null&&(n.preventDefault(),B(N,!0)),n.key==="End"&&v!==null&&(n.preventDefault(),B(v,!0))))},ie=n=>{n.preventDefault()};return t.jsx(Ee,{...y,ref:l,type:"text",role:"spinbutton",variant:ke,className:We("willa-number-input",`willa-number-input--${Z}`,q==="warning"&&"willa-number-input--warning",ue&&"willa-number-input--with-trailing",S&&"willa-number-input--with-addon-before",C&&"willa-number-input--with-addon-after",Re&&"willa-number-input--segmented",O&&"willa-number-input--with-suffix",se&&"willa-number-input--with-controls",xe),inputMode:ve,value:ae,disabled:_,invalid:Me,readOnly:J,leadingAddon:ze?t.jsxs("span",{className:"willa-number-input-leading",children:[S?t.jsx("span",{className:"willa-number-input-addon-before",children:Q}):null,re?t.jsx("span",{className:"willa-number-input-prefix",children:Y}):null]}):null,"aria-valuemin":N??void 0,"aria-valuemax":v??void 0,"aria-valuenow":b??void 0,trailingAddon:ue?t.jsxs("span",{className:"willa-number-input-trailing",children:[O?t.jsx("span",{className:"willa-number-input-suffix",children:ee}):null,d?t.jsxs("span",{className:"willa-number-input-controls",children:[t.jsx("button",{className:"willa-number-input-control-button",type:"button",tabIndex:-1,"aria-label":je,disabled:Ce,onMouseDown:ie,onClick:()=>k(1,1,"handler"),children:t.jsx("span",{className:"willa-number-input-control-icon","aria-hidden":"true",children:d.upIcon??t.jsx(Te,{})})}),t.jsx("button",{className:"willa-number-input-control-button",type:"button",tabIndex:-1,"aria-label":Se,disabled:Be,onMouseDown:ie,onClick:()=>k(-1,1,"handler"),children:t.jsx("span",{className:"willa-number-input-control-icon","aria-hidden":"true",children:d.downIcon??t.jsx(Oe,{})})})]}):null,C?t.jsx("span",{className:"willa-number-input-addon-after",children:X}):null]}):null,onFocus:n=>{var m;le(!0),(m=y.onFocus)==null||m.call(y,n)},onBlur:De,onChange:Ae,onKeyDown:Le})});r.displayName="NumberInput";const me=(e,l)=>l?l(e):e===null?"":String(e),K=(e,l,u)=>{const i=l?l(e):He(e,u),a=String(i).trim();if(!a)return{valid:!0,value:null};const s=Number(a);return Number.isFinite(s)?{valid:!0,value:s}:{valid:!1}},He=(e,l)=>(l&&l!=="."?e.split(l).join("."):e).replace(/,/g,""),H=(e,l)=>{if(e===null||!Number.isFinite(e))return null;const u=M(l.min),i=M(l.max),a=Ge(l.precision);let s=e;return l.clamp&&(u!==null&&(s=Math.max(s,u)),i!==null&&(s=Math.min(s,i))),a!==null&&(s=Number(s.toFixed(a))),Object.is(s,-0)?0:s},Ge=e=>typeof e!="number"||!Number.isFinite(e)?null:Math.max(0,Math.trunc(e)),M=e=>typeof e=="number"&&Number.isFinite(e)?e:null,Ue=e=>Number.isFinite(e)&&e>0?e:1,qe=e=>e?typeof e=="boolean"?{}:e:null,Ze=e=>e==="filled"||e==="soft"?"soft":"outline",_e=e=>{const{currentValue:l,inputValue:u}=e;return u!==null?u:l!==null?l:null},Je=e=>{const{direction:l,max:u,min:i,stepAmount:a}=e;return l>0?i??a:u??-a},g={display:"grid",gap:"0.85rem",maxWidth:"34rem",marginInline:"auto"},de={display:"flex",flexWrap:"wrap",alignItems:"center",gap:"0.75rem",maxWidth:"42rem",marginInline:"auto"},Qe={display:"flex",flexWrap:"wrap",gap:"0.55rem"},be={display:"grid",gap:"0.75rem",width:"min(100%, 34rem)",marginInline:"auto"},Xe=()=>{const[e,l]=f.useState(6),[u,i]=f.useState(5),a=o=>{l(c=>fe((c??0)+o))},s=o=>{i(c=>fe((c??0)+o))};return t.jsxs("div",{style:g,children:[t.jsx(r,{value:e,constraints:{min:0,max:12},stepper:{controls:!1},slots:{addonBefore:t.jsx("button",{className:"willa-number-input-addon-action",type:"button","aria-label":"减少席位",onClick:()=>a(-1),children:t.jsx(G,{})}),addonAfter:t.jsx("button",{className:"willa-number-input-addon-action",type:"button","aria-label":"增加席位",onClick:()=>a(1),children:t.jsx(U,{})})},"aria-label":"席位数量"}),t.jsx(r,{value:u,constraints:{min:0,max:12},stepper:{controls:!1},slots:{addonBefore:t.jsx("button",{className:"willa-number-input-addon-action",type:"button","aria-label":"减少访客",onClick:()=>s(-1),children:t.jsx(G,{})}),addonAfter:t.jsx("button",{className:"willa-number-input-addon-action",type:"button","aria-label":"增加访客",onClick:()=>s(1),children:t.jsx(U,{})})},"aria-label":"访客数量"})]})},Ye=()=>{const[e,l]=f.useState(.7);return t.jsxs("div",{style:g,children:[t.jsx(r,{value:e,constraints:{min:0,max:2,precision:1},stepper:{step:.1},slots:{suffix:"temp"},"aria-label":"模型温度",onValueChange:l}),t.jsxs($e,{tone:"info",children:["当前温度：",e===null?"未设置":e.toFixed(1)]})]})},et=()=>{const e=f.useRef(null),l=()=>{var a;(a=e.current)==null||a.focus()},u=()=>{const a=e.current;a==null||a.focus(),a==null||a.setSelectionRange(a.value.length,a.value.length)},i=()=>{var a;(a=e.current)==null||a.select()};return t.jsxs("div",{style:be,children:[t.jsxs("div",{style:Qe,children:[t.jsx($,{variant:"outline",onClick:l,children:"Focus"}),t.jsx($,{variant:"outline",onClick:u,children:"Focus last"}),t.jsx($,{variant:"outline",onClick:i,children:"Select all"})]}),t.jsx(r,{ref:e,defaultValue:999,stepper:{controls:!1},"aria-label":"可编程聚焦数字"})]})},fe=e=>Math.min(12,Math.max(0,e)),lt=Ke({id:"number-input",name:"NumberInput",displayName:"数字输入",category:"form",packageName:"willa/NumberInput",description:"用于价格、数量、比例和模型参数配置的数字输入框。",imports:[{name:"NumberInput",from:"willa/NumberInput"}],css:"willa/NumberInput.css",demo:{name:"NumberInput",component:r,props:{defaultValue:80,constraints:{min:0,max:100},slots:{suffix:"%"},width:"16rem","aria-label":"完成度"}},code:`
  ...
  `,sections:[{title:"基础用法",code:`
      ...
      `,content:t.jsx(Xe,{})},{title:"格式化",code:`
        <div style={stackStyle}>
          <NumberInput
            defaultValue={12800}
            constraints={{ min: 0 }}
