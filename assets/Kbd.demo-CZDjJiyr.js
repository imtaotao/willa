import{b1 as e,Y as r,a2 as t,a3 as s}from"./index-Kfv3pNKk.js";/* empty css              */import{d}from"./defineDoc-EZFsevgg.js";function c(){return e.jsxs("p",{children:["按 ",e.jsx(s,{keys:["⌘","K"]})," 打开命令面板，或按 ",e.jsx(t,{children:"Esc"})," ","关闭当前浮层。"]})}const a=d({id:"kbd",name:"Kbd",packageName:"willa/Kbd",description:"用于展示键盘按键、快捷键和命令提示的内联组件。",imports:[{name:"Kbd, KbdShortcut",from:"willa/Kbd"},{name:"Group",from:"willa/Group"}],css:"willa/Kbd.css",demo:{name:"KbdPreview",component:c},code:`
