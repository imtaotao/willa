import{b0 as c,a_ as a,aL as y,C as je,aJ as Se,aK as $,h as O}from"./index-DQDKl_tO.js";import{C as Fe}from"./index-DHS-Ma9m.js";import{F as $e,a as Ce}from"./floatingPanelParts-gQ_j0sFL.js";import{u as Me}from"./useFloatingPanel-BLTdbNRy.js";import{F as Ne,a as We}from"./index-BuD2FJNo.js";import{F as Re}from"./index-S2oNO-CX.js";import{F as ze}from"./index-DcHferaV.js";import{F as Ae}from"./index-BIHCd_vA.js";/* empty css              */import{d as Be}from"./defineDoc-DXtOPYIJ.js";function o(e){const{ref:t,picker:r="calendar",mode:n="month",wheelColumns:i="date",range:d=!1,size:f="md",variant:x="outline",width:U,invalid:X=!1,placeholder:Z,name:z,value:A,defaultValue:ee="",min:te,max:ae,markers:re=[],getMarker:le,disabledDate:ne,showScrollbar:ie=!1,onValueChange:P,className:se,disabled:g,style:oe,id:de,onBlur:ce,onClick:V,onKeyDown:v,...b}=e,ue=c.useId(),B=de??ue,j=`${B}-panel`,E=`${j}-label`,I=c.useRef(null),S=c.useRef(null),F=c.useRef(null),[u,h]=c.useState(!1),[me,pe]=c.useState(ee),p=A??me,D=c.useMemo(()=>qe(i),[i]),he=c.useCallback(()=>h(!1),[]),{position:fe,updatePosition:L}=Me({open:u,rootRef:I,triggerRef:S,panelRef:F,minWidth:r==="wheel"?Ge(D.length):void 0,matchTriggerWidth:r==="wheel",fullWidthBelow:520,fallbackHeight:290,onClose:he}),T=X||b["aria-invalid"]===!0||b["aria-invalid"]==="true",ye=Ie({width:U,style:oe}),we=q(p,{mode:n,picker:r,range:d})??Z??Y({mode:n,picker:r,range:d}),ke=`${Y({mode:n,picker:r,range:d})}面板`,ge=l=>{S.current=l,Se(t,l)};c.useEffect(()=>{u&&L()},[u,n,r,D.length,L]),c.useEffect(()=>{var l;!u||r!=="wheel"||(l=F.current)==null||l.querySelectorAll(".willa-date-picker-wheel-option--selected").forEach(s=>{s.scrollIntoView({block:"center",behavior:"smooth"})})},[p,u,r]);const K=(l,s)=>{A===void 0&&pe(l),P==null||P(l),s&&h(!1)},be=l=>{var m;const s=!d||!!((m=Q(l))!=null&&m.end);K(l,s)},De=(l,s)=>{const m=N(p),ve=k({...m,[l]:s});K(H(ve),!1)},xe=l=>{if(v==null||v(l),!l.defaultPrevented){if(l.key==="Escape"){h(!1);return}(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),h(s=>!s))}},Pe=l=>{var s;l.key==="Escape"&&(l.stopPropagation(),h(!1),(s=S.current)==null||s.focus())},Ve=u?a.jsx($e,{open:u,children:a.jsxs(Ce,{panelRef:F,id:j,className:y("willa-date-picker-panel",`willa-date-picker-panel--${n}`,r==="wheel"&&"willa-date-picker-panel--wheel"),position:fe,role:"dialog",ariaLabelledBy:E,onKeyDown:Pe,children:[a.jsx("span",{id:E,className:"willa-date-picker-panel-label",children:ke}),r==="wheel"?a.jsx("div",{className:"willa-date-picker-wheel",style:{gridTemplateColumns:`repeat(${D.length}, minmax(3.75rem, 1fr))`},children:D.map(l=>{const s=N(p);return a.jsxs("div",{className:"willa-date-picker-wheel-column",children:[a.jsx("div",{className:"willa-date-picker-wheel-label",children:Ee[l]}),a.jsx("div",{className:y("willa-date-picker-wheel-options",ie&&"willa-date-picker-wheel-options--scrollbar"),children:He(l,s).map(m=>a.jsx("button",{className:y("willa-date-picker-wheel-option",m.value===s[l]&&"willa-date-picker-wheel-option--selected"),type:"button",onClick:()=>De(l,m.value),children:m.label},m.value))})]},l)})}):a.jsx(Fe,{className:"willa-date-picker-calendar",mode:n,range:d,value:p,min:te,max:ae,markers:re,getMarker:le,disabledDate:ne,onValueChange:be})]})}):null;return a.jsxs("span",{ref:I,className:y("willa-date-picker",`willa-date-picker--${f}`,`willa-date-picker--${x}`,u&&"willa-date-picker--open",g&&"willa-date-picker--disabled",T&&"willa-date-picker--invalid",se),style:ye,"aria-disabled":g||void 0,children:[z?a.jsx("input",{type:"hidden",name:z,value:Je(p),disabled:g}):null,a.jsxs("button",{...b,ref:ge,id:B,type:"button",className:"willa-date-picker-control",disabled:g,"aria-expanded":u,"aria-controls":u?j:void 0,"aria-haspopup":"dialog","aria-invalid":T||b["aria-invalid"],onBlur:ce,onClick:l=>{V==null||V(l),l.defaultPrevented||h(s=>!s)},onKeyDown:xe,children:[a.jsx("span",{className:y("willa-date-picker-value",!q(p,{mode:n,picker:r,range:d})&&"willa-date-picker-value--placeholder"),children:we}),a.jsx(je,{className:"willa-date-picker-icon","aria-hidden":"true"})]}),Ve]})}o.displayName="DatePicker";const Ee={year:"年",month:"月",day:"日"},Ie=e=>{const{width:t,style:r}=e;return{...r,...t===void 0?void 0:{width:t}}},Y=e=>{const{mode:t,picker:r,range:n}=e;if(r==="wheel")return"选择日期";const i={year:"年份",month:"月份",week:"周",day:"日期"};return n?`选择${i[t]}范围`:`选择${i[t]}`},G=e=>{if(!/^\d{4}-\d{2}-\d{2}$/.test(e))return null;const[t,r,n]=e.split("-").map(Number),i=new Date(t,r-1,n);return i.getFullYear()!==t||i.getMonth()!==r-1||i.getDate()!==n?null:i},M=e=>{const t=e.getFullYear(),r=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0");return`${t}-${r}-${n}`},Le=e=>{const t=new Date(e);return t.setDate(e.getDate()-e.getDay()),Te(t)},_=e=>{const t=Le(e);return t.setDate(t.getDate()+6),t},Te=e=>new Date(e.getFullYear(),e.getMonth(),e.getDate()),q=(e,t)=>{const{mode:r,picker:n,range:i}=t;if(n==="wheel")return typeof e=="string"&&e?_e(e):void 0;if(i){const d=Q(e);return d!=null&&d.start?Ke(d,r):""}return typeof e=="string"&&e?R(e,r):void 0},Ke=(e,t)=>{const r=Oe(e.start,t),n=e.end?Ye(e.end,t):"";return n?`${r} - ${n}`:`${r} -`},Oe=(e,t)=>t!=="week"?R(e,t):e,Ye=(e,t)=>{if(t!=="week")return R(e,t);const r=G(e);return r?M(_(r)):e},R=(e,t)=>{if(t==="week"){const r=G(e);return r?`${M(r)} - ${M(_(r))}`:e}return e},qe=e=>Array.isArray(e)?e:["year","month","day"],Ge=e=>Math.max(244,e*4.25*16),N=e=>{const t=new Date,r={year:t.getFullYear(),month:t.getMonth()+1,day:t.getDate()};if(typeof e!="string"||!e)return k(r);const n=e.match(/^(\d{4})-(\d{2})-(\d{2})$/);if(n)return k({year:Number(n[1]),month:Number(n[2]),day:Number(n[3])});const i=e.match(/^(\d{4})-(\d{2})$/);return k(i?{year:Number(i[1]),month:Number(i[2]),day:1}:r)},k=e=>{const t=$(Math.trunc(e.year),1900,2100),r=$(Math.trunc(e.month),1,12),n=J(t,r);return{year:t,month:r,day:$(Math.trunc(e.day),1,n)}},H=e=>`${e.year}-${W(e.month)}-${W(e.day)}`,_e=e=>{const t=N(e);return H(t)},He=(e,t)=>e==="year"?C(1900,2100,""):e==="month"?C(1,12,"月"):C(1,J(t.year,t.month),"日"),C=(e,t,r,n=!1)=>Array.from({length:t-e+1},(i,d)=>{const f=e+d,x=n?W(f):String(f);return{value:f,label:`${x}${r}`}}),J=(e,t)=>new Date(e,t,0).getDate(),W=e=>String(e).padStart(2,"0"),Je=e=>typeof e=="string"?e:e.end?`${e.start},${e.end}`:e.start,Q=e=>typeof e=="string"?null:e,w={display:"grid",gap:"0.76rem",maxWidth:"42rem"},Qe={display:"grid",gap:"0.76rem",gridTemplateColumns:"repeat(auto-fit, minmax(13rem, 1fr))"},Ue=[{value:"2026-06-16",label:"发布",tone:"success"},{value:"2026-06-19",label:"端午",tone:"warning"},{value:"2026-06-24",label:"维护",tone:"info"}],Xe=()=>{const[e,t]=c.useState({start:"2026-06",end:"2026-09"});return a.jsx(o,{range:!0,value:e,onValueChange:t,width:"100%","aria-label":"选择分析周期"})},dt=Be({id:"date-picker",name:"DatePicker",category:"form",packageName:"willa/DatePicker",description:"用于选择年份、月份、周和日期范围。",imports:[{name:"DatePicker",from:"willa/DatePicker"}],css:"willa/DatePicker.css",demo:{name:"DatePickerPreview",component:Xe},code:`
