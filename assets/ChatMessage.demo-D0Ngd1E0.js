import{a$ as e,m as r,D as n,am as c}from"./index-D8h6quRF.js";import{C as a}from"./index-DzkNbzrJ.js";import{M as l}from"./index-DbX0g71w.js";import{d as m}from"./defineDoc-DgVgVUyg.js";import"./index-Djx3EYPP.js";const i="https://github.com/imtaotao.png",t="https://github.com/openai.png",p="https://github.com/vercel.png",o="https://github.com/github.png",s={display:"grid",gap:"1rem",width:"min(100%, 58rem)",border:"1px solid var(--willa-line)",borderRadius:"0.9rem",background:"var(--willa-panel-bg)",padding:"1rem"},d=()=>e.jsxs("div",{style:s,children:[e.jsx(a,{role:"assistant",name:"Willa AI",avatarSrc:t,meta:"准备就绪",compact:!0,children:"你可以把产品反馈、会议纪要或用户访谈贴进来，我会帮你整理结构。"}),e.jsx(a,{role:"user",showAvatar:!0,avatarSrc:i,avatarAlt:"imtaotao",meta:"刚刚",children:"帮我把这段产品反馈整理成三个优先级。"}),e.jsxs(a,{role:"assistant",name:"Willa AI",avatarSrc:t,meta:"已生成",actions:e.jsx(l,{items:[{id:"copy",label:"复制",icon:e.jsx(n,{}),copyText:`可以先按影响面、紧急程度和实现成本拆分。
我建议优先处理登录失败，其次是批量导出，最后再看主题配置。`},{id:"retry",label:"重试",icon:e.jsx(c,{})}]}),footer:"基于 12 条反馈归纳",children:[e.jsx("p",{children:"可以先按影响面、紧急程度和实现成本拆分。"}),e.jsx("p",{children:"我建议优先处理登录失败，其次是批量导出，最后再看主题配置。"})]})]}),y=m({id:"chat-message",name:"ChatMessage",category:"ai",packageName:"willa/ChatMessage",description:"用于 AI 对话流里的单条消息，支持角色、头像、状态和操作区。",imports:[{name:"ChatMessage",from:"willa/ChatMessage"}],css:"willa/ChatMessage.css",demo:{name:"ChatMessagePreview",component:d},code:`
