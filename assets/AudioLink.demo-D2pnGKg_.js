import{l as e}from"./aidly.esm-bundler-DaTrP4tr.js";import{t}from"./defineDoc-Cid5xIoZ.js";import{t as n}from"./AudioLink-g_PyR_mb.js";var r=e(),i=t({id:`audio-link`,name:`AudioLink`,packageName:`willa/AudioLink`,description:`可展开为小播放器的内联音频链接。`,imports:[{name:`AudioLink`,from:`willa/AudioLink`}],css:`willa/AudioLink.css`,propGroups:[{title:`媒体事件`,description:`这些事件透传给内联 audio 元素；仅外部链接状态不会触发。`}],demo:{name:`AudioLink`,component:n,props:{label:`播放音乐片段`,provider:`网易云音乐`,volume:.4,src:`http://music.163.com/song/media/outer/url?id=3370714076.mp3`,href:`http://music.163.com/song?id=3370714076`}},code:`
  ...
  `,sections:[{title:`仅外部链接`,code:`
        <AudioLink
          ...
          href="http://music.163.com/song?id=3370714076"
        />;
      `,content:(0,r.jsx)(n,{label:`打开音频来源`,provider:`网易云音乐`,href:`http://music.163.com/song?id=3370714076`})},{title:`文章相对资源`,code:`
      ...
      `,content:(0,r.jsx)(n,{provider:`MDX`,volume:.45,articleSourcePath:`/posts/audio-demo.mdx`,resolveAssetUrl:(e,t)=>`https://interactive-examples.mdn.mozilla.net/media/cc0-audio/${t.replace(/^\.\//,``)}`,src:`./t-rex-roar.mp3`,children:`播放文章音频`})},{title:`加载和错误状态`,code:`
        <AudioLink
          label="播放不可用音频"
          provider="Demo"
