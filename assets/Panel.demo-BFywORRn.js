import{b0 as e,ac as t,Y as n,B as a,h as i}from"./index-OxPLBg-5.js";/* empty css              *//* empty css              */import{d as o}from"./defineDoc-CWgp7IjM.js";const d=o({id:"panel",name:"Panel",category:"layout",packageName:"willa/Panel",description:"用于产品页面中的内容区域，提供标题、操作区、主体和底部区域。",imports:[{name:"Panel",from:"willa/Panel"},{name:"Button",from:"willa/Button"},{name:"Badge",from:"willa/Badge"},{name:"Group",from:"willa/Group"}],css:"willa/Panel.css",demo:{name:"Panel",component:t,props:{title:"发布概览",description:"展示当前组件发布状态。"},children:"已完成导出、样式和示例检查。"},code:`
