import{d as e,l as t,p as n}from"./aidly.esm-bundler-DaTrP4tr.js";import{t as r}from"./Button-O1aY2iqB.js";import{a as i}from"./index-y4TTR3pk.js";import"./style-B00R6KjV.js";import{t as a}from"./defineDoc-Cid5xIoZ.js";import{t as o}from"./MentionInput-CyZApkWE.js";var s=n(e(),1),c=t(),l={display:`grid`,gap:`0.85rem`,width:`min(100%, 52rem)`,margin:`0 auto`},u={display:`grid`,gap:`0.65rem`,fontSize:`0.84rem`,color:`var(--willa-text-soft)`},d={padding:`0.55rem 0.7rem`,borderRadius:`0.6rem`,background:`color-mix(in srgb, var(--willa-surface-bg) 86%, transparent)`,border:`1px solid var(--willa-list-border)`,lineHeight:1.5},f=[{id:`tom`,label:`Tom`,value:`tom`,description:`成员`,avatarSrc:`https://i.pravatar.cc/64?img=11`},{id:`lucy`,label:`Lucy`,value:`lucy`,description:`成员`,avatarSrc:`https://i.pravatar.cc/64?img=47`},{id:`nate`,label:`Nate`,value:`nate`,description:`成员`,avatarSrc:`https://i.pravatar.cc/64?img=12`}],p=[{id:`file-001`,label:`prd-briefing-v2`,value:`prd-briefing-v2`,description:`资源`},{id:`file-002`,label:`qa-反馈清单`,value:`qa-feedback`,description:`资源`},{id:`file-003`,label:`release-note`,value:`release-note`,description:`资源`}],m=[{id:`var-user`,label:`currentUser`,value:`currentUser`,description:`当前登录用户`},{id:`var-date`,label:`todayDate`,value:`todayDate`,description:`当天日期`},{id:`var-time`,label:`currentTime`,value:`currentTime`,description:`当前时间`}],h=[{trigger:`@`,label:`@`,description:`成员`,items:f},{trigger:`#`,label:`#`,description:`文件`,items:p},{trigger:`$`,label:`$`,description:`变量`,items:m}],g=()=>{let[e,t]=(0,s.useState)(``),[n,r]=(0,s.useState)(``);return(0,c.jsxs)(`div`,{style:l,children:[(0,c.jsx)(o,{value:e,onValueChange:t,users:f,resources:p,variables:m,placeholder:`输入 @ / # / $ 可快速提及相关实体`,footer:`输入 @、#、$ 分别表示用户、资源、变量`,onSubmit:(e,t)=>{r(e),t.clear()}}),n?(0,c.jsxs)(i,{tone:`success`,children:[`已提交：`,n]}):null]})},_=a({id:`mention-input`,name:`MentionInput`,category:`content`,packageName:`willa/MentionInput`,description:`支持多触发符提及能力的输入组件，适合提及用户、资源、变量等场景。`,imports:[{name:`MentionInput`,from:`willa/MentionInput`}],css:`willa/MentionInput.css`,demo:{name:`MentionInputPreview`,component:g},code:`
  ...
  `,sections:[{title:`多源提及`,code:`
        <MentionInput
          ...
          footer="按 @、#、$ 分别表示不同类型"
        />;
      `,content:(0,c.jsx)(g,{})},{title:`同一句混合提及`,code:`
        import { useState } from "react";
        import { MentionInput } from "willa/MentionInput";
        import "willa/MentionInput.css";
        ...
        <MentionInput
          ...
          footer={activeHint}
        />;
      `,content:(0,c.jsx)(()=>{let[e,t]=(0,s.useState)(`在 @Tom 的评论里，顺带提到 #prd-briefing-v2 和 $todayDate。`),[n,r]=(0,s.useState)(``),a=()=>r(`当前未触发提及`);return(0,c.jsxs)(`div`,{style:l,children:[(0,c.jsx)(o,{value:e,onValueChange:t,users:f,resources:p,variables:m,onMentionQuery:e=>{if(!e){a();return}let t={"@":`用户`,"#":`资源`,$:`变量`}[e.trigger]??`自定义`;r(`当前触发：${e.trigger}（${t}）｜关键词：${e.query||`未输入`}`)},footer:n||`在同一条输入中，分别用 @、#、$ 触发不同提及源`,mentionLabel:`插入`}),(0,c.jsxs)(`div`,{style:u,children:[(0,c.jsx)(i,{tone:`neutral`,children:`同一句可混合 @/#/$ 多源提及`}),(0,c.jsx)(`div`,{style:d,children:`说明：候选项根据输入的触发符自动按源过滤；如在 "@Tom" 后只搜成员，在 "#release-note" 后只搜资源，在 "$todayDate" 后只搜变量。`})]})]})},{})},{title:`自定义提及源`,code:`
