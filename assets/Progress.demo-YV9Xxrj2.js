import{ag as e,a8 as V}from"./index-DcKe6ljB.js";import{d as z}from"./defineDoc-CU4WbHug.js";function s({value:l=0,max:a=100,bufferValue:g,label:t,description:o,valueLabel:n,showValue:m,indeterminate:d,size:f="md",tone:h="default",width:x,height:y,className:j,...v}){const r=Number.isFinite(a)&&a>0?a:100,u=b(l,r),c=typeof g=="number"?b(g,r):void 0,p=n??`${Math.round(u/r*100)}%`,P=t||o||m||n,N={width:w(x),"--willa-progress-height-custom":w(y),"--willa-progress-value":`${u/r*100}%`,"--willa-progress-buffer-value":c===void 0?void 0:`${c/r*100}%`};return e.jsxs("div",{...v,className:V("willa-progress",`willa-progress--${f}`,`willa-progress--${h}`,d&&"willa-progress--indeterminate",j),style:{...N,...v.style},children:[P?e.jsxs("div",{className:"willa-progress-header",children:[e.jsxs("div",{className:"willa-progress-label-group",children:[t?e.jsx("div",{className:"willa-progress-label",children:t}):null,o?e.jsx("div",{className:"willa-progress-description",children:o}):null]}),m||n?e.jsx("div",{className:"willa-progress-value-label",children:p}):null]}):null,e.jsxs("div",{className:"willa-progress-track",role:"progressbar","aria-valuemin":0,"aria-valuemax":d?void 0:r,"aria-valuenow":d?void 0:u,"aria-valuetext":typeof p=="string"?p:void 0,children:[c===void 0?null:e.jsx("span",{className:"willa-progress-buffer"}),e.jsx("span",{className:"willa-progress-indicator"})]})]})}const b=(l,a)=>Number.isFinite(l)?Math.min(Math.max(l,0),a):0,w=l=>{if(typeof l=="number"&&Number.isFinite(l))return`${l}px`;if(typeof l=="string")return l.trim()},i={display:"grid",gap:"1rem",width:"min(100%, 28rem)"},S=()=>e.jsxs("div",{style:i,children:[e.jsx(s,{label:"下载进度",description:"willa-components.zip",value:68,showValue:!0,tone:"default"}),e.jsx(s,{label:"视频播放",value:42,bufferValue:64,size:"sm"})]}),$=z({id:"progress",name:"Progress",packageName:"willa/Progress",description:"用于视频播放、音频播放、下载任务和加载状态中的进度展示。",imports:[{name:"Progress",from:"willa/Progress"}],css:"willa/Progress.css",demo:{name:"ProgressPreview",component:S},code:`
