import{aZ as e}from"./index-aNmIUM73.js";import{S as t}from"./index-DtsIzdmQ.js";import{d as i}from"./defineDoc-RwdT-oK2.js";import"./index-C3eWCfX3.js";import"./useSelectablePanel-DKSGr01Q.js";import"./floatingPanelParts-DPERIkyo.js";import"./useFloatingPanel-DAQ1rMuD.js";const a={display:"grid",gap:"0.9rem",maxWidth:"42rem"},l=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],r=i({id:"select",name:"Select",category:"form",packageName:"willa/Select",description:"用于单选下拉，适合表单、筛选和配置场景。",imports:[{name:"Select",from:"willa/Select"}],css:"willa/Select.css",demo:{name:"Select",component:t,props:{options:l,defaultValue:"balanced",width:"100%"}},code:`
