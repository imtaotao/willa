import{ah as t,a9 as g,P as e,y}from"./index-BOgtpDIo.js";import{B as o}from"./index-C3KFRqo7.js";import{G as n}from"./index-DN8-mq7O.js";import{E as j}from"./index-CgMw8Ms8.js";/* empty css              */import{d as x}from"./defineDoc-Rn3qdaND.js";import"./heading-CBsR6W1X.js";function i(s){const{title:a="404 页面不存在",description:r="你访问的内容可能已被移动、删除，或暂时不可用。",icon:c=t.jsx(h,{}),actions:l,footer:d,variant:m="soft",size:p="lg",align:u="center",className:f,children:N}=s;return t.jsx(j,{className:g("willa-not-found",f),icon:c,title:a,description:r,actions:l,footer:d,variant:m,size:p,align:u,children:N})}function h(){return t.jsxs("span",{className:"willa-not-found-badge","aria-hidden":"true",children:[t.jsx("span",{className:"willa-not-found-badge-icon",children:t.jsx(e,{})}),t.jsx("span",{className:"willa-not-found-badge-code",children:"404"})]})}const F={display:"grid",gap:"0.9rem",width:"min(100%, 56rem)"},S=x({id:"not-found",name:"NotFound",packageName:"willa/NotFound",description:"用于 404、资源不存在和搜索路径失效等场景的缺省页面。",imports:[{name:"NotFound",from:"willa/NotFound"},{name:"Button",from:"willa/Button"},{name:"Group",from:"willa/Group"}],css:"willa/NotFound.css",demo:{name:"NotFound",component:i,props:{actions:t.jsxs(n,{gap:"sm",justify:"center",children:[t.jsx(o,{size:"sm",variant:"solid",children:"返回首页"}),t.jsx(o,{size:"sm",variant:"ghost",children:"查看文档"})]})}},code:`
