import{b0 as e,B as a,h as t,a1 as i,U as l,a6 as p}from"./index-BqHnT73R.js";import{P as o}from"./index-DGCKFkxT.js";/* empty css              *//* empty css              */import{d}from"./defineDoc-BRuAbgLN.js";import"./dom-DvRKQOia.js";import"./floating-BytRI0Oz.js";const c={display:"flex",flexWrap:"wrap",gap:"0.75rem",alignItems:"center"},n={display:"grid",gap:"0.7rem"},r={display:"grid",gap:"0.35rem"},s={color:"var(--willa-text-soft)",fontSize:"0.82rem"},x=d({id:"popover",name:"Popover",packageName:"willa/Popover",description:"用于承载可交互内容的轻量浮层，适合设置面板、筛选器和上下文信息。",imports:[{name:"Popover",from:"willa/Popover"},{name:"Button",from:"willa/Button"}],css:"willa/Popover.css",demo:{name:"Popover",component:o,props:{title:"生成设置",description:"调整回复长度和输出语气。",trigger:e.jsx(t,{icon:e.jsx(p,{}),variant:"outline",children:"打开设置"}),children:e.jsxs("div",{style:n,children:[e.jsxs("div",{style:r,children:[e.jsx("span",{style:s,children:"模型"}),e.jsx(i,{defaultValue:"willa-ai-default",size:"sm"})]}),e.jsx(a,{tone:"info",children:"已启用上下文增强"})]})}},code:`
