import{aZ as e,h as n,F as a,_ as l,ae as r,I as s,N as u,aE as c,T as m,m as d}from"./index-AT3pq52c.js";import{M as t}from"./index-CvGSSuBl.js";/* empty css              */import{d as p}from"./defineDoc-vm2MDznr.js";const i=[{value:"edit",label:"编辑内容",icon:e.jsx(r,{})},{value:"export",label:"导出为 Markdown",icon:e.jsx(s,{}),trailing:"⌘E"},{value:"open",label:"打开外部链接",icon:e.jsx(u,{})},{type:"separator"},{value:"delete",label:"删除记录",icon:e.jsx(c,{}),danger:!0}],g=[{value:"draft",label:"生成草稿",description:"根据当前上下文补全文案。",icon:e.jsx(r,{})},{value:"settings",label:"调整生成参数",description:"切换模型、语气和输出长度。",icon:e.jsx(m,{})},{value:"selected",label:"已选模式",description:"菜单项可以展示尾部状态。",trailing:e.jsx(d,{})}],o={display:"flex",flexWrap:"wrap",gap:"0.75rem",alignItems:"center"},I={display:"grid",minHeight:"8.5rem",placeItems:"center",padding:"1.25rem",border:"1px dashed var(--willa-menu-border)",borderRadius:"0.8rem",background:"var(--willa-menu-item-bg-hover)",color:"var(--willa-menu-muted)",fontWeight:700,textAlign:"center"},M=p({id:"menu",name:"Menu",packageName:"willa/Menu",description:"用于更多操作、模式切换和 AI 产品中的轻量动作菜单。",imports:[{name:"Menu",from:"willa/Menu"},{name:"Button",from:"willa/Button"}],css:"willa/Menu.css",demo:{name:"Menu",component:t,props:{items:i,trigger:e.jsx(n,{variant:"outline",trailingIcon:e.jsx(a,{}),children:"更多操作"})}},code:`
    import {
      DotsHorizontalIcon,
      Pencil1Icon,
      TrashIcon,
  ...
  `,sections:[{title:"基础菜单",code:`
      ...
      `,content:e.jsxs("div",{style:o,children:[e.jsx(t,{items:i,trigger:e.jsx(n,{variant:"outline",trailingIcon:e.jsx(a,{}),children:"更多操作"})}),e.jsx(t,{items:i,size:"sm",trigger:e.jsx(l,{ariaLabel:"打开操作菜单",icon:e.jsx(a,{}),variant:"outline"})})]})},{title:"描述和状态",code:`
        <Menu items={aiItems} trigger={<Button variant="soft">AI 生成模式</Button>} />;
      `,content:e.jsx(t,{items:g,trigger:e.jsx(n,{variant:"soft",children:"AI 生成模式"})})},{title:"右键菜单",code:`
        <Menu
        ...
        />;
      `,content:e.jsx(t,{triggerType:"contextmenu",items:i,trigger:e.jsx("div",{role:"button",tabIndex:0,style:I,children:"在此区域右键，或聚焦后按 Shift + F10"})})},{title:"对齐方式",code:`
        <div style={rowStyle}>
          <Menu
            align="start"
            items={basicItems}
