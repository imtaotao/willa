import{aZ as e}from"./index-D7YaWUUW.js";import{S as t}from"./index-DT_u24mq.js";import{d as i}from"./defineDoc-BHlsbD-w.js";import"./index-Dm8h4n-C.js";import"./useSelectablePanel-C-YUqkSa.js";import"./floatingPanelParts-DwadEjVO.js";import"./useFloatingPanel-DEfDOXGU.js";const a={display:"grid",gap:"0.9rem",maxWidth:"42rem"},l=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],r=i({id:"select",name:"Select",category:"form",packageName:"willa/Select",description:"用于单选下拉，适合表单、筛选和配置场景。",imports:[{name:"Select",from:"willa/Select"}],css:"willa/Select.css",demo:{name:"Select",component:t,props:{options:l,defaultValue:"balanced",width:"100%"}},code:`
