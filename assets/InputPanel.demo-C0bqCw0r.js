import{aY as e,ab as p,V as c,i as l,a_ as s,B as m}from"./index-DcUYsctR.js";import{I as n}from"./index-DkSdfIxl.js";/* empty css              *//* empty css              */import{d}from"./defineDoc-Bnz_Om-_.js";const a={display:"grid",gap:"0.85rem",width:"min(100%, 52rem)",margin:"0 auto"},f=()=>{const[t,i]=s.useState(""),[o,r]=s.useState("");return e.jsxs("div",{style:a,children:[e.jsx(n,{value:t,onValueChange:i,placeholder:"写下问题、反馈或操作指令...",footer:t?`${t.length} 个字符`:"⌘ Enter 提交",onSubmit:u=>r(u)}),o?e.jsxs(m,{tone:"success",children:["已提交：",o]}):null]})},v=d({id:"input-panel",name:"InputPanel",category:"content",packageName:"willa/InputPanel",description:"用于封装多行输入、底部信息、快捷操作和提交按钮的通用输入面板。",imports:[{name:"InputPanel",from:"willa/InputPanel"}],css:"willa/InputPanel.css",demo:{name:"InputPanelPreview",component:f},code:`
