import{b1 as e,aq as t,h as i,Y as n,B as a}from"./index-Ca7FJBfo.js";/* empty css              *//* empty css              */import{d as s}from"./defineDoc-DCAobL1p.js";const o={width:"min(100%, 58rem)",marginInline:"auto"},m=s({id:"section-header",name:"SectionHeader",category:"layout",packageName:"willa/SectionHeader",description:"用于页面区块、卡片区和详情段落的标题与操作区。",imports:[{name:"SectionHeader",from:"willa/SectionHeader"}],css:"willa/SectionHeader.css",demo:{name:"SectionHeader",component:t,props:{style:o,title:"来源证据",description:"展示本次生成使用的文档、链接和引用状态。",meta:e.jsx(a,{tone:"info",children:"12 条"}),actions:e.jsxs(n,{gap:"sm",children:[e.jsx(i,{size:"sm",variant:"ghost",children:"查看全部"}),e.jsx(i,{size:"sm",children:"添加来源"})]})}},code:`
