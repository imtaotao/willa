import{b2 as e}from"./index-DT6Ji1jU.js";import{T as t}from"./index-C64RGMYe.js";/* empty css              */import{d as l}from"./defineDoc-CA3QZQgp.js";const a={display:"grid",gap:"0.85rem",maxWidth:"42rem"},s=l({id:"text-area",name:"TextArea",category:"form",packageName:"willa/TextArea",description:"用于多行文本、提示词、反馈内容和 AI 输入区域的文本框。",imports:[{name:"TextArea",from:"willa/TextArea"}],css:"willa/TextArea.css",demo:{name:"TextArea",component:t,props:{placeholder:"告诉 Willa 你想生成什么内容...",width:"100%",rows:4}},code:`
