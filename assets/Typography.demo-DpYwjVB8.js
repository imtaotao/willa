import{aL as e}from"./index-CenWvRbQ.js";import{T as p}from"./index-6TWBNDW9.js";import{d as a}from"./defineDoc-YjbAJZXC.js";import"./index-DOQcjoBp.js";const r={width:"100%"},y={width:"min(100%, 44rem)",justifySelf:"start"};function t(){return e.jsx("div",{style:r,children:e.jsxs(p,{children:[e.jsx(p.Title,{level:2,children:"内容发布规范"}),e.jsx(p.Paragraph,{children:"Typography 用于承载文章、说明、日志和产品提示里的文本层级。它提供标题、段落、行内文本和链接， 并能处理常见的强调、语义颜色、复制和省略。"}),e.jsxs(p.Paragraph,{children:["你可以使用 ",e.jsx(p.Text,{strong:!0,children:"加粗文本"}),"、",e.jsx(p.Text,{type:"secondary",children:"辅助文本"}),"、",e.jsx(p.Text,{mark:!0,children:"标记文本"})," 和"," ",e.jsx(p.Text,{code:!0,children:"inline code"})," 组合说明。"]})]})})}const l=a({id:"typography",name:"Typography",packageName:"willa/Typography",description:"用于标题、段落、行内文本、链接和常见文本操作的排版组件。",imports:[{name:"Typography",from:"willa/Typography"}],css:"willa/Typography.css",demo:{name:"TypographyPreview",component:t},code:`
  ...
  `,sections:[{title:"标题层级",code:`
      ...
      `,content:e.jsx("div",{style:r,children:e.jsxs(p,{children:[e.jsx(p.Title,{level:1,children:"一级标题"}),e.jsx(p.Title,{level:2,children:"二级标题"}),e.jsx(p.Title,{level:3,children:"三级标题"}),e.jsx(p.Title,{level:4,children:"四级标题"}),e.jsx(p.Title,{level:5,children:"五级标题"})]})})},{title:"文本样式",code:`
        <Typography>
          <Typography.Paragraph>
      ...
      `,content:e.jsx("div",{style:r,children:e.jsxs(p,{children:[e.jsxs(p.Paragraph,{children:["查看"," ",e.jsx(p.Link,{href:"#typography",children:"排版组件说明"})," ","可以定位到当前文档中的组件说明。"]}),e.jsx(p.Text,{copyable:{text:"release: typography-ready"},children:"release: typography-ready"})]})})},{title:"子组件",code:`
        <Typography>
      ...
      `,content:e.jsx("div",{style:r,children:e.jsxs(p,{children:[e.jsx(p.Title,{level:4,children:"Typography.Title"}),e.jsxs(p.Paragraph,{children:["Typography.Paragraph 用于正文段落，Typography.Text 用于"," ",e.jsx(p.Text,{strong:!0,children:"行内强调"}),"， Typography.Link 用于文档内跳转或外部链接。"]})]})})},{title:"省略与展开",code:`
        <Typography.Paragraph
          ellipsis={{
            rows: 2,
            expandable: true,
