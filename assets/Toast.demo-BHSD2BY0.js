import{ae as t}from"./index-Dn8mGTzM.js";import{B as o}from"./index-DCbHg8ts.js";import{t as e,c as s}from"./index-BLv_kyjB.js";/* empty css              */import{d as p}from"./defineDoc-BXkZWhLB.js";import"./heading-CRPk0DTc.js";const r={display:"flex",flexWrap:"wrap",gap:"0.65rem",alignItems:"center"};let n,i,a;const c=()=>(n??(n=s({placement:"top",duration:1600,maxToasts:2})),n),l=()=>(i??(i=s({placement:"bottom"})),i),m=()=>(a??(a=s({placement:"bottom-right"})),a),d=()=>t.jsxs("div",{style:r,children:[t.jsx(o,{variant:"solid",onClick:()=>{e.success("发布成功",{description:"内容已经进入公开队列。"})},children:"成功提示"}),t.jsx(o,{variant:"soft",onClick:()=>{c().info("顶部配置",{description:"由 createToast 创建的实例触发。"})},children:"配置实例"})]}),u=()=>t.jsx(o,{variant:"soft",onClick:()=>{e.info("草稿已归档",{action:{label:"撤销",onClick:()=>e.success("已撤销归档")}})},children:"显示操作"}),T=()=>t.jsx(o,{variant:"outline",onClick:()=>{e.warning("同步仍在进行",{description:"这个提示不会自动关闭。",duration:!1})},children:"常驻提示"}),f=()=>t.jsxs("div",{style:r,children:[t.jsx(o,{variant:"soft",onClick:()=>{c().info("顶部居中",{description:"这个提示会更快关闭。"})},children:"顶部配置"}),t.jsx(o,{variant:"outline",onClick:()=>{m().success("右下角提示")},children:"右下角配置"})]}),y=p({id:"toast",name:"Toast",packageName:"willa/Toast",description:"用于操作反馈、状态变化和轻量通知的浮层提示。",imports:[{name:"toast",from:"willa/Toast"},{name:"createToast",from:"willa/Toast"}],css:"willa/Toast.css",demo:{name:"ToastPreview",component:d},code:`
