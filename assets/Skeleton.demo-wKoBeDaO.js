import{a_ as e,av as n}from"./index-acHovb3u.js";import{d as o}from"./defineDoc-C7psqEnR.js";const i=()=>e.jsx(n,{loading:!0,lines:["44%","100%","76%"],block:!0,blockHeight:160,children:e.jsx("div",{children:"Loaded content"})}),t={display:"grid",width:"min(100%, 34rem)",gap:"0.75rem"},r=o({id:"skeleton",name:"Skeleton",category:"content",packageName:"willa/Skeleton",description:"包裹真实内容的加载骨架屏，可用于文档、嵌入卡片等异步渲染场景。",imports:[{name:"Skeleton",from:"willa/Skeleton"}],css:"willa/Skeleton.css",demo:{name:"SkeletonPreview",component:i},code:`
