import{aC as m,aA as e,ao as S,N as H,e as v,B as M}from"./index-8h0iXH-K.js";import{A as T}from"./index-CQf52_Il.js";import{I as G}from"./index-ByVC5HDZ.js";/* empty css              *//* empty css              */import{d as _}from"./defineDoc-WQsG9bI2.js";function i(n){const{value:t,defaultValue:o="",onValueChange:a,onSubmit:s,placeholder:u="写下你的评论...",submitLabel:B="发布",disabled:C=!1,loading:c=!1,minRows:g=3,maxLength:p,autoFocus:k=!1,avatarSrc:b,avatarName:l,quote:d,mentionLabel:L="@",onMentionClick:h,actions:j,footer:w,className:q,textareaProps:A}=n,y=t!==void 0,[R,z]=m.useState(o),x=y?t:R,V=x.trim(),I=f=>{y||z(f),a==null||a(f)},E=()=>{I("")},P=(f,K)=>{V&&(s==null||s(V,{clear:E}))},N=!!(b||l),F=!!(h||j);return e.jsx(G,{...A,className:S("willa-comment-input",N&&"willa-comment-input--with-author",c&&"willa-comment-input--loading",q),slotClassNames:{actions:"willa-comment-input-actions",control:"willa-comment-input-control",footer:"willa-comment-input-footer",meta:"willa-comment-input-extra",submit:"willa-comment-input-submit"},autoFocus:k,autoResize:!1,minRows:g,maxRows:g,maxLength:p,submitShortcut:"mod-enter",loading:c,beforeInput:e.jsxs(e.Fragment,{children:[N?e.jsxs("div",{className:"willa-comment-input-author",children:[e.jsx(T,{className:"willa-comment-input-avatar",src:b,name:l??"Comment Author",alt:l??"Comment Author",size:"sm"}),e.jsx("span",{className:"willa-comment-input-author-name",children:l??"评论者"})]}):null,d?e.jsx("div",{className:"willa-comment-input-quote",children:e.jsxs("div",{className:"willa-comment-input-quote-content",children:[e.jsx("span",{className:"willa-comment-input-quote-mark","aria-hidden":"true",children:"“"}),e.jsxs("span",{className:"willa-comment-input-quote-author",children:["@",d.author]}),d.content,e.jsx("span",{className:"willa-comment-input-quote-mark","aria-hidden":"true",children:"”"})]})}):null]}),footer:w?e.jsx("span",{children:w}):p?e.jsxs("span",{children:[x.length,"/",p]}):e.jsx("span",{children:"⌘ Enter 发布"}),actions:F?e.jsxs(e.Fragment,{children:[h?e.jsx(D,{"aria-label":"提及用户",onClick:h,disabled:C||c,children:L}):null,j]}):null,submitLabel:B,value:x,placeholder:u,disabled:C,onValueChange:I,onSubmit:P})}const D=n=>{const{className:t,type:o="button",...a}=n;return e.jsx("button",{...a,type:o,className:S("willa-comment-input-tool",t)})},r={display:"grid",gap:"0.85rem",width:"min(100%, 52rem)",margin:"0 auto"},Q=()=>{const[n,t]=m.useState(""),[o,a]=m.useState("");return e.jsxs("div",{style:r,children:[e.jsx(i,{value:n,onValueChange:t,maxLength:180,onSubmit:(s,u)=>{a(s),u.clear()}}),o?e.jsxs(M,{tone:"success",children:["已发布：",o]}):null]})},J=()=>{const[n,t]=m.useState("");return e.jsx("div",{style:r,children:e.jsx(i,{placeholder:"回复这条评论...",quote:{author:"产品设计",content:"这个输入区需要支持评论扩展能力。"},onMentionClick:()=>t("打开成员选择面板"),actions:e.jsx(v,{size:"sm",variant:"ghost",onClick:()=>t("打开业务自己的表情包面板"),children:"表情"}),footer:n||"点击 @ 或表情按钮接入业务面板"})})},$=_({id:"comment-input",name:"CommentInput",category:"content",packageName:"willa/CommentInput",description:"用于评论、批注和反馈场景的轻量输入组件。",imports:[{name:"CommentInput",from:"willa/CommentInput"}],css:"willa/CommentInput.css",demo:{name:"CommentInputPreview",component:Q},code:`
  ...
  `,sections:[{title:"附加操作",code:`
      ...
      `,content:e.jsx("div",{style:r,children:e.jsx(i,{placeholder:"写下批注意见...",actions:e.jsxs(H,{gap:"xs",children:[e.jsx(v,{size:"sm",variant:"ghost",children:"引用段落"}),e.jsx(v,{size:"sm",variant:"ghost",children:"添加截图"})]}),footer:"支持 ⌘ Enter 快捷发布"})})},{title:"提及、表情和引用",code:`
        ...
        />;
      `,content:e.jsx(J,{})},{title:"提交状态",code:`
