import{b3 as e,Y as i,m as n,a7 as o,R as s}from"./index-C9Ot4add.js";import{C as t}from"./index-DFl13Ahf.js";/* empty css              */import{d as a}from"./defineDoc-DwmdElki.js";const r={display:"grid",gap:"1rem",width:"min(100%, 56rem)",border:"1px solid var(--willa-line)",borderRadius:"0.9rem",background:"var(--willa-panel-bg)",padding:"1rem"},c={margin:0,lineHeight:1.8},l=()=>e.jsx("div",{style:r,children:e.jsxs("p",{style:c,children:["文档中的引用标记需要足够轻量，既可以作为脚注入口，也可以承载来源状态"," ",e.jsx(t,{size:"xs",label:"组件指南",source:"component.md",index:"1",tone:"info",href:"#"}),"。当内容来自已经核验的资料时，可以用状态标明可信度"," ",e.jsx(t,{size:"xs",label:"架构说明",source:"architecture.md",index:"2",status:"已核验",tone:"success"}),"。"]})}),x=a({id:"citation",name:"Citation",category:"content",packageName:"willa/Citation",description:"用于正文里的来源引用、证据标注和可点击脚注。",imports:[{name:"Citation",from:"willa/Citation"}],css:"willa/Citation.css",demo:{name:"CitationPreview",component:l},code:`
  ...
  `,sections:[{title:"引用状态",code:`
      ...
      `,content:e.jsx(t,{label:"上下文命中",source:"组件规范",icon:e.jsx(o,{}),tone:"info",href:"#",children:"命中 ChatMessage、MessageList 和 SourceCard 相关规则。"})},{title:"尺寸",code:`
        <Group gap="xs" wrap>
