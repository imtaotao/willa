import{aD as e,U as t,e as l}from"./index-BqyZysBm.js";import{F as i}from"./index-BLVVtFky.js";import{T as o}from"./index-kKMd4qcm.js";/* empty css              *//* empty css              */import{d}from"./defineDoc-ChgvGsab.js";const r={display:"grid",gap:"1rem",maxWidth:"42rem"},a={display:"flex",flexWrap:"wrap",gap:"0.7rem"},u=d({id:"form-field",name:"FormField",category:"form",packageName:"willa/FormField",description:"统一表单字段的 label、说明、必填和错误状态。",imports:[{name:"FormField",from:"willa/FormField"}],css:"willa/FormField.css",demo:{name:"FormField",component:i,props:{label:"项目名称",description:"用于工作台、文档和分享链接中的展示名称。",required:!0},children:[{name:"Input",component:t,props:{placeholder:"输入项目名称",width:"100%"}}]},code:`
