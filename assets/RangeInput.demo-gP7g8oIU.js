import{a_ as e,b0 as i}from"./index-CiTBtHwL.js";import{R as a}from"./index-a2pQpSqQ.js";import{d as s}from"./defineDoc-C6xIJe2e.js";const r={display:"grid",gap:"0.85rem",width:"min(100%, 28rem)"},m={display:"flex",alignItems:"center",gap:"0.72rem"},d=()=>{const[l,n]=i.useState(60),[u,o]=i.useState(.7);return e.jsxs("div",{style:r,children:[e.jsx(a,{min:0,max:100,step:1,value:l,width:"18rem",height:"0.5rem",color:"#3b82f6",trackColor:"rgba(59, 130, 246, 0.18)",showValue:!0,formatValue:t=>`${t}%`,"aria-label":"生成强度",onChange:t=>n(Number(t.currentTarget.value))}),e.jsx(a,{min:0,max:1,step:.1,value:u,color:"#14b8a6",thumbBorderColor:"#0f766e",thumbColor:"#ecfeff",thumbSize:"1.2rem",trackColor:"rgba(20, 184, 166, 0.18)",showValue:!0,formatValue:t=>t.toFixed(1),marks:[{value:0,label:"保守"},{value:.5,label:"均衡"},{value:1,label:"发散"}],"aria-label":"温度",onChange:t=>o(Number(t.currentTarget.value))})]})},b=s({id:"range-input",name:"RangeInput",category:"form",packageName:"willa/RangeInput",description:"用于模型参数、音视频进度和数值配置的范围输入。",imports:[{name:"RangeInput",from:"willa/RangeInput"}],css:"willa/RangeInput.css",demo:{name:"RangeInputPreview",component:d},code:`
