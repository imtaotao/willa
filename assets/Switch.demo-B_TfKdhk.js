import{aY as e}from"./index-CTZ1VNtq.js";import{S as i}from"./index-mxysY3iL.js";import{d as l}from"./defineDoc-DS9v3ENx.js";const t={display:"grid",gap:"0.9rem",maxWidth:"42rem"},d=l({id:"switch",name:"Switch",category:"form",packageName:"willa/Switch",description:"用于开关型配置，适合产品设置和能力启停。",imports:[{name:"Switch",from:"willa/Switch"}],css:"willa/Switch.css",demo:{name:"Switch",component:i,props:{label:"启用自动摘要",description:"生成结果后自动提取重点。",defaultChecked:!0}},code:`
