import{al as t,L as s,$ as i,u as a,g as e,q as r}from"./index-CQ5SwHlJ.js";import{B as o}from"./index-3hwf-lCP.js";import{F as n}from"./index-Dm0Ejaek.js";/* empty css              */import{d as c}from"./defineDoc-BYfb4gho.js";const m={display:"grid",gap:"1rem",maxWidth:"42rem"},g=c({id:"form-actions",name:"FormActions",category:"form",packageName:"willa/FormActions",description:"用于表单底部提交、取消和辅助操作的布局组件。",imports:[{name:"FormActions",from:"willa/FormActions"}],css:"willa/FormActions.css",demo:{name:"FormActions",component:n,props:{gap:"md"},children:[{name:"Button",component:o,props:{variant:"ghost"},children:"取消"},{name:"Button",component:o,props:{type:"submit"},children:"保存"}]},code:`
