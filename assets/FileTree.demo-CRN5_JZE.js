import{c as e,d as t,l as n,p as r}from"./aidly.esm-bundler-DaTrP4tr.js";import{N as i}from"./react-icons.esm-mVdwEXuX.js";import{t as a}from"./CodeBlock-BYaA2QV-.js";import{t as o}from"./Group-C-JhzSsC.js";import"./index-Do4z6LCr.js";import{t as s}from"./defineDoc-Cid5xIoZ.js";import"./style-D3eq1OTT.js";import{t as c}from"./FileTree-JJXBldYI.js";var l=r(t(),1),u=n(),d=[{id:`agents`,name:`AGENTS.md`,meta:`仓库通用约定`,selected:!0,icon:(0,u.jsx)(i,{})},{id:`services`,name:`services`,type:`folder`,children:[{id:`payments`,name:`payments`,type:`folder`,children:[{id:`payments-agents`,name:`AGENTS.md`,muted:!0,meta:`因为存在覆盖文件，所以会被忽略`,icon:(0,u.jsx)(i,{})},{id:`payments-override`,name:`AGENTS.override.md`,selected:!0,meta:`payments 服务规则`,icon:(0,u.jsx)(i,{})},{id:`payments-readme`,name:`README.md`,icon:(0,u.jsx)(i,{})},{id:`payments-long-report`,name:`quarterly-payment-reconciliation-report-2026-final.md`,meta:`finance / reconciliation / archived`,icon:(0,u.jsx)(i,{})}]},{id:`search`,name:`search`,type:`folder`,children:[{id:`search-readme`,name:`README.md`,icon:(0,u.jsx)(i,{})}]}]}],f=[{id:`prompts`,name:`prompts`,type:`folder`,children:[{id:`system-prompt`,name:`system.md`,meta:`系统提示词`},{id:`rewrite-prompt`,name:`rewrite.md`,meta:`改写链路`}]},{id:`datasets`,name:`datasets`,type:`folder`,children:[{id:`faq-dataset`,name:`faq.jsonl`,meta:`1.2 MB`},{id:`eval-dataset`,name:`eval.csv`,meta:`320 KB`}]},{id:`agent-config`,name:`agent.config.ts`,meta:`运行配置`,selected:!0}],p=[{id:`agents`,language:`md`,code:e(`
      # AGENTS.md
