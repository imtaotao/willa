  ...
  `,sections:[{title:"基础列表",code:`
      ...
      `,content:e.jsx(d,{itemLayout:"vertical",items:te,style:{width:"min(100%, 50rem)"}})},{title:"分页设置",code:`
        ...
        <List
          ...
          style={{ width: "min(100%, 44rem)" }}
        />;
      `,content:e.jsx(d,{items:[{id:"one",title:"组件文档",description:"列表、表格和表单组件。"},{id:"two",title:"AI 场景",description:"对话、输入和推理过程。"},{id:"three",title:"布局能力",description:"Stack、Grid 和 SplitPane。"}],footer:e.jsx(K,{page:1,pageCount:5}),style:{width:"min(100%, 44rem)"}})},{title:"栅格列表",code:`
        import { Badge } from "willa/Badge";
        import { List, type ListItem } from "willa/List";
        import "willa/Badge.css";
        import "willa/List.css";
