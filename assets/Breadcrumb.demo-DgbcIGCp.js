import{b0 as e,_ as t,al as a}from"./index-BvtFLwN5.js";import{B as r}from"./index-DoVh8MV6.js";/* empty css              */import{d as c}from"./defineDoc-CQCHZfF9.js";const o=[{label:"首页",href:"#/"},{label:"基础组件",href:"#/button"},{label:"Breadcrumb"}],i=[{label:"Willa",href:"#/",icon:e.jsx(t,{})},{label:"文档",href:"#/mdx",icon:e.jsx(a,{})},{label:"导航层级"}],m={width:"min(100%, 44rem)",marginInline:"auto"},b=c({id:"breadcrumb",name:"Breadcrumb",packageName:"willa/Breadcrumb",description:"用于展示页面层级、返回路径和当前位置的导航组件。",imports:[{name:"Breadcrumb",from:"willa/Breadcrumb"}],css:"willa/Breadcrumb.css",demo:{name:"Breadcrumb",component:r,props:{style:m,items:o}},code:`
