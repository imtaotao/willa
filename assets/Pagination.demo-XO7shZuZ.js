import{au as e,aw as o,B as s}from"./index-VEztyUnl.js";import{P as a}from"./index-DcMO6r1Z.js";import{d as g}from"./defineDoc-fv-G_8j9.js";const p={display:"grid",gap:"0.75rem",justifyItems:"center"},r={display:"flex",flexWrap:"wrap",gap:"0.75rem",alignItems:"center"},d=()=>{const[t,n]=o.useState(4);return e.jsxs("div",{style:p,children:[e.jsxs(s,{tone:"info",children:["当前页：",t]}),e.jsx(a,{page:t,pageCount:12,onPageChange:n})]})},u=g({id:"pagination",name:"Pagination",packageName:"willa/Pagination",description:"用于文章列表、评论列表和搜索结果等分页内容的页码导航。",imports:[{name:"Pagination",from:"willa/Pagination"}],css:"willa/Pagination.css",demo:{name:"Pagination",component:a,props:{defaultPage:6,pageCount:20}},code:`
