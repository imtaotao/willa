import{aY as e,b0 as p,a_ as n,V as l,i as c,a4 as j,ax as m,am as v,B as d}from"./index-5Xo7nplC.js";import{T as f}from"./index-rUAggxh0.js";/* empty css              *//* empty css              */import{d as w}from"./defineDoc-DZKWvp5z.js";const x={width:"min(100%, 46rem)",padding:"1.25rem",color:"var(--willa-text)",background:"var(--willa-panel-surface-bg)",border:"1px solid var(--willa-panel-border)",borderRadius:"0.9rem"},R={display:"grid",gap:"0.9rem",padding:"1rem",background:"var(--willa-surface-soft)",border:"1px solid var(--willa-panel-border)",borderRadius:"0.75rem"},y={display:"grid",gap:"0.45rem",padding:"0.9rem",background:"var(--willa-panel-bg)",border:"1px solid var(--willa-panel-border)",borderRadius:"0.65rem"},u={margin:0,color:"var(--willa-text-soft)",fontSize:"0.9rem",lineHeight:1.6},g=t=>e.jsx(m,{align:"center",width:"100%",children:t.children}),T=()=>{const t=n.useRef(null),o=n.useRef(null),r=n.useRef(null),[i,s]=n.useState(!1),[a,h]=n.useState(0),b=[{target:()=>t.current,title:"确认任务上下文",description:"先让用户知道当前页面正在处理什么任务，避免引导脱离场景。",positioning:{placement:"bottom-start"}},{target:()=>r.current,title:"解释核心区域",description:"高亮用户需要优先关注的数据卡片、表格或操作区域。",positioning:{placement:"right"}},{target:()=>o.current,title:"落到下一步操作",description:"最后把用户带到可以继续推进流程的按钮上。",positioning:{placement:"top-end"}}];return e.jsxs(g,{children:[e.jsx("div",{style:x,children:e.jsxs(m,{gap:"lg",children:[e.jsxs(l,{justify:"between",gap:"md",children:[e.jsxs("div",{ref:t,children:[e.jsx("strong",{children:"产品反馈工作台"}),e.jsx("p",{style:u,children:"汇总反馈、优先级和后续动作。"})]}),e.jsx("div",{ref:o,children:e.jsx(c,{icon:e.jsx(v,{}),onClick:()=>{h(0),s(!0)},children:"开始引导"})})]}),e.jsxs("div",{style:R,children:[e.jsxs(l,{gap:"sm",children:[e.jsx(d,{tone:"info",children:"128 条反馈"}),e.jsx(d,{tone:"warning",children:"3 个风险"}),e.jsx(d,{tone:"success",children:"已生成摘要"})]}),e.jsxs("div",{ref:r,style:y,children:[e.jsx("strong",{children:"本周优先处理"}),e.jsx("p",{style:u,children:"登录失败、批量导出超时和移动端表单校验异常。"})]})]})]})}),e.jsx(f,{open:i,current:a,steps:b,onChange:h,onOpenChange:s})]})},C=()=>{const[t,o]=n.useState(!1),[r,i]=n.useState(0),s=[{title:"欢迎使用 Willa",description:"没有 target 的步骤会在视口中央展示，适合首屏欢迎和流程说明。",type:"primary"},{title:"保持简洁",description:"Tour 应该只解释关键路径，不要替代完整帮助文档。"}];return e.jsxs(g,{children:[e.jsx(l,{justify:"center",children:e.jsx(c,{icon:e.jsx(j,{}),onClick:()=>{i(0),o(!0)},children:"打开居中引导"})}),e.jsx(f,{open:t,current:r,steps:s,onChange:i,onOpenChange:a=>{o(a),a||i(0)}})]})},S=()=>{const t=n.useRef(null),[o,r]=n.useState(!1),i=[{target:()=>t.current,title:"可定制底部操作",description:"render.actions 可以替换默认按钮，适合接入跳过、查看帮助等业务动作。",positioning:{placement:"bottom"}}];return e.jsxs(g,{children:[e.jsx("div",{style:x,children:e.jsxs(m,{gap:"md",children:[e.jsxs("div",{ref:t,style:y,children:[e.jsx("strong",{children:"发布检查"}),e.jsx("p",{style:u,children:"确认文档、示例和样式都已经准备好。"})]}),e.jsx(c,{variant:"outline",onClick:()=>r(!0),children:"查看引导"})]})}),e.jsx(f,{open:o,steps:i,onOpenChange:r,render:{actions:s=>e.jsxs(l,{gap:"xs",children:[e.jsx(c,{size:"sm",variant:"ghost",onClick:()=>r(!1),children:"跳过"}),s]})}})]})},V=w({id:"tour",name:"Tour",packageName:"willa/Tour",description:"用于新功能介绍、关键路径说明和产品操作引导的漫游组件。",imports:[{name:"Tour",from:"willa/Tour"},{name:"Button",from:"willa/Button"}],css:"willa/Tour.css",demo:{name:"TourPreview",component:T},code:p(`
