import{aZ as e}from"./index-B8v9TYqC.js";import{T as t}from"./index-iTBYlcus.js";import{d as l}from"./defineDoc-CiTWYGpX.js";const a={display:"grid",gap:"0.85rem",maxWidth:"42rem"},o=l({id:"text-area",name:"TextArea",category:"form",packageName:"willa/TextArea",description:"用于多行文本、提示词、反馈内容和 AI 输入区域的文本框。",imports:[{name:"TextArea",from:"willa/TextArea"}],css:"willa/TextArea.css",demo:{name:"TextArea",component:t,props:{placeholder:"告诉 Willa 你想生成什么内容...",width:"100%",rows:4}},code:`
