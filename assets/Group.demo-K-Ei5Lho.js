import{an as t,B as s}from"./index-D1DxGs20.js";import{B as e}from"./index-Bruz1WA0.js";import{G as n}from"./index-Dn_wRn04.js";/* empty css              */import{d as o}from"./defineDoc-BreWiU-W.js";const m=o({id:"group",name:"Group",category:"layout",packageName:"willa/Group",description:"用于按钮组、标签组和工具栏等横向排列场景的轻量布局组件。",imports:[{name:"Group",from:"willa/Group"},{name:"Button",from:"willa/Button"}],css:"willa/Group.css",demo:{name:"Group",component:n,props:{gap:"sm"},children:[{name:"Button",component:e,props:{size:"sm",variant:"solid"},children:"返回首页"},{name:"Button",component:e,props:{size:"sm",variant:"ghost"},children:"查看文档"}]},code:`
  ...
  `,sections:[{title:"操作按钮",code:`
      ...
      `,content:t.jsxs(n,{gap:"sm",reverse:!0,children:[t.jsx(e,{size:"sm",variant:"ghost",children:"取消"}),t.jsx(e,{size:"sm",children:"提交"})]})}],props:[{name:"children",type:"ReactNode",description:"需要排列的内容。"},{name:"gap",type:'"none" | "xs" | "sm" | "md" | "lg" | "xl" | string',description:"子元素之间的间距，支持预设值或任意 CSS 间距值。"},{name:"align",type:'"start" | "center" | "end" | "stretch" | "baseline"',description:"交叉轴对齐方式。"},{name:"justify",type:'"start" | "center" | "end" | "between" | "around" | "evenly"',description:"主轴对齐方式。"},{name:"direction",type:'"row" | "column"',description:"排列方向，默认是横向排列。"},{name:"wrap",type:"boolean",description:"是否允许换行，默认开启。"},{name:"inline",type:"boolean",description:"是否使用 inline-flex。"},{name:"grow",type:"boolean",description:"是否让子元素等宽填充可用空间。"},{name:"reverse",type:"boolean",description:"是否反向排列子元素。"},{name:"width",type:"string",description:"外层宽度。"},{name:"separator",type:"ReactNode",description:"子元素之间的分隔内容。"},{name:"as",type:"ElementType",description:"自定义渲染标签或组件。"},{name:"className",type:"string",description:"外层 className。"}]});export{m as default};
