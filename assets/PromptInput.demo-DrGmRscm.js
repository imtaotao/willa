import{ay as e,c as l,T as m,aA as a}from"./index-DBsCKa5b.js";import{P as t}from"./index-BsYdSy6D.js";/* empty css              */import{d}from"./defineDoc-CeA5kaJR.js";import"./index-DqRtx5VZ.js";const o={display:"grid",gap:"1rem",width:"min(100%, 56rem)"},c=()=>{const[r,i]=a.useState(""),[s,p]=a.useState("暂无提交内容");return e.jsxs("div",{style:o,children:[e.jsx(t,{value:r,footer:"Enter 发送，Shift + Enter 换行",placeholder:"让 AI 帮我整理这段会议纪要...",onChange:n=>i(n.currentTarget.value),onSubmit:n=>{p(n),i("")}}),e.jsx("div",{children:s})]})},f=d({id:"prompt-input",name:"PromptInput",category:"ai",packageName:"willa/PromptInput",description:"用于 AI 对话、智能搜索和生成任务的提示词输入区域。",imports:[{name:"PromptInput",from:"willa/PromptInput"}],css:"willa/PromptInput.css",demo:{name:"PromptInputPreview",component:c},code:`
