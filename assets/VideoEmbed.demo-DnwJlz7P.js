import{l as e}from"./aidly.esm-bundler-DaTrP4tr.js";import{t}from"./defineDoc-Cid5xIoZ.js";import{t as n}from"./VideoEmbed-WWfFGF2e.js";var r=e(),i={width:`min(100%, 48rem)`,margin:`0 auto`},a=t({id:`video-embed`,name:`VideoEmbed`,packageName:`willa/VideoEmbed`,description:`视频卡片组件，可选择在页面内播放。`,imports:[{name:`VideoEmbed`,from:`willa/VideoEmbed`}],css:`willa/VideoEmbed.css`,propGroups:[{title:`媒体事件`,description:`这些事件透传给内联 video 元素；仅外部链接状态不会触发。`}],demo:{name:`VideoEmbedPreview`,component:()=>(0,r.jsx)(`div`,{style:i,children:(0,r.jsx)(n,{title:`Big Buck Bunny`,description:`一个带内联控制条的短视频示例。`,duration:`0:10`,provider:`MDN`,volume:.35,src:`https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4`,href:`https://developer.mozilla.org/`})})},code:`
  ...
  `,sections:[{title:`仅外部链接`,code:`
        <VideoEmbed
          ...
          href="https://developer.mozilla.org/"
        />;
      `,content:(0,r.jsx)(`div`,{style:i,children:(0,r.jsx)(n,{title:`外部视频`,description:`没有 src 时，组件会渲染为可点击的视频外链卡片。`,duration:`0:10`,provider:`MDN`,poster:`https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=900&q=80`,href:`https://developer.mozilla.org/`})})},{title:`文章相对资源`,code:`
        ...
        <VideoEmbed
          ...
          src="./flower.mp4"
        />;
      `,content:(0,r.jsx)(`div`,{style:i,children:(0,r.jsx)(n,{title:`文章内视频`,description:`src 可以是相对路径，由 articleSourcePath 和 resolveAssetUrl 转成可访问地址。`,duration:`0:10`,provider:`MDX`,volume:.35,articleSourcePath:`/posts/video-demo.mdx`,resolveAssetUrl:(e,t)=>`https://interactive-examples.mdn.mozilla.net/media/cc0-videos/${t.replace(/^\.\//,``)}`,src:`./flower.mp4`})})},{title:`加载和错误状态`,code:`
        <VideoEmbed
          title="不可用视频"
