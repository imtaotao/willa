import{aD as o,R as a,d as t,P as l,y as s,Y as i,c as d,H as e,j as r,n as c,ae as u}from"./index-BqyZysBm.js";import{d as p}from"./defineDoc-ChgvGsab.js";const n={display:"flex",flexWrap:"wrap",gap:"0.75rem",alignItems:"center"},x=p({id:"icon-button",name:"IconButton",packageName:"willa/IconButton",description:"用于工具栏、卡片操作区和内联内容中的纯图标按钮。",imports:[{name:"IconButton",from:"willa/IconButton"}],css:"willa/IconButton.css",demo:{name:"IconButton",component:a,props:{ariaLabel:"分享文章",icon:o.jsx(u,{})}},code:`
