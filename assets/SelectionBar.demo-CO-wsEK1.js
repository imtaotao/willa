import{d as e,l as t,p as n}from"./aidly.esm-bundler-DaTrP4tr.js";import{E as r,lt as i,n as a}from"./react-icons.esm-mVdwEXuX.js";import{t as o}from"./Button-O1aY2iqB.js";import{t as s}from"./Stack-DwlHdG-i.js";import{t as c}from"./SelectionBar-NgxmPMBy.js";import"./index-Coe6wwj0.js";import"./style-B00R6KjV.js";import{t as l}from"./defineDoc-Cid5xIoZ.js";var u=n(e(),1),d=t(),f=l({id:`selection-bar`,name:`SelectionBar`,packageName:`willa/SelectionBar`,description:`用于列表、表格、文件和卡片多选后的批量操作反馈。`,imports:[{name:`Button`,from:`willa/Button`},{name:`SelectionBar`,from:`willa/SelectionBar`},{name:`Stack`,from:`willa/Stack`}],css:`willa/SelectionBar.css`,demo:{name:`SelectionBar`,component:c,props:{selectedCount:3,totalCount:24,description:`已选项目会参与接下来的批量操作。`,actions:(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(o,{size:`sm`,variant:`soft`,icon:(0,d.jsx)(r,{}),children:`下载`}),(0,d.jsx)(o,{size:`sm`,variant:`outline`,icon:(0,d.jsx)(i,{}),children:`删除`})]}),onClear:()=>void 0}},code:`
  ...
  `,sections:[{title:`全选和清空`,code:`
      ...
      `,content:(0,d.jsx)(()=>{let[e,t]=(0,u.useState)(3);return(0,d.jsx)(c,{selectedCount:e,totalCount:18,description:`当前筛选结果中还有未选中的文件。`,onSelectAll:()=>t(18),onClear:()=>t(0),actions:(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(o,{size:`sm`,variant:`soft`,icon:(0,d.jsx)(r,{}),children:`下载`}),(0,d.jsx)(o,{size:`sm`,variant:`outline`,icon:(0,d.jsx)(a,{}),children:`归档`})]})})},{})},{title:`紧凑模式`,code:`
        <SelectionBar
          compact
          selectedCount={2}
          label="已选中 2 条评论"
          ...
          onClear={() => undefined}
        />;
      `,content:(0,d.jsx)(c,{compact:!0,selectedCount:2,label:`已选中 2 条评论`,actions:(0,d.jsx)(o,{size:`sm`,variant:`soft`,children:`标记已读`}),onClear:()=>void 0})},{title:`粘性操作区`,code:`
        <SelectionBar
          sticky
          selectedCount={6}
          totalCount={42}
          ...
          onClear={() => undefined}
        />;
      `,content:(0,d.jsx)(c,{sticky:!0,selectedCount:6,totalCount:42,description:`适合表格顶部、文件列表顶部和卡片墙顶部。`,actions:(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(o,{size:`sm`,variant:`soft`,children:`移动到分组`}),(0,d.jsx)(o,{size:`sm`,variant:`outline`,children:`批量设置标签`})]}),onSelectAll:()=>void 0,onClear:()=>void 0})},{title:`不同对齐方式`,code:`
        <Stack gap="sm">
          <SelectionBar
            align="start"
            selectedCount={1}
