import{a_ as t,i as e}from"./index-B2ZRy2dz.js";import{d as l}from"./defineDoc-BjqN8DJU.js";const o={display:"grid",gap:"0.85rem"},i={display:"grid",gap:"0.75rem",maxWidth:"720px"},s=l({id:"callout",name:"Callout",packageName:"willa/Callout",description:"用于文档、MDX 和文章正文中的语义提示块，适合承载解释、建议、注意事项和长文本说明；页面操作反馈优先使用 Alert。",imports:[{name:"Callout",from:"willa/Callout"}],css:"willa/Callout.css",demo:{name:"Callout",component:e,props:{tone:"tip",title:"阅读建议"},children:"这类内容会跟随正文长期存在，用来补充上下文，而不是反馈一次操作结果。"},code:`
