import{aZ as e,X as r,a1 as s,a2 as t}from"./index-D-LV62RM.js";/* empty css              */import{d}from"./defineDoc-CMyXJ6JB.js";function c(){return e.jsxs("p",{children:["按 ",e.jsx(t,{keys:["⌘","K"]})," 打开命令面板，或按 ",e.jsx(s,{children:"Esc"})," ","关闭当前浮层。"]})}const o=d({id:"kbd",name:"Kbd",packageName:"willa/Kbd",description:"用于展示键盘按键、快捷键和命令提示的内联组件。",imports:[{name:"Kbd, KbdShortcut",from:"willa/Kbd"},{name:"Group",from:"willa/Group"}],css:"willa/Kbd.css",demo:{name:"KbdPreview",component:c},code:`
