import{aY as e}from"./index-C6Ilh38B.js";import{S as t}from"./index-DMG2Zhh9.js";import{d as i}from"./defineDoc-nXmluo6Y.js";import"./index-DuZpdAbc.js";import"./useSelectablePanel-BMYvH9J4.js";import"./floatingPanelParts-8up2xgvC.js";import"./useFloatingPanel-BVNTvhfG.js";const a={display:"grid",gap:"0.9rem",maxWidth:"42rem"},l=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],r=i({id:"select",name:"Select",category:"form",packageName:"willa/Select",description:"用于单选下拉，适合表单、筛选和配置场景。",imports:[{name:"Select",from:"willa/Select"}],css:"willa/Select.css",demo:{name:"Select",component:t,props:{options:l,defaultValue:"balanced",width:"100%"}},code:`
