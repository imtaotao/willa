import{b2 as N,b0 as e,B as L,h as A,aN as z,l as $,F as q,aB as E,N as F,a5 as G,a_ as J}from"./index-BXsQUvzN.js";import{d as K}from"./defineDoc-DlZvCPX0.js";function d({title:l,description:n,status:t="pending",tone:u="neutral",icon:H,meta:h,details:m,approveText:S="确认继续",rejectText:P="拒绝",approveDisabled:I=!1,rejectDisabled:R=!1,approveLoading:j=!1,rejectLoading:g=!1,children:x,onApprove:p,onReject:o,onActionError:r,className:M,...B}){const[w,c]=N.useState(null),T=m!==void 0&&m.length>0,k=t==="pending",f=j||w==="approve",y=g||w==="reject",D=I||y||!p&&!j,V=R||f||!o&&!g,C=(a,i)=>{const b=a==="approve"?p:o;if(!b)return;let v;try{v=b(i)}catch(s){throw c(null),r==null||r(s,a,i),s}if(J(v))return c(a),v.then(()=>{c(null)},s=>(c(null),r==null||r(s,a,i),Promise.reject(s)))};return e.jsxs("section",{...B,className:z("willa-human-approval-card",`willa-human-approval-card--${t}`,`willa-human-approval-card--${u}`,M),"data-status":t,"data-tone":u,children:[e.jsxs("div",{className:"willa-human-approval-card__header",children:[e.jsx("span",{className:"willa-human-approval-card__mark","aria-hidden":"true",children:H??e.jsx(O,{status:t,tone:u})}),e.jsxs("div",{className:"willa-human-approval-card__heading",children:[e.jsxs("div",{className:"willa-human-approval-card__title-row",children:[e.jsx("h3",{className:"willa-human-approval-card__title",children:l}),e.jsx(L,{className:"willa-human-approval-card__status",size:"sm",tone:U[t],variant:"soft",children:Q[t]})]}),n?e.jsx("div",{className:"willa-human-approval-card__description",children:n}):null]}),h?e.jsx("div",{className:"willa-human-approval-card__meta",children:h}):null]}),T?e.jsx("dl",{className:"willa-human-approval-card__details",children:m.map((a,i)=>e.jsxs("div",{className:"willa-human-approval-card__detail",children:[e.jsx("dt",{children:a.label}),e.jsx("dd",{children:a.value})]},i))}):null,x?e.jsx("div",{className:"willa-human-approval-card__content",children:x}):null,k&&(p||o)?e.jsxs("div",{className:"willa-human-approval-card__actions",children:[o?e.jsx(A,{disabled:V,loading:y,size:"sm",variant:"soft",onClick:a=>C("reject",a),children:P}):null,p?e.jsx(A,{disabled:D,loading:f,size:"sm",variant:"solid",onClick:a=>C("approve",a),children:S}):null]}):null]})}const O=({status:l,tone:n})=>l==="approved"?e.jsx($,{}):l==="rejected"?e.jsx(q,{}):l==="expired"?e.jsx(E,{}):n==="danger"||n==="warning"?e.jsx(F,{}):e.jsx(G,{}),Q={pending:"等待确认",approved:"已通过",rejected:"已拒绝",expired:"已过期"},U={pending:"warning",approved:"success",rejected:"danger",expired:"neutral"};d.displayName="HumanApprovalCard";const _={display:"grid",gap:"1rem",width:"min(100%, 54rem)"},W={margin:0},X=()=>{const[l,n]=N.useState("pending");return e.jsx("div",{style:_,children:e.jsx(d,{title:"发送外部邮件前需要确认",description:"AI 即将把整理后的事故复盘发送给客户联系人。",status:l,tone:"warning",meta:"高影响操作",details:[{label:"收件人",value:"3 人"},{label:"附件",value:"2 个"},{label:"风险",value:"中"}],onApprove:()=>{n("approved")},onReject:()=>{n("rejected")},children:e.jsx("p",{style:W,children:"邮件包含事故时间线、影响范围和补偿说明。确认后将进入发送队列。"})})})},ee=K({id:"human-approval-card",name:"HumanApprovalCard",displayName:"人工确认卡片",category:"ai",packageName:"willa/HumanApprovalCard",description:"用于 AI 执行高影响操作前请求人工确认，并展示审批状态。",imports:[{name:"HumanApprovalCard",from:"willa/HumanApprovalCard"}],css:"willa/HumanApprovalCard.css",demo:{name:"HumanApprovalCardPreview",component:X},code:`
