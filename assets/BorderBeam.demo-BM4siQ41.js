import{aY as e,h as r,aa as a,V as n,B as o,i,k as t}from"./index-DUHj0FIn.js";/* empty css              *//* empty css              */import{d}from"./defineDoc-aIZu-0f7.js";const p=d({id:"border-beam",name:"BorderBeam",displayName:"边框流光",category:"layout",packageName:"willa/BorderBeam",description:"为任意容器增加持续流动的装饰性边框高亮，适合强调重点卡片、AI 模块和行动区。",imports:[{name:"BorderBeam",from:"willa/BorderBeam"},{name:"Card",from:"willa/Card"},{name:"Panel",from:"willa/Panel"},{name:"Group",from:"willa/Group"},{name:"Button",from:"willa/Button"},{name:"Badge",from:"willa/Badge"}],css:"willa/BorderBeam.css",demo:{name:"BorderBeam",component:r,props:{radius:8},children:[{name:"Card",component:t,props:{title:"智能分析完成",description:"流光边框用于提升视觉关注度，不承载业务状态语义。"},children:"已生成 12 条质量建议，可进入报告查看详情。"}]},code:`
  ...
  `,sections:[{title:"基础用法",code:`
      ...
      `,content:e.jsx(r,{disabled:!0,children:e.jsx(t,{title:"静态内容",description:"需要降低视觉干扰时可以关闭流光。",children:"用户开启减少动态效果时，组件也会自动隐藏流光层。"})})}],props:[{name:"children",type:"ReactNode",description:"被装饰的内容，通常是 Card、Panel 或其它容器组件。"},{name:"as",type:"ElementType",defaultValue:'"div"',description:"根节点元素。"},{name:"color",type:"string | { color: string; percent: number }[]",description:"流光颜色。传数组时 percent 使用 0 到 100 的输入范围。"},{name:"width",type:"number | string",defaultValue:"1",description:"流光边框宽度。number 按 px 处理。"},{name:"outset",type:"number | string",defaultValue:"0",description:"流光层相对容器边缘的外扩距离。number 按 px 处理。"},{name:"radius",type:"number | string",defaultValue:"8",description:"流光层圆角。number 按 px 处理。"},{name:"duration",type:"number | string",defaultValue:"5",description:"动画周期。number 按秒处理。"},{name:"delay",type:"number | string",defaultValue:"0",description:"动画延迟。number 按秒处理。"},{name:"disabled",type:"boolean",defaultValue:"false",description:"是否关闭流光效果。"}]});export{p as default};
