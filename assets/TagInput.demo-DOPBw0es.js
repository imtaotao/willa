  ...
  `,sections:[{title:"建议项",code:`
      ...
      `,content:a.jsx(o,{defaultValue:["AI 产品","文档站"],maxTags:3,suggestions:E,placeholder:"最多 3 个标签",width:"min(100%, 34rem)"})},{title:"自定义标签",code:`
        <TagInput
          ...
          width="min(100%, 34rem)"
        />;
      `,content:a.jsx(o,{defaultValue:["稳定","待复核","内部文档"],renderTag:(n,s)=>a.jsx(_e,{tone:n==="待复核"?"warning":"info",shape:"pill",close:{ariaLabel:`移除 ${n}`,disabled:s.disabled||s.readOnly,onClose:s.onRemove},children:n}),width:"min(100%, 34rem)"})},{title:"状态",code:`
        <Stack gap="sm" style={{ width: "min(100%, 34rem)" }}>
