import{l as e}from"./aidly.esm-bundler-DaTrP4tr.js";import{t}from"./defineDoc-Cid5xIoZ.js";import{t as n}from"./VideoLink-CXUHpMfm.js";var r=e(),i=t({id:`video-link`,name:`VideoLink`,packageName:`willa/VideoLink`,description:`可弹出播放层的内联视频链接。`,imports:[{name:`VideoLink`,from:`willa/VideoLink`}],css:`willa/VideoLink.css`,propGroups:[{title:`媒体事件`,description:`这些事件透传给内联 video 元素；仅外部链接状态不会触发。`}],demo:{name:`VideoLink`,component:n,props:{label:`观看示例视频`,provider:`MDN`,volume:.35,src:`https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4`,href:`https://developer.mozilla.org/`}},code:`
  ...
  `,sections:[{title:`仅外部链接`,code:`
        <VideoLink
          ...
          href="https://developer.mozilla.org/"
        />;
      `,content:(0,r.jsx)(n,{label:`打开视频来源`,provider:`MDN`,href:`https://developer.mozilla.org/`})},{title:`文章相对资源`,code:`
      ...
      `,content:(0,r.jsx)(n,{provider:`MDX`,volume:.35,articleSourcePath:`/posts/video-demo.mdx`,resolveAssetUrl:(e,t)=>`https://interactive-examples.mdn.mozilla.net/media/cc0-videos/${t.replace(/^\.\//,``)}`,src:`./flower.mp4`,children:`播放文章视频`})},{title:`加载和错误状态`,code:`
        <VideoLink
          label="打开不可用视频"
          provider="Demo"
