import{aD as e}from"./index-D5uFLOdF.js";import{S as t}from"./index-B-jErOka.js";import{d as i}from"./defineDoc-Bhi9w6ym.js";import"./index-DjA135kQ.js";import"./useSelectablePanel-DdTu6ABW.js";import"./useFloatingPanel-4le-n4ug.js";const a={display:"grid",gap:"0.9rem",maxWidth:"42rem"},l=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],u=i({id:"select",name:"Select",category:"form",packageName:"willa/Select",description:"用于单选下拉，适合表单、筛选和配置场景。",imports:[{name:"Select",from:"willa/Select"}],css:"willa/Select.css",demo:{name:"Select",component:t,props:{options:l,defaultValue:"balanced",width:"100%"}},code:`
