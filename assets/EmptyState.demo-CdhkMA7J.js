import{aO as t,F as i,Q as a,g as e,a0 as o,j as n,M as s}from"./index-C-tGzq2u.js";/* empty css              *//* empty css              *//* empty css              */import{d as r}from"./defineDoc-BM8EvMRd.js";const c={display:"grid",gap:"0.9rem",width:"min(100%, 56rem)"},y=r({id:"empty-state",name:"EmptyState",packageName:"willa/EmptyState",description:"用于列表为空、搜索无结果和 AI 上下文缺失时的空状态提示。",imports:[{name:"EmptyState",from:"willa/EmptyState"},{name:"Button",from:"willa/Button"},{name:"Group",from:"willa/Group"}],css:"willa/EmptyState.css",demo:{name:"EmptyState",component:i,props:{icon:t.jsx(o,{}),title:"没有找到结果",description:"换一个关键词，或清空筛选条件后重新搜索。",actions:t.jsxs(a,{gap:"sm",justify:"center",children:[t.jsx(e,{size:"sm",variant:"solid",children:"清空筛选"}),t.jsx(e,{size:"sm",variant:"ghost",children:"新建内容"})]})}},code:`
  ...
  `,sections:[{title:"搜索无结果",code:`
        ...
        />;
      `,content:t.jsx(i,{icon:t.jsx(o,{}),title:"没有找到匹配内容",description:"当前筛选条件过窄，可以减少标签或换一个关键词。",actions:t.jsxs(a,{gap:"sm",justify:"center",children:[t.jsx(e,{size:"sm",variant:"solid",children:"清空筛选"}),t.jsx(e,{size:"sm",variant:"outline",children:"保存搜索"})]})})},{title:"AI 上下文为空",code:`
        <EmptyState
          align="start"
          icon={<ChatBubbleIcon />}
          title="还没有添加上下文"
        ...
        />;
      `,content:t.jsx(i,{align:"start",icon:t.jsx(n,{}),title:"还没有添加上下文",description:"上传资料或选择知识库后，助手才能基于你的内容生成回答。",variant:"outline",actions:t.jsxs(a,{gap:"sm",children:[t.jsx(e,{size:"sm",variant:"solid",children:"添加资料"}),t.jsx(e,{size:"sm",variant:"ghost",children:"选择知识库"})]}),footer:"建议优先添加和当前任务直接相关的文档，减少无关噪音。"})},{title:"自定义图片",code:`
        <EmptyState
          image={
            <img
