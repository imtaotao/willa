import{a_ as e}from"./index-CiTBtHwL.js";import{S as t}from"./index-CX9C3lOM.js";import{d as i}from"./defineDoc-C6xIJe2e.js";import"./index-CPiUle2M.js";import"./useComboboxState-BC4mW05Q.js";import"./floatingPanelParts-qKQRykpZ.js";import"./useFloatingPanel-BvbLP3Rc.js";const a={display:"grid",gap:"0.9rem",maxWidth:"42rem"},l=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],r=i({id:"select",name:"Select",category:"form",packageName:"willa/Select",description:"用于单选下拉，适合表单、筛选和配置场景。",imports:[{name:"Select",from:"willa/Select"}],css:"willa/Select.css",demo:{name:"Select",component:t,props:{options:l,defaultValue:"balanced",width:"100%"}},code:`
