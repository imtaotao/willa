import{b0 as e}from"./index-BXsQUvzN.js";import{P as i}from"./index-BI_O_-ca.js";import{d as a}from"./defineDoc-DlZvCPX0.js";import"./useComboboxState-DA04pEHl.js";import"./floatingPanelParts-DTcHFzVu.js";import"./useFloatingPanel-xBf20LvO.js";import"./floatingLayer-DSNI4mZV.js";const t=[{value:"summary",label:"生成摘要",description:"快速归纳长文档中的关键结论",group:"内容处理"},{value:"risk",label:"提取风险",description:"识别合同、需求和日志中的异常点",group:"内容处理"},{value:"translate",label:"翻译成英文",description:"保持术语一致并保留段落结构",group:"语言任务"},{value:"polish",label:"润色文案",description:"让文本更适合产品公告和文档",group:"语言任务"}],r={display:"grid",justifyItems:"center",gap:"0.9rem"},s={display:"grid",gap:"0.8rem",width:"min(100%, 28rem)"},u=a({id:"picker",name:"Picker",category:"form",packageName:"willa/Picker",description:"用于富选项、分组、多选和可搜索选择场景。",imports:[{name:"Picker",from:"willa/Picker"}],css:"willa/Picker.css",demo:{name:"Picker",component:i,props:{items:t,defaultValue:"summary",searchable:!0,width:"min(100%, 28rem)"}},code:`
