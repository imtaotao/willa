import{al as t,B as o}from"./index-CQ5SwHlJ.js";import{B as n}from"./index-3hwf-lCP.js";import{G as e}from"./index-BXLyJRy7.js";/* empty css              */import{d as i}from"./defineDoc-BYfb4gho.js";const m=i({id:"group",name:"Group",category:"layout",packageName:"willa/Group",description:"用于按钮组、标签组和工具栏等横向排列场景的轻量布局组件。",imports:[{name:"Group",from:"willa/Group"},{name:"Button",from:"willa/Button"}],css:"willa/Group.css",demo:{name:"Group",component:e,props:{gap:"sm"},children:[{name:"Button",component:n,props:{size:"sm",variant:"solid"},children:"返回首页"},{name:"Button",component:n,props:{size:"sm",variant:"ghost"},children:"查看文档"}]},code:`
  ...
  `,sections:[{title:"操作按钮",code:`
      ...
      `,content:t.jsxs(e,{gap:"xs",children:[t.jsx(o,{tone:"info",children:"AI 产品"}),t.jsx(o,{tone:"success",children:"已发布"}),t.jsx(o,{tone:"warning",children:"需要审核"}),t.jsx(o,{children:"文档站"})]})},{title:"自定义间距",code:`
        <Group gap="14px">
          <Button size="sm" variant="solid">
            应用
          </Button>
