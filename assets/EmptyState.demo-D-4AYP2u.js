import{aX as t,I as i,U as n,h as e,a4 as s,k as o,P as a}from"./index-Qt9GVF18.js";/* empty css              *//* empty css              */import{d as r}from"./defineDoc-DExWJMRt.js";const l={display:"grid",gap:"0.9rem",width:"min(100%, 56rem)"},c={minHeight:"min(22rem, 70vh)",alignContent:"center"},p={display:"inline-flex",alignItems:"center",gap:"0.58rem",padding:"0.54rem 0.72rem",border:"1px solid var(--willa-empty-state-icon-border)",borderRadius:"0.72rem",background:"var(--willa-empty-state-icon-bg)",color:"var(--willa-empty-state-icon-text)",fontFamily:"var(--willa-title-font)",fontWeight:720,lineHeight:1},m={display:"inline-flex",alignItems:"center",justifyContent:"center",width:"1.45rem",height:"1.45rem",borderRadius:"0.42rem",background:"var(--willa-panel-bg)"},d=()=>t.jsxs("span",{style:p,"aria-hidden":"true",children:[t.jsx("span",{style:m,children:t.jsx(s,{})}),t.jsx("span",{children:"404"})]}),f=r({id:"empty-state",name:"EmptyState",packageName:"willa/EmptyState",description:"用于列表为空、搜索无结果和 AI 上下文缺失时的空状态提示。",imports:[{name:"EmptyState",from:"willa/EmptyState"},{name:"Button",from:"willa/Button"},{name:"Group",from:"willa/Group"}],css:"willa/EmptyState.css",demo:{name:"EmptyState",component:i,props:{icon:t.jsx(s,{}),title:"没有找到结果",description:"换一个关键词，或清空筛选条件后重新搜索。",actions:t.jsxs(n,{gap:"sm",justify:"center",children:[t.jsx(e,{size:"sm",variant:"solid",children:"清空筛选"}),t.jsx(e,{size:"sm",variant:"ghost",children:"新建内容"})]})}},code:`
