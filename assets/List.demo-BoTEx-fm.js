import{b1 as t,h as n,aA as x,a0 as g,B as a,l as L,t as I,ao as b,b3 as m}from"./index-BjtE9AVd.js";import{L as s}from"./index-CB4cQDV4.js";import{P as S}from"./index-DajOW3fj.js";/* empty css              *//* empty css              *//* empty css              */import{d as v}from"./defineDoc-CWmZ2fbW.js";const j=[{id:"one",title:"Racing car sprays burning fuel into crowd."},{id:"two",title:"Japanese princess to wed commoner."},{id:"three",title:"Australian walks 100km after outback crash."},{id:"four",title:"Man charged over missing wedding girl."},{id:"five",title:"Los Angeles battles huge wildfires."}],f=[{id:"review",title:"检查新增组件入口",description:"确认 content、willa 聚合包和 demo registry 都已经同步。",meta:t.jsx(a,{size:"sm",children:"组件"}),time:"刚刚",tone:"info",unread:!0,media:t.jsx(g,{}),actions:t.jsx(n,{size:"sm",variant:"ghost",children:"查看"})},{id:"styles",title:"整理列表类样式",description:"复用基础 List，避免通知和普通列表重复维护结构。",meta:t.jsx(a,{size:"sm",tone:"success",children:"已完成"}),time:"10:20",tone:"success",media:t.jsx(L,{})},{id:"build",title:"等待构建结果",description:"构建任务正在排队，完成后会同步状态。",meta:"CI 队列",time:"09:48",tone:"warning",media:t.jsx(I,{})}],B=[{id:"article-a",title:"组件体系整理完成",description:"把标准列表和通知场景拆清楚，普通数据展示优先使用 List。",meta:"Willa 设计系统",time:"2026-06-14",media:t.jsx(b,{}),extra:t.jsx("div",{style:{width:"9rem",height:"6.5rem",borderRadius:"0.7rem",background:"linear-gradient(135deg, rgb(228 235 255), rgb(245 246 250))"}}),actions:t.jsxs(t.Fragment,{children:[t.jsx(n,{size:"sm",variant:"ghost",children:"编辑"}),t.jsx(n,{size:"sm",variant:"ghost",children:"归档"})]})},{id:"article-b",title:"列表组件支持竖排布局",description:"竖排布局适合文章、活动、资源卡片这类需要额外图片区或操作区的内容。",meta:"产品日志",time:"2026-06-10",media:t.jsx(g,{}),extra:t.jsx("div",{style:{width:"9rem",height:"6.5rem",borderRadius:"0.7rem",background:"linear-gradient(135deg, rgb(232 248 240), rgb(247 247 244))"}}),actions:t.jsxs(t.Fragment,{children:[t.jsx(n,{size:"sm",variant:"ghost",children:"预览"}),t.jsx(n,{size:"sm",variant:"ghost",children:"发布"})]})}],C=[{id:"prompt",title:"PromptInput",description:"AI 输入和提交入口。",meta:t.jsx(a,{size:"sm",children:"AI"})},{id:"upload",title:"Upload",description:"上传、预览和进度管理。",meta:t.jsx(a,{size:"sm",children:"Form"})},{id:"table",title:"Table",description:"数据展示、筛选和批量操作。",meta:t.jsx(a,{size:"sm",children:"Content"})},{id:"calendar",title:"Calendar",description:"日期选择和日程视图。",meta:t.jsx(a,{size:"sm",children:"Form"})}],k=[{id:"import",title:"导入数据",description:"先读取用户上传的反馈文档。",media:t.jsx(g,{})},{id:"analyse",title:"分析优先级",description:"按影响面、成本和风险输出排序。",media:t.jsx(I,{})},{id:"publish",title:"生成报告",description:"把结论整理成可以直接交付的版本。",media:t.jsx(L,{})}],M=Array.from({length:120},(r,e)=>({id:`virtual-${e+1}`,title:`虚拟条目 ${e+1}`,description:"开启 virtualScroll 后，列表只渲染当前可视区附近的条目，长列表滚动时更稳定。",meta:e%2===0?"任务":"内容",time:`09:${String(e%60).padStart(2,"0")}`,tone:e%3===0?"info":e%3===1?"success":"warning"})),A=()=>{const[r,e]=m.useState(f),[c,l]=m.useState(!1),[p,h]=m.useState(!0),u=()=>(l(!0),new Promise(i=>{window.setTimeout(()=>{e(d=>[...d,{id:`more-${d.length}`,title:`滚动加载条目 ${d.length+1}`,description:"滚动接近底部时自动触发 onLoadMore。",meta:"自动加载",media:t.jsx(g,{})}]),h(r.length<7),l(!1),i()},500)}));return t.jsx(s,{items:r,maxHeight:"18rem",infiniteScroll:!0,hasMore:p,loading:c,loadingLabel:"加载更多内容",onLoadMore:u,style:{width:"min(100%, 42rem)"}})},z=()=>t.jsx(s,{items:M,maxHeight:"18rem",virtualScroll:!0,style:{width:"min(100%, 44rem)"}}),R=()=>{const[r,e]=m.useState(Array.from({length:80},(u,i)=>({id:`stream-${i+1}`,title:`流式条目 ${i+1}`,description:"接近底部时会自动加载下一批数据，配合 virtualScroll 保持滚动稳定。",meta:i%2===0?"实时":"批次",time:`10:${String(i%60).padStart(2,"0")}`,tone:i%3===0?"info":i%3===1?"success":"warning"}))),[c,l]=m.useState(!1),p=!0,h=()=>{if(!(c||!p))return l(!0),new Promise(u=>{window.setTimeout(()=>{e(i=>{const d=i.length+1,y=Array.from({length:40},(V,w)=>{const o=d+w;return{id:`stream-${o}`,title:`流式条目 ${o}`,description:"接近底部时会自动加载下一批数据。",meta:o%2===0?"实时":"批次",time:`10:${String(o%60).padStart(2,"0")}`,tone:o%3===0?"info":o%3===1?"success":"warning"}});return[...i,...y]}),l(!1),u()},450)})};return t.jsx(s,{items:r,maxHeight:"18rem",virtualScroll:!0,infiniteScroll:!0,loading:c,loadingLabel:"正在加载更多",hasMore:p,scrollThreshold:120,onLoadMore:h,style:{width:"min(100%, 44rem)"}})},$=()=>{const[r,e]=m.useState(k);return t.jsx(s,{items:r,draggable:!0,onItemsChange:e,style:{width:"min(100%, 42rem)"}})},E=v({id:"list",name:"List",packageName:"willa/List",description:"用于搭建任务、活动、文章、资源和通知等通用条目列表。",imports:[{name:"Badge",from:"willa/Badge"},{name:"Button",from:"willa/Button"},{name:"List",from:"willa/List"},{name:"Pagination",from:"willa/Pagination"},{name:"Stack",from:"willa/Stack"}],css:"willa/List.css",demo:{name:"List",component:s,props:{items:j,header:"Header",footer:"Footer",style:{width:"min(100%, 40rem)"}}},code:`
