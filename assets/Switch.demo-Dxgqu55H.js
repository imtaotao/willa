import{aX as e}from"./index-DpRBBwEt.js";import{S as i}from"./index-weAU2_Rj.js";import{d as l}from"./defineDoc-B4d7ymBJ.js";const t={display:"grid",gap:"0.9rem",maxWidth:"42rem"},d=l({id:"switch",name:"Switch",category:"form",packageName:"willa/Switch",description:"用于开关型配置，适合产品设置和能力启停。",imports:[{name:"Switch",from:"willa/Switch"}],css:"willa/Switch.css",demo:{name:"Switch",component:i,props:{label:"启用自动摘要",description:"生成结果后自动提取重点。",defaultChecked:!0}},code:`
