import{au as e,W as c,K as m,c as i,B as s,aw as r}from"./index-VEztyUnl.js";import{I as n}from"./index-CDu8pgb7.js";/* empty css              *//* empty css              */import{d}from"./defineDoc-fv-G_8j9.js";const o={display:"grid",gap:"0.85rem",width:"min(100%, 52rem)",margin:"0 auto"},b=()=>{const[t,l]=r.useState(""),[a,p]=r.useState("");return e.jsxs("div",{style:o,children:[e.jsx(n,{value:t,onValueChange:l,placeholder:"写下问题、反馈或操作指令...",footer:t?`${t.length} 个字符`:"⌘ Enter 提交",onSubmit:u=>p(u)}),a?e.jsxs(s,{tone:"success",children:["已提交：",a]}):null]})},P=d({id:"input-panel",name:"InputPanel",category:"content",packageName:"willa/InputPanel",description:"用于封装多行输入、底部信息、快捷操作和提交按钮的通用输入面板。",imports:[{name:"InputPanel",from:"willa/InputPanel"}],css:"willa/InputPanel.css",demo:{name:"InputPanelPreview",component:b},code:`
  ...
  `,sections:[{title:"Enter 发送",code:`
        ...
        />;
      `,content:e.jsx("div",{style:o,children:e.jsx(n,{submitShortcut:"enter",submitIcon:e.jsx(c,{}),submitLabel:"发送",placeholder:"输入 AI 指令，Enter 发送，Shift Enter 换行",footer:"适合 AI 对话、搜索和生成任务入口"})})},{title:"扩展区域",code:`
        <InputPanel
