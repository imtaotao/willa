  ...
  `,sections:[{title:"仅外部链接",code:`
      ...
      `,content:e.jsx("div",{style:i,children:e.jsx(t,{title:"外部音频",description:"没有 src 时，组件会渲染为可点击的外链卡片。",duration:"3:45",provider:"网易云音乐",href:"http://music.163.com/song?id=3370714076"})})},{title:"文章相对资源",code:`
        ...
        <AudioEmbed
          ...
          src="./t-rex-roar.mp3"
        />;
      `,content:e.jsx("div",{style:i,children:e.jsx(t,{title:"文章内音频",description:"src 可以是相对路径，由 articleSourcePath 和 resolveAssetUrl 转成可访问地址。",duration:"0:04",provider:"MDX",volume:.45,articleSourcePath:"/posts/audio-demo.mdx",resolveAssetUrl:s,src:"./t-rex-roar.mp3"})})}],props:[{name:"title",type:"string",required:!0,description:"音频卡片的主标题。"},{name:"src",type:"string",description:"用于内联播放的音频地址。"},{name:"href",type:"string",description:"可选的外部音频链接。"},{name:"volume",type:"number",description:"初始播放音量，取值范围为 0 到 1。"},{name:"description",type:"string",description:"标题下方的辅助说明。"},{name:"duration",type:"string",description:"展示在来源旁边的时长文本。"},{name:"provider",type:"string",description:"展示在卡片顶部的来源标签。"},{name:"className",type:"string",description:"传给音频嵌入根节点的 className。"},{name:"articleSourcePath",type:"string",defaultValue:'""',description:"当前文章路径，用于解析相对音频资源。"},{name:"resolveAssetUrl",type:"(articleSourcePath: string, assetPath: string) => string | undefined",description:"把相对音频资源转换为可访问 URL。"},...d]});export{v as default};
