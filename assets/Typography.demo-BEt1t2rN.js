import{aL as e,aN as s}from"./index-FxrQYZ7S.js";import{T as p}from"./index-kR2YB5_g.js";import{d as h}from"./defineDoc-7sLqiM9g.js";import"./index-BhbP4p_v.js";const r={width:"100%",maxWidth:"none",justifySelf:"stretch"},g={width:"min(100%, 38rem)",justifySelf:"start"},y="这是一段较长的说明文本，用于展示多行省略和展开行为。排版组件经常出现在组件文档、产品说明、活动日志和系统提示中，也会出现在知识库、更新记录、任务详情和搜索结果摘要里。当容器宽度有限时，正文需要先保留稳定的阅读节奏，只展示关键信息，再通过展开操作让用户继续阅读完整内容。",t={width:"100%",maxWidth:"72rem",marginInline:"auto"},o={display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(16rem, 1fr))",gap:"0.75rem 1.5rem",width:"100%"},T={display:"grid",gap:"0.9rem",width:"100%"},a={display:"grid",gap:"0.35rem",width:"100%",padding:"0.9rem 1rem",border:"1px solid var(--willa-line)",borderRadius:"0.5rem",background:"var(--willa-surface-tint)"};function d(){const[i,l]=s.useState(!1);return e.jsx("div",{style:g,children:e.jsx(p.Paragraph,{ellipsis:{rows:2,expandable:"collapsible",expanded:i,tooltip:!0,suffix:"（摘要）",onExpand:(x,n)=>l(n.expanded)},children:y})})}function c(){return e.jsx("div",{style:t,children:e.jsxs(p,{children:[e.jsx(p.Title,{level:2,children:"内容发布规范"}),e.jsx(p.Paragraph,{children:"Typography 用于承载文章、说明、日志和产品提示里的文本层级。它提供标题、段落、行内文本和链接， 并能处理常见的强调、语义颜色、复制、编辑和省略。"}),e.jsxs(p.Paragraph,{children:["你可以使用 ",e.jsx(p.Text,{strong:!0,children:"加粗文本"}),"、",e.jsx(p.Text,{type:"secondary",children:"辅助文本"}),"、",e.jsx(p.Text,{mark:!0,children:"标记文本"})," 和"," ",e.jsx(p.Text,{code:!0,children:"inline code"})," 组合说明。"]})]})})}const f=h({id:"typography",name:"Typography",packageName:"willa/Typography",description:"用于标题、段落、行内文本、链接和常见文本操作的排版组件。",imports:[{name:"Typography",from:"willa/Typography"}],css:"willa/Typography.css",demo:{name:"TypographyPreview",component:c},code:`
  ...
  `,sections:[{title:"标题层级",code:`
      ...
      `,content:e.jsx("div",{style:r,children:e.jsxs("div",{style:o,children:[e.jsx(p,{children:e.jsxs(p.Paragraph,{style:a,children:[e.jsx(p.Text,{children:"默认文本"}),e.jsx(p.Text,{type:"secondary",children:"辅助文本"}),e.jsx(p.Text,{type:"success",children:"成功文本"}),e.jsx(p.Text,{type:"warning",children:"警告文本"}),e.jsx(p.Text,{type:"danger",children:"危险文本"})]})}),e.jsx(p,{children:e.jsxs(p.Paragraph,{style:a,children:[e.jsx(p.Text,{strong:!0,children:"加粗"})," ",e.jsx(p.Text,{italic:!0,children:"斜体"})," ",e.jsx(p.Text,{underline:!0,children:"下划线"})," ",e.jsx(p.Text,{delete:!0,children:"删除线"}),e.jsx("br",{}),e.jsx(p.Text,{mark:!0,children:"标记"})," ",e.jsx(p.Text,{code:!0,children:"code"})," ",e.jsx(p.Text,{keyboard:!0,children:"⌘K"})]})})]})})},{title:"链接与操作",code:`
        <Typography>
          <Typography.Paragraph>
      ...
      `,content:e.jsx("div",{style:r,children:e.jsxs("div",{style:o,children:[e.jsx(p,{children:e.jsxs(p.Paragraph,{style:a,children:["查看"," ",e.jsx(p.Link,{href:"#typography",children:"排版组件说明"})," ","可以定位到当前文档中的组件说明。"]})}),e.jsx(p,{children:e.jsxs(p.Paragraph,{style:a,children:[e.jsx(p.Text,{copyable:{text:"release: typography-ready",tooltips:["复制发布标记","已复制发布标记"]},children:"release: typography-ready"}),e.jsx("br",{}),e.jsx(p.Text,{type:"secondary",children:"复制操作复用内部 IconButton 和 Tooltip。"})]})})]})})},{title:"可编辑",code:`
        <Typography.Paragraph
          editable={{
      ...
      `,content:e.jsx("div",{style:r,children:e.jsx(p,{children:e.jsx(p.Paragraph,{style:a,editable:{triggerType:["icon","text"],autoSize:{minRows:1,maxRows:3}},children:"点击文本或编辑图标，可以快速修改这一段说明。"})})})},{title:"子组件",code:`
        <Typography>
      ...
      `,content:e.jsx("div",{style:t,children:e.jsxs(p,{children:[e.jsx(p.Title,{level:4,children:"Typography.Title"}),e.jsxs(p.Paragraph,{children:["Typography.Paragraph 用于正文段落，Typography.Text 用于"," ",e.jsx(p.Text,{strong:!0,children:"行内强调"}),"， Typography.Link 用于文档内跳转或外部链接。"]})]})})},{title:"省略与展开",code:`
        <Typography.Paragraph
          ellipsis={{
            rows: 2,
