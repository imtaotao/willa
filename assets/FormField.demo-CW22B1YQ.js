import{a_ as e,a0 as t,h as l}from"./index-Bo8PUlF-.js";import{F as i}from"./index-CAzfW5rW.js";import{T as o}from"./index-BXRohURp.js";/* empty css              *//* empty css              */import{d}from"./defineDoc-B4fQnlag.js";const r={display:"grid",gap:"1rem",maxWidth:"42rem"},a={display:"flex",flexWrap:"wrap",gap:"0.7rem"},u=d({id:"form-field",name:"FormField",category:"form",packageName:"willa/FormField",description:"统一表单字段的 label、说明、必填和错误状态。",imports:[{name:"FormField",from:"willa/FormField"}],css:"willa/FormField.css",demo:{name:"FormField",component:i,props:{label:"项目名称",description:"用于工作台、文档和分享链接中的展示名称。",required:!0},children:[{name:"Input",component:t,props:{placeholder:"输入项目名称",width:"100%"}}]},code:`
