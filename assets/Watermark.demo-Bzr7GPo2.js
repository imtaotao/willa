import{aK as b,aI as t,at as _,g as L,aj as j,O as D,B as I}from"./index-D3fPsv2G.js";import{r as R}from"./media-CKA9EdjA.js";/* empty css              */import{d as O}from"./defineDoc-HKk9scXA.js";const G=152,P=84,U=[96,88],V=[24,12],N=-22,Y=1,M="rgba(15, 23, 42, 0.12)",K="rgba(255, 255, 255, 0.12)";function E(a){const{articleSourcePath:i,resolveAssetUrl:o,children:l,content:c,image:g,width:s=G,height:r=P,gap:n=U,offset:d=V,rotate:p=N,opacity:x=Y,zIndex:m=1,fixed:w=!1,font:e,className:A,style:H,...z}=a,y=b.useRef(null),[h,k]=b.useState(M),f=R({articleSourcePath:i,resolveAssetUrl:o},g),S=X(c),u=b.useMemo(()=>Z({lines:S,image:f,width:s,height:r,gap:n,rotate:p,font:{color:(e==null?void 0:e.color)??h,fontFamily:e==null?void 0:e.fontFamily,fontSize:e==null?void 0:e.fontSize,fontStyle:e==null?void 0:e.fontStyle,fontWeight:e==null?void 0:e.fontWeight,letterSpacing:e==null?void 0:e.letterSpacing,lineHeight:e==null?void 0:e.lineHeight}}),[S,f,s,r,n,p,e==null?void 0:e.color,e==null?void 0:e.fontFamily,e==null?void 0:e.fontSize,e==null?void 0:e.fontStyle,e==null?void 0:e.fontWeight,e==null?void 0:e.letterSpacing,e==null?void 0:e.lineHeight,h]);b.useEffect(()=>{const v=y.current;if(!v)return;const W=()=>{const C=getComputedStyle(v).getPropertyValue("--willa-watermark-ink").trim();if(C){k(C);return}const F=document.documentElement.getAttribute("data-wk-theme");k(F==="dark"?K:M)};W();const $=new MutationObserver(W);return $.observe(document.documentElement,{attributes:!0,attributeFilter:["data-wk-theme","class"]}),()=>$.disconnect()},[]);const B={...H,"--willa-watermark-image":u?`url("${u}")`:"none","--willa-watermark-size":`${s+n[0]}px ${r+n[1]}px`,"--willa-watermark-position":`${d[0]}px ${d[1]}px`,"--willa-watermark-opacity":`${x}`,"--willa-watermark-z-index":`${m}`};return t.jsxs("div",{...z,ref:y,className:_("willa-watermark",w&&"willa-watermark--fixed",A),style:B,children:[t.jsx("div",{className:"willa-watermark__overlay","aria-hidden":"true"}),l?t.jsx("div",{className:"willa-watermark__content",children:l}):null]})}const X=a=>a?(Array.isArray(a)?a:[a]).map(i=>i.trim()).filter(Boolean):new Array,T=a=>a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Z=a=>{const{lines:i,image:o,width:l,height:c,gap:g,rotate:s,font:r}=a;if(!o&&i.length===0)return"";const n=l+g[0],d=c+g[1],p=n/2,x=d/2,m=r.fontSize??15,w=r.lineHeight??m*1.45,e=r.letterSpacing??.6,A=r.fontWeight??560,H=r.fontFamily??"Inter, ui-sans-serif, system-ui, sans-serif",z=r.fontStyle??"normal",y=r.color??M,h=o?Math.min(c*.34,34):0,k=i.length?w*i.length-(w-m):0,f=o&&i.length?Math.max(c*.08,6):0,S=h+f+k,u=x-S/2,B=o?q({image:o,centerX:p,startY:u,width:l,imageBlockHeight:h}):"",v=i.map(($,C)=>{const F=u+h+f+m+w*C-m*.16;return`<text x="${p}" y="${F}" text-anchor="middle" fill="${y}" font-size="${m}" font-weight="${A}" font-family="${H}" font-style="${z}" letter-spacing="${e}">${T($)}</text>`}).join(""),W=`
  ...
  `;return`data:image/svg+xml;charset=utf-8,${encodeURIComponent(W)}`},q=a=>{const{image:i,centerX:o,startY:l,width:c,imageBlockHeight:g}=a,s=Math.min(c*.36,52),r=o-s/2,n=l;return`<image href="${T(i)}" x="${r}" y="${n}" width="${s}" height="${g}" preserveAspectRatio="xMidYMid meet" opacity="0.96" />`},J='data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><rect x="4" y="4" width="56" height="56" rx="18" fill="%2382A3EC"/><path d="M20 18h9.4l7.1 19.8L43.6 18H52l-12.6 28h-6.6L20 18Z" fill="white"/></svg>',Q={width:"min(100%, 56rem)",minHeight:"18rem"},ee={width:"min(100%, 44rem)",minHeight:"14rem"},te={width:"min(100%, 56rem)",minHeight:"22rem",padding:"1.75rem"},oe=O({id:"watermark",name:"Watermark",category:"content",packageName:"willa/Watermark",description:"用于页面、卡片、预览区和导出区域的文本或图片水印覆盖层。",imports:[{name:"Watermark",from:"willa/Watermark"}],css:"willa/Watermark.css",demo:{name:"Watermark",component:E,props:{content:["Willa Components","Internal Preview"],gap:[88,72],offset:[16,20],children:t.jsx(L,{style:Q,children:t.jsxs(j,{gap:"sm",children:[t.jsxs(D,{justify:"between",align:"center",children:[t.jsxs(j,{gap:"xs",children:[t.jsx("strong",{children:"组件预览草稿"}),t.jsx("span",{style:{color:"var(--willa-text-soft)",fontSize:"0.92rem"},children:"当前页面包含未发布的布局和样式调整。"})]}),t.jsx(I,{tone:"info",children:"仅内部可见"})]}),t.jsx("p",{style:{margin:0,color:"var(--willa-text)"},children:"这里适合放卡片、表格、文章内容或图片预览区。"})]})})}},code:`
