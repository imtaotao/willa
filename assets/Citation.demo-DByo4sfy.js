import{aX as e,U as i,m as n,a4 as o,P as s}from"./index-Qt9GVF18.js";import{C as t}from"./index-DL9AeLD6.js";/* empty css              */import{d as a}from"./defineDoc-DExWJMRt.js";const r={display:"grid",gap:"1rem",width:"min(100%, 56rem)",border:"1px solid var(--willa-line)",borderRadius:"0.9rem",background:"var(--willa-panel-bg)",padding:"1rem"},c={margin:0,lineHeight:1.8},l=()=>e.jsx("div",{style:r,children:e.jsxs("p",{style:c,children:["文档中的引用标记需要足够轻量，既可以作为脚注入口，也可以承载来源状态"," ",e.jsx(t,{size:"xs",label:"组件指南",source:"component.md",index:"1",tone:"info",href:"#"}),"。当内容来自已经核验的资料时，可以用状态标明可信度"," ",e.jsx(t,{size:"xs",label:"架构说明",source:"architecture.md",index:"2",status:"已核验",tone:"success"}),"。"]})}),x=a({id:"citation",name:"Citation",category:"content",packageName:"willa/Citation",description:"用于正文里的来源引用、证据标注和可点击脚注。",imports:[{name:"Citation",from:"willa/Citation"}],css:"willa/Citation.css",demo:{name:"CitationPreview",component:l},code:`
  ...
  `,sections:[{title:"引用状态",code:`
      ...
      `,content:e.jsxs(i,{gap:"sm",wrap:!0,children:[e.jsx(t,{label:"来源 1",source:"component.md",index:"1",href:"#"}),e.jsx(t,{label:"已核验",source:"architecture.md",index:e.jsx(n,{}),status:"可信",tone:"success",selected:!0}),e.jsx(t,{label:"需要确认",source:"support-log.json",index:"3",status:"待核验",tone:"warning"})]})},{title:"链接来源",code:`
        <Group gap="sm" wrap>
      ...
      `,content:e.jsx(t,{label:"上下文命中",source:"AI 组件规划",icon:e.jsx(o,{}),tone:"info",href:"#",children:"命中 ChatMessage、MessageList 和 SourceCard 相关规则。"})},{title:"尺寸",code:`
        <Group gap="xs" wrap>
