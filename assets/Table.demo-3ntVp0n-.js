import{al as e,a6 as t,an as b,B as n}from"./index-D4yNIa2_.js";import{B as o}from"./index-F6EMF-8j.js";/* empty css              */import{F as k}from"./index-WqPYix9m.js";import{S as v}from"./index-BY32s8kP.js";import{S as g}from"./index-BRX5Ox5N.js";import{d as T}from"./defineDoc-Cmw2Yd3K.js";import"./index-DdmDk3TZ.js";import"./index-CKXL_quh.js";import"./useSelectablePanel-DlVbt4rF.js";import"./useFloatingPanel-CLcptbm7.js";const i=[{key:"prompt-input",cells:[{key:"name",label:"组件",value:"PromptInput",width:"12rem",sortable:!0},{key:"owner",label:"归属",value:"AI"},{key:"status",label:"状态",value:"stable",render:e.jsx(n,{tone:"success",children:"稳定"})},{key:"coverage",label:"覆盖能力",value:"输入、提交、禁用、自动高度和辅助信息"}],expanded:"PromptInput 适合作为 AI 对话、智能搜索和生成任务的输入入口。",actions:e.jsx(o,{size:"sm",variant:"ghost",children:"查看"})},{key:"upload",tone:"warning",cells:[{key:"name",label:"组件",value:"Upload",width:"12rem",sortable:!0},{key:"owner",label:"归属",value:"Form"},{key:"status",label:"状态",value:"wip",render:e.jsx(n,{tone:"warning",children:"完善中"})},{key:"coverage",label:"覆盖能力",value:"拖拽、预览、上传进度和下载回退"}],expanded:"Upload 可以接入用户自己的上传逻辑，并展示上传进度。",actions:e.jsx(o,{size:"sm",variant:"ghost",children:"查看"})},{key:"code-block",selected:!0,cells:[{key:"name",label:"组件",value:"CodeBlock",width:"12rem",sortable:!0},{key:"owner",label:"归属",value:"Content"},{key:"status",label:"状态",value:"stable",render:e.jsx(n,{tone:"success",children:"稳定"})},{key:"coverage",label:"覆盖能力",value:"高亮、行号、复制、文件名和语言提示"}],expanded:"CodeBlock 是内容渲染和 AI 代码结果的基础展示组件。",actions:e.jsx(o,{size:"sm",variant:"ghost",children:"查看"})}],w=[{key:"mobile",cells:[{key:"task",label:"任务",value:"移动端校验"},{key:"owner",label:"负责人",value:"Design"},{key:"progress",label:"进度",value:"82%",align:"end"}]},{key:"theme",cells:[{key:"task",label:"任务",value:"主题变量整理"},{key:"owner",label:"负责人",value:"Frontend"},{key:"progress",label:"进度",value:"96%",align:"end"}]}],h=[{key:"feedback-summary",cells:[{key:"task",label:"任务",value:"产品反馈摘要生成",width:"12rem",render:e.jsxs("span",{style:{display:"inline-flex",alignItems:"center",gap:8},children:[e.jsx(n,{tone:"info",children:"AI"}),e.jsx("strong",{children:"产品反馈摘要生成"})]})},{key:"detail",label:"说明",value:"从近 128 条用户反馈中提取高频问题、风险提示和下一步可执行建议。",title:"从近 128 条用户反馈中提取高频问题、风险提示和下一步可执行建议。"},{key:"result",label:"结果",value:"已生成",render:e.jsx(n,{tone:"success",children:"已生成"}),align:"end"}],actions:e.jsx(o,{size:"sm",variant:"ghost",children:"复制"})},{key:"risk-check",cells:[{key:"task",label:"任务",value:"风险校验",width:"12rem",render:e.jsxs("span",{style:{display:"inline-flex",alignItems:"center",gap:8},children:[e.jsx(n,{tone:"warning",children:"审核"}),e.jsx("strong",{children:"风险校验"})]})},{key:"detail",label:"说明",value:"检查生成内容里是否包含敏感信息、缺少来源引用或需要人工确认的结论。",title:"检查生成内容里是否包含敏感信息、缺少来源引用或需要人工确认的结论。"},{key:"result",label:"结果",value:"需要复核",render:e.jsx(n,{tone:"warning",children:"需要复核"}),align:"end"}],actions:e.jsx(o,{size:"sm",variant:"ghost",children:"查看"})}],I={display:"grid",gap:"0.85rem",width:"min(100%, 72rem)",marginInline:"auto"},x=[{value:"all",label:"全部归属"},{value:"AI",label:"AI"},{value:"Form",label:"Form"},{value:"Content",label:"Content"}],C=[{value:"all",label:"全部状态"},{value:"stable",label:"稳定"},{value:"wip",label:"完善中"}],f=()=>{const[l,a]=b.useState(""),[r,s]=b.useState("all"),[m,p]=b.useState("all"),c=S(i,{keyword:l,owner:r,status:m}),d=[{id:"owner",width:"10rem",control:e.jsx(g,{value:r,options:x,width:"100%",onValueChange:s})},{id:"status",width:"10rem",control:e.jsx(g,{value:m,options:C,width:"100%",onValueChange:p})}];return e.jsx("div",{style:I,children:e.jsx(t,{header:e.jsx(k,{search:e.jsx(v,{value:l,onValueChange:a,placeholder:"搜索组件、归属或能力",width:"100%"}),items:d,actions:e.jsx(o,{size:"sm",variant:"ghost",onClick:()=>{a(""),s("all"),p("all")},children:"重置"}),summary:`匹配 ${c.length} 个组件。`}),caption:"组件筛选结果",items:c,empty:"没有匹配的组件",stickyActions:!0,footer:`当前展示 ${c.length} / ${i.length} 个组件。`})})},S=(l,a)=>{const r=a.keyword.trim().toLowerCase();return l.filter(s=>{var d,y;const m=s.cells.map(j).join(" ").toLowerCase(),p=String(((d=s.cells.find(u=>u.key==="owner"))==null?void 0:d.value)??""),c=String(((y=s.cells.find(u=>u.key==="status"))==null?void 0:y.value)??"");return(!r||m.includes(r))&&(a.owner==="all"||p===a.owner)&&(a.status==="all"||c===a.status)})},j=l=>typeof l.value=="string"||typeof l.value=="number"?String(l.value):"",L=T({id:"table",name:"Table",packageName:"willa/Table",description:"通过 items 渲染表格和产品数据列表，支持自定义单元格、排序、选择、分页、展开行和右侧操作区。",imports:[{name:"Table",from:"willa/Table"}],css:"willa/Table.css",demo:{name:"Table",component:t,props:{caption:"组件能力覆盖表",items:i}},code:`
  ...
  `,sections:[{title:"搜索与筛选",code:`
      ...
      `,content:e.jsx(f,{})},{title:"基础表格",code:`
        const items = [
          {
            key: "prompt-input",
            cells: [
      ...
      `,content:e.jsx(t,{caption:"组件能力覆盖表",items:i,defaultSort:{key:"name",direction:"asc"}})},{title:"选择与固定操作列",code:`
        ...
        <Table
          ...
          actionsWidth="5.6rem"
        />;
      `,content:e.jsx(t,{caption:"横向滚动时保留操作入口",items:i,selectionMode:"multiple",stickyActions:!0,actionsWidth:"5.6rem"})},{title:"分页与展开",code:`
        const items = [
          {
            key: "prompt-input",
            cells: [
      ...
      `,content:e.jsx(t,{caption:"自定义渲染和溢出提示",items:h,stickyActions:!0})},{title:"加载与空态",code:`
        <div style={{ display: "grid", gap: "1rem" }}>
          <Table items={[]} loading loadingText="正在同步组件状态..." />
          <Table items={[]} empty="没有匹配的组件" />
        </div>;
      `,content:e.jsxs("div",{style:{display:"grid",gap:"1rem"},children:[e.jsx(t,{items:[],loading:!0,loadingText:"正在同步组件状态..."}),e.jsx(t,{items:[],empty:"没有匹配的组件"})]})},{title:"紧凑尺寸",code:`
        const items = [
          {
            key: "mobile",
            cells: [
