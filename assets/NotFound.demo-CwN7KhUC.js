import{au as t,E as y,ak as h,S as s,K as o,c as i,G as j}from"./index-VEztyUnl.js";/* empty css              *//* empty css              *//* empty css              */import{d as x}from"./defineDoc-fv-G_8j9.js";function e(a){const{title:r="404 页面不存在",description:d="你访问的内容可能已被移动、删除，或暂时不可用。",icon:c=t.jsx(v,{}),image:n,actions:l,footer:m,variant:p="soft",size:u="lg",align:f="center",className:g,children:N}=a;return t.jsx(y,{className:h("willa-not-found",g),icon:n?void 0:c,image:n,title:r,description:d,actions:l,footer:m,variant:p,size:u,align:f,children:N})}function v(){return t.jsxs("span",{className:"willa-not-found-badge","aria-hidden":"true",children:[t.jsx("span",{className:"willa-not-found-badge-icon",children:t.jsx(s,{})}),t.jsx("span",{className:"willa-not-found-badge-code",children:"404"})]})}const w={display:"grid",gap:"0.9rem",width:"min(100%, 56rem)"},b=x({id:"not-found",name:"NotFound",packageName:"willa/NotFound",description:"用于 404、资源不存在和搜索路径失效等场景的缺省页面。",imports:[{name:"NotFound",from:"willa/NotFound"},{name:"Button",from:"willa/Button"},{name:"Group",from:"willa/Group"}],css:"willa/NotFound.css",demo:{name:"NotFound",component:e,props:{actions:t.jsxs(o,{gap:"sm",justify:"center",children:[t.jsx(i,{size:"sm",variant:"solid",children:"返回首页"}),t.jsx(i,{size:"sm",variant:"ghost",children:"查看文档"})]})}},code:`
