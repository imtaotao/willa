import{c as e,l as t}from"./aidly.esm-bundler-DaTrP4tr.js";import{X as n,a as r,c as i,nt as a,o}from"./react-icons.esm-mVdwEXuX.js";import{t as s}from"./Card-Dw_2SqSh.js";import{t as c}from"./Group-C-JhzSsC.js";import{t as l}from"./Stack-DwlHdG-i.js";import{a as u,l as d,u as f}from"./index-Coe6wwj0.js";import{t as p}from"./defineDoc-Cid5xIoZ.js";import"./style-D3eq1OTT.js";var m=t(),h={position:`relative`,width:`min(100%, 56rem)`,minHeight:`21rem`,padding:`1.5rem 1.5rem 6rem`,overflow:`hidden`,background:`var(--willa-panel-surface-bg)`,border:`1px solid var(--willa-panel-border)`,borderRadius:`1.25rem`},g={width:`min(100%, 30rem)`,padding:`1rem 1.05rem`},_=p({id:`float-button`,name:`FloatButton`,category:`content`,packageName:`willa/FloatButton`,description:`用于页面固定入口、回到顶部和高频快捷操作的悬浮按钮组件。`,imports:[{name:`FloatButton, FloatButtonGroup`,from:`willa/FloatButton`}],css:`willa/FloatButton.css`,demo:{name:`BasicPreview`,component:()=>(0,m.jsxs)(`div`,{style:h,children:[(0,m.jsxs)(l,{gap:`lg`,children:[(0,m.jsxs)(c,{justify:`between`,align:`start`,children:[(0,m.jsxs)(l,{gap:`xs`,children:[(0,m.jsx)(`strong`,{children:`产品反馈工作台`}),(0,m.jsx)(`p`,{style:{margin:0,color:`var(--willa-text-soft)`},children:`用于承接编辑、评论回复和回到顶部等高频页面动作。`})]}),(0,m.jsx)(u,{tone:`info`,children:`内部预览`})]}),(0,m.jsxs)(c,{gap:`md`,wrap:!0,align:`stretch`,children:[(0,m.jsx)(s,{style:g,children:(0,m.jsxs)(l,{gap:`xs`,children:[(0,m.jsx)(`strong`,{children:`当前工作项`}),(0,m.jsx)(`p`,{style:{margin:0,color:`var(--willa-text-soft)`},children:`本周需要同步评论体验、文件预览和 Tour 动画修复。`})]})}),(0,m.jsx)(s,{style:{width:`min(100%, 18rem)`,padding:`1rem 1.05rem`},children:(0,m.jsxs)(l,{gap:`xs`,children:[(0,m.jsx)(`strong`,{children:`待处理反馈`}),(0,m.jsx)(`p`,{style:{margin:0,color:`var(--willa-text-soft)`},children:`新增 12 条，建议优先处理移动端和导出问题。`})]})})]})]}),(0,m.jsx)(d,{fixed:!1,placement:`bottom-right`,icon:(0,m.jsx)(n,{}),tooltip:`创建反馈`,ariaLabel:`创建反馈`})]})},code:e(`
  ...
  `),sections:[{title:`带文案`,code:e(`
      ...
      `),content:(0,m.jsx)(()=>(0,m.jsxs)(`div`,{style:h,children:[(0,m.jsx)(c,{gap:`md`,wrap:!0,align:`stretch`,children:(0,m.jsx)(s,{style:{width:`min(100%, 32rem)`,padding:`1rem 1.05rem`},children:(0,m.jsxs)(l,{gap:`xs`,children:[(0,m.jsx)(`strong`,{children:`内容评审面板`}),(0,m.jsx)(`p`,{style:{margin:0,color:`var(--willa-text-soft)`},children:`展示带文案的悬浮入口，适合需要明确语义的操作。`})]})})}),(0,m.jsx)(d,{fixed:!1,placement:`bottom-left`,shape:`square`,icon:(0,m.jsx)(a,{}),label:`发布检查`,description:`进入预检流程`,tooltip:`执行发布前检查`,variant:`primary`,badge:`3`})]}),{})},{title:`分组操作`,code:e(`
        import {
          BellIcon,
          BookmarkIcon,
          ChatBubbleIcon,
      ...
      `),content:(0,m.jsx)(()=>(0,m.jsxs)(`div`,{style:h,children:[(0,m.jsx)(l,{gap:`md`,children:(0,m.jsx)(s,{style:{width:`min(100%, 32rem)`,padding:`1rem 1.05rem`},children:(0,m.jsxs)(l,{gap:`xs`,children:[(0,m.jsx)(`strong`,{children:`组合操作`}),(0,m.jsx)(`p`,{style:{margin:0,color:`var(--willa-text-soft)`},children:`多个高频操作可以折叠到一个主入口下，避免右下角堆太多按钮。`})]})})}),(0,m.jsxs)(f,{fixed:!1,placement:`bottom-left`,triggerTooltip:`更多快捷操作`,children:[(0,m.jsx)(d,{icon:(0,m.jsx)(i,{}),tooltip:`查看评论`,ariaLabel:`查看评论`}),(0,m.jsx)(d,{icon:(0,m.jsx)(r,{}),tooltip:`查看通知`,ariaLabel:`查看通知`,badge:`2`}),(0,m.jsx)(d,{icon:(0,m.jsx)(o,{}),tooltip:`收藏当前页`,ariaLabel:`收藏当前页`})]})]}),{})},{title:`自定义颜色`,code:e(`
        import { RocketIcon } from "@radix-ui/react-icons";
        import { Card } from "willa/Card";
        import { FloatButton } from "willa/FloatButton";
        import { Stack } from "willa/Stack";
      ...
      `),content:(0,m.jsx)(()=>(0,m.jsxs)(`div`,{style:h,children:[(0,m.jsx)(s,{style:{width:`min(100%, 32rem)`,padding:`1rem 1.05rem`},children:(0,m.jsxs)(l,{gap:`xs`,children:[(0,m.jsx)(`strong`,{children:`品牌快捷入口`}),(0,m.jsx)(`p`,{style:{margin:0,color:`var(--willa-text-soft)`},children:`可单独覆盖背景色和文字色，用于贴合品牌或模块语义。`})]})}),(0,m.jsx)(d,{fixed:!1,placement:`bottom-left`,shape:`square`,icon:(0,m.jsx)(a,{}),label:`上线中心`,description:`查看待发布项`,backgroundColor:`#1f2937`,hoverBackgroundColor:`#111827`,textColor:`#f8fafc`,hoverTextColor:`#ffffff`,badge:`2`})]}),{})},{title:`回到顶部`,code:e(`
