import{b0 as e}from"./index-MvDtKvGL.js";import{S as t}from"./index-BErhwKyk.js";import{d as i}from"./defineDoc-BE2V2Usy.js";import"./index-r6h2qtjB.js";import"./useComboboxState-BDuO-bz5.js";import"./floatingPanelParts-DOBPbWRM.js";import"./useFloatingPanel-qB5vS8UY.js";import"./floatingLayer-Bi4pWQ2I.js";const a={display:"grid",gap:"0.9rem",maxWidth:"42rem"},l=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],m=i({id:"select",name:"Select",category:"form",packageName:"willa/Select",description:"用于单选下拉，适合表单、筛选和配置场景。",imports:[{name:"Select",from:"willa/Select"}],css:"willa/Select.css",demo:{name:"Select",component:t,props:{options:l,defaultValue:"balanced",width:"100%"}},code:`
