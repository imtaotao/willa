import{ag as t,I as i,Z as n,t as e,f as r,p as a}from"./index-BHVmaN2F.js";import{B as o}from"./index-Dv6g4v1M.js";import{F as s}from"./index-D10on8Oc.js";/* empty css              */import{d as c}from"./defineDoc-CUYqPx2J.js";import"./heading-zbFH5KBq.js";const m={display:"grid",gap:"1rem",maxWidth:"34rem"},j=c({id:"form-actions",name:"FormActions",packageName:"willa/FormActions",description:"用于表单底部提交、取消和辅助操作的布局组件。",imports:[{name:"FormActions",from:"willa/FormActions"}],css:"willa/FormActions.css",demo:{name:"FormActions",component:s,props:{gap:"md"},children:[{name:"Button",component:o,props:{variant:"ghost"},children:"取消"},{name:"Button",component:o,props:{type:"submit"},children:"保存"}]},code:`
