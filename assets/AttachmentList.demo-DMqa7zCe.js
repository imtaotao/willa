...
- 优化文件预览
- 补充上下文附件`},{id:`screenshot`,name:`screen-capture.png`,meta:`428 KB`,href:`https://interactive-examples.mdn.mozilla.net/media/examples/plumeria.jpg`,previewType:`image`,alt:`屏幕截图预览`},{id:`brief`,name:`research-brief.pdf`,meta:`上传中`,status:`uploading`,progress:64},{id:`error`,name:`customer-export.xlsx`,meta:`上传失败`,status:`error`,actions:(0,l.jsx)(i,{size:`sm`,variant:`ghost`,icon:(0,l.jsx)(r,{}),children:`重试`})}],d={display:`grid`,gap:`0.85rem`,width:`min(100%, 48rem)`},f=o({id:`attachment-list`,name:`AttachmentList`,category:`ai`,packageName:`willa/AttachmentList`,description:`用于展示 AI 输入、消息和上下文面板里的附件列表。带 href 的附件默认在当前页面弹窗预览。`,imports:[{name:`AttachmentList`,from:`willa/AttachmentList`}],css:`willa/AttachmentList.css`,demo:{name:`AttachmentListPreview`,component:()=>{let[e,t]=(0,c.useState)(u),[n,r]=(0,c.useState)(36);(0,c.useEffect)(()=>{let e=window.setInterval(()=>{r(e=>e>=96?12:e+12)},900);return()=>window.clearInterval(e)},[]);let i=e.map(e=>e.status===`uploading`?{...e,progress:n}:e);return(0,l.jsx)(`div`,{style:d,children:(0,l.jsx)(s,{items:i,onRemove:e=>t(t=>t.filter(t=>t.id!==e.id))})})}},code:`
  ...
  `,sections:[{title:`纵向布局`,code:`
      ...
      `,content:(0,l.jsx)(`div`,{style:{display:`grid`,width:`min(100%, 34rem)`},children:(0,l.jsx)(s,{layout:`stack`,items:[{id:`architecture`,name:`architecture.md`,meta:`仓库结构和包边界`},{id:`component`,name:`component.md`,meta:`组件创建和迁移规则`}]})})},{title:`空状态`,code:`
        <AttachmentList items={[]} empty="暂无上下文附件" />;
      `,content:(0,l.jsx)(s,{items:[],empty:`暂无上下文附件`})},{title:`组合操作`,code:`
        <AttachmentList
          items={[
            {
              id: "logs",
