import{a_ as o,_ as a,f as t,Y as s,I as l,a6 as i,d,N as r,m as e,r as c,at as u}from"./index-kOedO2Qb.js";import{d as p}from"./defineDoc-BwDFvUQh.js";const n={display:"flex",flexWrap:"wrap",gap:"0.75rem",alignItems:"center"},I=p({id:"icon-button",name:"IconButton",packageName:"willa/IconButton",description:"用于工具栏、卡片操作区和内联内容中的纯图标按钮。",imports:[{name:"IconButton",from:"willa/IconButton"}],css:"willa/IconButton.css",demo:{name:"IconButton",component:a,props:{ariaLabel:"分享文章",icon:o.jsx(u,{})}},code:`
  ...
  `,sections:[{title:"视觉类型",code:`
      ...
      `,content:o.jsxs("div",{style:n,children:[o.jsx(a,{ariaLabel:"收藏",icon:o.jsx(t,{}),variant:"solid"}),o.jsx(a,{ariaLabel:"喜欢",icon:o.jsx(s,{}),variant:"soft"}),o.jsx(a,{ariaLabel:"下载",icon:o.jsx(l,{}),variant:"outline"}),o.jsx(a,{ariaLabel:"搜索",icon:o.jsx(i,{}),variant:"ghost"})]})},{title:"尺寸和形状",code:`
        <div style={iconButtonRowStyle}>
      ...
      `,content:o.jsxs("div",{style:n,children:[o.jsx(a,{ariaLabel:"上一步",icon:o.jsx(d,{}),size:"sm"}),o.jsx(a,{ariaLabel:"外部链接",icon:o.jsx(r,{}),shape:"circle"}),o.jsx(a,{ariaLabel:"确认",icon:o.jsx(e,{}),shape:"circle",size:"lg",variant:"outline"})]})},{title:"链接、禁用和加载",code:`
        <div style={iconButtonRowStyle}>
          <IconButton
            ariaLabel="打开 GitHub"
      ...
      `,content:o.jsxs("div",{style:n,children:[o.jsx(a,{ariaLabel:"打开 GitHub",href:"https://github.com",icon:o.jsx(r,{}),target:"_blank",variant:"outline"}),o.jsx(a,{ariaLabel:"不可点击",disabled:!0,icon:o.jsx(t,{})}),o.jsx(a,{ariaLabel:"保存",icon:o.jsx(e,{}),loading:!0,loadingLabel:"保存中",variant:"soft"})]})},{title:"按下态",code:`
        <div style={iconButtonRowStyle}>
          <IconButton
            ariaLabel="收藏"
            icon={<BookmarkIcon />}
      ...
      `,content:o.jsxs("div",{style:n,children:[o.jsx(a,{ariaLabel:"收藏",icon:o.jsx(t,{}),pressed:!0,variant:"ghost"}),o.jsx(a,{ariaLabel:"确认选择",icon:o.jsx(e,{}),pressed:!0,variant:"outline"})]})},{title:"点击复制",code:`
        <div style={iconButtonRowStyle}>
          <IconButton
            ariaLabel="复制安装命令"
