import{at as o,N as n,b as t,L as l,v as s,S as i,a as d,y as e,h as r,l as c,a7 as p}from"./index-JcQunHAD.js";import{d as u}from"./defineDoc-C6LiP5te.js";const a={display:"flex",flexWrap:"wrap",gap:"0.75rem",alignItems:"center"},x=u({id:"icon-button",name:"IconButton",packageName:"willa/IconButton",description:"用于工具栏、卡片操作区和内联内容中的纯图标按钮。",imports:[{name:"IconButton",from:"willa/IconButton"}],css:"willa/IconButton.css",demo:{name:"IconButton",component:n,props:{ariaLabel:"分享文章",icon:o.jsx(p,{})}},code:`
