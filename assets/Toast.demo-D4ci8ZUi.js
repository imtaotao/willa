import{aO as t,g as o,Q as r}from"./index-D31jhNsW.js";import{t as a,c as s}from"./index-YPqIfUBT.js";/* empty css              *//* empty css              */import{d as l}from"./defineDoc-YiaYi00G.js";let n,i,e;const c=()=>(n??(n=s({placement:"top",duration:1600,maxToasts:2})),n),m=()=>(i??(i=s({placement:"bottom"})),i),p=()=>(e??(e=s({placement:"bottom-right"})),e),u=()=>t.jsxs(r,{gap:"md",children:[t.jsx(o,{variant:"solid",onClick:()=>{a.success("发布成功",{description:"内容已经进入公开队列。"})},children:"成功提示"}),t.jsx(o,{variant:"soft",onClick:()=>{c().info("顶部配置",{description:"由 createToast 创建的实例触发。"})},children:"配置实例"})]}),d=()=>t.jsx(o,{variant:"soft",onClick:()=>{a.info("草稿已归档",{action:{label:"撤销",onClick:()=>a.success("已撤销归档")}})},children:"显示操作"}),T=()=>t.jsx(o,{variant:"outline",onClick:()=>{a.warning("同步仍在进行",{description:"这个提示不会自动关闭。",duration:!1})},children:"常驻提示"}),f=()=>t.jsxs(r,{gap:"md",children:[t.jsx(o,{variant:"soft",onClick:()=>{c().info("顶部居中",{description:"这个提示会更快关闭。"})},children:"顶部配置"}),t.jsx(o,{variant:"outline",onClick:()=>{p().success("右下角提示")},children:"右下角配置"})]}),h=l({id:"toast",name:"Toast",packageName:"willa/Toast",description:"用于操作反馈、状态变化和轻量通知的浮层提示。",imports:[{name:"toast",from:"willa/Toast"},{name:"createToast",from:"willa/Toast"},{name:"Button",from:"willa/Button"},{name:"Group",from:"willa/Group"}],css:"willa/Toast.css",demo:{name:"ToastPreview",component:u},code:`
