import{aX as o,W as a,g as t,U as l,G as s,a3 as i,d,L as e,m as r,q as c,ap as u}from"./index-CBWjYWX7.js";import{d as p}from"./defineDoc-C1P-18FN.js";const n={display:"flex",flexWrap:"wrap",gap:"0.75rem",alignItems:"center"},m=p({id:"icon-button",name:"IconButton",packageName:"willa/IconButton",description:"用于工具栏、卡片操作区和内联内容中的纯图标按钮。",imports:[{name:"IconButton",from:"willa/IconButton"}],css:"willa/IconButton.css",demo:{name:"IconButton",component:a,props:{ariaLabel:"分享文章",icon:o.jsx(u,{})}},code:`
