import{a$ as u,aZ as a,D as ne,aK as P,ay as se,h as Ae}from"./index-D-LV62RM.js";import{T as ke}from"./index-Ccn_64vc.js";/* empty css              *//* empty css              */import{d as _e}from"./defineDoc-CMyXJ6JB.js";const Ce=["Enter",","],o=u.forwardRef((n,s)=>{const{value:d,defaultValue:x=[],inputValue:m,defaultInputValue:c="",name:v,size:S="md",variant:ie="outline",width:q,placeholder:le="输入后按 Enter 添加",disabled:f=!1,readOnly:b=!1,invalid:K=!1,clearable:oe=!0,maxTags:j,allowDuplicates:A=!1,commitOnBlur:re=!0,separators:U=Ce,suggestions:N=[],maxSuggestions:Z=8,emptySuggestion:G,renderTag:D,normalizeTag:H=Ne,validateTag:h,onValueChange:B,onInputValueChange:$,onTagReject:R,className:ue,style:de,id:ce,onBlur:O,onFocus:z,onKeyDown:y,onPaste:w,...pe}=n,ge=u.useId(),M=ce??ge,J=d!==void 0,Q=m!==void 0,[me,fe]=u.useState(x),[he,ye]=u.useState(c),[we,W]=u.useState(!1),[k,_]=u.useState(0),l=J?d:me,I=Q?m:he,p=!f&&!b,Ie=oe&&p&&l.length>0,X=j===void 0||l.length<j,T=u.useMemo(()=>Re({allowDuplicates:A,inputValue:I,maxSuggestions:Z,suggestions:N,tags:l}),[A,I,l,Z,N]),V=we&&p&&(T.length>0||!!G),Te={...de,...q===void 0?void 0:{width:q}},C=e=>{J||fe(e),B==null||B(e)},L=e=>{Q||ye(e),$==null||$(e)},r=(e,t)=>{R==null||R(e,t)},Y=e=>{const t=H(e);if(!t)return r(e,"empty"),!1;if(!A&&l.includes(t))return r(t,"duplicate"),!1;if(!X)return r(t,"max"),!1;const i=h==null?void 0:h(t,l);return i===!1||typeof i=="string"?(r(t,"invalid"),!1):(C([...l,t]),L(""),_(0),!0)},ee=()=>I.trim()?Y(I):!1,Ve=e=>{let t=l;for(const i of e){const g=H(i);if(!g){r(i,"empty");continue}if(!A&&t.includes(g)){r(g,"duplicate");continue}if(j!==void 0&&t.length>=j){r(g,"max");continue}const ae=h==null?void 0:h(g,t);if(ae===!1||typeof ae=="string"){r(g,"invalid");continue}t=[...t,g]}t!==l&&(C(t),L(""),_(0))},F=e=>{p&&C(l.filter((t,i)=>i!==e))},xe=()=>{p&&C([])},te=e=>{Y(e)},ve=e=>{if(f||b){y==null||y(e);return}if(V&&e.key==="ArrowDown"){e.preventDefault(),_(t=>Math.min(t+1,T.length-1));return}if(V&&e.key==="ArrowUp"){e.preventDefault(),_(t=>Math.max(t-1,0));return}if(V&&e.key==="Enter"&&T[k]){e.preventDefault(),te(T[k]);return}if(De(e,U)){e.preventDefault(),ee();return}e.key==="Backspace"&&!I&&F(l.length-1),y==null||y(e)},be=e=>{if(!p){w==null||w(e);return}const t=e.clipboardData.getData("text"),i=Be(t,U).filter(Boolean);if(i.length>1){e.preventDefault(),Ve(i);return}w==null||w(e)},Se=e=>{e.currentTarget.contains(e.relatedTarget)||(W(!1),re&&p&&ee()),O==null||O(e)},je=e=>{W(!0),z==null||z(e)};return a.jsxs("div",{...pe,className:P("willa-tag-input",`willa-tag-input--${S}`,`willa-tag-input--${ie}`,f&&"willa-tag-input--disabled",b&&"willa-tag-input--readonly",K&&"willa-tag-input--invalid",ue),style:Te,"aria-disabled":f||void 0,onBlur:Se,onFocus:je,children:[a.jsxs("div",{className:"willa-tag-input__control",onClick:Ee,children:[l.map((e,t)=>a.jsxs("span",{className:P("willa-tag-input__tag",D&&"willa-tag-input__tag--custom"),children:[D?D(e,{index:t,disabled:f,readOnly:b,onRemove:()=>F(t)}):a.jsxs(a.Fragment,{children:[a.jsx("span",{className:"willa-tag-input__tag-label",children:e}),p?a.jsx("button",{className:"willa-tag-input__remove",type:"button","aria-label":`移除 ${e}`,onClick:i=>{i.stopPropagation(),F(t)},children:a.jsx(ne,{"aria-hidden":"true"})}):null]}),v?a.jsx("input",{type:"hidden",name:v,value:e,readOnly:!0}):null]},`${e}-${t}`)),a.jsx("input",{ref:s,id:M,className:"willa-tag-input__input",value:I,placeholder:l.length===0?le:void 0,disabled:f,readOnly:b||!X,"aria-invalid":K||void 0,"aria-autocomplete":N.length>0?"list":void 0,"aria-expanded":V||void 0,"aria-controls":V?`${M}-suggestions`:void 0,onChange:e=>L(e.target.value),onKeyDown:ve,onPaste:be}),Ie?a.jsx("button",{className:"willa-tag-input__clear",type:"button","aria-label":"清空标签",onClick:e=>{e.stopPropagation(),xe()},children:a.jsx(ne,{"aria-hidden":"true"})}):null]}),V?a.jsx("div",{className:"willa-tag-input__suggestions",id:`${M}-suggestions`,role:"listbox",children:T.length>0?T.map((e,t)=>a.jsx("button",{className:P("willa-tag-input__suggestion",t===k&&"willa-tag-input__suggestion--active"),type:"button",role:"option","aria-selected":t===k,onMouseDown:i=>{i.preventDefault(),te(e)},children:e},e)):G}):null]})});o.displayName="TagInput";const Ee=n=>{const s=n.currentTarget.querySelector("input:not([type='hidden'])");s==null||s.focus()},Ne=n=>n.trim(),De=(n,s)=>n.nativeEvent.isComposing?!1:s.includes(n.key),Be=(n,s)=>{const x=s.filter(c=>c.length===1).map($e),m=new RegExp(`[\\n\\r\\t${x.join("")}]+`,"g");return n.split(m).map(c=>c.trim())},$e=n=>n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),Re=n=>{const{allowDuplicates:s,inputValue:d,maxSuggestions:x,suggestions:m,tags:c}=n,v=d.trim().toLowerCase();return m.filter(S=>!s&&c.includes(S)?!1:v?S.toLowerCase().includes(v):!0).slice(0,x)},E=["AI 产品","文档站","表单","移动端","主题变量","上传","批量操作","日历"],Oe=()=>{const[n,s]=u.useState(["AI 产品","主题变量"]),d=n.length===0;return a.jsxs(se,{gap:"sm",style:{width:"min(100%, 34rem)"},children:[a.jsx(o,{value:n,invalid:d,placeholder:"至少添加一个标签",suggestions:E,onValueChange:s}),a.jsx(Ae,{size:"sm",variant:"soft",onClick:()=>s(["移动端"]),children:"重置为移动端"})]})},qe=_e({id:"tag-input",name:"TagInput",category:"form",packageName:"willa/TagInput",description:"用于输入、编辑和提交多个文本标签的表单组件。",imports:[{name:"Button",from:"willa/Button"},{name:"Stack",from:"willa/Stack"},{name:"Tag",from:"willa/Tag"},{name:"TagInput",from:"willa/TagInput"}],css:"willa/TagInput.css",demo:{name:"TagInput",component:o,props:{defaultValue:["AI 产品","文档站"],suggestions:E,placeholder:"输入标签后按 Enter",width:"min(100%, 34rem)"}},code:`
