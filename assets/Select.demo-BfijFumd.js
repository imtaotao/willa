import{a_ as e}from"./index-Bo8PUlF-.js";import{S as t}from"./index-Bmq1Iu2D.js";import{d as i}from"./defineDoc-B4fQnlag.js";import"./index-CN-WMSi0.js";import"./useComboboxState-CEnZQeuH.js";import"./floatingPanelParts-CluSa0RS.js";import"./useFloatingPanel-Kbff_vET.js";const a={display:"grid",gap:"0.9rem",maxWidth:"42rem"},l=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],r=i({id:"select",name:"Select",category:"form",packageName:"willa/Select",description:"用于单选下拉，适合表单、筛选和配置场景。",imports:[{name:"Select",from:"willa/Select"}],css:"willa/Select.css",demo:{name:"Select",component:t,props:{options:l,defaultValue:"balanced",width:"100%"}},code:`
