import{aC as T,aA as e,k as V,ao as A,i as M,v as D,T as P,V as f,N as r,e as a,t as g,a6 as E,a0 as L,j as W}from"./index-8h0iXH-K.js";/* empty css              *//* empty css              */import{d as q}from"./defineDoc-WQsG9bI2.js";function t({title:i,status:s="pending",description:x,meta:v,icon:y,metrics:c,actions:d,children:p,collapsible:C=!1,collapsed:j,defaultCollapsed:b=!1,summary:G,onCollapsedChange:m,className:I,...N}){const h=c!==void 0&&c.length>0,u=C&&!!p,[B,z]=T.useState(b),l=u?j??B:!1,R=G??"查看生成结果",S=()=>{const n=!l;j===void 0&&z(n),m==null||m(n)};return e.jsxs("section",{...N,className:A("willa-generation-card",`willa-generation-card--${s}`,u&&"willa-generation-card--collapsible",l&&"willa-generation-card--collapsed",I),"data-status":s,children:[e.jsxs("div",{className:"willa-generation-card-header",children:[e.jsx("span",{className:"willa-generation-card-mark","aria-hidden":"true",children:y??e.jsx(_,{status:s})}),e.jsxs("div",{className:"willa-generation-card-heading",children:[e.jsxs("div",{className:"willa-generation-card-title-row",children:[e.jsx("h3",{className:"willa-generation-card-title",children:i}),e.jsx("span",{className:"willa-generation-card-status",children:$[s]})]}),x?e.jsx("div",{className:"willa-generation-card-description",children:x}):null]}),v?e.jsx("div",{className:"willa-generation-card-meta",children:v}):null]}),u?e.jsxs("button",{className:"willa-generation-card-toggle",type:"button","aria-expanded":!l,onClick:S,children:[e.jsx("span",{className:"willa-generation-card-toggle-text",children:R}),e.jsx(V,{className:"willa-generation-card-toggle-icon"})]}):null,p&&!l?e.jsx("div",{className:"willa-generation-card-content",children:p}):null,h||d?e.jsxs("div",{className:"willa-generation-card-footer",children:[h?e.jsx("dl",{className:"willa-generation-card-metrics",children:c.map((n,k)=>e.jsxs("div",{className:"willa-generation-card-metric",children:[e.jsx("dt",{children:n.label}),e.jsx("dd",{children:n.value})]},k))}):null,d?e.jsx("div",{className:"willa-generation-card-actions",children:d}):null]}):null]})}const _=({status:i})=>i==="completed"?e.jsx(M,{}):i==="failed"?e.jsx(D,{}):i==="generating"?e.jsx(P,{}):e.jsx(f,{}),$={pending:"等待生成",generating:"生成中",completed:"已生成",failed:"生成失败"},w={display:"grid",gap:"0.82rem",width:"min(100%, 58rem)"},o={margin:0},F=()=>e.jsx("div",{style:w,children:e.jsx(t,{collapsible:!0,defaultCollapsed:!0,title:"产品反馈摘要",status:"completed",description:"从 128 条用户反馈中生成可直接进入周报的摘要。",meta:"刚刚",summary:"隐藏生成正文，只保留状态、指标和操作。",metrics:[{label:"来源",value:"128 条"},{label:"置信",value:"高"},{label:"耗时",value:"4.2s"}],actions:e.jsxs(r,{gap:"xs",wrap:!0,children:[e.jsx(a,{size:"sm",variant:"soft",trailingIcon:e.jsx(g,{}),children:"复制"}),e.jsx(a,{size:"sm",variant:"solid",trailingIcon:e.jsx(W,{}),children:"采纳"})]}),children:e.jsx("p",{style:o,children:"本周反馈集中在导出稳定性、批量处理体验和主题配置理解成本。建议优先处理导出失败兜底，其次优化批量任务进度提示。"})})}),Q=q({id:"generation-card",name:"GenerationCard",category:"ai",packageName:"willa/GenerationCard",description:"用于展示 AI 生成任务的状态、结果摘要、指标和后续操作。",imports:[{name:"GenerationCard",from:"willa/GenerationCard"}],css:"willa/GenerationCard.css",demo:{name:"GenerationCardPreview",component:F},code:`
