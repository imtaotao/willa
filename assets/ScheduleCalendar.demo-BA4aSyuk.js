import{aY as e,B as r,a_ as c}from"./index-5Xo7nplC.js";import{S as a}from"./index-DXy_ahnr.js";/* empty css              */import{d as v}from"./defineDoc-DZKWvp5z.js";const m={display:"grid",justifyItems:"center"},d={display:"grid",width:"min(100%, 56rem)",gap:"0.82rem"},s=[{id:"standup",title:"产品站会",start:"2026-06-16 09:30",end:"2026-06-16 10:00",tone:"info",meta:"30 分钟"},{id:"review",title:"发布评审",start:"2026-06-18 14:00",end:"2026-06-18 15:30",tone:"success",meta:"组件和文档"},{id:"holiday",title:"端午排期冻结",start:"2026-06-19 11:00",end:"2026-06-19 12:00",tone:"warning",meta:"发布窗口"},{id:"risk-review",title:"风险复核",start:"2026-06-18 14:30",end:"2026-06-18 15:30",tone:"warning",meta:"并行评审"}],l=[{id:"freeze",title:"发布冻结",start:"2026-06-19",end:"2026-06-20",tone:"warning"}],D=()=>{const[t,n]=c.useState("review");return e.jsx("div",{style:m,children:e.jsx(a,{width:"min(100%, 56rem)",defaultVisibleDate:new Date(2026,5,16),selectedEventId:t,slotMinutes:30,startHour:8,endHour:18,events:s,allDayEvents:l,onEventClick:i=>n(i.id)})})},y=()=>{const[t,n]=c.useState("review"),[i,u]=c.useState("2026-06-17 10:00");return e.jsxs("div",{style:d,children:[e.jsxs(r,{tone:"info",children:["当前选择：",t||i||"未选择"]}),e.jsx(a,{defaultVisibleDate:new Date(2026,5,16),selectedEventId:t,selectedSlot:i,slotMinutes:30,startHour:8,endHour:18,events:s,allDayEvents:l,onEventClick:o=>{n(o.id),u("")},onSlotClick:o=>{n(""),u(o)}})]})},E=v({id:"schedule-calendar",name:"ScheduleCalendar",displayName:"排期日历",category:"form",packageName:"willa/Calendar",description:"排期查看器，用于展示周排期、月排期、全天事件和可点击的时间格；适合查看、选择和触发外部操作，不内置拖拽创建或事件编辑。",imports:[{name:"ScheduleCalendar",from:"willa/Calendar"},{name:"Badge",from:"willa/Badge"}],css:"willa/Calendar.css",demo:{name:"ScheduleCalendarPreview",component:D},code:`
  ...
  `,sections:[{title:"定位边界",code:`
        ...
        />
      `,content:e.jsxs("div",{style:d,children:[e.jsx(r,{tone:"info",children:"适合排期查看、事件选择和空白时间格点击；编辑表单、拖拽创建和保存流程由业务侧承接。"}),e.jsx(r,{tone:"warning",children:"周视图和月视图是桌面优先的信息密度，移动端保留横向浏览，不压缩为完整移动排期工作台。"}),e.jsx(a,{width:"min(100%, 56rem)",defaultVisibleDate:new Date(2026,5,16),events:s,allDayEvents:l})]})},{title:"周视图和月视图",code:`
      ...
      `,content:e.jsxs("div",{style:d,children:[e.jsx(a,{defaultVisibleDate:new Date(2026,5,16),defaultView:"week",slotMinutes:30,startHour:8,endHour:18,events:s,allDayEvents:l}),e.jsx(a,{defaultVisibleDate:new Date(2026,5,16),defaultView:"month",events:s,allDayEvents:l})]})},{title:"选中态",code:`
        ...
        />;
      `,content:e.jsx(y,{})},{title:"空态和禁用",code:`
        <ScheduleCalendar
          defaultVisibleDate={new Date(2026, 5, 16)}
          emptyText="当前范围没有排期"
          disabledDate={(value) => {
