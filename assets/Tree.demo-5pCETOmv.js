import{ay as e,B as s,aA as n,ae as m,S as p,I as y,H as t,A as o}from"./index-DBsCKa5b.js";import{T as r}from"./index-BETTJx-l.js";import{d as T}from"./defineDoc-CeA5kaJR.js";const d=[{key:"workspace",title:"工作区",description:"团队共享资源",icon:e.jsx(o,{}),children:[{key:"product",title:"产品文档",description:"PRD、设计稿和上线记录",icon:e.jsx(t,{})},{key:"report",title:"数据报表",description:"用户反馈、埋点和业务指标",icon:e.jsx(t,{})}]},{key:"knowledge",title:"知识库",description:"AI 可检索资料",icon:e.jsx(o,{}),children:[{key:"component",title:"组件规范",description:"Willa 组件设计和 API 约定",icon:e.jsx(t,{})},{key:"style",title:"样式规则",description:"主题变量、CSS 和移动端规则",icon:e.jsx(t,{})}]}],k=[{key:"project",title:"项目权限",icon:e.jsx(p,{}),children:[{key:"project-read",title:"查看项目"},{key:"project-write",title:"编辑项目"},{key:"project-delete",title:"删除项目",disabled:!0}]},{key:"model",title:"模型权限",icon:e.jsx(y,{}),children:[{key:"model-read",title:"查看模型"},{key:"model-run",title:"调用模型"},{key:"model-admin",title:"管理模型"}]}],u=()=>{const[i,l]=n.useState(["workspace"]),[a,c]=n.useState(["product"]);return e.jsxs(m,{gap:"sm",style:{width:"min(100%, 32rem)"},children:[e.jsx(r,{items:d,expandedKeys:i,selectedKeys:a,onExpandedChange:l,onSelectedChange:c}),e.jsxs(s,{size:"sm",children:["当前选择：",a.join("、")||"无"]})]})},h=T({id:"tree",name:"Tree",packageName:"willa/Tree",description:"用于展示和操作层级数据，支持展开、选择、勾选和自定义节点内容。",imports:[{name:"Badge",from:"willa/Badge"},{name:"Stack",from:"willa/Stack"},{name:"Tree",from:"willa/Tree"}],css:"willa/Tree.css",demo:{name:"Tree",component:r,props:{items:d,defaultExpandAll:!0,style:{width:"min(100%, 32rem)"}}},code:`
  ...
  `,sections:[{title:"受控状态",code:`
      ...
      `,content:e.jsx(u,{})},{title:"勾选节点",code:`
        import { Tree, type TreeItem } from "willa/Tree";
        import "willa/Tree.css";
        ...
        <Tree
          ...
          style={{ width: "min(100%, 32rem)" }}
        />;
      `,content:e.jsx(r,{items:k,checkable:!0,defaultExpandAll:!0,defaultCheckedKeys:["project-read","model-run"],style:{width:"min(100%, 32rem)"}})},{title:"自定义节点",code:`
        import { Badge } from "willa/Badge";
        import { Tree, type TreeItem } from "willa/Tree";
        import "willa/Badge.css";
        import "willa/Tree.css";
