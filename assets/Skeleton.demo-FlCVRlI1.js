import{b0 as e,aw as n}from"./index-MvDtKvGL.js";import{d as o}from"./defineDoc-BE2V2Usy.js";const t=()=>e.jsx(n,{loading:!0,lines:["44%","100%","76%"],block:!0,blockHeight:160,children:e.jsx("div",{children:"Loaded content"})}),i={display:"grid",width:"min(100%, 34rem)",gap:"0.75rem"},r=o({id:"skeleton",name:"Skeleton",category:"content",packageName:"willa/Skeleton",description:"包裹真实内容的加载骨架屏，可用于文档、嵌入卡片等异步渲染场景。",imports:[{name:"Skeleton",from:"willa/Skeleton"}],css:"willa/Skeleton.css",demo:{name:"SkeletonPreview",component:t},code:`
