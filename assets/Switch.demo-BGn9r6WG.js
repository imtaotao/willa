import{aA as u,ay as i,am as d}from"./index-vVHMmPWZ.js";import{d as b}from"./defineDoc-CK669M_K.js";const e=u.forwardRef((r,o)=>{const{label:l,description:s,size:p="md",invalid:m=!1,inputClassName:w,className:h,disabled:t,...a}=r,c=m||a["aria-invalid"]===!0||a["aria-invalid"]==="true";return i.jsxs("label",{className:d("willa-switch",`willa-switch--${p}`,t&&"willa-switch--disabled",c&&"willa-switch--invalid",h),children:[l||s?i.jsxs("span",{className:"willa-switch-content",children:[l?i.jsx("span",{className:"willa-switch-label",children:l}):null,s?i.jsx("span",{className:"willa-switch-description",children:s}):null]}):null,i.jsxs("span",{className:"willa-switch-control",children:[i.jsx("input",{...a,ref:o,className:d("willa-switch-input",w),disabled:t,type:"checkbox",role:"switch","aria-invalid":c||a["aria-invalid"]}),i.jsx("span",{className:"willa-switch-track","aria-hidden":"true",children:i.jsx("span",{className:"willa-switch-thumb"})})]})]})});e.displayName="Switch";const n={display:"grid",gap:"0.9rem",maxWidth:"42rem"},f=b({id:"switch",name:"Switch",category:"form",packageName:"willa/Switch",description:"用于开关型配置，适合产品设置和能力启停。",imports:[{name:"Switch",from:"willa/Switch"}],css:"willa/Switch.css",demo:{name:"Switch",component:e,props:{label:"启用自动摘要",description:"生成结果后自动提取重点。",defaultChecked:!0}},code:`
