import{l as e}from"./aidly.esm-bundler-DaTrP4tr.js";import{t}from"./Button-O1aY2iqB.js";import{t as n}from"./Alert-DecsWCe8.js";import"./style-B00R6KjV.js";import{t as r}from"./defineDoc-Cid5xIoZ.js";var i=e(),a=r({id:`alert`,name:`Alert`,packageName:`willa/Alert`,description:`用于页面或区块内展示操作结果、异步状态和系统反馈，支持关闭、操作区、横幅和可访问性播报；文档正文里的长文本语义提示优先使用 Callout。`,imports:[{name:`Alert`,from:`willa/Alert`}],css:`willa/Alert.css`,demo:{name:`Alert`,component:n,props:{type:`success`,showIcon:!0,title:`发布成功`,description:`内容已保存并进入发布队列，稍后可在任务中心查看处理结果。`}},code:`
  ...
  `,sections:[{title:`语义类型`,code:`
      ...
      `,content:(0,i.jsxs)(`div`,{style:{display:`grid`,gap:`0.85rem`},children:[(0,i.jsx)(n,{type:`info`,showIcon:!0,title:`同步进行中`,description:`系统正在拉取最新配置，页面数据可能会短暂延迟。`}),(0,i.jsx)(n,{type:`success`,showIcon:!0,title:`保存完成`,description:`表单变更已写入服务端，团队成员可以查看最新版本。`}),(0,i.jsx)(n,{type:`warning`,showIcon:!0,title:`发布窗口即将关闭`,description:`当前任务仍可继续提交，但建议在截止前完成确认。`}),(0,i.jsx)(n,{type:`error`,showIcon:!0,title:`提交失败`,description:`接口返回校验错误，请修复表单中的必填项后重试。`})]})},{title:`操作与关闭`,code:`
        <Alert
          type="warning"
          showIcon
          closable
        ...
        />;
      `,content:(0,i.jsx)(n,{type:`warning`,showIcon:!0,closable:!0,title:`版本即将过期`,description:`当前配置仍可继续使用，但建议在下次发布前完成迁移。`,action:(0,i.jsx)(t,{size:`sm`,variant:`soft`,children:`查看详情`})})},{title:`横幅提示`,code:`
        <Alert
          banner
          showIcon
        ...
        />;
      `,content:(0,i.jsx)(n,{banner:!0,showIcon:!0,closable:{closeLabel:`关闭发布提示`},title:`系统将在 22:00 发布更新`,description:`发布期间部分写入操作可能短暂排队。`})},{title:`视觉样式`,code:`
