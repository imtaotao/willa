import{aY as t,W as e}from"./index-DfbXHl_X.js";import{C as o}from"./index-6pvDtqJS.js";/* empty css              */import{d as n}from"./defineDoc-C0wi4BKe.js";const d=n({id:"copy-button",name:"CopyButton",packageName:"willa/CopyButton",description:"用于复制命令、链接和代码片段，并内置复制成功与失败状态。",imports:[{name:"CopyButton",from:"willa/CopyButton"},{name:"Group",from:"willa/Group"}],css:"willa/CopyButton.css",demo:{name:"CopyButton",component:o,props:{text:"pnpm add willa"},children:"复制安装命令"},code:`
