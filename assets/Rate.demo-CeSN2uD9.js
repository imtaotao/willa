import{b0 as o,b3 as pe,a_ as e,aL as E,aD as me,az as g,X as V,h as x}from"./index-acHovb3u.js";/* empty css              *//* empty css              */import{d as fe}from"./defineDoc-C7psqEnR.js";const he=5,u=o.forwardRef((a,l)=>{const{value:i,defaultValue:r=0,count:c=he,allowClear:b=!0,allowHalf:m=!1,autoFocus:P=!1,character:T,disabled:s=!1,keyboard:$=!0,name:G,size:_="md",tooltips:D=[],className:X,style:U,tabIndex:J,onBlur:R,onChange:O,onFocus:j,onHoverChange:C,onKeyDown:S,onMouseLeave:k,...Q}=a,h=o.useRef(null),d=Math.max(1,Math.floor(c)),[Y,Z]=pe({value:i,defaultValue:()=>B(r,d,m),onChange:O}),[ee,ae]=o.useState(null),[H,F]=o.useState(!1),v=B(Y,d,m),f=ee??v,te=m?.5:1,le=o.useMemo(()=>Array.from({length:d},(t,n)=>n+1),[d]);o.useImperativeHandle(l,()=>({focus:()=>{var t;return(t=h.current)==null?void 0:t.focus()},blur:()=>{var t;return(t=h.current)==null?void 0:t.blur()}}),[]),o.useEffect(()=>{var t;P&&!s&&((t=h.current)==null||t.focus())},[P,s]);const I=(t,n={})=>{const p=B(t,d,m),w=n.clearable&&b&&p===v?0:p;Z(w)},N=t=>{ae(t),C==null||C(t??0)},re=(t,n)=>{s||N(K(t,n,m))},ne=(t,n)=>{var p;s||((p=h.current)==null||p.focus(),I(K(t,n,m),{clearable:!0}))},oe=t=>{if(S==null||S(t),t.defaultPrevented||s||!$)return;const n=ve({count:d,currentValue:v,key:t.key,step:te});n!==null&&(t.preventDefault(),I(n))},se=t=>{F(!0),j==null||j(t)},ue=t=>{F(!1),N(null),R==null||R(t)},ie=t=>{N(null),k==null||k(t)},ce=D[Math.ceil(f)-1]??`${f}/${d}`;return e.jsxs("div",{...Q,ref:h,className:E("willa-rate",`willa-rate--${_}`,s&&"willa-rate--disabled",H&&"willa-rate--focused",X),style:U,role:"slider","aria-disabled":s||void 0,"aria-valuemin":0,"aria-valuemax":d,"aria-valuenow":f,"aria-valuetext":ce,tabIndex:s?void 0:J??0,onBlur:ue,onFocus:se,onKeyDown:oe,onMouseLeave:ie,children:[e.jsx("span",{className:"willa-rate-items","aria-hidden":"true",children:le.map(t=>{const n=ge(f,t),p=n>0,w=n>0&&n<100,de={"--willa-rate-active-width":`${n}%`},q=e.jsxs("span",{className:E("willa-rate-item",p&&"willa-rate-item--active",w&&"willa-rate-item--half"),style:de,onClick:M=>ne(M,t),onMouseMove:M=>re(M,t),children:[e.jsx("span",{className:"willa-rate-character willa-rate-character--base",children:L({character:T,disabled:s,focused:H,active:!1,half:!1,index:t,value:f})}),e.jsx("span",{className:"willa-rate-character willa-rate-character--active","aria-hidden":"true",children:L({character:T,disabled:s,focused:H,active:p,half:w,index:t,value:f})})]},t),A=D[t-1];return A?e.jsx(me,{content:A,side:"top",size:"sm",children:q},t):q})}),G?e.jsx("input",{type:"hidden",name:G,value:v,disabled:s}):null]})});u.displayName="Rate";const L=a=>typeof a.character=="function"?a.character({active:a.active,disabled:a.disabled,focused:a.focused,half:a.half,index:a.index,value:a.value}):a.character??e.jsx(W,{}),W=()=>e.jsx("svg",{className:"willa-rate-star",viewBox:"0 0 24 24",focusable:"false","aria-hidden":"true",children:e.jsx("path",{d:"M12 2.8l2.82 5.72 6.31.92-4.56 4.45 1.08 6.28L12 17.2l-5.65 2.97 1.08-6.28-4.56-4.45 6.31-.92L12 2.8z"})});W.displayName="RateStarIcon";const B=(a,l,i)=>{const r=Number.isFinite(a)?Number(a):0,c=i?.5:1,b=Math.round(r/c)*c;return Math.min(l,Math.max(0,b))},K=(a,l,i)=>{if(!i)return l;const r=a.currentTarget.getBoundingClientRect();return a.clientX-r.left<=r.width/2?l-.5:l},ge=(a,l)=>a>=l?100:a<=l-1?0:(a-(l-1))*100,ve=a=>{const{count:l,currentValue:i,key:r,step:c}=a;return r==="ArrowRight"||r==="ArrowUp"?Math.min(l,i+c):r==="ArrowLeft"||r==="ArrowDown"?Math.max(0,i-c):r==="Home"?0:r==="End"?l:null},y=["很差","一般","还行","满意","推荐"],we={display:"grid",gap:"0.35rem",minWidth:"10rem",padding:"0.85rem",border:"1px solid var(--willa-panel-border)",borderRadius:"0.75rem",background:"var(--willa-panel-bg)"},z={color:"var(--willa-text-soft)",fontSize:"0.88rem",lineHeight:1.55},xe=()=>{const[a,l]=o.useState(3);return e.jsxs(V,{align:"center",gap:"lg",wrap:!0,children:[e.jsx(u,{value:a,tooltips:y,onChange:l}),e.jsxs("div",{style:we,children:[e.jsx("strong",{children:"服务体验"}),e.jsxs("span",{style:z,children:["当前 ",a," 分，",y[a-1]??"尚未评分","。"]})]})]})},ye=()=>e.jsxs(g,{gap:"md",children:[e.jsx(u,{allowHalf:!0,defaultValue:3.5}),e.jsx(u,{allowHalf:!0,defaultValue:2.5,count:7,size:"lg"})]}),Ve=()=>{const[a,l]=o.useState(4);return e.jsxs(V,{align:"center",gap:"md",wrap:!0,children:[e.jsx(u,{value:a,tooltips:y,onChange:l}),e.jsx("span",{style:z,children:y[a-1]})]})},be=()=>{const[a,l]=o.useState(2);return e.jsxs(g,{gap:"sm",children:[e.jsx(u,{value:a,allowClear:!0,onChange:l}),e.jsxs(V,{gap:"sm",wrap:!0,children:[e.jsx(x,{variant:"outline",onClick:()=>l(0),children:"清空"}),e.jsx(x,{variant:"outline",onClick:()=>l(5),children:"满分"})]})]})},Re=()=>e.jsxs(g,{gap:"md",children:[e.jsx(u,{defaultValue:4,character:"赞"}),e.jsx(u,{allowHalf:!0,defaultValue:3.5,character:({index:a})=>e.jsx("span",{children:a})})]}),je=()=>e.jsxs(g,{gap:"md",children:[e.jsx(u,{defaultValue:4,disabled:!0}),e.jsx(u,{allowHalf:!0,defaultValue:3.5,disabled:!0})]}),Ce=()=>{const a=o.useRef(null),[l,i]=o.useState(3);return e.jsxs(g,{gap:"sm",children:[e.jsx(u,{ref:a,allowHalf:!0,value:l,onChange:i}),e.jsxs(V,{gap:"sm",wrap:!0,children:[e.jsx(x,{variant:"outline",onClick:()=>{var r;return(r=a.current)==null?void 0:r.focus()},children:"聚焦"}),e.jsx(x,{variant:"outline",onClick:()=>{var r;return(r=a.current)==null?void 0:r.blur()},children:"失焦"})]}),e.jsx("span",{style:z,children:"聚焦后可用方向键、Home 和 End 调整评分。"})]})},Me=fe({id:"rate",name:"Rate",displayName:"Rate 评分",category:"form",packageName:"willa/Rate",description:"用于评价、满意度和偏好强度选择的评分控件。",imports:[{name:"Rate, type RateRef",from:"willa/Rate"}],css:"willa/Rate.css",demo:{name:"RatePreview",component:xe},code:`
