import{a_ as e,X as p,h as i,b0 as s,B as c}from"./index-CbNsWwWA.js";import{C as t}from"./index-CVXIRNkx.js";/* empty css              *//* empty css              */import{d}from"./defineDoc-CYRy-ddK.js";import"./index-CfmP9aCa.js";import"./index-BwDsl8Fk.js";const o={display:"grid",gap:"0.85rem",width:"min(100%, 52rem)",margin:"0 auto"},h=()=>{const[a,n]=s.useState(""),[m,r]=s.useState("");return e.jsxs("div",{style:o,children:[e.jsx(t,{value:a,onValueChange:n,maxLength:180,onSubmit:(l,u)=>{r(l),u.clear()}}),m?e.jsxs(c,{tone:"success",children:["已发布：",m]}):null]})},x=()=>{const[a,n]=s.useState("");return e.jsx("div",{style:o,children:e.jsx(t,{placeholder:"回复这条评论...",quote:{author:"产品设计",content:"这个输入区需要支持评论扩展能力。"},onMentionClick:()=>n("打开成员选择面板"),actions:e.jsx(i,{size:"sm",variant:"ghost",onClick:()=>n("打开业务自己的表情包面板"),children:"表情"}),footer:a||"点击 @ 或表情按钮接入业务面板"})})},I=d({id:"comment-input",name:"CommentInput",category:"content",packageName:"willa/CommentInput",description:"用于评论、批注和反馈场景的轻量输入组件。",imports:[{name:"CommentInput",from:"willa/CommentInput"}],css:"willa/CommentInput.css",demo:{name:"CommentInputPreview",component:h},code:`
