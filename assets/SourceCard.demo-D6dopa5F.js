import{b3 as e,R as r,a7 as s,W as n}from"./index-x8GQ-vXc.js";import{S as t}from"./index-DBbQdXg5.js";import{d}from"./defineDoc-C27-iyXB.js";const a=[{title:"组件创建规范",description:"说明新组件的包归属、导出、CSS、主题变量和示例文档接入规则。",source:"component.md",url:"docs/component.md",meta:"命中 92%",icon:e.jsx(r,{}),href:"#",selected:!0},{title:"组件创建规范",description:"说明新组件的包归属、导出、CSS、主题变量和示例文档接入规则。",source:"component.md",url:"docs/component.md",meta:"规范",icon:e.jsx(s,{}),href:"#"},{title:"Willa 官网文档",description:"用于展示外部网页来源、知识库链接和引用跳转入口。",source:"willa.dev",url:"https://willa.dev/components/source-card",meta:"网页",icon:e.jsx(n,{}),href:"#"}],c={display:"grid",gap:"0.82rem",width:"min(100%, 56rem)"},m={display:"grid",gap:"0.72rem",gridTemplateColumns:"repeat(auto-fit, minmax(13rem, 1fr))"},l=()=>e.jsx("div",{style:c,children:a.map((o,i)=>e.jsx(t,{...o},`${String(o.title)}-${i}`))}),f=d({id:"source-card",name:"SourceCard",category:"content",packageName:"willa/SourceCard",description:"用于展示来源、资料、搜索结果、摘要片段和跳转入口。",imports:[{name:"SourceCard",from:"willa/SourceCard"}],css:"willa/SourceCard.css",demo:{name:"SourceCardPreview",component:l},code:`
  ...
  `,sections:[{title:"紧凑来源",code:`
      ...
      `,content:e.jsxs("div",{style:m,children:[e.jsx(t,{size:"sm",title:"组件创建规范",source:"component.md",url:"docs/component.md",meta:"规范",index:"A",href:"#"}),e.jsx(t,{size:"sm",variant:"solid",title:"CSS 主题规则",source:"css.md",url:"docs/css.md",meta:"主题",index:"B",href:"#"})]})},{title:"知识库引用",code:`
        <SourceCard
          variant="solid"
          title="对话消息组件设计"
