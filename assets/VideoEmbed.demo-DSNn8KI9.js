import{b3 as e}from"./index-x8GQ-vXc.js";import{V as t}from"./index-5Lf1MxGw.js";import{d as o}from"./defineDoc-C27-iyXB.js";import"./nodes-Dp2bW0pc.js";import"./media-BCJ_ZfUH.js";import"./mediaEmbed-NTvYE3MP.js";import"./useMediaPlaybackState-B67yCBIY.js";const i={width:"min(100%, 48rem)",margin:"0 auto"},s=(a,r)=>`https://interactive-examples.mdn.mozilla.net/media/cc0-videos/${r.replace(/^\.\//,"")}`,n=[{name:"onLoadStart",type:"ReactEventHandler<HTMLVideoElement>",group:"媒体事件",description:"内联视频开始加载时触发；仅在传入 src 时生效。"},{name:"onProgress",type:"ReactEventHandler<HTMLVideoElement>",group:"媒体事件",description:"内联视频加载缓冲进度变化时触发；仅在传入 src 时生效。"},{name:"onCanPlay",type:"ReactEventHandler<HTMLVideoElement>",group:"媒体事件",description:"内联视频可以播放时触发；仅在传入 src 时生效。"},{name:"onLoadedMetadata",type:"ReactEventHandler<HTMLVideoElement>",group:"媒体事件",description:"内联视频元数据加载完成时触发；仅在传入 src 时生效。"},{name:"onTimeUpdate",type:"ReactEventHandler<HTMLVideoElement>",group:"媒体事件",description:"内联视频播放进度变化时触发；仅在传入 src 时生效。"},{name:"onWaiting",type:"ReactEventHandler<HTMLVideoElement>",group:"媒体事件",description:"内联视频等待更多数据时触发；仅在传入 src 时生效。"},{name:"onStalled",type:"ReactEventHandler<HTMLVideoElement>",group:"媒体事件",description:"内联视频取数停滞时触发；仅在传入 src 时生效。"},{name:"onPlay",type:"ReactEventHandler<HTMLVideoElement>",group:"媒体事件",description:"内联视频开始播放时触发；仅在传入 src 时生效。"},{name:"onPause",type:"ReactEventHandler<HTMLVideoElement>",group:"媒体事件",description:"内联视频暂停时触发；仅在传入 src 时生效。"},{name:"onEnded",type:"ReactEventHandler<HTMLVideoElement>",group:"媒体事件",description:"内联视频播放结束时触发；仅在传入 src 时生效。"},{name:"onError",type:"ReactEventHandler<HTMLVideoElement>",group:"媒体事件",description:"内联视频加载或播放失败时触发；仅在传入 src 时生效。"}],d=()=>e.jsx("div",{style:i,children:e.jsx(t,{title:"Big Buck Bunny",description:"一个带内联控制条的短视频示例。",duration:"0:10",provider:"MDN",volume:.35,src:"https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",href:"https://developer.mozilla.org/"})}),g=o({id:"video-embed",name:"VideoEmbed",packageName:"willa/VideoEmbed",description:"视频卡片组件，可选择在页面内播放。",imports:[{name:"VideoEmbed",from:"willa/VideoEmbed"}],css:"willa/VideoEmbed.css",propGroups:[{title:"媒体事件",description:"这些事件透传给内联 video 元素；仅外部链接状态不会触发。"}],demo:{name:"VideoEmbedPreview",component:d},code:`
  ...
  `,sections:[{title:"仅外部链接",code:`
        <VideoEmbed
          ...
          href="https://developer.mozilla.org/"
        />;
      `,content:e.jsx("div",{style:i,children:e.jsx(t,{title:"外部视频",description:"没有 src 时，组件会渲染为可点击的视频外链卡片。",duration:"0:10",provider:"MDN",poster:"https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=900&q=80",href:"https://developer.mozilla.org/"})})},{title:"文章相对资源",code:`
        ...
        <VideoEmbed
          ...
          src="./flower.mp4"
        />;
      `,content:e.jsx("div",{style:i,children:e.jsx(t,{title:"文章内视频",description:"src 可以是相对路径，由 articleSourcePath 和 resolveAssetUrl 转成可访问地址。",duration:"0:10",provider:"MDX",volume:.35,articleSourcePath:"/posts/video-demo.mdx",resolveAssetUrl:s,src:"./flower.mp4"})})},{title:"加载和错误状态",code:`
        <VideoEmbed
          title="不可用视频"
