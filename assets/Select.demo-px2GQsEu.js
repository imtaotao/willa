import{aY as e}from"./index-CTZ1VNtq.js";import{S as t}from"./index-D6rlz3az.js";import{d as i}from"./defineDoc-DS9v3ENx.js";import"./index-iH6tdvSv.js";import"./useSelectablePanel-Gf8meIqt.js";import"./floatingPanelParts-DZlhcTA3.js";import"./useFloatingPanel-D5O4-QE8.js";const a={display:"grid",gap:"0.9rem",maxWidth:"42rem"},l=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],r=i({id:"select",name:"Select",category:"form",packageName:"willa/Select",description:"用于单选下拉，适合表单、筛选和配置场景。",imports:[{name:"Select",from:"willa/Select"}],css:"willa/Select.css",demo:{name:"Select",component:t,props:{options:l,defaultValue:"balanced",width:"100%"}},code:`
