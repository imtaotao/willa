import{aB as m,az as t,an as S,M as F,d as v,B as H}from"./index-C16Conw4.js";import{A as T}from"./index-ConXrWQW.js";import{I as G}from"./index-P5qbpp-5.js";/* empty css              *//* empty css              */import{d as _}from"./defineDoc-CN769hh-.js";function i(n){const{value:e,defaultValue:o="",onValueChange:a,onSubmit:s,placeholder:u="写下你的评论...",submitLabel:B="发布",disabled:g=!1,loading:c=!1,minRows:C=3,maxLength:p,autoFocus:k=!1,avatarSrc:b,avatarName:l,quote:d,mentionLabel:L="@",onMentionClick:h,actions:j,footer:w,className:q,textareaProps:z}=n,y=e!==void 0,[R,A]=m.useState(o),x=y?e:R,V=x.trim(),I=f=>{y||A(f),a==null||a(f)},E=()=>{I("")},M=(f,K)=>{V&&(s==null||s(V,{clear:E}))},N=!!(b||l),P=!!(h||j);return t.jsx(G,{...z,className:S("willa-comment-input",N&&"willa-comment-input--with-author",c&&"willa-comment-input--loading",q),slotClassNames:{actions:"willa-comment-input-actions",control:"willa-comment-input-control",footer:"willa-comment-input-footer",meta:"willa-comment-input-extra",submit:"willa-comment-input-submit"},autoFocus:k,autoResize:!1,minRows:C,maxRows:C,maxLength:p,submitShortcut:"mod-enter",loading:c,beforeInput:t.jsxs(t.Fragment,{children:[N?t.jsxs("div",{className:"willa-comment-input-author",children:[t.jsx(T,{className:"willa-comment-input-avatar",src:b,name:l??"Comment Author",alt:l??"Comment Author",size:"sm"}),t.jsx("span",{className:"willa-comment-input-author-name",children:l??"评论者"})]}):null,d?t.jsx("div",{className:"willa-comment-input-quote",children:t.jsxs("div",{className:"willa-comment-input-quote-content",children:[t.jsx("span",{className:"willa-comment-input-quote-mark","aria-hidden":"true",children:"“"}),t.jsxs("span",{className:"willa-comment-input-quote-author",children:["@",d.author]}),d.content,t.jsx("span",{className:"willa-comment-input-quote-mark","aria-hidden":"true",children:"”"})]})}):null]}),footer:w?t.jsx("span",{children:w}):p?t.jsxs("span",{children:[x.length,"/",p]}):t.jsx("span",{children:"⌘ Enter 发布"}),actions:P?t.jsxs(t.Fragment,{children:[h?t.jsx(D,{"aria-label":"提及用户",onClick:h,disabled:g||c,children:L}):null,j]}):null,submitLabel:B,value:x,placeholder:u,disabled:g,onValueChange:I,onSubmit:M})}const D=n=>{const{className:e,type:o="button",...a}=n;return t.jsx("button",{...a,type:o,className:S("willa-comment-input-tool",e)})},r={display:"grid",gap:"0.85rem",width:"min(100%, 52rem)",margin:"0 auto"},Q=()=>{const[n,e]=m.useState(""),[o,a]=m.useState("");return t.jsxs("div",{style:r,children:[t.jsx(i,{value:n,onValueChange:e,maxLength:180,onSubmit:(s,u)=>{a(s),u.clear()}}),o?t.jsxs(H,{tone:"success",children:["已发布：",o]}):null]})},J=()=>{const[n,e]=m.useState("");return t.jsx("div",{style:r,children:t.jsx(i,{placeholder:"回复这条评论...",quote:{author:"产品设计",content:"这个输入区需要支持评论扩展能力。"},onMentionClick:()=>e("打开成员选择面板"),actions:t.jsx(v,{size:"sm",variant:"ghost",onClick:()=>e("打开业务自己的表情包面板"),children:"表情"}),footer:n||"点击 @ 或表情按钮接入业务面板"})})},$=_({id:"comment-input",name:"CommentInput",category:"content",packageName:"willa/CommentInput",description:"用于评论、批注和反馈场景的轻量输入组件。",imports:[{name:"CommentInput",from:"willa/CommentInput"}],css:"willa/CommentInput.css",demo:{name:"CommentInputPreview",component:Q},code:`
  ...
  `,sections:[{title:"附加操作",code:`
        ...
        />;
      `,content:t.jsx("div",{style:r,children:t.jsx(i,{placeholder:"写下批注意见...",actions:t.jsxs(F,{gap:"xs",children:[t.jsx(v,{size:"sm",variant:"ghost",children:"引用段落"}),t.jsx(v,{size:"sm",variant:"ghost",children:"添加截图"})]}),footer:"支持 ⌘ Enter 快捷发布"})})},{title:"提及、表情和引用",code:`
