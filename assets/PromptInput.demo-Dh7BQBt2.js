import{a_ as e,h as p,a5 as u,b0 as r}from"./index-B2ZRy2dz.js";import{P as t}from"./index-Bu4xoKKJ.js";/* empty css              */import{d}from"./defineDoc-BjqN8DJU.js";import"./index-CfxehwXT.js";import"./index-KOy2nzgu.js";import"./index-B3vcotJ4.js";import"./index-THG8KBgX.js";const o={display:"grid",gap:"1rem",width:"min(100%, 56rem)"},m=[{id:"wang",label:"王工",value:"@wang ",role:"PM"},{id:"li",label:"李工",value:"@li ",role:"研发"},{id:"zhao",label:"赵工",value:"@zhao ",role:"运营"}],c=[{id:"doc-101",label:"竞品分析材料",value:"#doc-101 ",description:"文档"},{id:"sheet-202",label:"用户反馈表",value:"#sheet-202 ",description:"表格"}],g=[{id:"var-ctx",label:"当前上下文",value:"$ctx "},{id:"var-time",label:"今天日期",value:"$today "}],v=()=>{const[a,i]=r.useState(""),[s,l]=r.useState("暂无提交内容");return e.jsxs("div",{style:o,children:[e.jsx(t,{value:a,footer:"Enter 发送，Shift + Enter 换行",placeholder:"让 AI 帮我整理这段会议纪要...",onChange:n=>i(n.currentTarget.value),onSubmit:n=>{l(n),i("")}}),e.jsx("div",{children:s})]})},I=()=>{const[a,i]=r.useState(""),[s,l]=r.useState("暂无提及内容");return e.jsxs("div",{style:o,children:[e.jsx(t,{value:a,placeholder:"输入问题，输入 @、#、$ 提及上下文",users:m,resources:c,variables:g,footer:"支持 @/#/$ 提及",onValueChange:n=>i(n),onSubmit:n=>{l(n)}}),e.jsxs("div",{children:["已提交：",s]})]})},S=d({id:"prompt-input",name:"PromptInput",category:"ai",packageName:"willa/PromptInput",description:"用于 AI 对话、智能搜索和生成任务的提示词输入区域。",imports:[{name:"PromptInput",from:"willa/PromptInput"}],css:"willa/PromptInput.css",demo:{name:"PromptInputPreview",component:v},code:`
  ...
  `,sections:[{title:"基础输入",code:`
      ...
      `,content:e.jsx("div",{style:o,children:e.jsx(t,{placeholder:"输入你的产品需求或数据分析问题",footer:"上下文已连接到当前文档",actions:e.jsx(p,{size:"sm",variant:"ghost",icon:e.jsx(u,{}),children:"优化"})})})},{title:"提交状态",code:`
        <div style={stackStyle}>
          <PromptInput
