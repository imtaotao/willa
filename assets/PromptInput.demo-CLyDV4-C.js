import{aX as e,h as p,a3 as d,aZ as i}from"./index-B2CJSIw_.js";import{P as t}from"./index-COiNFZlj.js";/* empty css              */import{d as u}from"./defineDoc-DuO7iIa5.js";import"./index-fKwyM3jN.js";const o={display:"grid",gap:"1rem",width:"min(100%, 56rem)"},m=()=>{const[l,n]=i.useState(""),[r,s]=i.useState("暂无提交内容");return e.jsxs("div",{style:o,children:[e.jsx(t,{value:l,footer:"Enter 发送，Shift + Enter 换行",placeholder:"让 AI 帮我整理这段会议纪要...",onChange:a=>n(a.currentTarget.value),onSubmit:a=>{s(a),n("")}}),e.jsx("div",{children:r})]})},I=u({id:"prompt-input",name:"PromptInput",category:"ai",packageName:"willa/PromptInput",description:"用于 AI 对话、智能搜索和生成任务的提示词输入区域。",imports:[{name:"PromptInput",from:"willa/PromptInput"}],css:"willa/PromptInput.css",demo:{name:"PromptInputPreview",component:m},code:`
