import{ah as t,O as l,aj as a}from"./index-C2E4XHzt.js";import{B as m}from"./index-3DZYmbrW.js";import{P as e}from"./index-fuBS-RLr.js";/* empty css              */import{d}from"./defineDoc-5r0NM0Fx.js";import"./heading-BzvB6qDP.js";const o={display:"grid",gap:"1rem",width:"min(100%, 56rem)"},c=()=>{const[r,i]=a.useState(""),[s,p]=a.useState("暂无提交内容");return t.jsxs("div",{style:o,children:[t.jsx(e,{value:r,footer:"Enter 发送，Shift + Enter 换行",placeholder:"让 AI 帮我整理这段会议纪要...",onChange:n=>i(n.currentTarget.value),onSubmit:n=>{p(n),i("")}}),t.jsx("div",{children:s})]})},h=d({id:"prompt-input",name:"PromptInput",category:"ai",packageName:"willa/PromptInput",description:"用于 AI 对话、智能搜索和生成任务的提示词输入区域。",imports:[{name:"PromptInput",from:"willa/PromptInput"}],css:"willa/PromptInput.css",demo:{name:"PromptInputPreview",component:c},code:`
