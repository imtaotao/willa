import{aL as e,aw as j,a1 as t,g as y,am as p,B as g}from"./index-Dyu9wa1y.js";/* empty css              */import{d as u}from"./defineDoc-gDFvY3Bj.js";function s(d){const{header:i,sidebar:l,aside:a,footer:n,sidebarWidth:r="16rem",asideWidth:o="18rem",minContentWidth:c="0",stickyHeader:h=!1,className:m,children:w,style:x,...f}=d,S={"--willa-app-shell-sidebar-width":r,"--willa-app-shell-aside-width":o,"--willa-app-shell-min-content-width":c,...x};return e.jsxs("div",{...f,style:S,className:j("willa-app-shell",!!l&&"willa-app-shell--with-sidebar",!!a&&"willa-app-shell--with-aside",h&&"willa-app-shell--sticky-header",m),children:[i?e.jsx("header",{className:"willa-app-shell-header",children:i}):null,e.jsxs("div",{className:"willa-app-shell-layout",children:[l?e.jsx("aside",{className:"willa-app-shell-sidebar",children:l}):null,e.jsx("main",{className:"willa-app-shell-main",children:w}),a?e.jsx("aside",{className:"willa-app-shell-aside",children:a}):null]}),n?e.jsx("footer",{className:"willa-app-shell-footer",children:n}):null]})}const A={display:"grid",gap:"0.45rem",color:"var(--willa-text-soft)"},k=u({id:"app-shell",name:"AppShell",category:"layout",packageName:"willa/AppShell",description:"用于产品级页面骨架，组合顶栏、侧栏、主内容、辅助栏和底部区域。",imports:[{name:"AppShell",from:"willa/AppShell"},{name:"Panel",from:"willa/Panel"},{name:"Stack",from:"willa/Stack"},{name:"Button",from:"willa/Button"},{name:"Badge",from:"willa/Badge"}],css:"willa/AppShell.css",demo:{name:"AppShell",component:s,props:{header:"Willa",sidebar:"导航",aside:"详情"},children:"工作区"},code:`
