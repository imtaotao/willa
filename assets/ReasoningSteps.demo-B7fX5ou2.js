import{aQ as S,aO as e,m as N,az as R,l as k,w as A,D,a0 as T,M as V}from"./index-DJhLLKG1.js";import{C as M}from"./index-rZizx_x3.js";import{T as z}from"./index-Gwvwosab.js";import{d as q}from"./defineDoc-B4WwYA2z.js";import"./index-DM2cLZ4I.js";function o({steps:t,activeStep:i=0,size:n="md",compact:r=!1,collapsible:s=!1,collapsed:l,defaultCollapsed:a=!1,summary:d,onStepClick:u,onCollapsedChange:m,className:x,...I}){const w=!!u,[j,h]=S.useState(a),p=s?l??j:!1,g=t[i]??t[t.length-1],b=d??(g==null?void 0:g.title)??`${t.length} 个处理步骤`,C=()=>{const v=!p;l===void 0&&h(v),m==null||m(v)};return e.jsxs("div",{...I,className:R("willa-reasoning-steps",`willa-reasoning-steps--${n}`,r&&"willa-reasoning-steps--compact",w&&"willa-reasoning-steps--interactive",s&&"willa-reasoning-steps--collapsible",p&&"willa-reasoning-steps--collapsed",x),children:[s?e.jsxs("button",{className:"willa-reasoning-steps-toggle",type:"button","aria-expanded":!p,onClick:C,children:[e.jsxs("span",{className:"willa-reasoning-steps-toggle-main",children:[e.jsx("span",{className:"willa-reasoning-steps-toggle-title",children:p?"查看处理过程":"收起处理过程"}),e.jsx("span",{className:"willa-reasoning-steps-toggle-summary",children:b})]}),e.jsxs("span",{className:"willa-reasoning-steps-toggle-meta",children:[t.length," 步"]}),e.jsx(N,{className:"willa-reasoning-steps-toggle-icon"})]}):null,p?null:e.jsx(z,{className:"willa-reasoning-steps-timeline",items:H({activeStep:i,onStepClick:u,steps:t}),size:n,variant:r?"compact":"default"})]})}const E=({status:t})=>t==="done"?e.jsx(k,{}):t==="error"?e.jsx(A,{}):t==="active"?e.jsx(D,{}):e.jsx("span",{className:"willa-reasoning-step-dot"}),$=(t,i,n)=>t.status?t.status:i<n?"done":i===n?"active":"pending",H=t=>{const{steps:i,activeStep:n,onStepClick:r}=t;return i.map((s,l)=>{const a=$(s,l,n);return{id:s.id,title:s.title,description:s.description,content:s.content?e.jsx("span",{className:"willa-reasoning-step-content",children:s.content}):void 0,meta:s.meta,icon:s.icon??e.jsx(E,{status:a}),tone:P[a],className:R("willa-reasoning-step",`willa-reasoning-step--${a}`),onClick:r?d=>{r({step:s,index:l,status:a,event:d})}:void 0}})},P={pending:"default",active:"info",done:"success",error:"danger"},B="https://github.com/openai.png",f={display:"grid",gap:"1rem",width:"min(100%, 58rem)"},y={border:"1px solid var(--willa-line)",borderRadius:"0.8rem",background:"var(--willa-panel-bg)",color:"var(--willa-text)",fontSize:"0.86rem",lineHeight:1.55,padding:"0.72rem 0.82rem"},c=[{id:"parse",title:"理解用户问题",description:"识别目标、约束和需要核对的上下文。",meta:"已完成"},{id:"search",title:"检索相关资料",description:"读取 architecture.md、component.md 和最近新增组件。",meta:"进行中",icon:e.jsx(T,{})},{id:"draft",title:"整理回答",description:"把证据、判断和建议合并成可执行结论。",meta:"等待中"}],F=()=>{const[t,i]=S.useState(c[1]);return e.jsxs("div",{style:f,children:[e.jsx(M,{role:"assistant",name:"Willa AI",avatarSrc:B,meta:"推理中",children:e.jsx(o,{collapsible:!0,defaultCollapsed:!0,steps:c,activeStep:1,summary:"AI 正在检索组件文档和主题规则。",onStepClick:({step:n})=>i(n)})}),e.jsxs("div",{style:y,children:["当前查看：",t.title," · ",t.meta]}),e.jsx(o,{compact:!0,size:"sm",activeStep:2,steps:[{id:"read",title:"读取文件",description:"确认组件入口和主题变量位置。",icon:e.jsx(V,{}),meta:"已完成"},{id:"compare",title:"比对实现",description:"检查 demo、props 和构建入口是否一致。",meta:"已完成"},{id:"failed",title:"构建校验",description:"发现缺少单组件 CSS 入口，需要修正后重跑。",status:"error",meta:"失败"}]})]})},G=()=>{const[t,i]=S.useState(c[0]);return e.jsxs("div",{style:f,children:[e.jsx(o,{steps:c,activeStep:1,onStepClick:({step:n})=>i(n)}),e.jsxs("div",{style:y,children:[e.jsx("strong",{children:t.title}),e.jsx("br",{}),t.description]})]})},K=q({id:"reasoning-steps",name:"ReasoningSteps",category:"ai",packageName:"willa/ReasoningSteps",description:"用于展示 AI 推理、检索和执行过程的分步轨迹。",imports:[{name:"ReasoningSteps",from:"willa/ReasoningSteps"}],css:"willa/ReasoningSteps.css",demo:{name:"ReasoningStepsPreview",component:F},code:`
