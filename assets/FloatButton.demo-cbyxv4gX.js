import{b1 as t,b5 as a,Y as l,j as r,aA as e,S as o,ao as s,T as d,k as p,e as c,f as m,B as u,ag as g}from"./index-Bn83wcBb.js";/* empty css              */import{d as f}from"./defineDoc-DJuv5mBO.js";const i={position:"relative",width:"min(100%, 56rem)",minHeight:"21rem",padding:"1.5rem 1.5rem 6rem",overflow:"hidden",background:"var(--willa-panel-surface-bg)",border:"1px solid var(--willa-panel-border)",borderRadius:"1.25rem"},x={width:"min(100%, 30rem)",padding:"1rem 1.05rem"},b=()=>t.jsxs("div",{"data-float-button-scroll":!0,style:{position:"relative",width:"min(100%, 56rem)",height:"22rem",overflow:"auto",padding:"1.5rem 1.5rem 6rem",background:"var(--willa-panel-surface-bg)",border:"1px solid var(--willa-panel-border)",borderRadius:"1.25rem"},children:[t.jsx(e,{gap:"md",children:Array.from({length:8}).map((v,n)=>t.jsx(r,{children:t.jsxs(e,{gap:"xs",children:[t.jsxs("strong",{children:["更新记录 ",n+1]}),t.jsx("p",{style:{margin:0,color:"var(--willa-text-soft)"},children:"用于演示滚动容器中的 backToTop 行为，悬浮按钮会在滚动后出现。"})]})},n))}),t.jsx(o,{backToTop:!0,target:()=>document.querySelector("[data-float-button-scroll]")})]}),w=()=>t.jsxs("div",{style:i,children:[t.jsxs(e,{gap:"lg",children:[t.jsxs(l,{justify:"between",align:"start",children:[t.jsxs(e,{gap:"xs",children:[t.jsx("strong",{children:"产品反馈工作台"}),t.jsx("p",{style:{margin:0,color:"var(--willa-text-soft)"},children:"用于承接编辑、评论回复和回到顶部等高频页面动作。"})]}),t.jsx(u,{tone:"info",children:"内部预览"})]}),t.jsxs(l,{gap:"md",wrap:!0,align:"stretch",children:[t.jsx(r,{style:x,children:t.jsxs(e,{gap:"xs",children:[t.jsx("strong",{children:"当前工作项"}),t.jsx("p",{style:{margin:0,color:"var(--willa-text-soft)"},children:"本周需要同步评论体验、文件预览和 Tour 动画修复。"})]})}),t.jsx(r,{style:{width:"min(100%, 18rem)",padding:"1rem 1.05rem"},children:t.jsxs(e,{gap:"xs",children:[t.jsx("strong",{children:"待处理反馈"}),t.jsx("p",{style:{margin:0,color:"var(--willa-text-soft)"},children:"新增 12 条，建议优先处理移动端和导出问题。"})]})})]})]}),t.jsx(o,{fixed:!1,placement:"bottom-right",icon:t.jsx(g,{}),tooltip:"创建反馈",ariaLabel:"创建反馈"})]}),h=()=>t.jsxs("div",{style:i,children:[t.jsx(l,{gap:"md",wrap:!0,align:"stretch",children:t.jsx(r,{style:{width:"min(100%, 32rem)",padding:"1rem 1.05rem"},children:t.jsxs(e,{gap:"xs",children:[t.jsx("strong",{children:"内容评审面板"}),t.jsx("p",{style:{margin:0,color:"var(--willa-text-soft)"},children:"展示带文案的悬浮入口，适合需要明确语义的操作。"})]})})}),t.jsx(o,{fixed:!1,placement:"bottom-left",shape:"square",icon:t.jsx(s,{}),label:"发布检查",description:"进入预检流程",tooltip:"执行发布前检查",variant:"primary",badge:"3"})]}),y=()=>t.jsxs("div",{style:i,children:[t.jsx(e,{gap:"md",children:t.jsx(r,{style:{width:"min(100%, 32rem)",padding:"1rem 1.05rem"},children:t.jsxs(e,{gap:"xs",children:[t.jsx("strong",{children:"组合操作"}),t.jsx("p",{style:{margin:0,color:"var(--willa-text-soft)"},children:"多个高频操作可以折叠到一个主入口下，避免右下角堆太多按钮。"})]})})}),t.jsxs(d,{fixed:!1,placement:"bottom-left",triggerTooltip:"更多快捷操作",children:[t.jsx(o,{icon:t.jsx(p,{}),tooltip:"查看评论",ariaLabel:"查看评论"}),t.jsx(o,{icon:t.jsx(c,{}),tooltip:"查看通知",ariaLabel:"查看通知",badge:"2"}),t.jsx(o,{icon:t.jsx(m,{}),tooltip:"收藏当前页",ariaLabel:"收藏当前页"})]})]}),B=()=>t.jsxs("div",{style:i,children:[t.jsx(r,{style:{width:"min(100%, 32rem)",padding:"1rem 1.05rem"},children:t.jsxs(e,{gap:"xs",children:[t.jsx("strong",{children:"品牌快捷入口"}),t.jsx("p",{style:{margin:0,color:"var(--willa-text-soft)"},children:"可单独覆盖背景色和文字色，用于贴合品牌或模块语义。"})]})}),t.jsx(o,{fixed:!1,placement:"bottom-left",shape:"square",icon:t.jsx(s,{}),label:"上线中心",description:"查看待发布项",backgroundColor:"#1f2937",textColor:"#f8fafc",badge:"2"})]}),C=f({id:"float-button",name:"FloatButton",category:"content",packageName:"willa/FloatButton",description:"用于页面固定入口、回到顶部和高频快捷操作的悬浮按钮组件。",imports:[{name:"FloatButton, FloatButtonGroup",from:"willa/FloatButton"}],css:"willa/FloatButton.css",demo:{name:"BasicPreview",component:w},code:a(`
