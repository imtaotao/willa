import{b1 as e,a1 as t,h as l}from"./index-BjtE9AVd.js";import{F as i}from"./index-C6pZxn2Y.js";import{T as o}from"./index-dCrH3SKE.js";/* empty css              *//* empty css              *//* empty css              */import{d as a}from"./defineDoc-CWmZ2fbW.js";const r={display:"grid",gap:"1rem",maxWidth:"42rem"},d={display:"flex",flexWrap:"wrap",gap:"0.7rem"},h=a({id:"form-field",name:"FormField",category:"form",packageName:"willa/FormField",description:"统一表单字段的 label、说明、必填和错误状态。",imports:[{name:"FormField",from:"willa/FormField"}],css:"willa/FormField.css",demo:{name:"FormField",component:i,props:{label:"项目名称",description:"用于工作台、文档和分享链接中的展示名称。",required:!0},children:[{name:"Input",component:t,props:{placeholder:"输入项目名称",width:"100%"}}]},code:`
