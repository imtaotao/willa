import{aX as e}from"./index-BvNxTYr_.js";import{S as t}from"./index-BVNCJ2Pj.js";import{d as i}from"./defineDoc-Cynn6Kgz.js";import"./index-C2V00AuO.js";import"./useSelectablePanel-DWVITSQ7.js";import"./floatingPanelParts-C9fmg_KY.js";import"./useFloatingPanel-DMDWIcDY.js";const a={display:"grid",gap:"0.9rem",maxWidth:"42rem"},l=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],r=i({id:"select",name:"Select",category:"form",packageName:"willa/Select",description:"用于单选下拉，适合表单、筛选和配置场景。",imports:[{name:"Select",from:"willa/Select"}],css:"willa/Select.css",demo:{name:"Select",component:t,props:{options:l,defaultValue:"balanced",width:"100%"}},code:`
