import{d as e,l as t,p as n}from"./aidly.esm-bundler-DaTrP4tr.js";import{a as r}from"./index-y4TTR3pk.js";import{t as i}from"./defineDoc-Cid5xIoZ.js";import{n as a}from"./Calendar-hH4GYb4w.js";import"./style-BMgrzffJ.js";var o=n(e(),1),s=t(),c={display:`grid`,justifyItems:`center`},l={display:`grid`,width:`min(100%, 56rem)`,minWidth:0,gap:`0.82rem`},u={maxWidth:`100%`,whiteSpace:`normal`,lineHeight:1.5,textAlign:`left`},d=[{id:`standup`,title:`产品站会`,start:`2026-06-16 09:30`,end:`2026-06-16 10:00`,tone:`info`,meta:`30 分钟`},{id:`review`,title:`发布评审`,start:`2026-06-18 14:00`,end:`2026-06-18 15:30`,tone:`success`,meta:`组件和文档`},{id:`holiday`,title:`端午排期冻结`,start:`2026-06-19 11:00`,end:`2026-06-19 12:00`,tone:`warning`,meta:`发布窗口`},{id:`risk-review`,title:`风险复核`,start:`2026-06-18 14:30`,end:`2026-06-18 15:30`,tone:`warning`,meta:`并行评审`}],f=[{id:`freeze`,title:`发布冻结`,start:`2026-06-19`,end:`2026-06-20`,tone:`warning`}],p=i({id:`schedule-calendar`,name:`ScheduleCalendar`,displayName:`排期日历`,category:`form`,packageName:`willa/Calendar`,description:`排期查看器，用于展示周排期、月排期、全天事件和可点击的时间格；适合查看、选择和触发外部操作，不内置拖拽创建或事件编辑。`,imports:[{name:`ScheduleCalendar`,from:`willa/Calendar`},{name:`Badge`,from:`willa/Badge`}],css:`willa/Calendar.css`,demo:{name:`ScheduleCalendarPreview`,component:()=>{let[e,t]=(0,o.useState)(`review`);return(0,s.jsx)(`div`,{style:c,children:(0,s.jsx)(a,{width:`min(100%, 56rem)`,defaultVisibleDate:new Date(2026,5,16),selectedEventId:e,slotMinutes:30,startHour:8,endHour:18,events:d,allDayEvents:f,onEventClick:e=>t(e.id)})})}},code:`
  ...
  `,sections:[{title:`定位边界`,code:`
        ...
        />
      `,content:(0,s.jsxs)(`div`,{style:l,children:[(0,s.jsx)(r,{tone:`info`,style:u,children:`适合排期查看、事件选择和空白时间格点击；编辑表单、拖拽创建和保存流程由业务侧承接。`}),(0,s.jsx)(r,{tone:`warning`,style:u,children:`周视图和月视图是桌面优先的信息密度，移动端保留横向浏览，不压缩为完整移动排期工作台。`}),(0,s.jsx)(a,{width:`min(100%, 56rem)`,defaultVisibleDate:new Date(2026,5,16),events:d,allDayEvents:f})]})},{title:`周视图和月视图`,code:`
      ...
      `,content:(0,s.jsxs)(`div`,{style:l,children:[(0,s.jsx)(a,{defaultVisibleDate:new Date(2026,5,16),defaultView:`week`,slotMinutes:30,startHour:8,endHour:18,events:d,allDayEvents:f}),(0,s.jsx)(a,{defaultVisibleDate:new Date(2026,5,16),defaultView:`month`,events:d,allDayEvents:f})]})},{title:`选中态`,code:`
        const [selectedEventId, setSelectedEventId] = useState("review");
        ...
        />;
      `,content:(0,s.jsx)(()=>{let[e,t]=(0,o.useState)(`review`),[n,i]=(0,o.useState)(`2026-06-17 10:00`);return(0,s.jsxs)(`div`,{style:l,children:[(0,s.jsxs)(r,{tone:`info`,style:u,children:[`当前选择：`,e||n||`未选择`]}),(0,s.jsx)(a,{defaultVisibleDate:new Date(2026,5,16),selectedEventId:e,selectedSlot:n,slotMinutes:30,startHour:8,endHour:18,events:d,allDayEvents:f,onEventClick:e=>{t(e.id),i(``)},onSlotClick:e=>{t(``),i(e)}})]})},{})},{title:`空态和禁用`,code:`
        <ScheduleCalendar
          defaultVisibleDate={new Date(2026, 5, 16)}
          emptyText="当前范围没有排期"
          disabledDate={(value) => {
        ...
        />;
      `,content:(0,s.jsx)(`div`,{style:l,children:(0,s.jsx)(a,{defaultVisibleDate:new Date(2026,5,16),emptyText:`当前范围没有排期`,disabledDate:e=>{let t=new Date(`${e}T00:00:00`).getDay();return t===0||t===6},disabledSlot:e=>e.endsWith(`12:00`)})})},{title:`事件时间语义`,code:`
