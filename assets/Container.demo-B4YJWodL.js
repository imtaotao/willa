import{au as e,ak as m}from"./index-VEztyUnl.js";import{d as p}from"./defineDoc-fv-G_8j9.js";function n(a){const{as:i="div",size:o="lg",padding:t="md",centered:s=!0,className:d,children:l,...c}=a;return e.jsx(i,{...c,className:m("willa-container",`willa-container--${o}`,`willa-container--padding-${t}`,s&&"willa-container--centered",d),children:l})}const r={border:"1px solid var(--willa-border)",borderRadius:"0.75rem",background:"var(--willa-surface)"},u=p({id:"container",name:"Container",category:"layout",packageName:"willa/Container",description:"用于控制页面或区块主体宽度，并提供一致的左右留白。",imports:[{name:"Container",from:"willa/Container"}],css:"willa/Container.css",demo:{name:"Container",component:n,props:{size:"sm",padding:"md"},children:"适合文档、设置页和窄内容表单。"},code:`
