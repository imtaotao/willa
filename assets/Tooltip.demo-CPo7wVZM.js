import{aA as t,ak as o,e,Q as i,S as l,a3 as a}from"./index-CqEhPxJh.js";/* empty css              */import{d as r}from"./defineDoc-E7lv7YTw.js";const n={display:"flex",flexWrap:"wrap",gap:"0.75rem",alignItems:"center"},d=r({id:"tooltip",name:"Tooltip",packageName:"willa/Tooltip",description:"用于解释图标按钮、字段含义和轻量操作提示的说明气泡。",imports:[{name:"Tooltip",from:"willa/Tooltip"},{name:"IconButton",from:"willa/IconButton"}],css:"willa/Tooltip.css",demo:{name:"Tooltip",component:o,props:{content:"更多设置"},children:t.jsx(i,{ariaLabel:"更多设置",icon:t.jsx(a,{}),variant:"outline"})},code:`
