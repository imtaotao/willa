import{aw as u,au as a,r as nt,ak as q,B as kt,ac as st,c as At}from"./index-VEztyUnl.js";/* empty css              */import{d as _t}from"./defineDoc-fv-G_8j9.js";const Bt=["Enter",","],o=u.forwardRef((n,s)=>{const{value:c,defaultValue:v=[],inputValue:m,defaultInputValue:d="",name:S,size:b="md",variant:it="outline",width:L,placeholder:lt="输入后按 Enter 添加",disabled:f=!1,readOnly:V=!1,invalid:U=!1,clearable:ot=!0,maxTags:j,allowDuplicates:k=!1,commitOnBlur:rt=!0,separators:G=Bt,suggestions:E=[],maxSuggestions:H=8,emptySuggestion:J,renderTag:N,normalizeTag:K=Et,validateTag:h,onValueChange:D,onInputValueChange:R,onTagReject:$,className:ut,style:ct,id:dt,onBlur:O,onFocus:z,onKeyDown:y,onPaste:w,...pt}=n,gt=u.useId(),M=dt??gt,Q=c!==void 0,W=m!==void 0,[mt,ft]=u.useState(v),[ht,yt]=u.useState(d),[wt,X]=u.useState(!1),[A,_]=u.useState(0),l=Q?c:mt,I=W?m:ht,p=!f&&!V,It=ot&&p&&l.length>0,Y=j===void 0||l.length<j,x=u.useMemo(()=>$t({allowDuplicates:k,inputValue:I,maxSuggestions:H,suggestions:E,tags:l}),[k,I,l,H,E]),T=wt&&p&&(x.length>0||!!J),xt={...ct,...L===void 0?void 0:{width:L}},B=t=>{Q||ft(t),D==null||D(t)},F=t=>{W||yt(t),R==null||R(t)},r=(t,e)=>{$==null||$(t,e)},Z=t=>{const e=K(t);if(!e)return r(t,"empty"),!1;if(!k&&l.includes(e))return r(e,"duplicate"),!1;if(!Y)return r(e,"max"),!1;const i=h==null?void 0:h(e,l);return i===!1||typeof i=="string"?(r(e,"invalid"),!1):(B([...l,e]),F(""),_(0),!0)},tt=()=>I.trim()?Z(I):!1,Tt=t=>{let e=l;for(const i of t){const g=K(i);if(!g){r(i,"empty");continue}if(!k&&e.includes(g)){r(g,"duplicate");continue}if(j!==void 0&&e.length>=j){r(g,"max");continue}const at=h==null?void 0:h(g,e);if(at===!1||typeof at=="string"){r(g,"invalid");continue}e=[...e,g]}e!==l&&(B(e),F(""),_(0))},P=t=>{p&&B(l.filter((e,i)=>i!==t))},vt=()=>{p&&B([])},et=t=>{Z(t)},St=t=>{if(f||V){y==null||y(t);return}if(T&&t.key==="ArrowDown"){t.preventDefault(),_(e=>Math.min(e+1,x.length-1));return}if(T&&t.key==="ArrowUp"){t.preventDefault(),_(e=>Math.max(e-1,0));return}if(T&&t.key==="Enter"&&x[A]){t.preventDefault(),et(x[A]);return}if(Nt(t,G)){t.preventDefault(),tt();return}t.key==="Backspace"&&!I&&P(l.length-1),y==null||y(t)},Vt=t=>{if(!p){w==null||w(t);return}const e=t.clipboardData.getData("text"),i=Dt(e,G).filter(Boolean);if(i.length>1){t.preventDefault(),Tt(i);return}w==null||w(t)},bt=t=>{t.currentTarget.contains(t.relatedTarget)||(X(!1),rt&&p&&tt()),O==null||O(t)},jt=t=>{X(!0),z==null||z(t)};return a.jsxs("div",{...pt,className:q("willa-tag-input",`willa-tag-input--${b}`,`willa-tag-input--${it}`,f&&"willa-tag-input--disabled",V&&"willa-tag-input--readonly",U&&"willa-tag-input--invalid",ut),style:xt,"aria-disabled":f||void 0,onBlur:bt,onFocus:jt,children:[a.jsxs("div",{className:"willa-tag-input__control",onClick:Ct,children:[l.map((t,e)=>a.jsxs("span",{className:q("willa-tag-input__tag",N&&"willa-tag-input__tag--custom"),children:[N?N(t,{index:e,disabled:f,readOnly:V,onRemove:()=>P(e)}):a.jsxs(a.Fragment,{children:[a.jsx("span",{className:"willa-tag-input__tag-label",children:t}),p?a.jsx("button",{className:"willa-tag-input__remove",type:"button","aria-label":`移除 ${t}`,onClick:i=>{i.stopPropagation(),P(e)},children:a.jsx(nt,{"aria-hidden":"true"})}):null]}),S?a.jsx("input",{type:"hidden",name:S,value:t,readOnly:!0}):null]},`${t}-${e}`)),a.jsx("input",{ref:s,id:M,className:"willa-tag-input__input",value:I,placeholder:l.length===0?lt:void 0,disabled:f,readOnly:V||!Y,"aria-invalid":U||void 0,"aria-autocomplete":E.length>0?"list":void 0,"aria-expanded":T||void 0,"aria-controls":T?`${M}-suggestions`:void 0,onChange:t=>F(t.target.value),onKeyDown:St,onPaste:Vt}),It?a.jsx("button",{className:"willa-tag-input__clear",type:"button","aria-label":"清空标签",onClick:t=>{t.stopPropagation(),vt()},children:a.jsx(nt,{"aria-hidden":"true"})}):null]}),T?a.jsx("div",{className:"willa-tag-input__suggestions",id:`${M}-suggestions`,role:"listbox",children:x.length>0?x.map((t,e)=>a.jsx("button",{className:q("willa-tag-input__suggestion",e===A&&"willa-tag-input__suggestion--active"),type:"button",role:"option","aria-selected":e===A,onMouseDown:i=>{i.preventDefault(),et(t)},children:t},t)):J}):null]})});o.displayName="TagInput";const Ct=n=>{const s=n.currentTarget.querySelector("input:not([type='hidden'])");s==null||s.focus()},Et=n=>n.trim(),Nt=(n,s)=>n.nativeEvent.isComposing?!1:s.includes(n.key),Dt=(n,s)=>{const v=s.filter(d=>d.length===1).map(Rt),m=new RegExp(`[\\n\\r\\t${v.join("")}]+`,"g");return n.split(m).map(d=>d.trim())},Rt=n=>n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),$t=n=>{const{allowDuplicates:s,inputValue:c,maxSuggestions:v,suggestions:m,tags:d}=n,S=c.trim().toLowerCase();return m.filter(b=>!s&&d.includes(b)?!1:S?b.toLowerCase().includes(S):!0).slice(0,v)},C=["AI 产品","文档站","表单","移动端","主题变量","上传","批量操作","日历"],Ot=()=>{const[n,s]=u.useState(["AI 产品","主题变量"]),c=n.length===0;return a.jsxs(st,{gap:"sm",style:{width:"min(100%, 34rem)"},children:[a.jsx(o,{value:n,invalid:c,placeholder:"至少添加一个标签",suggestions:C,onValueChange:s}),a.jsx(At,{size:"sm",variant:"soft",onClick:()=>s(["移动端"]),children:"重置为移动端"})]})},Pt=_t({id:"tag-input",name:"TagInput",category:"form",packageName:"willa/TagInput",description:"用于输入、编辑和提交多个文本标签的表单组件。",imports:[{name:"Badge",from:"willa/Badge"},{name:"Button",from:"willa/Button"},{name:"Stack",from:"willa/Stack"},{name:"TagInput",from:"willa/TagInput"}],css:"willa/TagInput.css",demo:{name:"TagInput",component:o,props:{defaultValue:["AI 产品","文档站"],suggestions:C,placeholder:"输入标签后按 Enter",width:"min(100%, 34rem)"}},code:`
  ...
  `,sections:[{title:"建议项",code:`
      ...
      `,content:a.jsx(o,{defaultValue:["AI 产品","文档站"],maxTags:3,suggestions:C,placeholder:"最多 3 个标签",width:"min(100%, 34rem)"})},{title:"自定义标签",code:`
        <TagInput
          ...
          width="min(100%, 34rem)"
        />;
      `,content:a.jsx(o,{defaultValue:["稳定","待复核","内部文档"],renderTag:n=>a.jsx(kt,{tone:n==="待复核"?"warning":"info",children:n}),width:"min(100%, 34rem)"})},{title:"状态",code:`
        <Stack gap="sm" style={{ width: "min(100%, 34rem)" }}>
