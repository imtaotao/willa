import{aZ as e}from"./index-BuvJf_nF.js";import{S as t}from"./index-Ce-_LUXr.js";import{d as i}from"./defineDoc-BjvM3Vn5.js";import"./index-BMD_zBIA.js";import"./useSelectablePanel-D8Uc7dml.js";import"./floatingPanelParts-4BeICuWz.js";import"./useFloatingPanel-DfwCNGNj.js";const a={display:"grid",gap:"0.9rem",maxWidth:"42rem"},l=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],r=i({id:"select",name:"Select",category:"form",packageName:"willa/Select",description:"用于单选下拉，适合表单、筛选和配置场景。",imports:[{name:"Select",from:"willa/Select"}],css:"willa/Select.css",demo:{name:"Select",component:t,props:{options:l,defaultValue:"balanced",width:"100%"}},code:`
