import{b2 as l,aL as e}from"./index-np_LpDYz.js";import{d as i}from"./defineDoc-CVPycvmb.js";const a={border:"1px solid var(--willa-border)",borderRadius:"0.75rem",padding:"1rem",background:"var(--willa-surface)"},o=i({id:"willa-shell",name:"WillaShell",displayName:"Willa 作用域",category:"layout",packageName:"willa/WillaShell",description:"为 Willa 组件提供统一的 .willa-shell 作用域和基础文本样式。",imports:[{name:"WillaShell",from:"willa/WillaShell"}],css:"willa/WillaShell.css",demo:{name:"WillaShell",component:e,props:{style:a},children:"页面或应用根节点可以包裹在 WillaShell 内。"},code:`
