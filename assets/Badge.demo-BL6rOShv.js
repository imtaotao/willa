import{aO as e,Q as a,B as n,k as o,I as i,r as t,af as s}from"./index-D31jhNsW.js";/* empty css              */import{d}from"./defineDoc-YiaYi00G.js";const g=d({id:"badge",name:"Badge",packageName:"willa/Badge",description:"用于文章、文档和 MDX 内容中的分类、版本、状态和轻量标记。",imports:[{name:"Badge",from:"willa/Badge"},{name:"Group",from:"willa/Group"}],css:"willa/Badge.css",demo:{name:"Badge",component:n,props:{tone:"info",icon:e.jsx(s,{})},children:"新功能"},code:`
