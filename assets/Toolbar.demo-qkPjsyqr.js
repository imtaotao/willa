import{aZ as o,Z as a,al as s,S as l,h as e,H as i,ar as c,a$ as d,N as b,v}from"./index-D7YaWUUW.js";import{T as t}from"./index-CBc_d1xM.js";/* empty css              *//* empty css              */import{d as h}from"./defineDoc-BHlsbD-w.js";const z={display:"grid",gap:"1rem",width:"min(100%, 42rem)",marginInline:"auto"},g={display:"grid",gap:"0.85rem",width:"min(100%, 38rem)",marginInline:"auto",color:"var(--willa-text)"},I=()=>{const[m,p]=d.useState(!0),[r,u]=d.useState(!1);return o.jsxs("div",{style:g,children:[o.jsxs(t,{ariaLabel:"编辑器工具",size:"sm",separator:o.jsx(c,{orientation:"vertical",size:"sm"}),children:[o.jsx(a,{ariaLabel:"预览",icon:o.jsx(b,{}),pressed:m,size:"sm",variant:"ghost",onClick:()=>p(n=>!n)}),o.jsx(a,{ariaLabel:"源码模式",icon:o.jsx(v,{}),pressed:r,size:"sm",variant:"ghost",onClick:()=>u(n=>!n)}),o.jsx(e,{icon:o.jsx(i,{}),pressed:r,size:"sm",variant:"ghost",children:"导出"})]}),o.jsxs("p",{style:{margin:0},children:["当前模式：",m?"预览开启":"预览关闭","，",r?"源码视图":"富文本视图"]})]})},f=h({id:"toolbar",name:"Toolbar",displayName:"工具栏",packageName:"willa/Toolbar",description:"为表格、代码块、编辑器和内容操作区提供稳定的工具栏语义和编排模式。",imports:[{name:"Button",from:"willa/Button"},{name:"IconButton",from:"willa/IconButton"},{name:"Separator",from:"willa/Separator"},{name:"Toolbar",from:"willa/Toolbar"},{name:"DownloadIcon, GearIcon, ReloadIcon",from:"@radix-ui/react-icons"}],css:"willa/Toolbar.css",demo:{name:"Toolbar",component:t,props:{ariaLabel:"表格操作",size:"sm",separator:o.jsx(c,{orientation:"vertical",size:"sm"})},children:[{name:"IconButton",component:a,props:{ariaLabel:"刷新",icon:o.jsx(s,{}),size:"sm",variant:"ghost"}},{name:"IconButton",component:a,props:{ariaLabel:"列设置",icon:o.jsx(l,{}),size:"sm",variant:"ghost"}},{name:"Button",component:e,props:{icon:o.jsx(i,{}),size:"sm",variant:"ghost"},children:"导出"}]},code:`
  ...
  `,sections:[{title:"基础编排",code:`
      ...
      `,content:o.jsx(I,{})},{title:"竖向工具栏",code:`
