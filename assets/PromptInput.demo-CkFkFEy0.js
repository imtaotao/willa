import{au as e,c as l,R as m,aw as a}from"./index-VEztyUnl.js";import{P as t}from"./index-DKmhAP6i.js";/* empty css              */import{d}from"./defineDoc-fv-G_8j9.js";import"./index-CDu8pgb7.js";const o={display:"grid",gap:"1rem",width:"min(100%, 56rem)"},c=()=>{const[r,i]=a.useState(""),[s,p]=a.useState("暂无提交内容");return e.jsxs("div",{style:o,children:[e.jsx(t,{value:r,footer:"Enter 发送，Shift + Enter 换行",placeholder:"让 AI 帮我整理这段会议纪要...",onChange:n=>i(n.currentTarget.value),onSubmit:n=>{p(n),i("")}}),e.jsx("div",{children:s})]})},f=d({id:"prompt-input",name:"PromptInput",category:"ai",packageName:"willa/PromptInput",description:"用于 AI 对话、智能搜索和生成任务的提示词输入区域。",imports:[{name:"PromptInput",from:"willa/PromptInput"}],css:"willa/PromptInput.css",demo:{name:"PromptInputPreview",component:c},code:`
  ...
  `,sections:[{title:"基础输入",code:`
      ...
      `,content:e.jsx("div",{style:o,children:e.jsx(t,{placeholder:"输入你的产品需求或数据分析问题",footer:"上下文已连接到当前文档",actions:e.jsx(l,{size:"sm",variant:"ghost",icon:e.jsx(m,{}),children:"优化"})})})},{title:"提交状态",code:`
        <div style={stackStyle}>
          <PromptInput
