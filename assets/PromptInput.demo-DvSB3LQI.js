import{aZ as e,h as p,a5 as d,a$ as i}from"./index-D8sN41D9.js";import{P as t}from"./index-Bg_VdQJp.js";/* empty css              */import{d as u}from"./defineDoc-DBFRTY64.js";import"./index-BLVSHXdc.js";const o={display:"grid",gap:"1rem",width:"min(100%, 56rem)"},m=()=>{const[l,n]=i.useState(""),[r,s]=i.useState("暂无提交内容");return e.jsxs("div",{style:o,children:[e.jsx(t,{value:l,footer:"Enter 发送，Shift + Enter 换行",placeholder:"让 AI 帮我整理这段会议纪要...",onChange:a=>n(a.currentTarget.value),onSubmit:a=>{s(a),n("")}}),e.jsx("div",{children:r})]})},I=u({id:"prompt-input",name:"PromptInput",category:"ai",packageName:"willa/PromptInput",description:"用于 AI 对话、智能搜索和生成任务的提示词输入区域。",imports:[{name:"PromptInput",from:"willa/PromptInput"}],css:"willa/PromptInput.css",demo:{name:"PromptInputPreview",component:m},code:`
