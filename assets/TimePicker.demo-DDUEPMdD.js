import{aM as X,b2 as m,b5 as Le,b0 as a,aN as k,E as me,t as he,m as Be,aL as Fe}from"./index-MvDtKvGL.js";import{F as Ke,a as Oe}from"./floatingPanelParts-DOBPbWRM.js";import{u as _e}from"./useFloatingPanel-qB5vS8UY.js";import{d as qe}from"./defineDoc-BE2V2Usy.js";import"./floatingLayer-Bi4pWQ2I.js";function Ge(l){return Array.isArray(l)?l:["hour","minute","second"]}function N(l){var o;const e=new Date,i={hour:e.getHours(),minute:e.getMinutes(),second:e.getSeconds()};if(!l)return P(i);const n=l.match(/^(\d{2}):(\d{2})(?::(\d{2}))?$/);if(n)return P({hour:Number(n[1]),minute:Number(n[2]),second:Number(n[3]??i.second)});const s=l.match(/^(?:\d{4}-\d{2}-\d{2}[ T])?(\d{1,2}):(\d{2})(?::(\d{2}))?\s*([AaPp][Mm])?$/);if(s){const b=(o=s[4])==null?void 0:o.toLowerCase(),u=Number(s[1]);return P({hour:b==="pm"&&u<12?u+12:b==="am"&&u===12?0:u,minute:Number(s[2]),second:Number(s[3]??i.second)})}return P(i)}function P(l){return{hour:X(Math.trunc(l.hour),0,23),minute:X(Math.trunc(l.minute),0,59),second:X(Math.trunc(l.second),0,59)}}function O(l,e){const i=e.includes("hour"),n=e.includes("minute"),s=e.includes("second");return!i&&!n&&!s?"":[i?_(l.hour):null,n?_(l.minute):null,s?_(l.second):null].filter(b=>b!==null).join(":")}function Je(l,e){const i=N(l);return O(i,e)}function Qe(l,e){var x,H,y,M,V,E;const i=Math.max(1,Math.trunc((e==null?void 0:e.hourStep)??1)),n=Math.max(1,Math.trunc((e==null?void 0:e.minuteStep)??1)),s=Math.max(1,Math.trunc((e==null?void 0:e.secondStep)??1)),o=(e==null?void 0:e.use12Hours)??!1,b=((H=(x=e==null?void 0:e.disabledTime)==null?void 0:x.disabledHours)==null?void 0:H.call(x))??[],u=(e==null?void 0:e.selectedParts)??N("");if(l==="hour"){const d=o?1:0,C=o?12:23,q=e==null?void 0:e.period;return Y(d,C,i).map(T=>{const R=o?Xe(T.value,q):T.value;return{...T,disabled:b.includes(R)}})}if(l==="minute"){const d=((M=(y=e==null?void 0:e.disabledTime)==null?void 0:y.disabledMinutes)==null?void 0:M.call(y,u.hour))??[];return Y(0,59,n).map(C=>({...C,disabled:d.includes(C.value)}))}const z=((E=(V=e==null?void 0:e.disabledTime)==null?void 0:V.disabledSeconds)==null?void 0:E.call(V,u.hour,u.minute))??[];return Y(0,59,s).map(d=>({...d,disabled:z.includes(d.value)}))}function Ue(l){return Math.max(244,l*4.25*16)}const Y=(l,e,i)=>Array.from({length:Math.floor((e-l)/i)+1},(n,s)=>{const o=l+s*i;return{value:o,label:_(o)}}).filter(n=>n.value<=e),Xe=(l,e)=>{const i=Math.trunc(l);return e==="pm"?i===12?12:i+12:e==="am"&&i===12?0:i},_=l=>String(l).padStart(2,"0");function c(l){const{ref:e,allowClear:i=!1,disabledTime:n=null,format:s,hourStep:o=1,minuteStep:b=1,needConfirm:u=!1,presets:z=[],secondStep:x=1,showNow:H=!1,showScrollbar:y=!1,wheelColumns:M="time",size:V="md",variant:E="outline",use12Hours:d=!1,width:C,invalid:q=!1,placeholder:T,name:R,value:we,defaultValue:ae="",onValueChange:ke,className:ye,disabled:$,style:ve,id:Pe,onBlur:xe,onClick:G,onKeyDown:J,...I}=l,Ve=m.useId(),te=Pe??Ve,Q=`${te}-panel`,ie=`${Q}-label`,re=m.useRef(null),L=m.useRef(null),U=m.useRef(null),[h,v]=m.useState(!1),[p,Ce]=Le({value:we,defaultValue:ae,onChange:ke}),[ne,g]=m.useState(ae),w=m.useMemo(()=>Ge(M),[M]),B=w.includes("hour"),S=u&&h?ne:p,D=m.useMemo(()=>N(S),[S]),F=m.useMemo(()=>d&&B?le(D.hour):void 0,[B,D.hour,d]),Te=m.useCallback(()=>v(!1),[]),{position:ge,updatePosition:se}=_e({open:h,rootRef:re,triggerRef:L,panelRef:U,minWidth:Ue(w.length),matchTriggerWidth:!0,fullWidthBelow:420,fallbackHeight:250,onClose:Te}),ue=q||I["aria-invalid"]===!0||I["aria-invalid"]==="true",Se=Ze({width:C,style:ve}),ce=el({value:p,columns:w,format:s,use12Hours:d}),je=ce??T??"选择时间",Ne=`${T??"选择时间"}面板`,He=t=>{L.current=t,Fe(e,t)};m.useEffect(()=>{u&&g(p)},[p,u,h]),m.useEffect(()=>{h&&se()},[h,se]),m.useEffect(()=>{var t;h&&((t=U.current)==null||t.querySelectorAll(".willa-time-picker-wheel-option--selected").forEach(r=>{r.scrollIntoView({block:"center",behavior:"smooth"})}))},[h,S]);const j=(t,r)=>{Ce(t),r&&v(!1)},Me=t=>{if(u){g(t);return}j(t,!1)},De=(t,r)=>{const W=N(S),f=P({...W,[t]:d&&t==="hour"?pe(r,F):r});Me(O(f,w))},We=t=>{if(J==null||J(t),!t.defaultPrevented){if(t.key==="Escape"){v(!1);return}(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),v(r=>!r))}},Ae=t=>{var r;t.key==="Escape"&&(t.stopPropagation(),u&&g(p),v(!1),(r=L.current)==null||r.focus())},ze=t=>{if(u){g(t);return}j(t,!0)},Ee=()=>{const t=P({hour:new Date().getHours(),minute:new Date().getMinutes(),second:new Date().getSeconds()});j(O(t,w),!0)},oe=()=>{j("",!0)},Re=()=>{j(ne,!0)},$e=()=>{var t;g(p),v(!1),(t=L.current)==null||t.focus()},de=t=>{if(!d||!B)return;const r=ee(D.hour),W=P({...D,hour:pe(r,t)}),f=O(W,w);if(u){g(f);return}j(f,!1)},Ie=h?a.jsx(Ke,{open:h,children:a.jsxs(Oe,{panelRef:U,id:Q,className:k("willa-time-picker-panel","willa-time-picker-panel--wheel"),position:ge,role:"dialog",ariaLabelledBy:ie,onKeyDown:Ae,children:[a.jsx("span",{id:ie,className:"willa-time-picker-panel-label",children:Ne}),z.length>0?a.jsx("div",{className:"willa-time-picker-presets","aria-label":"快捷时间预设",children:z.map(t=>{const r=t.value===S;return a.jsx("button",{className:k("willa-time-picker-preset",r&&"willa-time-picker-preset--selected"),type:"button",onClick:()=>ze(t.value),children:t.label},t.value)})}):null,a.jsx("div",{className:"willa-time-picker-wheel",style:{gridTemplateColumns:`repeat(${w.length}, minmax(3.75rem, 1fr))`},children:w.map(t=>{const r=N(S),W=d&&t==="hour"?ee(r.hour):r[t];return a.jsxs("div",{className:"willa-time-picker-wheel-column",children:[a.jsx("div",{className:"willa-time-picker-wheel-label",children:Ye[t]}),a.jsx("div",{className:k("willa-time-picker-wheel-options",y&&"willa-time-picker-wheel-options--scrollbar",y&&"willa-form-scrollbar"),children:Qe(t,{hourStep:o,minuteStep:b,secondStep:x,use12Hours:d,disabledTime:n,selectedParts:D,period:F??void 0}).map(f=>a.jsx("button",{className:k("willa-time-picker-wheel-option",f.disabled&&"willa-time-picker-wheel-option--disabled",f.value===W&&"willa-time-picker-wheel-option--selected"),type:"button",disabled:f.disabled,onClick:()=>De(t,f.value),children:f.label},f.value))})]},t)})}),d&&B?a.jsxs("div",{className:"willa-time-picker-periods","aria-label":"上午下午切换",children:[a.jsx("button",{type:"button",className:k("willa-time-picker-period",F==="am"&&"willa-time-picker-period--selected"),onClick:()=>de("am"),children:"上午"}),a.jsx("button",{type:"button",className:k("willa-time-picker-period",F==="pm"&&"willa-time-picker-period--selected"),onClick:()=>de("pm"),children:"下午"})]}):null,i||H||u?a.jsxs("div",{className:"willa-time-picker-footer",children:[a.jsxs("div",{className:"willa-time-picker-footer-start",children:[i?a.jsxs("button",{type:"button",className:"willa-time-picker-action",onClick:oe,children:[a.jsx(me,{}),"清除"]}):null,H?a.jsxs("button",{type:"button",className:"willa-time-picker-action",onClick:Ee,children:[a.jsx(he,{"aria-hidden":"true"}),"现在"]}):null]}),u?a.jsxs("div",{className:"willa-time-picker-footer-end",children:[a.jsx("button",{type:"button",className:"willa-time-picker-action",onClick:$e,children:"取消"}),a.jsxs("button",{type:"button",className:"willa-time-picker-action willa-time-picker-action--primary",onClick:Re,children:[a.jsx(Be,{}),"确定"]})]}):null]}):null]})}):null;return a.jsxs("span",{ref:re,className:k("willa-time-picker",`willa-time-picker--${V}`,`willa-time-picker--${E}`,i&&"willa-time-picker--clearable",h&&"willa-time-picker--open",$&&"willa-time-picker--disabled",ue&&"willa-time-picker--invalid",ye),style:Se,"aria-disabled":$||void 0,children:[R?a.jsx("input",{type:"hidden",name:R,value:p,disabled:$}):null,a.jsxs("button",{...I,ref:He,id:te,type:"button",className:"willa-time-picker-control",disabled:$,"aria-expanded":h,"aria-controls":h?Q:void 0,"aria-haspopup":"dialog","aria-invalid":ue||I["aria-invalid"],onBlur:xe,onClick:t=>{G==null||G(t),t.defaultPrevented||v(r=>!r)},onKeyDown:We,children:[a.jsx("span",{className:k("willa-time-picker-value",!ce&&"willa-time-picker-value--placeholder"),children:je}),i&&p?null:a.jsx(he,{className:"willa-time-picker-icon","aria-hidden":"true"})]}),i&&p?a.jsx("button",{type:"button",className:"willa-time-picker-clear","aria-label":"清除时间",onClick:t=>{t.stopPropagation(),oe()},children:a.jsx(me,{"aria-hidden":"true"})}):null,Ie]})}c.displayName="TimePicker";const Ye={hour:"时",minute:"分",second:"秒"},Ze=l=>{const{width:e,style:i}=l;return{...i,...e===void 0?void 0:{width:e}}},el=l=>{const{value:e,columns:i,format:n,use12Hours:s=!1}=l;if(!e)return;const o=N(e);return n?fe(o,n):s&&i.includes("hour")?fe(o,ll(i)):Je(e,i)},ll=l=>`${[l.includes("hour")?"hh":null,l.includes("minute")?"mm":null,l.includes("second")?"ss":null].filter(i=>i!==null).join(":")} A`,fe=(l,e)=>{const i=ee(l.hour),n={HH:K(l.hour),H:String(l.hour),hh:K(i),h:String(i),mm:K(l.minute),m:String(l.minute),ss:K(l.second),s:String(l.second),A:le(l.hour)==="pm"?"PM":"AM",a:le(l.hour)==="pm"?"pm":"am"};return e.replace(/HH|hh|mm|ss|H|h|m|s|A|a/g,s=>n[s]??s)},ee=l=>{const e=Math.trunc(l)%24;return e%12===0?12:e%12},le=l=>Math.trunc(l)>=12?"pm":"am",pe=(l,e)=>{const i=Math.trunc(l);return e==="pm"?i===12?12:i+12:e==="am"&&i===12?0:i},K=l=>String(l).padStart(2,"0"),A={display:"grid",gap:"0.76rem",maxWidth:"42rem"},be=["hour","minute"],Z=["hour","minute","second"],al=[{label:"08:30",value:"08:30:00"},{label:"12:00",value:"12:00:00"},{label:"18:30",value:"18:30:00"}],tl={disabledHours:()=>[0,1,2,3,4,5],disabledMinutes:l=>l===9?[0,1,2,3,4,5]:[],disabledSeconds:(l,e)=>l===9&&e===30?[0,1,2,3,4]:[]},il=()=>{const[l,e]=m.useState("09:30:00");return a.jsx(c,{value:l,onValueChange:e,width:"100%","aria-label":"选择时间"})},rl=()=>{const[l,e]=m.useState("09:30:00");return a.jsx(c,{value:l,onValueChange:e,needConfirm:!0,showNow:!0,allowClear:!0,use12Hours:!0,format:"hh:mm A",width:"100%","aria-label":"选择时间"})},dl=qe({id:"time-picker",name:"TimePicker",category:"form",packageName:"willa/TimePicker",description:"用于选择时间点、时分秒和调度时间。",imports:[{name:"TimePicker",from:"willa/TimePicker"}],css:"willa/TimePicker.css",demo:{name:"TimePickerPreview",component:il},code:`
