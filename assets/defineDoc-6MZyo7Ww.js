...
`)}if(S(n)){const e=Object.entries(n);if(e.length===0)return"{}";const o="  ".repeat(r),s="  ".repeat(r+1);return["{",...e.map(([i,c])=>{const $=f(c,r+1),[y,...b]=$.split(`
`),m=[`${s}${i}: ${y}`,...b];return m[m.length-1]+=",",m.join(`
`)}),`${o}}`].join(`
