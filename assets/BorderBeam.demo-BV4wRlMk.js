import{aY as e,g as r,aa as a,W as n,B as o,h as i,j as t}from"./index-Djvd3Ldj.js";/* empty css              *//* empty css              */import{d}from"./defineDoc-7izoR4mK.js";const p=d({id:"border-beam",name:"BorderBeam",displayName:"边框流光",category:"layout",packageName:"willa/BorderBeam",description:"为任意容器增加持续流动的装饰性边框高亮，适合强调重点卡片、AI 模块和行动区。",imports:[{name:"BorderBeam",from:"willa/BorderBeam"},{name:"Card",from:"willa/Card"},{name:"Panel",from:"willa/Panel"},{name:"Group",from:"willa/Group"},{name:"Button",from:"willa/Button"},{name:"Badge",from:"willa/Badge"}],css:"willa/BorderBeam.css",demo:{name:"BorderBeam",component:r,props:{radius:8},children:[{name:"Card",component:t,props:{title:"智能分析完成",description:"流光边框用于提升视觉关注度，不承载业务状态语义。"},children:"已生成 12 条质量建议，可进入报告查看详情。"}]},code:`
