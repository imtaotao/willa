import{aL as o,T as a,f as t,R as l,E as s,_ as i,c as d,J as e,l as r,p as c,ah as u}from"./index-CZ_sl3Px.js";import{d as p}from"./defineDoc-CrvnmmL7.js";const n={display:"flex",flexWrap:"wrap",gap:"0.75rem",alignItems:"center"},x=p({id:"icon-button",name:"IconButton",packageName:"willa/IconButton",description:"用于工具栏、卡片操作区和内联内容中的纯图标按钮。",imports:[{name:"IconButton",from:"willa/IconButton"}],css:"willa/IconButton.css",demo:{name:"IconButton",component:a,props:{ariaLabel:"分享文章",icon:o.jsx(u,{})}},code:`
