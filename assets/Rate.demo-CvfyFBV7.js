import{b1 as o,b4 as pe,a$ as e,aM as I,aE as me,aA as h,Y as V,h as y}from"./index-D5aNn3Bg.js";/* empty css              *//* empty css              */import{d as fe}from"./defineDoc-BtQ_Wzfn.js";const ve=5,u=o.forwardRef((t,l)=>{const{value:i,defaultValue:r=0,count:c=ve,allowClear:b=!0,allowHalf:m=!1,autoFocus:B=!1,character:D,disabled:s=!1,keyboard:W=!0,name:F,size:_="md",tooltips:z=[],className:U,style:X,tabIndex:Y,onBlur:R,onChange:J,onFocus:j,onHoverChange:C,onKeyDown:S,onMouseLeave:k,...O}=t,v=o.useRef(null),d=Math.max(1,Math.floor(c)),[Q,Z]=pe({value:i,defaultValue:()=>N(r,d,m),onChange:J}),[ee,te]=o.useState(null),[H,P]=o.useState(!1),g=N(Q,d,m),f=ee??g,ae=m?.5:1,le=o.useMemo(()=>Array.from({length:d},(a,n)=>n+1),[d]);o.useImperativeHandle(l,()=>({focus:()=>{var a;return(a=v.current)==null?void 0:a.focus()},blur:()=>{var a;return(a=v.current)==null?void 0:a.blur()}}),[]),o.useEffect(()=>{var a;B&&!s&&((a=v.current)==null||a.focus())},[B,s]);const G=(a,n={})=>{const p=N(a,d,m),w=n.clearable&&b&&p===g?0:p;Z(w)},M=a=>{te(a),C==null||C(a??0)},re=(a,n)=>{s||M(q(a,n,m))},ne=(a,n)=>{var p;s||((p=v.current)==null||p.focus(),G(q(a,n,m),{clearable:!0}))},oe=a=>{if(S==null||S(a),a.defaultPrevented||s||!W)return;const n=ge({count:d,currentValue:g,key:a.key,step:ae});n!==null&&(a.preventDefault(),G(n))},se=a=>{P(!0),j==null||j(a)},ue=a=>{P(!1),M(null),R==null||R(a)},ie=a=>{M(null),k==null||k(a)},ce=z[Math.ceil(f)-1]??`${f}/${d}`;return e.jsxs("div",{...O,ref:v,className:I("willa-rate",`willa-rate--${_}`,s&&"willa-rate--disabled",H&&"willa-rate--focused",U),style:X,role:"slider","aria-disabled":s||void 0,"aria-valuemin":0,"aria-valuemax":d,"aria-valuenow":f,"aria-valuetext":ce,tabIndex:s?void 0:Y??0,onBlur:ue,onFocus:se,onKeyDown:oe,onMouseLeave:ie,children:[e.jsx("span",{className:"willa-rate-items","aria-hidden":"true",children:le.map(a=>{const n=he(f,a),p=n>0,w=n>0&&n<100,de={"--willa-rate-active-width":`${n}%`},L=e.jsxs("span",{className:I("willa-rate-item",p&&"willa-rate-item--active",w&&"willa-rate-item--half"),style:de,onClick:E=>ne(E,a),onMouseMove:E=>re(E,a),children:[e.jsx("span",{className:"willa-rate-character willa-rate-character--base",children:$({character:D,disabled:s,focused:H,active:!1,half:!1,index:a,value:f})}),e.jsx("span",{className:"willa-rate-character willa-rate-character--active","aria-hidden":"true",children:$({character:D,disabled:s,focused:H,active:p,half:w,index:a,value:f})})]},a),A=z[a-1];return A?e.jsx(me,{content:A,side:"top",size:"sm",children:L},a):L})}),F?e.jsx("input",{type:"hidden",name:F,value:g,disabled:s}):null]})});u.displayName="Rate";const $=t=>typeof t.character=="function"?t.character({active:t.active,disabled:t.disabled,focused:t.focused,half:t.half,index:t.index,value:t.value}):t.character??e.jsx(K,{}),K=()=>e.jsx("svg",{className:"willa-rate-star",viewBox:"0 0 24 24",focusable:"false","aria-hidden":"true",children:e.jsx("path",{d:"M12 2.8l2.82 5.72 6.31.92-4.56 4.45 1.08 6.28L12 17.2l-5.65 2.97 1.08-6.28-4.56-4.45 6.31-.92L12 2.8z"})});K.displayName="RateStarIcon";const N=(t,l,i)=>{const r=Number.isFinite(t)?Number(t):0,c=i?.5:1,b=Math.round(r/c)*c;return Math.min(l,Math.max(0,b))},q=(t,l,i)=>{if(!i)return l;const r=t.currentTarget.getBoundingClientRect();return t.clientX-r.left<=r.width/2?l-.5:l},he=(t,l)=>t>=l?100:t<=l-1?0:(t-(l-1))*100,ge=t=>{const{count:l,currentValue:i,key:r,step:c}=t;return r==="ArrowRight"||r==="ArrowUp"?Math.min(l,i+c):r==="ArrowLeft"||r==="ArrowDown"?Math.max(0,i-c):r==="Home"?0:r==="End"?l:null},x=["很差","一般","还行","满意","推荐"],we={display:"grid",gap:"0.35rem",minWidth:"10rem",padding:"0.85rem",border:"1px solid var(--willa-panel-border)",borderRadius:"0.75rem",background:"var(--willa-panel-bg)"},T={color:"var(--willa-text-soft)",fontSize:"0.88rem",lineHeight:1.55},ye=()=>{const[t,l]=o.useState(3);return e.jsxs(V,{align:"center",gap:"lg",wrap:!0,children:[e.jsx(u,{value:t,tooltips:x,onChange:l}),e.jsxs("div",{style:we,children:[e.jsx("strong",{children:"服务体验"}),e.jsxs("span",{style:T,children:["当前 ",t," 分，",x[t-1]??"尚未评分","。"]})]})]})},xe=()=>e.jsxs(h,{gap:"md",children:[e.jsx(u,{allowHalf:!0,defaultValue:3.5}),e.jsx(u,{allowHalf:!0,defaultValue:2.5,count:7,size:"lg"})]}),Ve=()=>{const[t,l]=o.useState(4);return e.jsxs(V,{align:"center",gap:"md",wrap:!0,children:[e.jsx(u,{value:t,tooltips:x,onChange:l}),e.jsx("span",{style:T,children:x[t-1]})]})},be=()=>{const[t,l]=o.useState(2);return e.jsxs(h,{gap:"sm",children:[e.jsx(u,{value:t,allowClear:!0,onChange:l}),e.jsxs(V,{gap:"sm",wrap:!0,children:[e.jsx(y,{variant:"outline",onClick:()=>l(0),children:"清空"}),e.jsx(y,{variant:"outline",onClick:()=>l(5),children:"满分"})]})]})},Re=()=>e.jsxs(h,{gap:"md",children:[e.jsx(u,{defaultValue:4,character:"赞"}),e.jsx(u,{allowHalf:!0,defaultValue:3.5,character:({index:t})=>e.jsx("span",{children:t})})]}),je=()=>e.jsxs(h,{gap:"md",children:[e.jsx(u,{defaultValue:4,disabled:!0}),e.jsx(u,{allowHalf:!0,defaultValue:3.5,disabled:!0})]}),Ce=()=>{const t=o.useRef(null),[l,i]=o.useState(3);return e.jsxs(h,{gap:"sm",children:[e.jsx(u,{ref:t,allowHalf:!0,value:l,onChange:i}),e.jsxs(V,{gap:"sm",wrap:!0,children:[e.jsx(y,{variant:"outline",onClick:()=>{var r;return(r=t.current)==null?void 0:r.focus()},children:"聚焦"}),e.jsx(y,{variant:"outline",onClick:()=>{var r;return(r=t.current)==null?void 0:r.blur()},children:"失焦"})]}),e.jsx("span",{style:T,children:"聚焦后可用方向键、Home 和 End 调整评分。"})]})},Ee=fe({id:"rate",name:"Rate",displayName:"Rate 评分",category:"form",packageName:"willa/Rate",description:"用于评价、满意度和偏好强度选择的评分控件。",imports:[{name:"Rate, type RateRef",from:"willa/Rate"}],css:"willa/Rate.css",demo:{name:"RatePreview",component:ye},code:`
