import{ag as e,N as a,O as o,ai as r,y as l,M as d}from"./index-DcKe6ljB.js";import{S as t}from"./index-BfgvPJvX.js";import{P as p}from"./index-CiBpsxUk.js";import{d as m}from"./defineDoc-CU4WbHug.js";import"./index-DiHwngaR.js";import"./heading-CPth9o3N.js";const g=[{id:"summarize",label:"总结这份文档",description:"输出重点和风险",icon:e.jsx(l,{})},{id:"search",label:"检索相关资料",description:"补充来源证据",icon:e.jsx(o,{})},{id:"plan",label:"拆成执行计划",description:"按优先级排序",icon:e.jsx(d,{})}],c={display:"grid",gap:"0.85rem",width:"min(100%, 56rem)",border:"1px solid var(--willa-line)",borderRadius:"0.9rem",background:"var(--willa-panel-bg)",padding:"1rem"},u=()=>{const[n,s]=r.useState("");return e.jsxs("div",{style:c,children:[e.jsx(t,{items:g,onSelect:i=>{s(String(i.label))}}),e.jsx(p,{value:n,placeholder:"选择一个建议，或直接输入问题...",minRows:2,maxRows:5,onChange:i=>s(i.currentTarget.value)})]})},x=m({id:"suggestion-chips",name:"SuggestionChips",category:"ai",packageName:"willa/SuggestionChips",description:"用于展示快捷提示词、推荐问题和 AI 任务入口。",imports:[{name:"SuggestionChips",from:"willa/SuggestionChips"}],css:"willa/SuggestionChips.css",demo:{name:"SuggestionChipsPreview",component:u},code:`
