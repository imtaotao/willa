import{aA as w,ay as e,am as N,ac as G,aw as J,c as g,ae as U,Q as y,B as h,g as S,n as z,a6 as O}from"./index-vVHMmPWZ.js";import{P as Q}from"./index-Br3Re81M.js";/* empty css              */import{d as K}from"./defineDoc-CK669M_K.js";function d(s){const{items:t,size:o="md",variant:a="panel",itemLayout:l="horizontal",split:c=!0,header:p,footer:m,loadMore:u,loading:x=!1,loadingLabel:R="正在加载",grid:n,empty:A="暂无内容",maxHeight:_,draggable:I=!1,infiniteScroll:P=!1,hasMore:D=!1,scrollThreshold:H=56,renderItem:C,onItemsChange:b,onLoadMore:k,onItemClick:T,onScroll:j,className:V,style:F,...$}=s,[f,L]=w.useState(),v=w.useRef(!1),W={...F,..._===void 0?void 0:{maxHeight:_},...(n==null?void 0:n.columns)===void 0?void 0:{"--willa-list-grid-columns":n.columns},...(n==null?void 0:n.minItemWidth)===void 0?void 0:{"--willa-list-grid-min-width":String(n.minItemWidth)},...(n==null?void 0:n.gap)===void 0?void 0:{"--willa-list-grid-gap":String(n.gap)}},E=i=>{if(j==null||j(i),!P||!D||x||!k||v.current)return;const r=i.currentTarget;if(r.scrollHeight-r.scrollTop-r.clientHeight>H)return;const B=k();J(B)&&(v.current=!0,B.finally(()=>{v.current=!1}))},q=(i,r)=>{if(r.preventDefault(),!f||f===i.id){L(void 0);return}b==null||b(Z(t,f,i.id)),L(void 0)};return e.jsxs("section",{...$,className:N("willa-list",`willa-list--${o}`,`willa-list--${a}`,`willa-list--${l}`,c&&"willa-list--split",n&&"willa-list--grid",I&&"willa-list--draggable",x&&"willa-list--loading",V),style:W,onScroll:E,children:[p?e.jsx("div",{className:"willa-list__slot",children:p}):null,t.length>0?e.jsx("ul",{className:"willa-list__items",children:t.map(i=>e.jsx("li",{className:N("willa-list__item",`willa-list__item--${i.tone??"neutral"}`,i.unread&&"willa-list__item--unread",i.selected&&"willa-list__item--selected",i.disabled&&"willa-list__item--disabled",f===i.id&&"willa-list__item--dragging"),draggable:I&&!i.disabled,onDragStart:r=>{!I||i.disabled||(r.dataTransfer.effectAllowed="move",r.dataTransfer.setData("text/plain",i.id),L(i.id))},onDragOver:r=>{!I||i.disabled||!f||(r.preventDefault(),r.dataTransfer.dropEffect="move")},onDrop:r=>q(i,r),onDragEnd:()=>L(void 0),children:C?C(i):e.jsx(X,{item:i,onItemClick:T})},i.id))}):e.jsx("div",{className:"willa-list__empty",children:A}),x?e.jsx("div",{className:"willa-list__loading",children:e.jsx(G,{size:"sm",label:R})}):null,u?e.jsx("div",{className:"willa-list__load-more",children:u}):null,m?e.jsx("div",{className:"willa-list__slot",children:m}):null]})}const X=s=>{const{item:t,onItemClick:o}=s,a=e.jsxs(e.Fragment,{children:[t.media?e.jsx("span",{className:"willa-list__media","aria-hidden":"true",children:t.media}):null,e.jsxs("span",{className:"willa-list__body",children:[e.jsxs("span",{className:"willa-list__header",children:[e.jsx("span",{className:"willa-list__title",children:t.title}),t.time?e.jsx("span",{className:"willa-list__time",children:t.time}):null]}),t.description?e.jsx("span",{className:"willa-list__description",children:t.description}):null,t.meta?e.jsx("span",{className:"willa-list__meta",children:t.meta}):null]}),t.extra?e.jsx("span",{className:"willa-list__extra",children:t.extra}):null]});return e.jsxs(e.Fragment,{children:[Y({item:t,mainContent:a,onItemClick:o}),t.actions?e.jsx("span",{className:"willa-list__actions",children:t.actions}):null,t.unread?e.jsx("span",{className:"willa-list__unread","aria-hidden":"true"}):null]})},Y=s=>{const{item:t,mainContent:o,onItemClick:a}=s;return t.href?e.jsx("a",{className:"willa-list__main",href:t.disabled?void 0:t.href,target:t.target,rel:t.target==="_blank"?"noreferrer":void 0,"aria-disabled":t.disabled||void 0,onClick:l=>{if(t.disabled){l.preventDefault();return}a==null||a(t,l)},children:o}):a?e.jsx("button",{className:"willa-list__main",type:"button",disabled:t.disabled,onClick:l=>a(t,l),children:o}):e.jsx("div",{className:"willa-list__main",children:o})},Z=(s,t,o)=>{const a=s.findIndex(m=>m.id===t),l=s.findIndex(m=>m.id===o);if(a<0||l<0)return s;const c=[...s],[p]=c.splice(a,1);return c.splice(l,0,p),c},ee=[{id:"one",title:"Racing car sprays burning fuel into crowd."},{id:"two",title:"Japanese princess to wed commoner."},{id:"three",title:"Australian walks 100km after outback crash."},{id:"four",title:"Man charged over missing wedding girl."},{id:"five",title:"Los Angeles battles huge wildfires."}],M=[{id:"review",title:"检查新增组件入口",description:"确认 content、willa 聚合包和 demo registry 都已经同步。",meta:e.jsx(h,{size:"sm",children:"组件"}),time:"刚刚",tone:"info",unread:!0,media:e.jsx(y,{}),actions:e.jsx(g,{size:"sm",variant:"ghost",children:"查看"})},{id:"styles",title:"整理列表类样式",description:"复用基础 List，避免通知和普通列表重复维护结构。",meta:e.jsx(h,{size:"sm",tone:"success",children:"已完成"}),time:"10:20",tone:"success",media:e.jsx(S,{})},{id:"build",title:"等待构建结果",description:"构建任务正在排队，完成后会同步状态。",meta:"CI 队列",time:"09:48",tone:"warning",media:e.jsx(z,{})}],te=[{id:"article-a",title:"组件体系整理完成",description:"把标准列表和通知场景拆清楚，普通数据展示优先使用 List。",meta:"Willa 设计系统",time:"2026-06-14",media:e.jsx(O,{}),extra:e.jsx("div",{style:{width:"9rem",height:"6.5rem",borderRadius:"0.7rem",background:"linear-gradient(135deg, rgb(228 235 255), rgb(245 246 250))"}}),actions:e.jsxs(e.Fragment,{children:[e.jsx(g,{size:"sm",variant:"ghost",children:"编辑"}),e.jsx(g,{size:"sm",variant:"ghost",children:"归档"})]})},{id:"article-b",title:"列表组件支持竖排布局",description:"竖排布局适合文章、活动、资源卡片这类需要额外图片区或操作区的内容。",meta:"产品日志",time:"2026-06-10",media:e.jsx(y,{}),extra:e.jsx("div",{style:{width:"9rem",height:"6.5rem",borderRadius:"0.7rem",background:"linear-gradient(135deg, rgb(232 248 240), rgb(247 247 244))"}}),actions:e.jsxs(e.Fragment,{children:[e.jsx(g,{size:"sm",variant:"ghost",children:"预览"}),e.jsx(g,{size:"sm",variant:"ghost",children:"发布"})]})}],ie=[{id:"prompt",title:"PromptInput",description:"AI 输入和提交入口。",meta:e.jsx(h,{size:"sm",children:"AI"})},{id:"upload",title:"Upload",description:"上传、预览和进度管理。",meta:e.jsx(h,{size:"sm",children:"Form"})},{id:"table",title:"Table",description:"数据展示、筛选和批量操作。",meta:e.jsx(h,{size:"sm",children:"Content"})},{id:"calendar",title:"Calendar",description:"日期选择和日程视图。",meta:e.jsx(h,{size:"sm",children:"Form"})}],se=[{id:"import",title:"导入数据",description:"先读取用户上传的反馈文档。",media:e.jsx(y,{})},{id:"analyse",title:"分析优先级",description:"按影响面、成本和风险输出排序。",media:e.jsx(z,{})},{id:"publish",title:"生成报告",description:"把结论整理成可以直接交付的版本。",media:e.jsx(S,{})}],ae=()=>{const[s,t]=w.useState(M),[o,a]=w.useState(!1),[l,c]=w.useState(!0),p=()=>(a(!0),new Promise(m=>{window.setTimeout(()=>{t(u=>[...u,{id:`more-${u.length}`,title:`滚动加载条目 ${u.length+1}`,description:"滚动接近底部时自动触发 onLoadMore。",meta:"自动加载",media:e.jsx(y,{})}]),c(s.length<7),a(!1),m()},500)}));return e.jsx(d,{items:s,maxHeight:"18rem",infiniteScroll:!0,hasMore:l,loading:o,loadingLabel:"加载更多内容",onLoadMore:p,style:{width:"min(100%, 42rem)"}})},ne=()=>{const[s,t]=w.useState(se);return e.jsx(d,{items:s,draggable:!0,onItemsChange:t,style:{width:"min(100%, 42rem)"}})},ce=K({id:"list",name:"List",packageName:"willa/List",description:"用于搭建任务、活动、文章、资源和通知等通用条目列表。",imports:[{name:"Badge",from:"willa/Badge"},{name:"Button",from:"willa/Button"},{name:"List",from:"willa/List"},{name:"Pagination",from:"willa/Pagination"},{name:"Stack",from:"willa/Stack"}],css:"willa/List.css",demo:{name:"List",component:d,props:{items:ee,header:"Header",footer:"Footer",style:{width:"min(100%, 40rem)"}}},code:`
  ...
  `,sections:[{title:"基础列表",code:`
        ...
        />;
      `,content:e.jsx(d,{items:M,style:{width:"min(100%, 44rem)"},onItemClick:()=>{}})},{title:"加载更多",code:`
        import { Button } from "willa/Button";
        import { List, type ListItem } from "willa/List";
        import "willa/Button.css";
        import "willa/List.css";
        ...
        <List
          ...
          style={{ width: "min(100%, 40rem)" }}
        />;
      `,content:e.jsx(d,{items:[{id:"one",title:"已同步 12 个组件状态",description:"组件入口和 demo 已更新。"},{id:"two",title:"等待视觉验收",description:"确认列表、通知和表格组合效果。"}],loadMore:e.jsx(g,{size:"sm",children:"加载更多"}),style:{width:"min(100%, 40rem)"}})},{title:"竖排列表",code:`
