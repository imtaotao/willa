import{b1 as t,h as o,$ as s,am as i,J as a,m as e,E as r}from"./index-C37Rprsh.js";import{F as n}from"./index-2HdRZH1d.js";/* empty css              */import{d as c}from"./defineDoc-UoumDtnn.js";const m={display:"grid",gap:"1rem",maxWidth:"42rem"},h=c({id:"form-actions",name:"FormActions",category:"form",packageName:"willa/FormActions",description:"用于表单底部提交、取消和辅助操作的布局组件。",imports:[{name:"FormActions",from:"willa/FormActions"}],css:"willa/FormActions.css",demo:{name:"FormActions",component:n,props:{gap:"md"},children:[{name:"Button",component:o,props:{variant:"ghost"},children:"取消"},{name:"Button",component:o,props:{type:"submit"},children:"保存"}]},code:`
