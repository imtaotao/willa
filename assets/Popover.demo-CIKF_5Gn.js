import{aA as s,ay as e,az as re,am as M,B as K,c as p,I as se,T as le}from"./index-DrRUehET.js";import{I as k}from"./index-DkIqrJ94.js";/* empty css              *//* empty css              */import{d as ae}from"./defineDoc-CvDLWAkX.js";const de=["a[href]","button:not([disabled])","textarea:not([disabled])","input:not([disabled])","select:not([disabled])","[tabindex]:not([tabindex='-1'])"].join(","),ce=n=>Array.from(n.querySelectorAll(de));function f(n){const{trigger:t,children:i,title:r,description:d,footer:m,open:w,defaultOpen:R=!1,onOpenChange:v,side:y="bottom",align:x="start",offset:h=10,size:H="md",autoFocus:O=!0,closeOnOutsidePointerDown:T=!0,closeOnEscape:U=!0,showArrow:P=!0,ariaLabel:_,className:J,contentClassName:Q}=n,j=s.useId(),L=r?`${j}-title`:void 0,A=d?`${j}-description`:void 0,F=w!==void 0,[X,Y]=s.useState(R),g=w??X,[Z,ee]=s.useState(),S=s.useRef(null),b=s.useRef(null),V=s.useRef(null),E=s.useCallback(o=>{F||Y(o),v==null||v(o)},[F,v]),z=s.useCallback(()=>{E(!1)},[E]),B=s.useCallback(()=>{const o=S.current,c=b.current;if(!o||!c||typeof window>"u")return;const l=o.getBoundingClientRect(),u=c.getBoundingClientRect(),a=pe({triggerRect:l,popoverRect:u,side:y,align:x,offset:P?h+6:h});ee({top:G(a.top,8,window.innerHeight-u.height-8),left:G(a.left,8,window.innerWidth-u.width-8),minWidth:Math.min(l.width,window.innerWidth-16)})},[x,h,P,y]);s.useEffect(()=>{if(!g||typeof window>"u")return;V.current=document.activeElement instanceof HTMLElement?document.activeElement:null,B();const o=window.requestAnimationFrame(B),c=window.setTimeout(()=>{if(!O)return;const a=b.current;if(!a)return;(ce(a)[0]??a).focus()},0),l=a=>{var W,$;if(!T)return;const N=a.target;N instanceof Node&&((W=b.current)!=null&&W.contains(N)||($=S.current)!=null&&$.contains(N)||z())},u=()=>B();return document.addEventListener("pointerdown",l),window.addEventListener("resize",u),window.addEventListener("scroll",u,!0),()=>{var a;window.cancelAnimationFrame(o),window.clearTimeout(c),document.removeEventListener("pointerdown",l),window.removeEventListener("resize",u),window.removeEventListener("scroll",u,!0),(a=V.current)==null||a.focus(),V.current=null}},[O,T,z,g,B]);const te=o=>{var c,l;(l=(c=t.props).onClick)==null||l.call(c,o),o.defaultPrevented||E(!g)},oe=o=>{var c,l;(l=(c=t.props).onKeyDown)==null||l.call(c,o),!o.defaultPrevented&&(o.key==="ArrowDown"||o.key==="Enter"||o.key===" ")&&(o.preventDefault(),E(!0))},ne=o=>{o.key==="Escape"&&U&&(o.stopPropagation(),z())},ie=()=>{if(!s.isValidElement(t))return null;const o=t;return s.cloneElement(o,{ref:me(o.props.ref,S),"aria-controls":g?j:void 0,"aria-expanded":g,"aria-haspopup":"dialog",onClick:te,onKeyDown:oe})};return e.jsxs("span",{className:M("willa-popover",J),children:[ie(),g&&typeof document<"u"?re.createPortal(e.jsxs("div",{ref:b,id:j,className:M("willa-popover-content",`willa-popover-content--${H}`,P&&`willa-popover-content--${y}`,Q),style:ue(Z),role:"dialog","aria-label":r?void 0:_??"Popover","aria-labelledby":L,"aria-describedby":A,tabIndex:-1,onKeyDown:ne,children:[P?e.jsx("span",{className:"willa-popover-arrow","aria-hidden":"true"}):null,r||d?e.jsxs("header",{className:"willa-popover-header",children:[r?e.jsx("h2",{id:L,className:"willa-popover-title",children:r}):null,d?e.jsx("p",{id:A,className:"willa-popover-description",children:d}):null]}):null,i?e.jsx("div",{className:"willa-popover-body",children:i}):null,m?e.jsx("footer",{className:"willa-popover-footer",children:m}):null]}),document.body):null]})}const pe=n=>{const{triggerRect:t,popoverRect:i,side:r,align:d,offset:m}=n,w=t.left+t.width/2-i.width/2,R=t.top+t.height/2-i.height/2;if(r==="top"||r==="bottom"){const x=r==="top"?t.top-i.height-m:t.bottom+m,h=q(t.left,t.right,i.width,w,d);return{top:x,left:h}}const v=r==="left"?t.left-i.width-m:t.right+m;return{top:q(t.top,t.bottom,i.height,R,d),left:v}},q=(n,t,i,r,d)=>d==="start"?n:d==="end"?t-i:r,ue=n=>({top:n?`${n.top}px`:void 0,left:n?`${n.left}px`:void 0,minWidth:n?`${n.minWidth}px`:void 0,visibility:n?void 0:"hidden"}),G=(n,t,i)=>Math.min(Math.max(n,t),Math.max(t,i)),me=(...n)=>t=>{n.forEach(i=>{if(i){if(typeof i=="function"){i(t);return}i.current=t}})},fe={display:"flex",flexWrap:"wrap",gap:"0.75rem",alignItems:"center"},C={display:"grid",gap:"0.7rem"},I={display:"grid",gap:"0.35rem"},D={color:"var(--willa-text-soft)",fontSize:"0.82rem"},xe=ae({id:"popover",name:"Popover",packageName:"willa/Popover",description:"用于承载可交互内容的轻量浮层，适合设置面板、筛选器和上下文信息。",imports:[{name:"Popover",from:"willa/Popover"},{name:"Button",from:"willa/Button"}],css:"willa/Popover.css",demo:{name:"Popover",component:f,props:{title:"生成设置",description:"调整回复长度和输出语气。",trigger:e.jsx(p,{icon:e.jsx(le,{}),variant:"outline",children:"打开设置"}),children:e.jsxs("div",{style:C,children:[e.jsxs("div",{style:I,children:[e.jsx("span",{style:D,children:"模型"}),e.jsx(k,{defaultValue:"willa-ai-default",size:"sm"})]}),e.jsx(K,{tone:"info",children:"已启用上下文增强"})]})}},code:`
