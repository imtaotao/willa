import{aM as Y,b2 as o,b0 as a,aN as k,E as fe,t as pe,m as Be,aL as Fe}from"./index-DGZYFfoN.js";import{F as Ke,a as Oe}from"./floatingPanelParts-Dw0bdth3.js";import{u as _e}from"./useFloatingPanel-CqAzKmSR.js";import{d as qe}from"./defineDoc-CvsgFtKJ.js";function Ge(l){return Array.isArray(l)?l:["hour","minute","second"]}function N(l){var d;const e=new Date,i={hour:e.getHours(),minute:e.getMinutes(),second:e.getSeconds()};if(!l)return P(i);const n=l.match(/^(\d{2}):(\d{2})(?::(\d{2}))?$/);if(n)return P({hour:Number(n[1]),minute:Number(n[2]),second:Number(n[3]??i.second)});const s=l.match(/^(?:\d{4}-\d{2}-\d{2}[ T])?(\d{1,2}):(\d{2})(?::(\d{2}))?\s*([AaPp][Mm])?$/);if(s){const w=(d=s[4])==null?void 0:d.toLowerCase(),u=Number(s[1]);return P({hour:w==="pm"&&u<12?u+12:w==="am"&&u===12?0:u,minute:Number(s[2]),second:Number(s[3]??i.second)})}return P(i)}function P(l){return{hour:Y(Math.trunc(l.hour),0,23),minute:Y(Math.trunc(l.minute),0,59),second:Y(Math.trunc(l.second),0,59)}}function O(l,e){const i=e.includes("hour"),n=e.includes("minute"),s=e.includes("second");return!i&&!n&&!s?"":[i?_(l.hour):null,n?_(l.minute):null,s?_(l.second):null].filter(w=>w!==null).join(":")}function Je(l,e){const i=N(l);return O(i,e)}function Qe(l,e){var x,H,y,M,V,E;const i=Math.max(1,Math.trunc((e==null?void 0:e.hourStep)??1)),n=Math.max(1,Math.trunc((e==null?void 0:e.minuteStep)??1)),s=Math.max(1,Math.trunc((e==null?void 0:e.secondStep)??1)),d=(e==null?void 0:e.use12Hours)??!1,w=((H=(x=e==null?void 0:e.disabledTime)==null?void 0:x.disabledHours)==null?void 0:H.call(x))??[],u=(e==null?void 0:e.selectedParts)??N("");if(l==="hour"){const m=d?1:0,T=d?12:23,q=e==null?void 0:e.period;return Z(m,T,i).map(C=>{const I=d?Xe(C.value,q):C.value;return{...C,disabled:w.includes(I)}})}if(l==="minute"){const m=((M=(y=e==null?void 0:e.disabledTime)==null?void 0:y.disabledMinutes)==null?void 0:M.call(y,u.hour))??[];return Z(0,59,n).map(T=>({...T,disabled:m.includes(T.value)}))}const z=((E=(V=e==null?void 0:e.disabledTime)==null?void 0:V.disabledSeconds)==null?void 0:E.call(V,u.hour,u.minute))??[];return Z(0,59,s).map(m=>({...m,disabled:z.includes(m.value)}))}function Ue(l){return Math.max(244,l*4.25*16)}const Z=(l,e,i)=>Array.from({length:Math.floor((e-l)/i)+1},(n,s)=>{const d=l+s*i;return{value:d,label:_(d)}}).filter(n=>n.value<=e),Xe=(l,e)=>{const i=Math.trunc(l);return e==="pm"?i===12?12:i+12:e==="am"&&i===12?0:i},_=l=>String(l).padStart(2,"0");function c(l){const{ref:e,allowClear:i=!1,disabledTime:n=null,format:s,hourStep:d=1,minuteStep:w=1,needConfirm:u=!1,presets:z=[],secondStep:x=1,showNow:H=!1,showScrollbar:y=!1,wheelColumns:M="time",size:V="md",variant:E="outline",use12Hours:m=!1,width:T,invalid:q=!1,placeholder:C,name:I,value:te,defaultValue:ie="",onValueChange:G,className:ye,disabled:R,style:ve,id:Pe,onBlur:xe,onClick:J,onKeyDown:Q,...$}=l,Ve=o.useId(),re=Pe??Ve,U=`${re}-panel`,ne=`${U}-label`,se=o.useRef(null),L=o.useRef(null),X=o.useRef(null),[h,v]=o.useState(!1),[Te,Ce]=o.useState(ie),[ue,S]=o.useState(ie),p=te??Te,b=o.useMemo(()=>Ge(M),[M]),B=b.includes("hour"),g=u&&h?ue:p,D=o.useMemo(()=>N(g),[g]),F=o.useMemo(()=>m&&B?ae(D.hour):void 0,[B,D.hour,m]),Se=o.useCallback(()=>v(!1),[]),{position:ge,updatePosition:ce}=_e({open:h,rootRef:se,triggerRef:L,panelRef:X,minWidth:Ue(b.length),matchTriggerWidth:!0,fullWidthBelow:420,fallbackHeight:250,onClose:Se}),oe=q||$["aria-invalid"]===!0||$["aria-invalid"]==="true",je=Ze({width:T,style:ve}),de=el({value:p,columns:b,format:s,use12Hours:m}),Ne=de??C??"选择时间",He=`${C??"选择时间"}面板`,Me=t=>{L.current=t,Fe(e,t)};o.useEffect(()=>{u&&S(p)},[p,u,h]),o.useEffect(()=>{h&&ce()},[h,ce]),o.useEffect(()=>{var t;h&&((t=X.current)==null||t.querySelectorAll(".willa-time-picker-wheel-option--selected").forEach(r=>{r.scrollIntoView({block:"center",behavior:"smooth"})}))},[h,g]);const j=(t,r)=>{te===void 0&&Ce(t),G==null||G(t),r&&v(!1)},De=t=>{if(u){S(t);return}j(t,!1)},We=(t,r)=>{const W=N(g),f=P({...W,[t]:m&&t==="hour"?be(r,F):r});De(O(f,b))},Ae=t=>{if(Q==null||Q(t),!t.defaultPrevented){if(t.key==="Escape"){v(!1);return}(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),v(r=>!r))}},ze=t=>{var r;t.key==="Escape"&&(t.stopPropagation(),u&&S(p),v(!1),(r=L.current)==null||r.focus())},Ee=t=>{if(u){S(t);return}j(t,!0)},Ie=()=>{const t=P({hour:new Date().getHours(),minute:new Date().getMinutes(),second:new Date().getSeconds()});j(O(t,b),!0)},me=()=>{j("",!0)},Re=()=>{j(ue,!0)},$e=()=>{var t;S(p),v(!1),(t=L.current)==null||t.focus()},he=t=>{if(!m||!B)return;const r=le(D.hour),W=P({...D,hour:be(r,t)}),f=O(W,b);if(u){S(f);return}j(f,!1)},Le=h?a.jsx(Ke,{open:h,children:a.jsxs(Oe,{panelRef:X,id:U,className:k("willa-time-picker-panel","willa-time-picker-panel--wheel"),position:ge,role:"dialog",ariaLabelledBy:ne,onKeyDown:ze,children:[a.jsx("span",{id:ne,className:"willa-time-picker-panel-label",children:He}),z.length>0?a.jsx("div",{className:"willa-time-picker-presets","aria-label":"快捷时间预设",children:z.map(t=>{const r=t.value===g;return a.jsx("button",{className:k("willa-time-picker-preset",r&&"willa-time-picker-preset--selected"),type:"button",onClick:()=>Ee(t.value),children:t.label},t.value)})}):null,a.jsx("div",{className:"willa-time-picker-wheel",style:{gridTemplateColumns:`repeat(${b.length}, minmax(3.75rem, 1fr))`},children:b.map(t=>{const r=N(g),W=m&&t==="hour"?le(r.hour):r[t];return a.jsxs("div",{className:"willa-time-picker-wheel-column",children:[a.jsx("div",{className:"willa-time-picker-wheel-label",children:Ye[t]}),a.jsx("div",{className:k("willa-time-picker-wheel-options",y&&"willa-time-picker-wheel-options--scrollbar",y&&"willa-form-scrollbar"),children:Qe(t,{hourStep:d,minuteStep:w,secondStep:x,use12Hours:m,disabledTime:n,selectedParts:D,period:F??void 0}).map(f=>a.jsx("button",{className:k("willa-time-picker-wheel-option",f.disabled&&"willa-time-picker-wheel-option--disabled",f.value===W&&"willa-time-picker-wheel-option--selected"),type:"button",disabled:f.disabled,onClick:()=>We(t,f.value),children:f.label},f.value))})]},t)})}),m&&B?a.jsxs("div",{className:"willa-time-picker-periods","aria-label":"上午下午切换",children:[a.jsx("button",{type:"button",className:k("willa-time-picker-period",F==="am"&&"willa-time-picker-period--selected"),onClick:()=>he("am"),children:"上午"}),a.jsx("button",{type:"button",className:k("willa-time-picker-period",F==="pm"&&"willa-time-picker-period--selected"),onClick:()=>he("pm"),children:"下午"})]}):null,i||H||u?a.jsxs("div",{className:"willa-time-picker-footer",children:[a.jsxs("div",{className:"willa-time-picker-footer-start",children:[i?a.jsxs("button",{type:"button",className:"willa-time-picker-action",onClick:me,children:[a.jsx(fe,{}),"清除"]}):null,H?a.jsxs("button",{type:"button",className:"willa-time-picker-action",onClick:Ie,children:[a.jsx(pe,{"aria-hidden":"true"}),"现在"]}):null]}),u?a.jsxs("div",{className:"willa-time-picker-footer-end",children:[a.jsx("button",{type:"button",className:"willa-time-picker-action",onClick:$e,children:"取消"}),a.jsxs("button",{type:"button",className:"willa-time-picker-action willa-time-picker-action--primary",onClick:Re,children:[a.jsx(Be,{}),"确定"]})]}):null]}):null]})}):null;return a.jsxs("span",{ref:se,className:k("willa-time-picker",`willa-time-picker--${V}`,`willa-time-picker--${E}`,i&&"willa-time-picker--clearable",h&&"willa-time-picker--open",R&&"willa-time-picker--disabled",oe&&"willa-time-picker--invalid",ye),style:je,"aria-disabled":R||void 0,children:[I?a.jsx("input",{type:"hidden",name:I,value:p,disabled:R}):null,a.jsxs("button",{...$,ref:Me,id:re,type:"button",className:"willa-time-picker-control",disabled:R,"aria-expanded":h,"aria-controls":h?U:void 0,"aria-haspopup":"dialog","aria-invalid":oe||$["aria-invalid"],onBlur:xe,onClick:t=>{J==null||J(t),t.defaultPrevented||v(r=>!r)},onKeyDown:Ae,children:[a.jsx("span",{className:k("willa-time-picker-value",!de&&"willa-time-picker-value--placeholder"),children:Ne}),i&&p?null:a.jsx(pe,{className:"willa-time-picker-icon","aria-hidden":"true"})]}),i&&p?a.jsx("button",{type:"button",className:"willa-time-picker-clear","aria-label":"清除时间",onClick:t=>{t.stopPropagation(),me()},children:a.jsx(fe,{"aria-hidden":"true"})}):null,Le]})}c.displayName="TimePicker";const Ye={hour:"时",minute:"分",second:"秒"},Ze=l=>{const{width:e,style:i}=l;return{...i,...e===void 0?void 0:{width:e}}},el=l=>{const{value:e,columns:i,format:n,use12Hours:s=!1}=l;if(!e)return;const d=N(e);return n?we(d,n):s&&i.includes("hour")?we(d,ll(i)):Je(e,i)},ll=l=>`${[l.includes("hour")?"hh":null,l.includes("minute")?"mm":null,l.includes("second")?"ss":null].filter(i=>i!==null).join(":")} A`,we=(l,e)=>{const i=le(l.hour),n={HH:K(l.hour),H:String(l.hour),hh:K(i),h:String(i),mm:K(l.minute),m:String(l.minute),ss:K(l.second),s:String(l.second),A:ae(l.hour)==="pm"?"PM":"AM",a:ae(l.hour)==="pm"?"pm":"am"};return e.replace(/HH|hh|mm|ss|H|h|m|s|A|a/g,s=>n[s]??s)},le=l=>{const e=Math.trunc(l)%24;return e%12===0?12:e%12},ae=l=>Math.trunc(l)>=12?"pm":"am",be=(l,e)=>{const i=Math.trunc(l);return e==="pm"?i===12?12:i+12:e==="am"&&i===12?0:i},K=l=>String(l).padStart(2,"0"),A={display:"grid",gap:"0.76rem",maxWidth:"42rem"},ke=["hour","minute"],ee=["hour","minute","second"],al=[{label:"08:30",value:"08:30:00"},{label:"12:00",value:"12:00:00"},{label:"18:30",value:"18:30:00"}],tl={disabledHours:()=>[0,1,2,3,4,5],disabledMinutes:l=>l===9?[0,1,2,3,4,5]:[],disabledSeconds:(l,e)=>l===9&&e===30?[0,1,2,3,4]:[]},il=()=>{const[l,e]=o.useState("09:30:00");return a.jsx(c,{value:l,onValueChange:e,width:"100%","aria-label":"选择时间"})},rl=()=>{const[l,e]=o.useState("09:30:00");return a.jsx(c,{value:l,onValueChange:e,needConfirm:!0,showNow:!0,allowClear:!0,use12Hours:!0,format:"hh:mm A",width:"100%","aria-label":"选择时间"})},ol=qe({id:"time-picker",name:"TimePicker",category:"form",packageName:"willa/TimePicker",description:"用于选择时间点、时分秒和调度时间。",imports:[{name:"TimePicker",from:"willa/TimePicker"}],css:"willa/TimePicker.css",demo:{name:"TimePickerPreview",component:il},code:`
