import{al as e,P as a,Q as n,an as r,z as l,O as d}from"./index-CVWWokxc.js";import{S as t}from"./index-D0oC2Yqd.js";import{P as p}from"./index-D-2uFZ79.js";import{d as m}from"./defineDoc-e_S1Bl0w.js";import"./index-DHIehsfy.js";import"./index-DERC9WBo.js";const c=[{id:"summarize",label:"总结这份文档",description:"输出重点和风险",icon:e.jsx(l,{})},{id:"search",label:"检索相关资料",description:"补充来源证据",icon:e.jsx(n,{})},{id:"plan",label:"拆成执行计划",description:"按优先级排序",icon:e.jsx(d,{})}],g={display:"grid",gap:"0.85rem",width:"min(100%, 56rem)",border:"1px solid var(--willa-line)",borderRadius:"0.9rem",background:"var(--willa-panel-bg)",padding:"1rem"},u=()=>{const[o,s]=r.useState("");return e.jsxs("div",{style:g,children:[e.jsx(t,{items:c,onSelect:i=>{s(String(i.label))}}),e.jsx(p,{value:o,placeholder:"选择一个建议，或直接输入问题...",minRows:2,maxRows:5,onChange:i=>s(i.currentTarget.value)})]})},x=m({id:"suggestion-chips",name:"SuggestionChips",category:"ai",packageName:"willa/SuggestionChips",description:"用于展示快捷提示词、推荐问题和 AI 任务入口。",imports:[{name:"SuggestionChips",from:"willa/SuggestionChips"}],css:"willa/SuggestionChips.css",demo:{name:"SuggestionChipsPreview",component:u},code:`
