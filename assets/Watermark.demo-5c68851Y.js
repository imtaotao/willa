import{aN as b,aL as t,aw as _,i as F,am as j,Q as D,B as I}from"./index-DNQF9iNw.js";import{r as R}from"./media-NETBme5W.js";/* empty css              */import{d as G}from"./defineDoc-zHnHUJEc.js";const O=152,P=84,U=[96,88],N=[24,12],V=-22,Y=1,M="rgba(15, 23, 42, 0.12)",K="rgba(255, 255, 255, 0.12)";function E(a){const{articleSourcePath:i,resolveAssetUrl:o,children:l,content:c,image:g,width:s=O,height:r=P,gap:n=U,offset:d=N,rotate:p=V,opacity:x=Y,zIndex:m=1,fixed:w=!1,font:e,className:A,style:H,...z}=a,y=b.useRef(null),[h,k]=b.useState(M),f=R({articleSourcePath:i,resolveAssetUrl:o},g),S=X(c),u=b.useMemo(()=>Z({lines:S,image:f,width:s,height:r,gap:n,rotate:p,font:{color:(e==null?void 0:e.color)??h,fontFamily:e==null?void 0:e.fontFamily,fontSize:e==null?void 0:e.fontSize,fontStyle:e==null?void 0:e.fontStyle,fontWeight:e==null?void 0:e.fontWeight,letterSpacing:e==null?void 0:e.letterSpacing,lineHeight:e==null?void 0:e.lineHeight}}),[S,f,s,r,n,p,e==null?void 0:e.color,e==null?void 0:e.fontFamily,e==null?void 0:e.fontSize,e==null?void 0:e.fontStyle,e==null?void 0:e.fontWeight,e==null?void 0:e.letterSpacing,e==null?void 0:e.lineHeight,h]);b.useEffect(()=>{const v=y.current;if(!v)return;const W=()=>{const C=getComputedStyle(v).getPropertyValue("--willa-watermark-ink").trim();if(C){k(C);return}const L=document.documentElement.getAttribute("data-wk-theme");k(L==="dark"?K:M)};W();const $=new MutationObserver(W);return $.observe(document.documentElement,{attributes:!0,attributeFilter:["data-wk-theme","class"]}),()=>$.disconnect()},[]);const B={...H,"--willa-watermark-image":u?`url("${u}")`:"none","--willa-watermark-size":`${s+n[0]}px ${r+n[1]}px`,"--willa-watermark-position":`${d[0]}px ${d[1]}px`,"--willa-watermark-opacity":`${x}`,"--willa-watermark-z-index":`${m}`};return t.jsxs("div",{...z,ref:y,className:_("willa-watermark",w&&"willa-watermark--fixed",A),style:B,children:[t.jsx("div",{className:"willa-watermark__overlay","aria-hidden":"true"}),l?t.jsx("div",{className:"willa-watermark__content",children:l}):null]})}const X=a=>a?(Array.isArray(a)?a:[a]).map(i=>i.trim()).filter(Boolean):new Array,T=a=>a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Z=a=>{const{lines:i,image:o,width:l,height:c,gap:g,rotate:s,font:r}=a;if(!o&&i.length===0)return"";const n=l+g[0],d=c+g[1],p=n/2,x=d/2,m=r.fontSize??15,w=r.lineHeight??m*1.45,e=r.letterSpacing??.6,A=r.fontWeight??560,H=r.fontFamily??"Inter, ui-sans-serif, system-ui, sans-serif",z=r.fontStyle??"normal",y=r.color??M,h=o?Math.min(c*.34,34):0,k=i.length?w*i.length-(w-m):0,f=o&&i.length?Math.max(c*.08,6):0,S=h+f+k,u=x-S/2,B=o?q({image:o,centerX:p,startY:u,width:l,imageBlockHeight:h}):"",v=i.map(($,C)=>{const L=u+h+f+m+w*C-m*.16;return`<text x="${p}" y="${L}" text-anchor="middle" fill="${y}" font-size="${m}" font-weight="${A}" font-family="${H}" font-style="${z}" letter-spacing="${e}">${T($)}</text>`}).join(""),W=`
  ...
  `,sections:[{title:"文字样式与密度",code:`
      ...
      `,content:t.jsx(E,{content:["Design Review","Preview Only"],width:184,height:96,gap:[56,48],rotate:-16,font:{color:"rgba(79, 117, 214, 0.18)",fontSize:17,fontWeight:640,letterSpacing:1},children:t.jsx(F,{style:ee,children:t.jsxs(j,{gap:"xs",children:[t.jsx("strong",{children:"更高密度的审批面板"}),t.jsx("span",{style:{color:"var(--willa-text-soft)",fontSize:"0.9rem"},children:"适合评审区、导出预览区和二次确认面板。"})]})})})},{title:"图片水印",code:`
        const brandMark =
