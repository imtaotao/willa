import{aZ as e}from"./index-D-LV62RM.js";import{S as t}from"./index-v8WyPh8E.js";import{d as i}from"./defineDoc-CMyXJ6JB.js";import"./index-99fdLmsC.js";import"./useSelectablePanel-D6g2zJ0p.js";import"./floatingPanelParts-Bt6TCwun.js";import"./useFloatingPanel-CdeSl92G.js";const a={display:"grid",gap:"0.9rem",maxWidth:"42rem"},l=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],r=i({id:"select",name:"Select",category:"form",packageName:"willa/Select",description:"用于单选下拉，适合表单、筛选和配置场景。",imports:[{name:"Select",from:"willa/Select"}],css:"willa/Select.css",demo:{name:"Select",component:t,props:{options:l,defaultValue:"balanced",width:"100%"}},code:`
