import{b1 as e,D as a,am as o,m as t}from"./index-C37Rprsh.js";import{C as n}from"./index-Byh0G_EB.js";import{M as s}from"./index-CH377r8_.js";import{d as c}from"./defineDoc-UoumDtnn.js";import"./index-DVYrMtCN.js";const r="https://github.com/openai.png",l={display:"grid",gap:"1rem",width:"min(100%, 58rem)",border:"1px solid var(--willa-line)",borderRadius:"0.9rem",background:"var(--willa-panel-bg)",padding:"1rem"},p=()=>{const i=[{id:"copy",label:"复制",icon:e.jsx(a,{}),copyText:`可以先按影响面、紧急程度和实现成本拆分。
