import{a$ as u,aZ as a,z as ne,aK as q,B as Ae,ay as se,h as ke}from"./index-D1WL8Azw.js";/* empty css              */import{d as _e}from"./defineDoc-D4e1n7NZ.js";const Be=["Enter",","],r=u.forwardRef((n,s)=>{const{value:d,defaultValue:T=[],inputValue:m,defaultInputValue:c="",name:v,size:b="md",variant:ie="outline",width:L,placeholder:le="输入后按 Enter 添加",disabled:f=!1,readOnly:S=!1,invalid:K=!1,clearable:re=!0,maxTags:j,allowDuplicates:A=!1,commitOnBlur:oe=!0,separators:U=Be,suggestions:E=[],maxSuggestions:Z=8,emptySuggestion:G,renderTag:N,normalizeTag:H=Ee,validateTag:h,onValueChange:D,onInputValueChange:$,onTagReject:R,className:ue,style:de,id:ce,onBlur:z,onFocus:O,onKeyDown:y,onPaste:w,...pe}=n,ge=u.useId(),M=ce??ge,J=d!==void 0,Q=m!==void 0,[me,fe]=u.useState(T),[he,ye]=u.useState(c),[we,W]=u.useState(!1),[k,_]=u.useState(0),l=J?d:me,I=Q?m:he,p=!f&&!S,Ie=re&&p&&l.length>0,X=j===void 0||l.length<j,V=u.useMemo(()=>Re({allowDuplicates:A,inputValue:I,maxSuggestions:Z,suggestions:E,tags:l}),[A,I,l,Z,E]),x=we&&p&&(V.length>0||!!G),Ve={...de,...L===void 0?void 0:{width:L}},B=e=>{J||fe(e),D==null||D(e)},F=e=>{Q||ye(e),$==null||$(e)},o=(e,t)=>{R==null||R(e,t)},Y=e=>{const t=H(e);if(!t)return o(e,"empty"),!1;if(!A&&l.includes(t))return o(t,"duplicate"),!1;if(!X)return o(t,"max"),!1;const i=h==null?void 0:h(t,l);return i===!1||typeof i=="string"?(o(t,"invalid"),!1):(B([...l,t]),F(""),_(0),!0)},ee=()=>I.trim()?Y(I):!1,xe=e=>{let t=l;for(const i of e){const g=H(i);if(!g){o(i,"empty");continue}if(!A&&t.includes(g)){o(g,"duplicate");continue}if(j!==void 0&&t.length>=j){o(g,"max");continue}const ae=h==null?void 0:h(g,t);if(ae===!1||typeof ae=="string"){o(g,"invalid");continue}t=[...t,g]}t!==l&&(B(t),F(""),_(0))},P=e=>{p&&B(l.filter((t,i)=>i!==e))},Te=()=>{p&&B([])},te=e=>{Y(e)},ve=e=>{if(f||S){y==null||y(e);return}if(x&&e.key==="ArrowDown"){e.preventDefault(),_(t=>Math.min(t+1,V.length-1));return}if(x&&e.key==="ArrowUp"){e.preventDefault(),_(t=>Math.max(t-1,0));return}if(x&&e.key==="Enter"&&V[k]){e.preventDefault(),te(V[k]);return}if(Ne(e,U)){e.preventDefault(),ee();return}e.key==="Backspace"&&!I&&P(l.length-1),y==null||y(e)},Se=e=>{if(!p){w==null||w(e);return}const t=e.clipboardData.getData("text"),i=De(t,U).filter(Boolean);if(i.length>1){e.preventDefault(),xe(i);return}w==null||w(e)},be=e=>{e.currentTarget.contains(e.relatedTarget)||(W(!1),oe&&p&&ee()),z==null||z(e)},je=e=>{W(!0),O==null||O(e)};return a.jsxs("div",{...pe,className:q("willa-tag-input",`willa-tag-input--${b}`,`willa-tag-input--${ie}`,f&&"willa-tag-input--disabled",S&&"willa-tag-input--readonly",K&&"willa-tag-input--invalid",ue),style:Ve,"aria-disabled":f||void 0,onBlur:be,onFocus:je,children:[a.jsxs("div",{className:"willa-tag-input__control",onClick:Ce,children:[l.map((e,t)=>a.jsxs("span",{className:q("willa-tag-input__tag",N&&"willa-tag-input__tag--custom"),children:[N?N(e,{index:t,disabled:f,readOnly:S,onRemove:()=>P(t)}):a.jsxs(a.Fragment,{children:[a.jsx("span",{className:"willa-tag-input__tag-label",children:e}),p?a.jsx("button",{className:"willa-tag-input__remove",type:"button","aria-label":`移除 ${e}`,onClick:i=>{i.stopPropagation(),P(t)},children:a.jsx(ne,{"aria-hidden":"true"})}):null]}),v?a.jsx("input",{type:"hidden",name:v,value:e,readOnly:!0}):null]},`${e}-${t}`)),a.jsx("input",{ref:s,id:M,className:"willa-tag-input__input",value:I,placeholder:l.length===0?le:void 0,disabled:f,readOnly:S||!X,"aria-invalid":K||void 0,"aria-autocomplete":E.length>0?"list":void 0,"aria-expanded":x||void 0,"aria-controls":x?`${M}-suggestions`:void 0,onChange:e=>F(e.target.value),onKeyDown:ve,onPaste:Se}),Ie?a.jsx("button",{className:"willa-tag-input__clear",type:"button","aria-label":"清空标签",onClick:e=>{e.stopPropagation(),Te()},children:a.jsx(ne,{"aria-hidden":"true"})}):null]}),x?a.jsx("div",{className:"willa-tag-input__suggestions",id:`${M}-suggestions`,role:"listbox",children:V.length>0?V.map((e,t)=>a.jsx("button",{className:q("willa-tag-input__suggestion",t===k&&"willa-tag-input__suggestion--active"),type:"button",role:"option","aria-selected":t===k,onMouseDown:i=>{i.preventDefault(),te(e)},children:e},e)):G}):null]})});r.displayName="TagInput";const Ce=n=>{const s=n.currentTarget.querySelector("input:not([type='hidden'])");s==null||s.focus()},Ee=n=>n.trim(),Ne=(n,s)=>n.nativeEvent.isComposing?!1:s.includes(n.key),De=(n,s)=>{const T=s.filter(c=>c.length===1).map($e),m=new RegExp(`[\\n\\r\\t${T.join("")}]+`,"g");return n.split(m).map(c=>c.trim())},$e=n=>n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),Re=n=>{const{allowDuplicates:s,inputValue:d,maxSuggestions:T,suggestions:m,tags:c}=n,v=d.trim().toLowerCase();return m.filter(b=>!s&&c.includes(b)?!1:v?b.toLowerCase().includes(v):!0).slice(0,T)},C=["AI 产品","文档站","表单","移动端","主题变量","上传","批量操作","日历"],ze=()=>{const[n,s]=u.useState(["AI 产品","主题变量"]),d=n.length===0;return a.jsxs(se,{gap:"sm",style:{width:"min(100%, 34rem)"},children:[a.jsx(r,{value:n,invalid:d,placeholder:"至少添加一个标签",suggestions:C,onValueChange:s}),a.jsx(ke,{size:"sm",variant:"soft",onClick:()=>s(["移动端"]),children:"重置为移动端"})]})},Pe=_e({id:"tag-input",name:"TagInput",category:"form",packageName:"willa/TagInput",description:"用于输入、编辑和提交多个文本标签的表单组件。",imports:[{name:"Badge",from:"willa/Badge"},{name:"Button",from:"willa/Button"},{name:"Stack",from:"willa/Stack"},{name:"TagInput",from:"willa/TagInput"}],css:"willa/TagInput.css",demo:{name:"TagInput",component:r,props:{defaultValue:["AI 产品","文档站"],suggestions:C,placeholder:"输入标签后按 Enter",width:"min(100%, 34rem)"}},code:`
  ...
  `,sections:[{title:"建议项",code:`
      ...
      `,content:a.jsx(ze,{})},{title:"分隔符和粘贴",code:`
        <TagInput
          defaultValue={["表单"]}
          separators={["Enter", ",", "，"]}
