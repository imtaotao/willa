import{aA as m,ay as t,am as S,L as H,c as v,B as M}from"./index-DrRUehET.js";import{A as T}from"./index-qUs3Axmh.js";import{I as G}from"./index-TAC5Yzvj.js";/* empty css              *//* empty css              */import{d as _}from"./defineDoc-CvDLWAkX.js";function i(n){const{value:e,defaultValue:o="",onValueChange:a,onSubmit:s,placeholder:u="写下你的评论...",submitLabel:B="发布",disabled:g=!1,loading:c=!1,minRows:C=3,maxLength:p,autoFocus:L=!1,avatarSrc:b,avatarName:l,quote:d,mentionLabel:k="@",onMentionClick:h,actions:j,footer:w,className:q,textareaProps:A}=n,y=e!==void 0,[R,z]=m.useState(o),x=y?e:R,V=x.trim(),I=f=>{y||z(f),a==null||a(f)},E=()=>{I("")},P=(f,K)=>{V&&(s==null||s(V,{clear:E}))},N=!!(b||l),F=!!(h||j);return t.jsx(G,{...A,className:S("willa-comment-input",N&&"willa-comment-input--with-author",c&&"willa-comment-input--loading",q),slotClassNames:{actions:"willa-comment-input-actions",control:"willa-comment-input-control",footer:"willa-comment-input-footer",meta:"willa-comment-input-extra",submit:"willa-comment-input-submit"},autoFocus:L,autoResize:!1,minRows:C,maxRows:C,maxLength:p,submitShortcut:"mod-enter",loading:c,beforeInput:t.jsxs(t.Fragment,{children:[N?t.jsxs("div",{className:"willa-comment-input-author",children:[t.jsx(T,{className:"willa-comment-input-avatar",src:b,name:l??"Comment Author",alt:l??"Comment Author",size:"sm"}),t.jsx("span",{className:"willa-comment-input-author-name",children:l??"评论者"})]}):null,d?t.jsx("div",{className:"willa-comment-input-quote",children:t.jsxs("div",{className:"willa-comment-input-quote-content",children:[t.jsx("span",{className:"willa-comment-input-quote-mark","aria-hidden":"true",children:"“"}),t.jsxs("span",{className:"willa-comment-input-quote-author",children:["@",d.author]}),d.content,t.jsx("span",{className:"willa-comment-input-quote-mark","aria-hidden":"true",children:"”"})]})}):null]}),footer:w?t.jsx("span",{children:w}):p?t.jsxs("span",{children:[x.length,"/",p]}):t.jsx("span",{children:"⌘ Enter 发布"}),actions:F?t.jsxs(t.Fragment,{children:[h?t.jsx(D,{"aria-label":"提及用户",onClick:h,disabled:g||c,children:k}):null,j]}):null,submitLabel:B,value:x,placeholder:u,disabled:g,onValueChange:I,onSubmit:P})}const D=n=>{const{className:e,type:o="button",...a}=n;return t.jsx("button",{...a,type:o,className:S("willa-comment-input-tool",e)})},r={display:"grid",gap:"0.85rem",width:"min(100%, 52rem)",margin:"0 auto"},Q=()=>{const[n,e]=m.useState(""),[o,a]=m.useState("");return t.jsxs("div",{style:r,children:[t.jsx(i,{value:n,onValueChange:e,maxLength:180,onSubmit:(s,u)=>{a(s),u.clear()}}),o?t.jsxs(M,{tone:"success",children:["已发布：",o]}):null]})},J=()=>{const[n,e]=m.useState("");return t.jsx("div",{style:r,children:t.jsx(i,{placeholder:"回复这条评论...",quote:{author:"产品设计",content:"这个输入区需要支持评论扩展能力。"},onMentionClick:()=>e("打开成员选择面板"),actions:t.jsx(v,{size:"sm",variant:"ghost",onClick:()=>e("打开业务自己的表情包面板"),children:"表情"}),footer:n||"点击 @ 或表情按钮接入业务面板"})})},$=_({id:"comment-input",name:"CommentInput",category:"content",packageName:"willa/CommentInput",description:"用于评论、批注和反馈场景的轻量输入组件。",imports:[{name:"CommentInput",from:"willa/CommentInput"}],css:"willa/CommentInput.css",demo:{name:"CommentInputPreview",component:Q},code:`
