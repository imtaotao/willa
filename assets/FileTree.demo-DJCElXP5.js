import{a_ as e,Q as i,b2 as n,b0 as o,X as u,u as y}from"./index-CiTBtHwL.js";import{F as s}from"./index-DV42YDiW.js";/* empty css              */import{d as g}from"./defineDoc-C6xIJe2e.js";import"./index-DCN2kULE.js";const c=[{id:"agents",name:"AGENTS.md",meta:"仓库通用约定",selected:!0,icon:e.jsx(i,{})},{id:"services",name:"services",type:"folder",children:[{id:"payments",name:"payments",type:"folder",children:[{id:"payments-agents",name:"AGENTS.md",muted:!0,meta:"因为存在覆盖文件，所以会被忽略",icon:e.jsx(i,{})},{id:"payments-override",name:"AGENTS.override.md",selected:!0,meta:"payments 服务规则",icon:e.jsx(i,{})},{id:"payments-readme",name:"README.md",icon:e.jsx(i,{})},{id:"payments-long-report",name:"quarterly-payment-reconciliation-report-2026-final.md",meta:"finance / reconciliation / archived",icon:e.jsx(i,{})}]},{id:"search",name:"search",type:"folder",children:[{id:"search-readme",name:"README.md",icon:e.jsx(i,{})}]}]}],T=[{id:"prompts",name:"prompts",type:"folder",children:[{id:"system-prompt",name:"system.md",meta:"系统提示词"},{id:"rewrite-prompt",name:"rewrite.md",meta:"改写链路"}]},{id:"datasets",name:"datasets",type:"folder",children:[{id:"faq-dataset",name:"faq.jsonl",meta:"1.2 MB"},{id:"eval-dataset",name:"eval.csv",meta:"320 KB"}]},{id:"agent-config",name:"agent.config.ts",meta:"运行配置",selected:!0}],l=[{id:"agents",language:"md",code:n(`
      # AGENTS.md
