import{aW as e}from"./index-Clga5H6i.js";import{S as t}from"./index-X8hoo1pH.js";import{d as i}from"./defineDoc-CXpq5YLG.js";import"./index-BTL9mcUY.js";import"./useSelectablePanel-SjLwVG2d.js";import"./floatingPanelParts-Dh0-P-VY.js";import"./useFloatingPanel-B0C7evKv.js";const a={display:"grid",gap:"0.9rem",maxWidth:"42rem"},l=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],r=i({id:"select",name:"Select",category:"form",packageName:"willa/Select",description:"用于单选下拉，适合表单、筛选和配置场景。",imports:[{name:"Select",from:"willa/Select"}],css:"willa/Select.css",demo:{name:"Select",component:t,props:{options:l,defaultValue:"balanced",width:"100%"}},code:`
