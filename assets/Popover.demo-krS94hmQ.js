import{aA as s,ay as e,az as re,am as V,B as K,c as p,I as se,T as le}from"./index-DBsCKa5b.js";import{I as C}from"./index-D2tEayrX.js";/* empty css              *//* empty css              */import{d as ae}from"./defineDoc-CeA5kaJR.js";const ce=["a[href]","button:not([disabled])","textarea:not([disabled])","input:not([disabled])","select:not([disabled])","[tabindex]:not([tabindex='-1'])"].join(","),de=n=>Array.from(n.querySelectorAll(ce));function f(n){const{trigger:t,children:i,title:r,description:c,footer:m,open:w,defaultOpen:R=!1,onOpenChange:v,side:y="bottom",align:x="start",offset:h=10,size:H="md",autoFocus:T=!0,closeOnOutsidePointerDown:L=!0,closeOnEscape:U=!0,showArrow:P=!0,ariaLabel:_,className:J,contentClassName:Q}=n,j=s.useId(),A=r?`${j}-title`:void 0,F=c?`${j}-description`:void 0,W=w!==void 0,[X,Y]=s.useState(R),g=w??X,[Z,ee]=s.useState(),S=s.useRef(null),b=s.useRef(null),z=s.useRef(null),E=s.useCallback(o=>{W||Y(o),v==null||v(o)},[W,v]),k=s.useCallback(()=>{E(!1)},[E]),B=s.useCallback(()=>{const o=S.current,d=b.current;if(!o||!d||typeof window>"u")return;const l=o.getBoundingClientRect(),u=d.getBoundingClientRect(),a=pe({triggerRect:l,popoverRect:u,side:y,align:x,offset:P?h+6:h});ee({top:G(a.top,8,window.innerHeight-u.height-8),left:G(a.left,8,window.innerWidth-u.width-8),minWidth:Math.min(l.width,window.innerWidth-16)})},[x,h,P,y]);s.useEffect(()=>{if(!g||typeof window>"u")return;z.current=document.activeElement instanceof HTMLElement?document.activeElement:null,B();const o=window.requestAnimationFrame(B),d=window.setTimeout(()=>{if(!T)return;const a=b.current;if(!a)return;(de(a)[0]??a).focus()},0),l=a=>{var $,M;if(!L)return;const N=a.target;N instanceof Node&&(($=b.current)!=null&&$.contains(N)||(M=S.current)!=null&&M.contains(N)||k())},u=()=>B();return document.addEventListener("pointerdown",l),window.addEventListener("resize",u),window.addEventListener("scroll",u,!0),()=>{var a;window.cancelAnimationFrame(o),window.clearTimeout(d),document.removeEventListener("pointerdown",l),window.removeEventListener("resize",u),window.removeEventListener("scroll",u,!0),(a=z.current)==null||a.focus(),z.current=null}},[T,L,k,g,B]);const te=o=>{var d,l;(l=(d=t.props).onClick)==null||l.call(d,o),o.defaultPrevented||E(!g)},oe=o=>{var d,l;(l=(d=t.props).onKeyDown)==null||l.call(d,o),!o.defaultPrevented&&(o.key==="ArrowDown"||o.key==="Enter"||o.key===" ")&&(o.preventDefault(),E(!0))},ne=o=>{o.key==="Escape"&&U&&(o.stopPropagation(),k())},ie=()=>{if(!s.isValidElement(t))return null;const o=t;return s.cloneElement(o,{ref:me(o.props.ref,S),"aria-controls":g?j:void 0,"aria-expanded":g,"aria-haspopup":"dialog",onClick:te,onKeyDown:oe})};return e.jsxs("span",{className:V("willa-popover",J),children:[ie(),g&&typeof document<"u"?re.createPortal(e.jsxs("div",{ref:b,id:j,className:V("willa-popover-content",`willa-popover-content--${H}`,P&&`willa-popover-content--${y}`,Q),style:ue(Z),role:"dialog","aria-label":r?void 0:_??"Popover","aria-labelledby":A,"aria-describedby":F,tabIndex:-1,onKeyDown:ne,children:[P?e.jsx("span",{className:"willa-popover-arrow","aria-hidden":"true"}):null,r||c?e.jsxs("header",{className:"willa-popover-header",children:[r?e.jsx("h2",{id:A,className:"willa-popover-title",children:r}):null,c?e.jsx("p",{id:F,className:"willa-popover-description",children:c}):null]}):null,i?e.jsx("div",{className:"willa-popover-body",children:i}):null,m?e.jsx("footer",{className:"willa-popover-footer",children:m}):null]}),document.body):null]})}const pe=n=>{const{triggerRect:t,popoverRect:i,side:r,align:c,offset:m}=n,w=t.left+t.width/2-i.width/2,R=t.top+t.height/2-i.height/2;if(r==="top"||r==="bottom"){const x=r==="top"?t.top-i.height-m:t.bottom+m,h=q(t.left,t.right,i.width,w,c);return{top:x,left:h}}const v=r==="left"?t.left-i.width-m:t.right+m;return{top:q(t.top,t.bottom,i.height,R,c),left:v}},q=(n,t,i,r,c)=>c==="start"?n:c==="end"?t-i:r,ue=n=>({top:n?`${n.top}px`:void 0,left:n?`${n.left}px`:void 0,minWidth:n?`${n.minWidth}px`:void 0,visibility:n?void 0:"hidden"}),G=(n,t,i)=>Math.min(Math.max(n,t),Math.max(t,i)),me=(...n)=>t=>{n.forEach(i=>{if(i){if(typeof i=="function"){i(t);return}i.current=t}})},fe={display:"flex",flexWrap:"wrap",gap:"0.75rem",alignItems:"center"},I={display:"grid",gap:"0.7rem"},D={display:"grid",gap:"0.35rem"},O={color:"var(--willa-text-soft)",fontSize:"0.82rem"},xe=ae({id:"popover",name:"Popover",packageName:"willa/Popover",description:"用于承载可交互内容的轻量浮层，适合设置面板、筛选器和上下文信息。",imports:[{name:"Popover",from:"willa/Popover"},{name:"Button",from:"willa/Button"}],css:"willa/Popover.css",demo:{name:"Popover",component:f,props:{title:"生成设置",description:"调整回复长度和输出语气。",trigger:e.jsx(p,{icon:e.jsx(le,{}),variant:"outline",children:"打开设置"}),children:e.jsxs("div",{style:I,children:[e.jsxs("div",{style:D,children:[e.jsx("span",{style:O,children:"模型"}),e.jsx(C,{defaultValue:"willa-ai-default",size:"sm"})]}),e.jsx(K,{tone:"info",children:"已启用上下文增强"})]})}},code:`
  ...
  `,sections:[{title:"基础浮层",code:`
      ...
      `,content:e.jsx(f,{title:"内容策略",description:"适合放少量说明和一组轻量操作，不适合承载完整流程。",trigger:e.jsx(p,{variant:"outline",children:"查看策略"}),children:e.jsxs("div",{style:I,children:[e.jsx(K,{tone:"info",children:"轻量交互"}),e.jsx("span",{children:"点击外部区域或按 Escape 可以关闭浮层。"})]})})},{title:"表单内容",code:`
        <Popover
          title="快速配置"
