import{d as e,l as t,p as n}from"./aidly.esm-bundler-DaTrP4tr.js";import{t as r}from"./Button-O1aY2iqB.js";import{t as i}from"./Group-C-JhzSsC.js";import{a}from"./index-Do4z6LCr.js";import"./style-B00R6KjV.js";import{t as o}from"./defineDoc-Cid5xIoZ.js";import"./style-D3eq1OTT.js";import{t as s}from"./Avatar-3sKWhOgv.js";import"./style-Bz_qNkMQ.js";import{t as c}from"./List-CKoCxChV.js";import{t as l}from"./CommentInput-Bp_es4M3.js";import"./style-Bd5UDEOd.js";var u=n(e(),1),d=t(),f={display:`grid`,gap:`0.85rem`,width:`min(100%, 52rem)`,margin:`0 auto`},p=[{id:`tom`,label:`Tom`,value:`@tom `,avatarSrc:`https://i.pravatar.cc/64?img=11`,team:`设计`},{id:`lucy`,label:`Lucy`,value:`@lucy `,avatarSrc:`https://i.pravatar.cc/64?img=47`,team:`产品`},{id:`nate`,label:`Nate`,value:`@nate `,avatarSrc:`https://i.pravatar.cc/64?img=12`},{id:`willa`,label:`Willa`,value:`@willa `,avatarSrc:`https://i.pravatar.cc/64?img=50`},{id:`zoe`,label:`Zoe`,value:`@zoe `,avatarSrc:`https://i.pravatar.cc/64?img=33`},{id:`harry`,label:`Harry`,value:`@harry `,avatarSrc:`https://i.pravatar.cc/64?img=69`},{id:`luna`,label:`Luna`,value:`@luna `,avatarSrc:`https://i.pravatar.cc/64?img=63`,role:`文案`},{id:`mona`,label:`Mona`,value:`@mona `,avatarSrc:`https://i.pravatar.cc/64?img=67`},{id:`neo`,label:`Neo`,value:`@neo `,avatarSrc:`https://i.pravatar.cc/64?img=69`},{id:`ava`,label:`Ava`,value:`@ava `,avatarSrc:`https://i.pravatar.cc/64?img=55`},{id:`finn`,label:`Finn`,value:`@finn `,avatarSrc:`https://i.pravatar.cc/64?img=53`},{id:`ivy`,label:`Ivy`,value:`@ivy `,avatarSrc:`https://i.pravatar.cc/64?img=48`},{id:`joel`,label:`Joel`,value:`@joel `,avatarSrc:`https://i.pravatar.cc/64?img=51`},{id:`kim`,label:`Kim`,value:`@kim `,avatarSrc:`https://i.pravatar.cc/64?img=56`},{id:`lara`,label:`Lara`,value:`@lara `,avatarSrc:`https://i.pravatar.cc/64?img=65`},{id:`mike`,label:`Mike`,value:`@mike `,avatarSrc:`https://i.pravatar.cc/64?img=57`},{id:`nina`,label:`Nina`,value:`@nina `,avatarSrc:`https://i.pravatar.cc/64?img=58`,role:`前端`},{id:`owen`,label:`Owen`,value:`@owen `,avatarSrc:`https://i.pravatar.cc/64?img=60`,team:`设计`},{id:`peter`,label:`Peter`,value:`@peter `,avatarSrc:`https://i.pravatar.cc/64?img=59`,team:`产品`},{id:`quinn`,label:`Quinn`,value:`@quinn `,avatarSrc:`https://i.pravatar.cc/64?img=61`,role:`运营`},{id:`rosie`,label:`Rosie`,value:`@rosie `,avatarSrc:`https://i.pravatar.cc/64?img=62`,team:`测试`},{id:`simon`,label:`Simon`,value:`@simon `,avatarSrc:`https://i.pravatar.cc/64?img=64`,team:`后端`},{id:`tracy`,label:`Tracy`,value:`@tracy `,avatarSrc:`https://i.pravatar.cc/64?img=66`,role:`运营`},{id:`ursula`,label:`Ursula`,value:`@ursula `,avatarSrc:`https://i.pravatar.cc/64?img=68`,team:`文案`},{id:`vincent`,label:`Vincent`,value:`@vincent `,avatarSrc:`https://i.pravatar.cc/64?img=70`,role:`研发`},{id:`wren`,label:`Wren`,value:`@wren `,avatarSrc:`https://i.pravatar.cc/64?img=71`,team:`支持`},{id:`yuki`,label:`Yuki`,value:`@yuki `,avatarSrc:`https://i.pravatar.cc/64?img=72`,role:`前端`},{id:`zane`,label:`Zane`,value:`@zane `,avatarSrc:`https://i.pravatar.cc/64?img=73`,team:`客服`}],m={display:`grid`,gridTemplateColumns:`auto minmax(0, 1fr)`,alignItems:`center`,gap:`0.58rem`,width:`100%`,minHeight:`2.4rem`,padding:`0.12rem 0.42rem`,border:`0`,borderRadius:`0.58rem`,background:`transparent`,color:`inherit`,textAlign:`left`,font:`inherit`,cursor:`pointer`,transition:`background-color 160ms ease`},h={display:`grid`,minWidth:0,gap:`0.12rem`},g={overflow:`hidden`,color:`var(--willa-comment-input-text)`,fontSize:`0.87rem`,fontWeight:650,lineHeight:1.35,textOverflow:`ellipsis`,whiteSpace:`nowrap`},_={overflow:`hidden`,color:`var(--willa-comment-input-muted)`,fontSize:`0.76rem`,lineHeight:1.35,textOverflow:`ellipsis`,whiteSpace:`nowrap`},v=o({id:`comment-input`,name:`CommentInput`,category:`content`,packageName:`willa/CommentInput`,description:`用于评论、批注和反馈场景的轻量输入组件。`,imports:[{name:`CommentInput`,from:`willa/CommentInput`}],css:`willa/CommentInput.css`,demo:{name:`CommentInputPreview`,component:()=>{let[e,t]=(0,u.useState)(``),[n,r]=(0,u.useState)(``);return(0,d.jsxs)(`div`,{style:f,children:[(0,d.jsx)(l,{value:e,onValueChange:t,maxLength:180,onSubmit:(e,t)=>{r(e),t.clear()}}),n?(0,d.jsxs)(a,{tone:`success`,children:[`已发布：`,n]}):null]})}},code:`
  ...
  `,sections:[{title:`附加操作`,code:`
        ...
        />;
      `,content:(0,d.jsx)(`div`,{style:f,children:(0,d.jsx)(l,{placeholder:`写下批注意见...`,actions:(0,d.jsxs)(i,{gap:`xs`,children:[(0,d.jsx)(r,{size:`sm`,variant:`ghost`,children:`引用段落`}),(0,d.jsx)(r,{size:`sm`,variant:`ghost`,children:`添加截图`})]}),footer:`支持 ⌘ Enter 快捷发布`})})},{title:`提及、表情和引用`,code:`
        ...
        />;
      `,content:(0,d.jsx)(()=>{let[e,t]=(0,u.useState)(``),[n,i]=(0,u.useState)(``);return(0,d.jsx)(`div`,{style:f,children:(0,d.jsx)(l,{placeholder:`回复这条评论...`,quote:{author:`产品设计`,content:`这个输入区需要支持评论扩展能力。`},onMentionClick:()=>t(`打开成员选择面板`),mentionListProps:{virtualScroll:!0,onItemClick:e=>{let t=p.find(t=>(t.id??t.value)===e.id);t&&i(`已插入 ${String(t.label??t.value)}`)}},actions:(0,d.jsx)(r,{size:`sm`,variant:`ghost`,onClick:()=>t(`打开业务自己的表情包面板`),children:`表情`}),mentionOptions:p,mentionMaxSuggestions:30,onMentionQuery:e=>{if(!e){i(``);return}i(`正在匹配 ${e.trigger} 开头的候选项`)},footer:n||e||`输入 @ 可弹出候选人，或点击 @ 图标触发外部面板`})})},{})},{title:`renderMentionOptions 自定义提及弹层`,code:`
        ...
        />;
      `,content:(0,d.jsx)(()=>{let[e,t]=(0,u.useState)(``);return(0,d.jsx)(`div`,{style:f,children:(0,d.jsx)(l,{placeholder:`输入 @ 可以展示自定义候选项`,quote:{author:`产品开发`,content:`这个列表只负责演示 renderMentionOptions 自定义渲染。`},onMentionClick:()=>t(`打开业务自己的成员弹窗`),renderMentionOptions:(e,t,n)=>{let r=new Map(t.map(e=>[e.id??e.value,e]));return(0,d.jsx)(c,{size:`sm`,variant:`plain`,split:!1,itemLayout:`horizontal`,maxHeight:`13.8rem`,renderItem:t=>{let i=r.get(t.id);return i?(0,d.jsxs)(`button`,{type:`button`,style:m,onMouseDown:e=>e.preventDefault(),onClick:()=>n(i),children:[i.avatarSrc?(0,d.jsx)(s,{size:`sm`,name:String(i.label??i.value),src:i.avatarSrc}):null,(0,d.jsxs)(`span`,{style:h,children:[(0,d.jsx)(`span`,{style:g,children:i.label}),(0,d.jsx)(`span`,{style:_,children:String(i.role??i.team??`匹配: ${e.query||`全部`}`)})]})]}):null},items:t.map(t=>{let n=t.id??t.value,r=String(t.label??t.value);return{id:n,title:r,description:e.query?`${r} 包含 ${e.query}`:r}})})},mentionOptions:Array.from(p),mentionMaxSuggestions:30,onMentionQuery:e=>{if(!e){t(``);return}t(`命中 ${e.trigger}，查询关键字：${e.query||`未输入`}`)},actions:(0,d.jsx)(r,{size:`sm`,variant:`ghost`,onClick:()=>t(`自定义成员选择弹层已触发`),children:`表情`}),footer:e||`renderMentionOptions：支持全量接管弹层内容和交互`})})},{})},{title:`提交状态`,code:`
