import{aX as t,a4 as i,a8 as n}from"./index-DpRBBwEt.js";import{d as a}from"./defineDoc-B4d7ymBJ.js";const l=[{title:"产品反馈",height:"7rem"},{title:"发布记录",height:"10rem"},{title:"设计笔记",height:"8rem"},{title:"用户访谈",height:"12rem"},{title:"数据摘要",height:"7.5rem"},{title:"文档片段",height:"9rem"}],o=a({id:"masonry",name:"Masonry",category:"layout",packageName:"willa/Masonry",description:"用于高度不一致的卡片流、图片流和内容集合的瀑布流布局。",imports:[{name:"Masonry",from:"willa/Masonry"},{name:"Panel",from:"willa/Panel"}],css:"willa/Masonry.css",demo:{name:"Masonry",component:i,props:{columns:3,gap:"md",width:"min(100%, 42rem)"},children:l.slice(0,3).map(e=>({name:"Panel",component:n,props:{title:e.title,style:{minHeight:e.height}},children:"内容高度可以不同。"}))},code:`
