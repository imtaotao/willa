import{al as t}from"./index-CQ5SwHlJ.js";import{B as o}from"./index-3hwf-lCP.js";import{t as s,c as a}from"./index-B-YA_tWr.js";/* empty css              */import{d as l}from"./defineDoc-BYfb4gho.js";const r={display:"flex",flexWrap:"wrap",gap:"0.65rem",alignItems:"center"};let i,n,e;const c=()=>(i??(i=a({placement:"top",duration:1600,maxToasts:2})),i),p=()=>(n??(n=a({placement:"bottom"})),n),m=()=>(e??(e=a({placement:"bottom-right"})),e),u=()=>t.jsxs("div",{style:r,children:[t.jsx(o,{variant:"solid",onClick:()=>{s.success("发布成功",{description:"内容已经进入公开队列。"})},children:"成功提示"}),t.jsx(o,{variant:"soft",onClick:()=>{c().info("顶部配置",{description:"由 createToast 创建的实例触发。"})},children:"配置实例"})]}),T=()=>t.jsx(o,{variant:"soft",onClick:()=>{s.info("草稿已归档",{action:{label:"撤销",onClick:()=>s.success("已撤销归档")}})},children:"显示操作"}),d=()=>t.jsx(o,{variant:"outline",onClick:()=>{s.warning("同步仍在进行",{description:"这个提示不会自动关闭。",duration:!1})},children:"常驻提示"}),f=()=>t.jsxs("div",{style:r,children:[t.jsx(o,{variant:"soft",onClick:()=>{c().info("顶部居中",{description:"这个提示会更快关闭。"})},children:"顶部配置"}),t.jsx(o,{variant:"outline",onClick:()=>{m().success("右下角提示")},children:"右下角配置"})]}),x=l({id:"toast",name:"Toast",packageName:"willa/Toast",description:"用于操作反馈、状态变化和轻量通知的浮层提示。",imports:[{name:"toast",from:"willa/Toast"},{name:"createToast",from:"willa/Toast"}],css:"willa/Toast.css",demo:{name:"ToastPreview",component:u},code:`
