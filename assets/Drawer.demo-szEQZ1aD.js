import{b1 as o,aZ as e,h as t,W as l,ak as s,ay as d,a0 as i,S as c}from"./index-D7YaWUUW.js";import{D as r}from"./index-D-1jCObG.js";import{F as a}from"./index-DpvyEbOI.js";/* empty css              *//* empty css              *//* empty css              */import{d as p}from"./defineDoc-BHlsbD-w.js";import"./dom-DvRKQOia.js";const n=()=>e.jsxs(d,{gap:"md",children:[e.jsx(a,{label:"任务名称",description:"用于侧边详情和编辑场景。",children:e.jsx(i,{defaultValue:"组件体验梳理"})}),e.jsx(a,{label:"负责人",children:e.jsx(i,{defaultValue:"Willa Team"})})]}),D=p({id:"drawer",name:"Drawer",category:"content",packageName:"willa/Drawer",description:"用于侧边详情、配置编辑和移动端面板的抽屉组件。",imports:[{name:"Drawer",from:"willa/Drawer"}],css:"willa/Drawer.css",demo:{name:"Drawer",component:r,props:{title:"编辑任务",description:"抽屉适合保留当前页面上下文的侧边编辑。",trigger:e.jsx(t,{icon:e.jsx(c,{}),children:"打开抽屉"}),confirmText:"保存",children:e.jsx(n,{})}},code:o(`
