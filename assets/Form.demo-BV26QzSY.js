import{an as e,ap as u}from"./index-B_h_YYgH.js";import{B as t}from"./index-D_CHJp_x.js";import{C as s}from"./index-BVzMWZ6u.js";import{F as r,a as i}from"./index-l6ZJPSPa.js";import{F as l}from"./index-Bm2EUj9E.js";import{F as o}from"./index-Bl0p6rBz.js";import{F as p}from"./index-CDssIbkt.js";import{I as a}from"./index-BE7ArQSX.js";import{S as F}from"./index-B9b5vL8Y.js";/* empty css              *//* empty css              */import{d as b}from"./defineDoc-Bzp7FD3_.js";import"./index-BBXrqVxy.js";import"./useSelectablePanel-D3QqV__f.js";import"./useFloatingPanel-LS65Lsu1.js";const f=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],h=()=>{const[n,m]=u.useState(!1),d=c=>{c.preventDefault(),m(!0),window.setTimeout(()=>m(!1),900)};return e.jsx(r,{onSubmit:d,actions:e.jsxs(l,{children:[e.jsx(t,{variant:"ghost",children:"取消"}),e.jsx(t,{type:"submit",loading:n,children:"保存"})]}),children:e.jsxs(i,{title:"创建 AI 配置",description:"用于产品后台、模型配置和轻量提交场景。",children:[e.jsx(o,{label:"配置名称",required:!0,children:e.jsx(a,{name:"name",defaultValue:"内容生成助手",width:"100%"})}),e.jsx(o,{label:"默认模式",children:e.jsx(F,{name:"mode",defaultValue:"balanced",options:f,width:"100%"})}),e.jsx(s,{name:"search",defaultChecked:!0,label:"允许联网检索",description:"回答前可以读取公开资料。"})]})})},q=b({id:"form",name:"Form",category:"form",packageName:"willa/Form",description:"统一表单语义、表单级错误、提交状态和底部操作区。",imports:[{name:"Form",from:"willa/Form"}],css:"willa/Form.css",demo:{name:"FormPreview",component:h},code:`
  ...
  `,sections:[{title:"表单级错误",code:`
      ...
      `,content:e.jsx(r,{error:"保存失败，请检查配置名称和默认模式。",actions:e.jsxs(l,{children:[e.jsx(t,{variant:"outline",children:"返回"}),e.jsx(t,{type:"submit",children:"重新提交"})]}),children:e.jsx(i,{title:"提交配置",children:e.jsx(o,{label:"配置名称",error:"配置名称不能为空。",children:e.jsx(a,{invalid:!0,defaultValue:"",width:"100%"})})})})},{title:"禁用状态",code:`
        <Form
          disabled
          actions={
            <FormActions>
