import{aY as e}from"./index-8_Ro2kKr.js";import{S as t}from"./index-DxxP2huq.js";import{d as i}from"./defineDoc-C10JAUTq.js";import"./index-DhO7tNkz.js";import"./useSelectablePanel-YeMSjTMm.js";import"./floatingPanelParts-BuGJxEh8.js";import"./useFloatingPanel-B2WD2EjA.js";const a={display:"grid",gap:"0.9rem",maxWidth:"42rem"},l=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],r=i({id:"select",name:"Select",category:"form",packageName:"willa/Select",description:"用于单选下拉，适合表单、筛选和配置场景。",imports:[{name:"Select",from:"willa/Select"}],css:"willa/Select.css",demo:{name:"Select",component:t,props:{options:l,defaultValue:"balanced",width:"100%"}},code:`
