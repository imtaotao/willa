import{at as e,M as a,a1 as t}from"./index-JcQunHAD.js";import{B as r}from"./index-DVCOgsVj.js";import{d as c}from"./defineDoc-C6LiP5te.js";const o=[{label:"首页",href:"#/"},{label:"基础组件",href:"#/button"},{label:"Breadcrumb"}],l=[{label:"Willa",href:"#/",icon:e.jsx(a,{})},{label:"文档",href:"#/mdx",icon:e.jsx(t,{})},{label:"导航层级"}],m={width:"min(100%, 44rem)",marginInline:"auto"},n=c({id:"breadcrumb",name:"Breadcrumb",packageName:"willa/Breadcrumb",description:"用于展示页面层级、返回路径和当前位置的导航组件。",imports:[{name:"Breadcrumb",from:"willa/Breadcrumb"}],css:"willa/Breadcrumb.css",demo:{name:"Breadcrumb",component:r,props:{style:m,items:o}},code:`
