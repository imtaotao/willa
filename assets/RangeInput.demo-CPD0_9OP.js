import{aw as p,au as e,ak as h}from"./index-VEztyUnl.js";import{d as b}from"./defineDoc-fv-G_8j9.js";const t=p.forwardRef((r,a)=>{const{width:n,height:i,color:l,thumbColor:o,trackColor:s,className:c,style:d,...m}=r,g=y({color:l,height:i,thumbColor:o,trackColor:s,width:n,style:d});return e.jsx("input",{...m,ref:a,type:"range",className:h("willa-range-input",c),style:g})});t.displayName="RangeInput";const y=r=>{const{color:a,height:n,thumbColor:i,trackColor:l,width:o,style:s}=r;return{...s,...o===void 0?void 0:{width:o},...a?{"--willa-range-input-custom-color":a}:void 0,...n?{"--willa-range-input-custom-height":n}:void 0,...i?{"--willa-range-input-custom-thumb":i}:void 0,...l?{"--willa-range-input-custom-track":l}:void 0}},u={display:"grid",gap:"0.85rem",width:"min(100%, 28rem)"},f=()=>{const[r,a]=p.useState(60);return e.jsxs("div",{style:u,children:[e.jsx(t,{min:0,max:100,step:1,value:r,width:"18rem",height:"0.5rem",color:"#3b82f6",trackColor:"rgba(59, 130, 246, 0.18)","aria-label":"生成强度",onChange:n=>a(Number(n.currentTarget.value))}),e.jsx(t,{min:0,max:1,step:.1,defaultValue:.7,color:"#14b8a6",thumbColor:"#ecfeff",trackColor:"rgba(20, 184, 166, 0.18)","aria-label":"温度"})]})},I=b({id:"range-input",name:"RangeInput",category:"form",packageName:"willa/RangeInput",description:"用于模型参数、音视频进度和数值配置的范围输入。",imports:[{name:"RangeInput",from:"willa/RangeInput"}],css:"willa/RangeInput.css",demo:{name:"RangeInputPreview",component:f},code:`
