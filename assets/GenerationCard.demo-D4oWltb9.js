import{a$ as e,aM as k,l as A,F as D,a4 as M,a6 as h,Y as l,z as p,D as m,h as t,am as T,af as V,m as P}from"./index-D5aNn3Bg.js";import{u as L,C as W}from"./cardCollapse-DPP5Fm6x.js";/* empty css              *//* empty css              *//* empty css              */import{d as $}from"./defineDoc-BtQ_Wzfn.js";function a({title:i,status:n="pending",description:u,meta:g,icon:y,metrics:r,actions:o,children:d,collapsible:w=!1,collapsed:f,defaultCollapsed:G=!1,summary:b,onCollapsedChange:I,className:N,...B}){const x=r!==void 0&&r.length>0,{canCollapse:j,isCollapsed:c,resolvedSummary:z,toggleCollapsed:R}=L({collapsible:w,collapsed:f,defaultCollapsed:G,hasContent:!!d,summary:b,defaultSummary:"查看生成结果",onCollapsedChange:I});return e.jsxs("section",{...B,className:k("willa-generation-card",`willa-generation-card--${n}`,j&&"willa-generation-card--collapsible",c&&"willa-generation-card--collapsed",N),"data-status":n,children:[e.jsxs("div",{className:"willa-generation-card-header",children:[e.jsx("span",{className:"willa-generation-card-mark","aria-hidden":"true",children:y??e.jsx(q,{status:n})}),e.jsxs("div",{className:"willa-generation-card-heading",children:[e.jsxs("div",{className:"willa-generation-card-title-row",children:[e.jsx("h3",{className:"willa-generation-card-title",children:i}),e.jsx("span",{className:"willa-generation-card-status",children:E[n]})]}),u?e.jsx("div",{className:"willa-generation-card-description",children:u}):null]}),g?e.jsx("div",{className:"willa-generation-card-meta",children:g}):null]}),j?e.jsx(W,{className:"willa-generation-card-toggle",textClassName:"willa-generation-card-toggle-text",iconClassName:"willa-generation-card-toggle-icon",summary:z,expanded:!c,onClick:R}):null,d&&!c?e.jsx("div",{className:"willa-generation-card-content",children:d}):null,x||o?e.jsxs("div",{className:"willa-generation-card-footer",children:[x?e.jsx("dl",{className:"willa-generation-card-metrics",children:r.map((C,S)=>e.jsxs("div",{className:"willa-generation-card-metric",children:[e.jsx("dt",{children:C.label}),e.jsx("dd",{children:C.value})]},S))}):null,o?e.jsx("div",{className:"willa-generation-card-actions",children:o}):null]}):null]})}const q=({status:i})=>i==="completed"?e.jsx(A,{}):i==="failed"?e.jsx(D,{}):i==="generating"?e.jsx(M,{}):e.jsx(h,{}),E={pending:"等待生成",generating:"生成中",completed:"已生成",failed:"生成失败"};a.displayName="GenerationCard";const v={display:"grid",gap:"0.82rem",width:"min(100%, 58rem)"},s={margin:0},F=()=>e.jsx("div",{style:v,children:e.jsx(a,{collapsible:!0,defaultCollapsed:!0,title:"产品反馈摘要",status:"completed",description:"从 128 条用户反馈中生成可直接进入周报的摘要。",meta:"刚刚",summary:"隐藏生成正文，只保留状态、指标和操作。",metrics:[{label:"来源",value:"128 条"},{label:"置信",value:"高"},{label:"耗时",value:"4.2s"}],actions:e.jsxs(l,{gap:"xs",wrap:!0,children:[e.jsx(p,{icon:e.jsx(m,{}),size:"sm",text:"本周反馈集中在导出稳定性、批量处理体验和主题配置理解成本。建议优先处理导出失败兜底，其次优化批量任务进度提示。",children:"复制"}),e.jsx(t,{size:"sm",variant:"solid",trailingIcon:e.jsx(P,{}),children:"采纳"})]}),children:e.jsx("p",{style:s,children:"本周反馈集中在导出稳定性、批量处理体验和主题配置理解成本。建议优先处理导出失败兜底，其次优化批量任务进度提示。"})})}),Q=$({id:"generation-card",name:"GenerationCard",category:"ai",packageName:"willa/GenerationCard",description:"用于展示 AI 生成任务的状态、结果摘要、指标和后续操作。",imports:[{name:"GenerationCard",from:"willa/GenerationCard"}],css:"willa/GenerationCard.css",demo:{name:"GenerationCardPreview",component:F},code:`
