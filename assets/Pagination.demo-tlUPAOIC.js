import{aj as v,ah as a,s as z,i as R,j as $,t as D,a9 as N,B as F}from"./index-BOgtpDIo.js";import{d as A}from"./defineDoc-Rn3qdaND.js";function c(e){const{page:t,defaultPage:n=1,pageCount:i,onPageChange:l,siblingCount:o=1,boundaryCount:h=1,size:b="md",showFirstLast:j=!0,showPrevNext:w=!0,getPageHref:u,previousLabel:f="上一页",nextLabel:C="下一页",ariaLabel:M="分页导航",disabled:d=!1,className:L,getEllipsisPage:E}=e,r=Math.max(0,Math.floor(i)),[S,k]=v.useState(()=>p(n,r)),s=p(t??S,r),H=t!==void 0;if(r<=0)return null;const P=g=>{const x=p(g,r);x===s||d||(H||k(x),l==null||l(x))},I=U({page:s,pageCount:r,siblingCount:o,boundaryCount:h});return a.jsx("nav",{className:N("willa-pagination",`willa-pagination--${b}`,d&&"willa-pagination--disabled",L),"aria-label":M,children:a.jsxs("ol",{className:"willa-pagination-list",children:[j?a.jsx("li",{children:a.jsx(m,{page:1,currentPage:s,disabled:d||s===1,getPageHref:u,label:"第一页",onPageChange:P,children:a.jsx(z,{})})}):null,w?a.jsx("li",{children:a.jsxs(m,{page:s-1,currentPage:s,disabled:d||s===1,getPageHref:u,label:typeof f=="string"?f:"上一页",onPageChange:P,children:[a.jsx(R,{}),a.jsx("span",{className:"willa-pagination-control-label",children:f})]})}):null,I.map(g=>a.jsx("li",{children:typeof g=="number"?a.jsx(m,{page:g,currentPage:s,disabled:d,getPageHref:u,label:`第 ${g} 页`,onPageChange:P,children:g}):a.jsx(B,{item:g,currentPage:s,pageCount:r,disabled:d,getPageHref:u,getEllipsisPage:E,onPageChange:P})},typeof g=="number"?g:g.key)),w?a.jsx("li",{children:a.jsxs(m,{page:s+1,currentPage:s,disabled:d||s===r,getPageHref:u,label:typeof C=="string"?C:"下一页",onPageChange:P,children:[a.jsx("span",{className:"willa-pagination-control-label",children:C}),a.jsx($,{})]})}):null,j?a.jsx("li",{children:a.jsx(m,{page:r,currentPage:s,disabled:d||s===r,getPageHref:u,label:"最后一页",onPageChange:P,children:a.jsx(D,{})})}):null]})})}const B=e=>{var i;const t={direction:e.item.direction,startPage:e.item.startPage,endPage:e.item.endPage,currentPage:e.currentPage,pageCount:e.pageCount},n=p(((i=e.getEllipsisPage)==null?void 0:i.call(e,t))??Math.round((e.item.startPage+e.item.endPage)/2),e.pageCount);return e.item.startPage>e.item.endPage?a.jsx("span",{className:"willa-pagination-ellipsis","aria-hidden":"true",children:"..."}):a.jsx(m,{page:n,currentPage:e.currentPage,disabled:e.disabled,getPageHref:e.getPageHref,label:`跳转到第 ${n} 页`,onPageChange:e.onPageChange,className:"willa-pagination-ellipsis",children:a.jsx("span",{"aria-hidden":"true",children:"..."})})},m=e=>{const t=e.page===e.currentPage,n=N("willa-pagination-control",e.className,t&&"willa-pagination-control--current"),i=l=>{if(e.disabled||t){l.preventDefault();return}e.onPageChange(e.page)};return e.getPageHref&&!e.disabled&&!t?a.jsx("a",{className:n,href:e.getPageHref(e.page),"aria-label":e.label,onClick:i,children:e.children}):a.jsx("button",{className:n,type:"button","aria-current":t?"page":void 0,"aria-label":e.label,disabled:e.disabled,onClick:i,children:e.children})},U=e=>{const t=Math.max(0,Math.floor(e.siblingCount)),n=Math.max(0,Math.floor(e.boundaryCount)),i=Math.max(e.page-t,n+1),l=Math.min(e.page+t,e.pageCount-n),o=[],h=y(1,Math.min(n,e.pageCount)),b=y(Math.max(e.pageCount-n+1,n+1),e.pageCount);return o.push(...h),i>n+2?o.push({type:"ellipsis",key:"ellipsis-start",direction:"start",startPage:n+1,endPage:i-1}):n+1<i&&o.push(n+1),o.push(...y(i,l)),l<e.pageCount-n-1?o.push({type:"ellipsis",key:"ellipsis-end",direction:"end",startPage:l+1,endPage:e.pageCount-n}):l+1<e.pageCount-n+1&&o.push(l+1),o.push(...b),_(o)},_=e=>{const t=new Set;return e.filter(n=>typeof n!="number"?!0:t.has(n)?!1:(t.add(n),!0))},y=(e,t)=>t<e?[]:Array.from({length:t-e+1},(n,i)=>e+i),p=(e,t)=>t<=0?1:Math.min(Math.max(1,Math.floor(e)),t),q={display:"grid",gap:"0.75rem",justifyItems:"start"},W={display:"flex",flexWrap:"wrap",gap:"0.75rem",alignItems:"center"},G=()=>{const[e,t]=v.useState(4);return a.jsxs("div",{style:q,children:[a.jsxs(F,{tone:"info",children:["当前页：",e]}),a.jsx(c,{page:e,pageCount:12,onPageChange:t})]})},O=A({id:"pagination",name:"Pagination",packageName:"willa/Pagination",description:"用于文章列表、评论列表和搜索结果等分页内容的页码导航。",imports:[{name:"Pagination",from:"willa/Pagination"}],css:"willa/Pagination.css",demo:{name:"Pagination",component:c,props:{defaultPage:6,pageCount:20}},code:`
