import{ah as t,J as i,_ as n,u as e,g as r,q as a}from"./index-Bdj8Q3L_.js";import{B as o}from"./index-mSh11lIp.js";import{F as s}from"./index-C_Nbs1IV.js";/* empty css              */import{d as c}from"./defineDoc-ClbrtoXF.js";import"./heading-D9kAmVXU.js";const m={display:"grid",gap:"1rem",maxWidth:"34rem"},u=c({id:"form-actions",name:"FormActions",category:"form",packageName:"willa/FormActions",description:"用于表单底部提交、取消和辅助操作的布局组件。",imports:[{name:"FormActions",from:"willa/FormActions"}],css:"willa/FormActions.css",demo:{name:"FormActions",component:s,props:{gap:"md"},children:[{name:"Button",component:o,props:{variant:"ghost"},children:"取消"},{name:"Button",component:o,props:{type:"submit"},children:"保存"}]},code:`
