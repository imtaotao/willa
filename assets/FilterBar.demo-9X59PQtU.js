import{aL as e,g as h,ae as t,B as a,aN as s}from"./index-FxrQYZ7S.js";import{F as r}from"./index-DUcN7gmo.js";import{S as u}from"./index-C-yx_5wY.js";/* empty css              */import{d as B}from"./defineDoc-7sLqiM9g.js";import"./index-D50_OL6K.js";import"./useSelectablePanel-BSITUR6j.js";import"./useFloatingPanel-D0zXiYxj.js";const i={display:"grid",gap:"0.85rem",width:"min(100%, 70rem)",marginInline:"auto"},y=[{value:"all",label:"全部状态"},{value:"open",label:"进行中"},{value:"done",label:"已完成"}],S=[{value:"all",label:"全部负责人"},{value:"design",label:"设计组"},{value:"engineering",label:"工程组"}],g=()=>{const[o,n]=s.useState(""),[c,m]=s.useState("all"),[d,p]=s.useState("all"),l=!!(o||c!=="all"||d!=="all"),w=[{id:"status",width:"10rem",control:e.jsx(u,{value:c,options:y,width:"100%",onValueChange:m})},{id:"owner",width:"11rem",control:e.jsx(u,{value:d,options:S,width:"100%",onValueChange:p})}];return e.jsxs("div",{style:i,children:[e.jsx(r,{search:e.jsx(t,{value:o,onValueChange:n,placeholder:"搜索任务、文档或负责人",width:"100%"}),items:w,actions:e.jsx(h,{variant:"ghost",size:"sm",onClick:()=>{n(""),m("all"),p("all")},children:"重置"}),summary:l?e.jsx("span",{children:"已应用筛选条件，列表将按当前条件刷新。"}):e.jsx("span",{children:"未应用筛选条件。"})}),e.jsx(a,{tone:l?"info":"neutral",children:l?"筛选中":"全部结果"})]})},C=B({id:"filter-bar",name:"FilterBar",category:"form",packageName:"willa/FilterBar",description:"用于列表、表格和搜索页顶部的搜索、筛选和操作区域。",imports:[{name:"FilterBar",from:"willa/FilterBar"}],css:"willa/FilterBar.css",demo:{name:"FilterBar",component:r,props:{search:e.jsx(t,{placeholder:"搜索任务",width:"100%"}),summary:"未应用筛选条件。"}},code:`
  ...
  `,sections:[{title:"完整筛选",code:`
      ...
      `,content:e.jsx(g,{})},{title:"紧凑布局",code:`
        <FilterBar
          density="compact"
