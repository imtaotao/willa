import{b3 as e,D as a,am as o,m as t}from"./index-CX7dlnN9.js";import{C as n}from"./index-CviDfEOg.js";import{M as s}from"./index-BocAyxzO.js";import{d as c}from"./defineDoc-DzpR41Bj.js";import"./index-DiGq191G.js";const r="https://github.com/openai.png",l={display:"grid",gap:"1rem",width:"min(100%, 58rem)",border:"1px solid var(--willa-line)",borderRadius:"0.9rem",background:"var(--willa-panel-bg)",padding:"1rem"},p=()=>{const i=[{id:"copy",label:"复制",icon:e.jsx(a,{}),copyText:`可以先按影响面、紧急程度和实现成本拆分。
