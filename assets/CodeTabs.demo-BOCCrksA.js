import{ah as a,o as t,ak as e}from"./index-Bdj8Q3L_.js";import{d as s}from"./defineDoc-ClbrtoXF.js";const o=[{label:"pnpm",language:"bash",code:"pnpm add willa"},{label:"npm",language:"bash",code:"npm install willa"},{label:"yarn",language:"bash",code:"yarn add willa"}],n=[{label:"ShareButton.tsx",language:"tsx",code:e(`
    ...
    `)}],m=s({id:"code-tabs",name:"CodeTabs",packageName:"willa/CodeTabs",description:"用于在一组相关代码片段之间切换，例如安装命令、多框架示例和配置片段。",imports:[{name:"CodeTabs",from:"willa/CodeTabs"}],css:"willa/CodeTabs.css",demo:{name:"CodeTabs",component:t,props:{items:n,showLineNumbers:!0}},code:`
