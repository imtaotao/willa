import{aL as t,aw as M,a1 as n}from"./index-CnzNztlw.js";import{d as w}from"./defineDoc-DoH8FXKM.js";function m(e){const{as:i="div",columns:o,columnWidth:h,gap:l="md",width:c,className:d,children:p,style:y,...g}=e,u={columnCount:o,columnWidth:h,columnGap:a(l),"--willa-masonry-item-gap":a(l),width:c,...y};return t.jsx(i,{...g,style:u,className:M("willa-masonry",d),children:p})}const r={none:"0",xs:"0.35rem",sm:"0.55rem",md:"0.75rem",lg:"1rem",xl:"1.25rem"},P=e=>e in r,a=e=>P(e)?r[e]:e,s=[{title:"产品反馈",height:"7rem"},{title:"发布记录",height:"10rem"},{title:"设计笔记",height:"8rem"},{title:"用户访谈",height:"12rem"},{title:"数据摘要",height:"7.5rem"},{title:"文档片段",height:"9rem"}],H=w({id:"masonry",name:"Masonry",category:"layout",packageName:"willa/Masonry",description:"用于高度不一致的卡片流、图片流和内容集合的瀑布流布局。",imports:[{name:"Masonry",from:"willa/Masonry"},{name:"Panel",from:"willa/Panel"}],css:"willa/Masonry.css",demo:{name:"Masonry",component:m,props:{columns:3,gap:"md",width:"min(100%, 42rem)"},children:s.slice(0,3).map(e=>({name:"Panel",component:n,props:{title:e.title,style:{minHeight:e.height}},children:"内容高度可以不同。"}))},code:`
