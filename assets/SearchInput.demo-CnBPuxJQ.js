import{b3 as e,ap as t,b5 as i,B as d}from"./index-CX7dlnN9.js";import{d as o}from"./defineDoc-DzpR41Bj.js";const n={display:"grid",gap:"0.85rem",maxWidth:"44rem",marginInline:"auto"},c={display:"flex",flexWrap:"wrap",alignItems:"center",gap:"0.75rem",maxWidth:"44rem",marginInline:"auto"},p=()=>{const[l,s]=i.useState("组件文档"),[a,r]=i.useState("组件文档");return e.jsxs("div",{style:n,children:[e.jsx(t,{value:l,onValueChange:s,onSearch:r,onClear:()=>r(""),placeholder:"搜索组件、文档或示例",width:"100%"}),e.jsx(d,{tone:a?"info":"neutral",children:a?`已搜索：${a}`:"暂无搜索内容"})]})},h=o({id:"search-input",name:"SearchInput",category:"form",packageName:"willa/SearchInput",description:"带搜索图标、清除按钮和回车搜索语义的单行输入框。",imports:[{name:"SearchInput",from:"willa/SearchInput"}],css:"willa/SearchInput.css",demo:{name:"SearchInput",component:t,props:{placeholder:"搜索组件、文档或示例",width:"100%"}},code:`
  ...
  `,sections:[{title:"基础搜索",code:`
      ...
      `,content:e.jsxs("div",{style:n,children:[e.jsx(t,{placeholder:"搜索项目",width:"100%"}),e.jsx(t,{size:"sm",placeholder:"紧凑搜索",width:"16rem"}),e.jsx(t,{size:"lg",placeholder:"大尺寸搜索",width:"100%"})]})},{title:"受控和清除",code:`
