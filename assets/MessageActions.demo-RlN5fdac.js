import{aO as e,v as i,ad as n,l as t,aQ as r}from"./index-D31jhNsW.js";import{C as l}from"./index-D7vWDweo.js";import{M as a}from"./index-CASnZZgA.js";import{d}from"./defineDoc-YiaYi00G.js";import"./index-C8ICS-Xs.js";const p="https://github.com/openai.png",m={display:"grid",gap:"1rem",width:"min(100%, 58rem)",border:"1px solid var(--willa-line)",borderRadius:"0.9rem",background:"var(--willa-panel-bg)",padding:"1rem"},g=()=>{const[s,o]=r.useState(!1),c=[{id:"copy",label:s?"已复制":"复制",icon:s?e.jsx(t,{}):e.jsx(i,{}),active:s,onClick:()=>{o(!0),window.setTimeout(()=>o(!1),600)}},{id:"regenerate",label:"重试",icon:e.jsx(n,{})},{id:"accept",label:"采纳",icon:e.jsx(t,{}),tone:"positive"}];return e.jsx("div",{style:m,children:e.jsxs(l,{role:"assistant",name:"Willa AI",avatarSrc:p,meta:"已生成",actions:e.jsx(a,{items:c}),children:[e.jsx("p",{children:"可以先按影响面、紧急程度和实现成本拆分。"}),e.jsx("p",{children:"优先处理阻塞登录的问题，其次是批量导出，最后再看主题配置。"})]})})},v=d({id:"message-actions",name:"MessageActions",category:"ai",packageName:"willa/MessageActions",description:"用于 AI 消息上的复制、重试、采纳和反馈等轻量操作。",imports:[{name:"MessageActions",from:"willa/MessageActions"}],css:"willa/MessageActions.css",demo:{name:"MessageActionsPreview",component:g},code:`
