import{an as e,a8 as t,a7 as w,ap as b,B as n}from"./index-D1DxGs20.js";import{B as r}from"./index-Bruz1WA0.js";/* empty css              */import{F as v}from"./index-E2cm_YBu.js";import{G as g}from"./index-Dn_wRn04.js";import{S as T}from"./index-BXvdO65T.js";import{S as k}from"./index-Bv-QDIcf.js";import{d as h}from"./defineDoc-BreWiU-W.js";import"./index-BFd0wmC_.js";import"./index-AKEzAYwR.js";import"./useSelectablePanel-D1yoMN0d.js";import"./useFloatingPanel-948YkXGY.js";const s=[{key:"prompt-input",cells:[{key:"name",label:"组件",value:"PromptInput",width:"12rem",sortable:!0},{key:"owner",label:"归属",value:"AI"},{key:"status",label:"状态",value:"stable",render:e.jsx(n,{tone:"success",children:"稳定"})},{key:"coverage",label:"覆盖能力",value:"输入、提交、禁用、自动高度和辅助信息"}],expanded:"PromptInput 适合作为 AI 对话、智能搜索和生成任务的输入入口。",actions:e.jsx(r,{size:"sm",variant:"ghost",children:"查看"})},{key:"upload",tone:"warning",cells:[{key:"name",label:"组件",value:"Upload",width:"12rem",sortable:!0},{key:"owner",label:"归属",value:"Form"},{key:"status",label:"状态",value:"wip",render:e.jsx(n,{tone:"warning",children:"完善中"})},{key:"coverage",label:"覆盖能力",value:"拖拽、预览、上传进度和下载回退"}],expanded:"Upload 可以接入用户自己的上传逻辑，并展示上传进度。",actions:e.jsx(r,{size:"sm",variant:"ghost",children:"查看"})},{key:"code-block",selected:!0,cells:[{key:"name",label:"组件",value:"CodeBlock",width:"12rem",sortable:!0},{key:"owner",label:"归属",value:"Content"},{key:"status",label:"状态",value:"stable",render:e.jsx(n,{tone:"success",children:"稳定"})},{key:"coverage",label:"覆盖能力",value:"高亮、行号、复制、文件名和语言提示"}],expanded:"CodeBlock 是内容渲染和 AI 代码结果的基础展示组件。",actions:e.jsx(r,{size:"sm",variant:"ghost",children:"查看"})}],I=[{key:"mobile",cells:[{key:"task",label:"任务",value:"移动端校验"},{key:"owner",label:"负责人",value:"Design"},{key:"progress",label:"进度",value:"82%",align:"end"}]},{key:"theme",cells:[{key:"task",label:"任务",value:"主题变量整理"},{key:"owner",label:"负责人",value:"Frontend"},{key:"progress",label:"进度",value:"96%",align:"end"}]}],x=[{key:"feedback-summary",cells:[{key:"task",label:"任务",value:"产品反馈摘要生成",width:"12rem",render:e.jsxs(g,{as:"span",gap:"xs",inline:!0,wrap:!1,children:[e.jsx(n,{tone:"info",children:"AI"}),e.jsx("strong",{children:"产品反馈摘要生成"})]})},{key:"detail",label:"说明",value:"从近 128 条用户反馈中提取高频问题、风险提示和下一步可执行建议。",title:"从近 128 条用户反馈中提取高频问题、风险提示和下一步可执行建议。"},{key:"result",label:"结果",value:"已生成",render:e.jsx(n,{tone:"success",children:"已生成"}),align:"end"}],actions:e.jsx(r,{size:"sm",variant:"ghost",children:"复制"})},{key:"risk-check",cells:[{key:"task",label:"任务",value:"风险校验",width:"12rem",render:e.jsxs(g,{as:"span",gap:"xs",inline:!0,wrap:!1,children:[e.jsx(n,{tone:"warning",children:"审核"}),e.jsx("strong",{children:"风险校验"})]})},{key:"detail",label:"说明",value:"检查生成内容里是否包含敏感信息、缺少来源引用或需要人工确认的结论。",title:"检查生成内容里是否包含敏感信息、缺少来源引用或需要人工确认的结论。"},{key:"result",label:"结果",value:"需要复核",render:e.jsx(n,{tone:"warning",children:"需要复核"}),align:"end"}],actions:e.jsx(r,{size:"sm",variant:"ghost",children:"查看"})}],C=[{value:"all",label:"全部归属"},{value:"AI",label:"AI"},{value:"Form",label:"Form"},{value:"Content",label:"Content"}],f=[{value:"all",label:"全部状态"},{value:"stable",label:"稳定"},{value:"wip",label:"完善中"}],S=()=>{const[a,l]=b.useState(""),[i,o]=b.useState("all"),[m,p]=b.useState("all"),c=j(s,{keyword:a,owner:i,status:m}),d=[{id:"owner",width:"10rem",control:e.jsx(k,{value:i,options:C,width:"100%",onValueChange:o})},{id:"status",width:"10rem",control:e.jsx(k,{value:m,options:f,width:"100%",onValueChange:p})}];return e.jsx(w,{gap:"md",width:"min(100%, 72rem)",style:{marginInline:"auto"},children:e.jsx(t,{header:e.jsx(v,{search:e.jsx(T,{value:a,onValueChange:l,placeholder:"搜索组件、归属或能力",width:"100%"}),items:d,actions:e.jsx(r,{size:"sm",variant:"ghost",onClick:()=>{l(""),o("all"),p("all")},children:"重置"}),summary:`匹配 ${c.length} 个组件。`}),caption:"组件筛选结果",items:c,empty:"没有匹配的组件",stickyActions:!0,footer:`当前展示 ${c.length} / ${s.length} 个组件。`})})},j=(a,l)=>{const i=l.keyword.trim().toLowerCase();return a.filter(o=>{var d,y;const m=o.cells.map(A).join(" ").toLowerCase(),p=String(((d=o.cells.find(u=>u.key==="owner"))==null?void 0:d.value)??""),c=String(((y=o.cells.find(u=>u.key==="status"))==null?void 0:y.value)??"");return(!i||m.includes(i))&&(l.owner==="all"||p===l.owner)&&(l.status==="all"||c===l.status)})},A=a=>typeof a.value=="string"||typeof a.value=="number"?String(a.value):"",$=h({id:"table",name:"Table",packageName:"willa/Table",description:"通过 items 渲染表格和产品数据列表，支持自定义单元格、排序、选择、分页、展开行和右侧操作区。",imports:[{name:"Table",from:"willa/Table"},{name:"Stack",from:"willa/Stack"},{name:"Group",from:"willa/Group"}],css:"willa/Table.css",demo:{name:"Table",component:t,props:{caption:"组件能力覆盖表",items:s}},code:`
  ...
  `,sections:[{title:"搜索与筛选",code:`
      ...
      `,content:e.jsx(S,{})},{title:"基础表格",code:`
        ...
        />;
      `,content:e.jsx(t,{caption:"组件能力覆盖表",items:s,defaultSort:{key:"name",direction:"asc"}})},{title:"选择与固定操作列",code:`
        const items = [
          {
            key: "prompt-input",
            cells: [
        ...
        <Table
          ...
          actionsWidth="5.6rem"
        />;
      `,content:e.jsx(t,{caption:"横向滚动时保留操作入口",items:s,selectionMode:"multiple",stickyActions:!0,actionsWidth:"5.6rem"})},{title:"分页与展开",code:`
        const items = [
          {
            key: "prompt-input",
            cells: [
        ...
        />;
      `,content:e.jsx(t,{caption:"分页后仍可展开查看详情",items:s,defaultExpandedKeys:["prompt-input"],pagination:{pageSize:2}})},{title:"自定义单元格",code:`
        const items = [
          {
      ...
      `,content:e.jsx(t,{caption:"自定义渲染和溢出提示",items:x,stickyActions:!0})},{title:"加载与空态",code:`
        <Stack gap="lg">
          <Table items={[]} loading loadingText="正在同步组件状态..." />
          <Table items={[]} empty="没有匹配的组件" />
        </Stack>;
      `,content:e.jsxs(w,{gap:"lg",children:[e.jsx(t,{items:[],loading:!0,loadingText:"正在同步组件状态..."}),e.jsx(t,{items:[],empty:"没有匹配的组件"})]})},{title:"紧凑尺寸",code:`
        const items = [
          {
            key: "mobile",
            cells: [
