import{aQ as e,aS as l}from"./index-CA85kz7q.js";import{R as t}from"./index-BQV8sa-S.js";import{d as o}from"./defineDoc-iMEoDSDg.js";const a={display:"grid",gap:"0.85rem",width:"min(100%, 28rem)"},m={display:"flex",alignItems:"center",gap:"0.72rem"},d=()=>{const[r,n]=l.useState(60);return e.jsxs("div",{style:a,children:[e.jsx(t,{min:0,max:100,step:1,value:r,width:"18rem",height:"0.5rem",color:"#3b82f6",trackColor:"rgba(59, 130, 246, 0.18)","aria-label":"生成强度",onChange:i=>n(Number(i.currentTarget.value))}),e.jsx(t,{min:0,max:1,step:.1,defaultValue:.7,color:"#14b8a6",thumbBorderColor:"#0f766e",thumbColor:"#ecfeff",thumbSize:"1.2rem",trackColor:"rgba(20, 184, 166, 0.18)","aria-label":"温度"})]})},c=o({id:"range-input",name:"RangeInput",category:"form",packageName:"willa/RangeInput",description:"用于模型参数、音视频进度和数值配置的范围输入。",imports:[{name:"RangeInput",from:"willa/RangeInput"}],css:"willa/RangeInput.css",demo:{name:"RangeInputPreview",component:d},code:`
