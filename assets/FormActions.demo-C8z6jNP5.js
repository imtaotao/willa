import{an as t,L as s,a0 as i,u as a,g as e,q as r}from"./index-D1DxGs20.js";import{B as o}from"./index-Bruz1WA0.js";import{F as n}from"./index-BG10KOUM.js";/* empty css              */import{d as c}from"./defineDoc-BreWiU-W.js";const m={display:"grid",gap:"1rem",maxWidth:"42rem"},g=c({id:"form-actions",name:"FormActions",category:"form",packageName:"willa/FormActions",description:"用于表单底部提交、取消和辅助操作的布局组件。",imports:[{name:"FormActions",from:"willa/FormActions"}],css:"willa/FormActions.css",demo:{name:"FormActions",component:n,props:{gap:"md"},children:[{name:"Button",component:o,props:{variant:"ghost"},children:"取消"},{name:"Button",component:o,props:{type:"submit"},children:"保存"}]},code:`
