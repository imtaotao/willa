import{b3 as e,aO as l,h as r,a6 as d,b5 as c,Y as j,al as w,aa as M,B as P}from"./index-CX7dlnN9.js";import{A as R}from"./index-idk7e8RV.js";import{P as E}from"./index-DRflkNjA.js";import{S as B}from"./index-DEYaDUpv.js";/* empty css              *//* empty css              */import{d as k}from"./defineDoc-DzpR41Bj.js";import"./index-CIPuiTfD.js";import"./media-Bt1qVdZv.js";import"./index-C2AOGhPo.js";import"./dom-DvRKQOia.js";import"./index-BCmVO6DV.js";import"./index-TVdOcRxF.js";import"./index-DiGq191G.js";import"./index-CqvSpOIA.js";import"./index-lvaR0AW0.js";function a(o){const{header:n,model:i,tools:s,attachments:t,attachmentListProps:y,actions:h,footer:g,id:I,role:x,style:f,inputClassName:b,inputStyle:v,className:C,...S}=o,m=p(n),A=p(i)||p(s),N=t!==void 0&&t.length>0;return e.jsxs("section",{id:I,className:l("willa-composer",C),style:f,role:x,children:[m||A?e.jsxs("div",{className:"willa-composer-header",children:[m||i?e.jsxs("div",{className:"willa-composer-meta",children:[m?e.jsx("div",{className:"willa-composer-title",children:n}):null,i?e.jsx("div",{className:"willa-composer-model",children:i}):null]}):null,s?e.jsx("div",{className:"willa-composer-tools",children:s}):null]}):null,N?e.jsx("div",{className:"willa-composer-attachments",children:e.jsx(R,{items:t,...y})}):null,e.jsx(E,{...S,className:l("willa-composer-input",b),style:v,actions:h,footer:g})]})}const p=o=>o!=null&&o!==!1;a.displayName="Composer";const u={display:"grid",gap:"0.85rem",width:"min(100%, 56rem)"},L={color:"var(--willa-text-soft)",fontSize:"0.84rem",lineHeight:1.45},z={display:"grid",gap:"0.16rem"},V={color:"var(--willa-text-soft)",fontSize:"0.78rem",fontWeight:400,lineHeight:1.4},T={display:"grid",gap:"0.85rem",width:"min(100%, 56rem)"},O=()=>{const[o,n]=c.useState(""),[i,s]=c.useState("暂无提交内容");return e.jsxs("div",{style:u,children:[e.jsx(B,{size:"sm",items:[{id:"priority",label:"整理优先级"},{id:"risk",label:"提取风险"},{id:"summary",label:"生成摘要"}],onSelect:t=>n(String(t.label))}),e.jsx(a,{value:o,header:e.jsxs("span",{style:z,children:[e.jsx("span",{children:"产品反馈分析"}),e.jsx("span",{style:V,children:"从用户反馈中提取优先级和风险"})]}),model:e.jsx(P,{tone:"info",children:"Willa AI Pro"}),tools:e.jsxs(j,{gap:"xs",children:[e.jsx(r,{size:"sm",variant:"ghost",icon:e.jsx(w,{}),children:"阅读"}),e.jsx(r,{size:"sm",variant:"ghost",icon:e.jsx(M,{}),children:"推理"})]}),attachments:[{id:"feedback",name:"feedback.csv",meta:"12 KB",href:"data:text/csv;charset=utf-8,id,feedback%0A1,%E5%B8%8C%E6%9C%9B%E8%A1%A8%E6%A0%BC%E5%AF%BC%E5%87%BA%E6%9B%B4%E5%BF%AB",downloadName:"feedback.csv"},{id:"roadmap",name:"roadmap.md",meta:"8 KB",href:"data:text/markdown;charset=utf-8,%23%20Roadmap%0A%0A- AI%20Composer%0A- Message%20actions",downloadName:"roadmap.md"}],actions:e.jsx(r,{size:"sm",variant:"ghost",icon:e.jsx(d,{}),children:"优化"}),footer:"已连接 2 个上下文，Enter 发送",minRows:3,placeholder:"让 AI 帮我分析这些反馈的优先级...",onChange:t=>n(t.currentTarget.value),onSubmit:t=>{s(t),n("")}}),e.jsx("div",{style:L,children:i})]})},te=k({id:"composer",name:"Composer",category:"ai",packageName:"willa/Composer",description:"用于 AI 对话和任务执行的高阶输入组合，承载模型、工具、附件和 PromptInput。",imports:[{name:"Composer",from:"willa/Composer"}],css:"willa/Composer.css",demo:{name:"ComposerPreview",component:O},code:`
