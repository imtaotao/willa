import{aW as t,T as e}from"./index-1sAkrObt.js";import{C as o}from"./index-m9OUr14J.js";/* empty css              */import{d as n}from"./defineDoc-2hDcXBT_.js";const d=n({id:"copy-button",name:"CopyButton",packageName:"willa/CopyButton",description:"用于复制命令、链接和代码片段，并内置复制成功与失败状态。",imports:[{name:"CopyButton",from:"willa/CopyButton"},{name:"Group",from:"willa/Group"}],css:"willa/CopyButton.css",demo:{name:"CopyButton",component:o,props:{text:"pnpm add willa"},children:"复制安装命令"},code:`
  ...
  `,sections:[{title:"基础复制",code:`
      ...
      `,content:t.jsxs(e,{gap:"md",children:[t.jsx(o,{text:"small",size:"sm",children:"小尺寸"}),t.jsx(o,{text:"medium",children:"默认尺寸"}),t.jsx(o,{text:"large",size:"lg",children:"大尺寸"})]})}],props:[{name:"text *",type:"string",description:"要写入剪贴板的文本。"},{name:"variant",type:'"solid" | "soft" | "outline" | "ghost" | "link"',defaultValue:'"soft"',description:"按钮的视觉类型，沿用 Button 的 variant。"},{name:"size",type:'"sm" | "md" | "lg"',defaultValue:'"md"',description:"按钮尺寸，沿用 Button 的 size。"},{name:"copiedLabel",type:"ReactNode",defaultValue:'"已复制"',description:"复制成功后的临时文案。"},{name:"failedLabel",type:"ReactNode",defaultValue:'"复制失败"',description:"复制失败后的临时文案。"},{name:"copiedDuration",type:"number",defaultValue:"1200",description:"复制反馈持续时间，单位为毫秒。"},{name:"onCopyText",type:"(text: string) => void",description:"复制成功后的回调。"},{name:"children",type:"ReactNode",defaultValue:'"复制"',description:"默认状态的按钮文案。"}]});export{d as default};
