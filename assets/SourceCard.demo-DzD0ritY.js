import{b1 as e,R as r,a7 as i,W as s}from"./index-BjtE9AVd.js";import{S as t}from"./index-DbsvaheD.js";import{d as n}from"./defineDoc-CWmZ2fbW.js";const d=[{title:"组件创建规范",description:"说明新组件的包归属、导出、CSS、主题变量和示例文档接入规则。",source:"component.md",url:"docs/component.md",meta:"命中 92%",icon:e.jsx(r,{}),href:"#",selected:!0},{title:"组件创建规范",description:"说明新组件的包归属、导出、CSS、主题变量和示例文档接入规则。",source:"component.md",url:"docs/component.md",meta:"规范",icon:e.jsx(i,{}),href:"#"},{title:"Willa 官网文档",description:"用于展示外部网页来源、知识库链接和引用跳转入口。",source:"willa.dev",url:"https://willa.dev/components/source-card",meta:"网页",icon:e.jsx(s,{}),href:"#"}],a={display:"grid",gap:"0.82rem",width:"min(100%, 56rem)"},c={display:"grid",gap:"0.72rem",gridTemplateColumns:"repeat(auto-fit, minmax(13rem, 1fr))"},m=()=>e.jsx("div",{style:a,children:d.map(o=>e.jsx(t,{...o},String(o.title)))}),S=n({id:"source-card",name:"SourceCard",category:"content",packageName:"willa/SourceCard",description:"用于展示来源、资料、搜索结果、摘要片段和跳转入口。",imports:[{name:"SourceCard",from:"willa/SourceCard"}],css:"willa/SourceCard.css",demo:{name:"SourceCardPreview",component:m},code:`
