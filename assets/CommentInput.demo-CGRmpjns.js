import{aY as e,V as p,i,a_ as s,B as c}from"./index-Dig-IRy4.js";import{C as t}from"./index-BDiV7gug.js";/* empty css              *//* empty css              */import{d}from"./defineDoc-D08ZLFOW.js";import"./index-Io5KrOMS.js";import"./index-t61SeD2P.js";const o={display:"grid",gap:"0.85rem",width:"min(100%, 52rem)",margin:"0 auto"},x=()=>{const[a,n]=s.useState(""),[m,r]=s.useState("");return e.jsxs("div",{style:o,children:[e.jsx(t,{value:a,onValueChange:n,maxLength:180,onSubmit:(l,u)=>{r(l),u.clear()}}),m?e.jsxs(c,{tone:"success",children:["已发布：",m]}):null]})},h=()=>{const[a,n]=s.useState("");return e.jsx("div",{style:o,children:e.jsx(t,{placeholder:"回复这条评论...",quote:{author:"产品设计",content:"这个输入区需要支持评论扩展能力。"},onMentionClick:()=>n("打开成员选择面板"),actions:e.jsx(i,{size:"sm",variant:"ghost",onClick:()=>n("打开业务自己的表情包面板"),children:"表情"}),footer:a||"点击 @ 或表情按钮接入业务面板"})})},b=d({id:"comment-input",name:"CommentInput",category:"content",packageName:"willa/CommentInput",description:"用于评论、批注和反馈场景的轻量输入组件。",imports:[{name:"CommentInput",from:"willa/CommentInput"}],css:"willa/CommentInput.css",demo:{name:"CommentInputPreview",component:x},code:`
  ...
  `,sections:[{title:"附加操作",code:`
      ...
      `,content:e.jsx("div",{style:o,children:e.jsx(t,{placeholder:"写下批注意见...",actions:e.jsxs(p,{gap:"xs",children:[e.jsx(i,{size:"sm",variant:"ghost",children:"引用段落"}),e.jsx(i,{size:"sm",variant:"ghost",children:"添加截图"})]}),footer:"支持 ⌘ Enter 快捷发布"})})},{title:"提及、表情和引用",code:`
        ...
        />;
      `,content:e.jsx(h,{})},{title:"提交状态",code:`
