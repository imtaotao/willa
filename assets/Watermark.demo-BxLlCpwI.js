import{aS as y,aQ as t,aA as R,i as z,ao as k,Q as U,B as G}from"./index-CA85kz7q.js";import{r as P}from"./media-533LghOh.js";/* empty css              */import{d as N}from"./defineDoc-iMEoDSDg.js";const V=152,Y=84,K=[96,88],X=[24,12],Q=-22,Z=1,M="rgba(15, 23, 42, 0.12)",q="rgba(255, 255, 255, 0.12)";function H(r){const{articleSourcePath:i,resolveAssetUrl:s,children:c,content:m,image:p,width:o=V,height:a=Y,gap:n=K,offset:h=X,rotate:l=Q,opacity:S=Z,zIndex:g=1,fixed:w=!1,font:e,className:_,style:B,...F}=r,v=y.useRef(null),[u,W]=y.useState(M),f=P({articleSourcePath:i,resolveAssetUrl:s},p),x=J(m),d={color:(e==null?void 0:e.color)??u,fontFamily:e==null?void 0:e.fontFamily,fontSize:e==null?void 0:e.fontSize,fontStyle:e==null?void 0:e.fontStyle,fontWeight:e==null?void 0:e.fontWeight,letterSpacing:e==null?void 0:e.letterSpacing,lineHeight:e==null?void 0:e.lineHeight},b=y.useMemo(()=>f?I({lines:[],image:f,width:o,height:a,gap:n,rotate:l,font:d}):"",[f,o,a,n,l,d]),C=y.useMemo(()=>x.length?I({lines:x,width:o,height:a,gap:n,rotate:l,font:d}):"",[x,o,a,n,l,d]);y.useEffect(()=>{const $=v.current;if(!$)return;const j=()=>{const E=getComputedStyle($).getPropertyValue("--willa-watermark-ink").trim();if(E){W(E);return}const O=document.documentElement.getAttribute("data-wk-theme");W(O==="dark"?q:M)};j();const A=new MutationObserver(j);return A.observe(document.documentElement,{attributes:!0,attributeFilter:["data-wk-theme","class"]}),()=>A.disconnect()},[]);const L={...B,"--willa-watermark-size":`${o+n[0]}px ${a+n[1]}px`,"--willa-watermark-position":`${h[0]}px ${h[1]}px`,"--willa-watermark-opacity":`${S}`,"--willa-watermark-z-index":`${g}`};return t.jsxs("div",{...F,ref:v,className:R("willa-watermark",w&&"willa-watermark--fixed",_),style:L,children:[t.jsx("div",{className:"willa-watermark__layer willa-watermark__layer--image","aria-hidden":"true",style:{backgroundImage:b?`url("${b}")`:"none"}}),t.jsx("div",{className:"willa-watermark__layer willa-watermark__layer--text","aria-hidden":"true",style:{backgroundImage:C?`url("${C}")`:"none"}}),c?t.jsx("div",{className:"willa-watermark__content",children:c}):null]})}const J=r=>r?(Array.isArray(r)?r:[r]).map(i=>i.trim()).filter(Boolean):new Array,D=r=>r.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),I=r=>{const{lines:i,image:s,width:c,height:m,gap:p,rotate:o,font:a}=r;if(!s&&i.length===0)return"";const n=c+p[0],h=m+p[1],l=n/2,S=h/2,g=a.fontSize??15,w=a.lineHeight??g*1.45,e=a.letterSpacing??.6,_=a.fontWeight??560,B=a.fontFamily??"Inter, ui-sans-serif, system-ui, sans-serif",F=a.fontStyle??"normal",v=a.color??M,u=s?Math.min(m*.34,34):0,W=i.length?w*i.length-(w-g):0,f=s&&i.length?Math.max(m*.08,6):0,x=u+f+W,d=S-x/2,b=s?tt({image:s,centerX:l,startY:d,width:c,imageBlockHeight:u}):"",C=i.map(($,j)=>{const A=d+u+f+g+w*j-g*.16;return`<text x="${l}" y="${A}" text-anchor="middle" fill="${v}" font-size="${g}" font-weight="${_}" font-family="${B}" font-style="${F}" letter-spacing="${e}">${D($)}</text>`}).join(""),L=`
  ...
  `,sections:[{title:"文字样式与密度",code:`
      ...
      `,content:t.jsx(H,{content:["Design Review","Preview Only"],width:184,height:96,gap:[56,48],rotate:-16,font:{color:"rgba(79, 117, 214, 0.18)",fontSize:17,fontWeight:640,letterSpacing:1},children:t.jsx(z,{variant:"outline",style:T,children:t.jsxs(k,{gap:"xs",children:[t.jsx("strong",{children:"更高密度的审批面板"}),t.jsx("span",{style:{color:"var(--willa-text-soft)",fontSize:"0.9rem"},children:"适合评审区、导出预览区和二次确认面板。"})]})})})},{title:"自定义字体颜色",code:`
        <Watermark
      ...
      `,content:t.jsx(H,{content:["Internal","Only"],width:168,height:92,gap:[72,60],rotate:-18,font:{color:"rgba(34, 197, 94, 0.18)",fontSize:16,fontWeight:620,letterSpacing:.8},children:t.jsx(z,{variant:"outline",style:T,children:t.jsxs(k,{gap:"xs",children:[t.jsx("strong",{children:"可调色的文字水印"}),t.jsx("span",{style:{color:"var(--willa-text-soft)",fontSize:"0.9rem"},children:"适合内部预览、评审稿和半透明提示层。"})]})})})},{title:"图片水印",code:`
        const brandMark =
