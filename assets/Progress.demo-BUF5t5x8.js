import{ay as e,am as V,ae as i}from"./index-DBsCKa5b.js";import{d as S}from"./defineDoc-CeA5kaJR.js";function s({value:a=0,max:r=100,bufferValue:p,label:t,description:n,valueLabel:o,showValue:g,indeterminate:c,size:h="md",tone:f="default",width:x,height:j,className:P,...b}){const l=Number.isFinite(r)&&r>0?r:100,u=v(a,l),d=typeof p=="number"?v(p,l):void 0,m=o??`${Math.round(u/l*100)}%`,y=t||n||g||o,N={width:w(x),"--willa-progress-height-custom":w(j),"--willa-progress-value":`${u/l*100}%`,"--willa-progress-buffer-value":d===void 0?void 0:`${d/l*100}%`};return e.jsxs("div",{...b,className:V("willa-progress",`willa-progress--${h}`,`willa-progress--${f}`,c&&"willa-progress--indeterminate",P),style:{...N,...b.style},children:[y?e.jsxs("div",{className:"willa-progress-header",children:[e.jsxs("div",{className:"willa-progress-label-group",children:[t?e.jsx("div",{className:"willa-progress-label",children:t}):null,n?e.jsx("div",{className:"willa-progress-description",children:n}):null]}),g||o?e.jsx("div",{className:"willa-progress-value-label",children:m}):null]}):null,e.jsxs("div",{className:"willa-progress-track",role:"progressbar","aria-valuemin":0,"aria-valuemax":c?void 0:l,"aria-valuenow":c?void 0:u,"aria-valuetext":typeof m=="string"?m:void 0,children:[d===void 0?null:e.jsx("span",{className:"willa-progress-buffer"}),e.jsx("span",{className:"willa-progress-indicator"})]})]})}const v=(a,r)=>Number.isFinite(a)?Math.min(Math.max(a,0),r):0,w=a=>{if(typeof a=="number"&&Number.isFinite(a))return`${a}px`;if(typeof a=="string")return a.trim()},z=()=>e.jsxs(i,{gap:"lg",width:"min(100%, 28rem)",children:[e.jsx(s,{label:"下载进度",description:"willa-components.zip",value:68,showValue:!0,tone:"default"}),e.jsx(s,{label:"视频播放",value:42,bufferValue:64,size:"sm"})]}),$=S({id:"progress",name:"Progress",packageName:"willa/Progress",description:"用于视频播放、音频播放、下载任务和加载状态中的进度展示。",imports:[{name:"Progress",from:"willa/Progress"},{name:"Stack",from:"willa/Stack"}],css:"willa/Progress.css",demo:{name:"ProgressPreview",component:z},code:`
