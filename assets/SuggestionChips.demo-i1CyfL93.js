import{a_ as e,a5 as o,a6 as a,b0 as l,ab as r,Q as d,a3 as p}from"./index-B3pVmlUa.js";import{S as t}from"./index-DoDmp6lC.js";import{P as m}from"./index-CbzvWGRo.js";import{d as c}from"./defineDoc-_c-0B-WB.js";import"./index-DWrSmwND.js";const u=[{id:"summarize",label:"总结这份文档",description:"输出重点和风险",icon:e.jsx(d,{})},{id:"search",label:"检索相关资料",description:"补充来源证据",icon:e.jsx(a,{})},{id:"plan",label:"拆成执行计划",description:"按优先级排序",icon:e.jsx(p,{})}],g=()=>{const[n,s]=l.useState("");return e.jsxs(r,{padding:"md",style:{width:"min(100%, 56rem)"},children:[e.jsx(t,{items:u,style:{marginBottom:"0.8rem"},onSelect:i=>{s(String(i.label))}}),e.jsx(m,{value:n,placeholder:"选择一个建议，或直接输入问题...",minRows:2,maxRows:5,onChange:i=>s(i.currentTarget.value)})]})},y=c({id:"suggestion-chips",name:"SuggestionChips",category:"ai",packageName:"willa/SuggestionChips",description:"用于展示快捷提示词、推荐问题和 AI 任务入口。",imports:[{name:"SuggestionChips",from:"willa/SuggestionChips"},{name:"Panel",from:"willa/Panel"}],css:"willa/SuggestionChips.css",demo:{name:"SuggestionChipsPreview",component:g},code:`
