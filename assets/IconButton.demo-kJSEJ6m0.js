import{aB as o,R as a,d as t,P as l,y as s,X as i,c as d,H as e,j as c,n as r,ac as u}from"./index-C1QWwz82.js";import{d as p}from"./defineDoc-DiUWnIsG.js";const n={display:"flex",flexWrap:"wrap",gap:"0.75rem",alignItems:"center"},x=p({id:"icon-button",name:"IconButton",packageName:"willa/IconButton",description:"用于工具栏、卡片操作区和内联内容中的纯图标按钮。",imports:[{name:"IconButton",from:"willa/IconButton"}],css:"willa/IconButton.css",demo:{name:"IconButton",component:a,props:{ariaLabel:"分享文章",icon:o.jsx(u,{})}},code:`
  ...
  `,sections:[{title:"视觉类型",code:`
      ...
      `,content:o.jsxs("div",{style:n,children:[o.jsx(a,{ariaLabel:"上一步",icon:o.jsx(d,{}),size:"sm"}),o.jsx(a,{ariaLabel:"外部链接",icon:o.jsx(e,{}),shape:"circle"}),o.jsx(a,{ariaLabel:"确认",icon:o.jsx(c,{}),shape:"circle",size:"lg",variant:"outline"})]})},{title:"链接、禁用和加载",code:`
        <div style={iconButtonRowStyle}>
          <IconButton
            ariaLabel="打开 GitHub"
      ...
      `,content:o.jsxs("div",{style:n,children:[o.jsx(a,{ariaLabel:"打开 GitHub",href:"https://github.com",icon:o.jsx(e,{}),target:"_blank",variant:"outline"}),o.jsx(a,{ariaLabel:"不可点击",disabled:!0,icon:o.jsx(t,{})}),o.jsx(a,{ariaLabel:"保存",icon:o.jsx(c,{}),loading:!0,loadingLabel:"保存中",variant:"soft"})]})},{title:"点击复制",code:`
        <div style={iconButtonRowStyle}>
          <IconButton
            ariaLabel="复制安装命令"
      ...
      `,content:o.jsxs("div",{style:n,children:[o.jsx(a,{ariaLabel:"复制安装命令",copyText:"pnpm add willa",icon:o.jsx(r,{})}),o.jsx(a,{ariaLabel:"复制组件引入",copyText:"import { IconButton } from 'willa/IconButton';",icon:o.jsx(r,{}),variant:"outline"})]})},{title:"自定义颜色",code:`
        <div style={iconButtonRowStyle}>
          <IconButton
            ariaLabel="暖色收藏"
