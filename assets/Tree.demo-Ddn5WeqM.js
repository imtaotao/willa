  ...
  `,sections:[{title:"受控状态",code:`
      ...
      `,content:e.jsx(k,{})},{title:"勾选节点",code:`
        ...
        <Tree
          ...
          style={{ width: "min(100%, 32rem)" }}
        />;
      `,content:e.jsx(r,{items:u,checkable:!0,defaultExpandAll:!0,defaultCheckedKeys:["project-read","model-run"],style:{width:"min(100%, 32rem)"}})},{title:"自定义节点",code:`
        import { Badge } from "willa/Badge";
        import { Tree, type TreeItem } from "willa/Tree";
        import "willa/Badge.css";
        import "willa/Tree.css";
