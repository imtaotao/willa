import{b3 as e,j as t,B as i,d as r,h as o,f as n}from"./index-BV4pINJl.js";/* empty css              */import{d}from"./defineDoc-XrY6kqJ7.js";const a={display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(14rem, 1fr))",gap:"0.9rem",width:"min(100%, 56rem)"},s={aspectRatio:"16 / 9",background:"linear-gradient(135deg, rgba(37, 99, 235, 0.18), rgba(5, 150, 105, 0.12))"},m=d({id:"card",name:"Card",category:"layout",packageName:"willa/Card",description:"用于资源入口、文章摘要、链接推荐和组合式内容块。",imports:[{name:"Card",from:"willa/Card"}],css:"willa/Card.css",demo:{name:"Card",component:t,props:{eyebrow:"指南",title:"构建内容组件",description:"用统一的结构和主题变量组织文章页里的推荐资源。"}},code:`
