import{C as a}from"./index-Dlyep3BO.js";import{d as e}from"./defineDoc-0G99HOBK.js";import"./index-3_sPVMI1.js";import"./index-BBCCVeqp.js";const t=[{name:"作者",avatar:"idea",content:"公共包会导出所有组件。"},{align:"right",name:"审阅者",avatar:"user",content:"单组件引入可以让示例更轻量。"}],o=e({id:"chat-thread",name:"ChatThread",packageName:"willa/ChatThread",description:"用于博客、文档站和 MDX 内容里的轻量聊天记录块；AI 产品对话流优先使用 MessageList 和 ChatMessage。",imports:[{name:"ChatThread",from:"willa/ChatThread"}],css:"willa/ChatThread.css",demo:{name:"ChatThread",component:a,props:{title:"组件备注",messages:t}},code:`
