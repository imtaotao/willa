import{a_ as a,_ as o,al as r,T as l,h as e,I as i,as as c,b0 as p,O as b,v}from"./index-CQznDQQV.js";import{T as t}from"./index-BcPnB0ek.js";/* empty css              *//* empty css              */import{d as h}from"./defineDoc-qJMfmiGr.js";const z={display:"grid",gap:"1rem",width:"min(100%, 42rem)",marginInline:"auto"},g={display:"grid",gap:"0.85rem",width:"min(100%, 38rem)",marginInline:"auto",color:"var(--willa-text)"},I=()=>{const[m,d]=p.useState(!0),[n,u]=p.useState(!1);return a.jsxs("div",{style:g,children:[a.jsxs(t,{ariaLabel:"编辑器工具",size:"sm",separator:a.jsx(c,{orientation:"vertical",size:"sm"}),children:[a.jsx(o,{ariaLabel:"预览",icon:a.jsx(b,{}),pressed:m,size:"sm",variant:"ghost",onClick:()=>d(s=>!s)}),a.jsx(o,{ariaLabel:"源码模式",icon:a.jsx(v,{}),pressed:n,size:"sm",variant:"ghost",onClick:()=>u(s=>!s)}),a.jsx(e,{icon:a.jsx(i,{}),pressed:n,size:"sm",variant:"ghost",children:"导出"})]}),a.jsxs("p",{style:{margin:0},children:["当前模式：",m?"预览开启":"预览关闭","，",n?"源码视图":"富文本视图"]})]})},f=h({id:"toolbar",name:"Toolbar",displayName:"工具栏",packageName:"willa/Toolbar",description:"为表格、代码块、编辑器和内容操作区提供稳定的工具栏语义和编排模式。",imports:[{name:"Button",from:"willa/Button"},{name:"IconButton",from:"willa/IconButton"},{name:"Separator",from:"willa/Separator"},{name:"Toolbar",from:"willa/Toolbar"},{name:"DownloadIcon, GearIcon, ReloadIcon",from:"@radix-ui/react-icons"}],css:"willa/Toolbar.css",demo:{name:"Toolbar",component:t,props:{ariaLabel:"表格操作",size:"sm",separator:a.jsx(c,{orientation:"vertical",size:"sm"})},children:[{name:"IconButton",component:o,props:{ariaLabel:"刷新",icon:a.jsx(r,{}),size:"sm",variant:"ghost"}},{name:"IconButton",component:o,props:{ariaLabel:"列设置",icon:a.jsx(l,{}),size:"sm",variant:"ghost"}},{name:"Button",component:e,props:{icon:a.jsx(i,{}),size:"sm",variant:"ghost"},children:"导出"}]},code:`
  ...
  `,sections:[{title:"基础编排",code:`
      ...
      `,content:a.jsxs(t,{ariaLabel:"表格操作",size:"sm",separator:a.jsx(c,{orientation:"vertical",size:"sm"}),children:[a.jsx(o,{ariaLabel:"刷新",icon:a.jsx(r,{}),size:"sm",variant:"ghost"}),a.jsx(o,{ariaLabel:"列设置",icon:a.jsx(l,{}),size:"sm",variant:"ghost"}),a.jsx(e,{icon:a.jsx(i,{}),size:"sm",variant:"ghost",children:"导出"})]})},{title:"开关型工具",code:`
      ...
      `,content:a.jsxs(t,{ariaLabel:"画布工具",orientation:"vertical",size:"sm",children:[a.jsx(o,{ariaLabel:"刷新画布",icon:a.jsx(r,{}),size:"sm",variant:"ghost"}),a.jsx(o,{ariaLabel:"配置画布",icon:a.jsx(l,{}),size:"sm",variant:"ghost"}),a.jsx(o,{ariaLabel:"导出画布",icon:a.jsx(i,{}),size:"sm",variant:"ghost"})]})},{title:"换行工具栏",code:`
