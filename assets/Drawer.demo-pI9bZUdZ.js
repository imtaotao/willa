import{aD as n,aC as ce,aB as e,R as de,u as ue,ap as v,e as o,az as me,aE as pe,O as fe,a6 as we,ah as he,L as xe}from"./index-D5IYuN_l.js";import{F as S}from"./index-BFpZ3tk_.js";import{I as P}from"./index-Di7C_48p.js";/* empty css              *//* empty css              *//* empty css              */import{d as ge}from"./defineDoc-DEnQ702g.js";const be=["a[href]","button:not([disabled])","textarea:not([disabled])","input:not([disabled])","select:not([disabled])","[tabindex]:not([tabindex='-1'])"].join(",");function d(i){const{open:j,defaultOpen:G,trigger:c,title:f,description:w,children:K,footer:D,extra:C,placement:h="right",size:A="md",width:W,height:q,closeText:H="取消",confirmText:E,confirmDisabled:N=!1,confirmLoading:B=!1,ariaLabel:M,closeOnOverlayClick:U=!0,closeOnEscape:J=!0,showCloseButton:Q=!0,className:X,overlayClassName:Y,panelClassName:Z,onConfirm:u,onOpenChange:m}=i,F=j!==void 0,[ee,te]=n.useState(G??!1),[k,p]=n.useState(!1),l=j??ee,_=n.useId(),R=f?`${_}-title`:void 0,T=w?`${_}-description`:void 0,x=n.useRef(null),g=n.useRef(null),b=n.useCallback(t=>{F||te(t),m==null||m(t)},[F,m]),s=n.useCallback(()=>{b(!1)},[b]);n.useEffect(()=>{if(!l||typeof document>"u")return;const t=document.body.style.overflow;g.current=document.activeElement instanceof HTMLElement?document.activeElement:null,document.body.style.overflow="hidden";const a=window.setTimeout(()=>{const r=x.current;if(!r)return;(L(r)[0]??r).focus()},0);return()=>{var r;window.clearTimeout(a),document.body.style.overflow=t,(r=g.current)==null||r.focus(),g.current=null}},[l]),n.useEffect(()=>{l||p(!1)},[l]);const re=t=>{var a,r;(r=c==null?void 0:(a=c.props).onClick)==null||r.call(a,t),t.defaultPrevented||b(!0)},ne=t=>{!U||t.target!==t.currentTarget||s()},ae=t=>{if(t.key==="Escape"&&J){t.stopPropagation(),s();return}if(t.key!=="Tab")return;const a=x.current;if(!a)return;const r=L(a);if(r.length===0){t.preventDefault(),a.focus();return}const y=r[0],I=r[r.length-1],z=document.activeElement;if(t.shiftKey&&z===y){t.preventDefault(),I.focus();return}!t.shiftKey&&z===I&&(t.preventDefault(),y.focus())},oe=()=>{if(!(N||B||k))try{const t=u==null?void 0:u();if(me(t)){p(!0),t.then(()=>{s()}).catch(()=>{p(!1)});return}s()}catch{p(!1)}},ie=n.isValidElement(c)?n.cloneElement(c,{"aria-expanded":l,"aria-haspopup":"dialog",onClick:re}):null,O=D??(D===void 0&&(E!==void 0||u)?e.jsxs(e.Fragment,{children:[e.jsx(o,{type:"button",variant:"ghost",onClick:s,children:H}),e.jsx(o,{type:"button",variant:"solid",loading:B||k,disabled:N,onClick:oe,children:E??"确认"})]}):null),V=h==="left"||h==="right"?W:q,le=V===void 0?void 0:{"--willa-drawer-size":ye(V)},se=l&&typeof document<"u"?ce.createPortal(e.jsx("div",{className:v("willa-drawer",`willa-drawer--${h}`,Y),onClick:ne,children:e.jsxs("div",{className:v("willa-drawer__panel",`willa-drawer__panel--${A}`,Z),style:le,ref:x,role:"dialog","aria-modal":"true","aria-label":M,"aria-labelledby":R,"aria-describedby":T,tabIndex:-1,onKeyDown:ae,children:[e.jsxs("div",{className:"willa-drawer__header",children:[e.jsxs("div",{className:"willa-drawer__heading",children:[f?e.jsx("h2",{className:"willa-drawer__title",id:R,children:f}):null,w?e.jsx("p",{className:"willa-drawer__description",id:T,children:w}):null]}),C?e.jsx("div",{className:"willa-drawer__extra",children:C}):null,Q?e.jsx(de,{ariaLabel:"关闭抽屉",icon:e.jsx(ue,{}),variant:"ghost",size:"sm",onClick:s}):null]}),e.jsx("div",{className:"willa-drawer__body",children:K}),O?e.jsx("div",{className:"willa-drawer__footer",children:O}):null]})}),document.body):null;return e.jsxs(e.Fragment,{children:[ie,e.jsx("span",{className:v("willa-drawer-root",X),children:se})]})}const L=i=>Array.from(i.querySelectorAll(be)),ye=i=>typeof i=="number"?`${i}px`:i,$=()=>e.jsxs(he,{gap:"md",children:[e.jsx(S,{label:"任务名称",description:"用于侧边详情和编辑场景。",children:e.jsx(P,{defaultValue:"组件体验梳理"})}),e.jsx(S,{label:"负责人",children:e.jsx(P,{defaultValue:"Willa Team"})})]}),ke=ge({id:"drawer",name:"Drawer",category:"content",packageName:"willa/Drawer",description:"用于侧边详情、配置编辑和移动端面板的抽屉组件。",imports:[{name:"Drawer",from:"willa/Drawer"}],css:"willa/Drawer.css",demo:{name:"Drawer",component:d,props:{title:"编辑任务",description:"抽屉适合保留当前页面上下文的侧边编辑。",trigger:e.jsx(o,{icon:e.jsx(xe,{}),children:"打开抽屉"}),confirmText:"保存",children:e.jsx($,{})}},code:pe(`
