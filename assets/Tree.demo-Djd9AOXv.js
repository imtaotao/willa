import{d as e,l as t,p as n}from"./aidly.esm-bundler-DaTrP4tr.js";import{N as r,P as i,V as a,n as o}from"./react-icons.esm-mVdwEXuX.js";import{t as s}from"./Stack-DwlHdG-i.js";import{a as c}from"./index-Do4z6LCr.js";import{t as l}from"./defineDoc-Cid5xIoZ.js";import{t as u}from"./Tree-Ddp4tRwF.js";var d=n(e(),1),f=t(),p=[{key:`workspace`,title:`工作区`,description:`团队共享资源`,icon:(0,f.jsx)(o,{}),children:[{key:`product`,title:`产品文档`,description:`PRD、设计稿和上线记录`,icon:(0,f.jsx)(r,{})},{key:`report`,title:`数据报表`,description:`用户反馈、埋点和业务指标`,icon:(0,f.jsx)(r,{})}]},{key:`knowledge`,title:`知识库`,description:`AI 可检索资料`,icon:(0,f.jsx)(o,{}),children:[{key:`component`,title:`组件规范`,description:`Willa 组件设计和 API 约定`,icon:(0,f.jsx)(r,{})},{key:`style`,title:`样式规则`,description:`主题变量、CSS 和移动端规则`,icon:(0,f.jsx)(r,{})}]}],m=[{key:`project`,title:`项目权限`,icon:(0,f.jsx)(a,{}),children:[{key:`project-read`,title:`查看项目`},{key:`project-write`,title:`编辑项目`},{key:`project-delete`,title:`删除项目`,disabled:!0}]},{key:`model`,title:`模型权限`,icon:(0,f.jsx)(i,{}),children:[{key:`model-read`,title:`查看模型`},{key:`model-run`,title:`调用模型`},{key:`model-admin`,title:`管理模型`}]}],h=l({id:`tree`,name:`Tree`,packageName:`willa/Tree`,description:`用于展示和操作层级数据，支持展开、选择、勾选和自定义节点内容。`,imports:[{name:`Badge`,from:`willa/Badge`},{name:`Stack`,from:`willa/Stack`},{name:`Tree`,from:`willa/Tree`}],css:`willa/Tree.css`,demo:{name:`Tree`,component:u,props:{items:p,defaultExpandAll:!0,style:{width:`min(100%, 32rem)`}}},code:`
  ...
  `,sections:[{title:`受控状态`,code:`
      ...
      `,content:(0,f.jsx)(()=>{let[e,t]=(0,d.useState)([`workspace`]),[n,r]=(0,d.useState)([`product`]);return(0,f.jsxs)(s,{gap:`sm`,style:{width:`min(100%, 32rem)`},children:[(0,f.jsx)(u,{items:p,expandedKeys:e,selectedKeys:n,onExpandedChange:t,onSelectedChange:r}),(0,f.jsxs)(c,{size:`sm`,children:[`当前选择：`,n.join(`、`)||`无`]})]})},{})},{title:`勾选节点`,code:`
        import { Tree, type TreeItem } from "willa/Tree";
        import "willa/Tree.css";
        ...
        <Tree
          ...
          style={{ width: "min(100%, 32rem)" }}
        />;
      `,content:(0,f.jsx)(u,{items:m,checkable:!0,defaultExpandAll:!0,defaultCheckedKeys:[`project-read`,`model-run`],style:{width:`min(100%, 32rem)`}})},{title:`自定义节点`,code:`
        import { Badge } from "willa/Badge";
        import { Tree, type TreeItem } from "willa/Tree";
        import "willa/Badge.css";
        import "willa/Tree.css";
