import{ae as e,N as m,ag as r}from"./index-Dn8mGTzM.js";import{B as l}from"./index-DCbHg8ts.js";import{P as t}from"./index-1l7BtDkj.js";/* empty css              */import{d as c}from"./defineDoc-BXkZWhLB.js";import"./heading-CRPk0DTc.js";const o={display:"grid",gap:"1rem",width:"min(100%, 42rem)"},d=()=>{const[a,i]=r.useState(""),[s,p]=r.useState("暂无提交内容");return e.jsxs("div",{style:o,children:[e.jsx(t,{value:a,footer:"Enter 发送，Shift + Enter 换行",placeholder:"让 AI 帮我整理这段会议纪要...",onChange:n=>i(n.currentTarget.value),onSubmit:n=>{p(n),i("")}}),e.jsx("div",{children:s})]})},b=c({id:"prompt-input",name:"PromptInput",category:"ai",packageName:"willa/PromptInput",description:"用于 AI 对话、智能搜索和生成任务的提示词输入区域。",imports:[{name:"PromptInput",from:"willa/PromptInput"}],css:"willa/PromptInput.css",demo:{name:"PromptInputPreview",component:d},code:`
