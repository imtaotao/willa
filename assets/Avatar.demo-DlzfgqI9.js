import{b3 as e}from"./index-C9Ot4add.js";import{A as a}from"./index-CYRyWODZ.js";/* empty css              */import{d as r}from"./defineDoc-DwmdElki.js";const t={display:"flex",flexWrap:"wrap",gap:"0.75rem",alignItems:"center"},o={display:"grid",minWidth:"12rem",gap:"0.35rem"},i={color:"var(--willa-text-strong)",fontSize:"0.92rem",fontWeight:600,lineHeight:1.3},s={color:"var(--willa-text-soft)",fontSize:"0.82rem",lineHeight:1.45},n={display:"flex",gap:"0.5rem",color:"var(--willa-text-faint)",fontSize:"0.78rem"},d=r({id:"avatar",name:"Avatar",packageName:"willa/Avatar",description:"用于作者、评论、社区内容和引用来源中的头像展示。",imports:[{name:"Avatar",from:"willa/Avatar"}],css:"willa/Avatar.css",demo:{name:"Avatar",component:a,props:{src:"https://github.com/imtaotao.png",name:"Tao Tao",alt:"Tao Tao",previewable:!0}},code:`
