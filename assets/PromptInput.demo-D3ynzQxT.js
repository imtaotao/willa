import{af as e,N as m,ah as i}from"./index-DscgVaJe.js";import{B as l}from"./index-Be-IG3zl.js";import{P as t}from"./index-BK0-qKRO.js";/* empty css              */import{d as c}from"./defineDoc-BNnDXU4q.js";import"./heading-CGFEtO8f.js";const o={display:"grid",gap:"1rem",width:"min(100%, 42rem)"},d=()=>{const[a,r]=i.useState(""),[s,p]=i.useState("暂无提交内容");return e.jsxs("div",{style:o,children:[e.jsx(t,{value:a,footer:"Enter 发送，Shift + Enter 换行",placeholder:"让 AI 帮我整理这段会议纪要...",onChange:n=>r(n.currentTarget.value),onSubmit:n=>{p(n),r("")}}),e.jsx("div",{children:s})]})},P=c({id:"prompt-input",name:"PromptInput",category:"ai",packageName:"willa/PromptInput",description:"用于 AI 对话、智能搜索和生成任务的提示词输入区域。",imports:[{name:"PromptInput",from:"willa/PromptInput"}],css:"willa/PromptInput.css",demo:{name:"PromptInputPreview",component:d},code:`
