import{aB as e,e as t}from"./index-DlOA7KkB.js";import{D as i}from"./index-EVJjo-Y4.js";/* empty css              */import{d as s}from"./defineDoc-DraEbAe5.js";const r={display:"grid",gap:"0.65rem"},o={margin:0,color:"var(--willa-text)"},l={margin:0,color:"var(--willa-text-soft)",fontSize:"0.88rem"},n={display:"flex",flexWrap:"wrap",justifyContent:"flex-end",gap:"0.55rem"},m=s({id:"dialog",name:"Dialog",packageName:"willa/Dialog",description:"用于确认操作、补充信息和轻量表单的基础弹层。",imports:[{name:"Dialog",from:"willa/Dialog"}],css:"willa/Dialog.css",demo:{name:"Dialog",component:i,props:{trigger:e.jsx(t,{variant:"soft",children:"打开 Dialog"}),title:"发布前确认",description:"确认后内容会进入公开队列。",confirmText:"确认发布"},children:e.jsxs("div",{style:r,children:[e.jsx("p",{style:o,children:"这篇内容包含 3 张图片和 2 个代码片段。"}),e.jsx("p",{style:l,children:"发布后仍然可以继续编辑，但读者会看到最新版本。"})]})},code:`
