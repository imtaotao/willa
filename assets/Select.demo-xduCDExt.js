import{aW as e}from"./index-D6gpxGUM.js";import{S as t}from"./index-DSDxsRia.js";import{d as i}from"./defineDoc-B7YJrgpp.js";import"./index-7wb5Kzzw.js";import"./useSelectablePanel-SkgzhQze.js";import"./floatingPanelParts-W-Yn95s4.js";import"./useFloatingPanel-CzwexwbZ.js";const a={display:"grid",gap:"0.9rem",maxWidth:"42rem"},l=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],r=i({id:"select",name:"Select",category:"form",packageName:"willa/Select",description:"用于单选下拉，适合表单、筛选和配置场景。",imports:[{name:"Select",from:"willa/Select"}],css:"willa/Select.css",demo:{name:"Select",component:t,props:{options:l,defaultValue:"balanced",width:"100%"}},code:`
