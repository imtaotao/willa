import{b3 as e,a1 as t,h as l}from"./index-BFdlIxUH.js";import{F as i}from"./index-BIXXSdCW.js";import{T as o}from"./index-C_mw3WNA.js";/* empty css              *//* empty css              *//* empty css              */import{d as a}from"./defineDoc-CmN89srR.js";const r={display:"grid",gap:"1rem",maxWidth:"42rem"},d={display:"flex",flexWrap:"wrap",gap:"0.7rem"},h=a({id:"form-field",name:"FormField",category:"form",packageName:"willa/FormField",description:"统一表单字段的 label、说明、必填和错误状态。",imports:[{name:"FormField",from:"willa/FormField"}],css:"willa/FormField.css",demo:{name:"FormField",component:i,props:{label:"项目名称",description:"用于工作台、文档和分享链接中的展示名称。",required:!0},children:[{name:"Input",component:t,props:{placeholder:"输入项目名称",width:"100%"}}]},code:`
  ...
  `,sections:[{title:"字段状态",code:`
      ...
      `,content:e.jsxs("div",{style:r,children:[e.jsx(i,{label:"默认模型",description:"适合设置页和密集配置表单。",orientation:"horizontal",children:e.jsx(t,{defaultValue:"willa-ai-default",width:"100%"})}),e.jsx(i,{label:"提交",orientation:"horizontal",children:e.jsxs("div",{style:d,children:[e.jsx(l,{size:"sm",children:"保存"}),e.jsx(l,{size:"sm",variant:"ghost",children:"取消"})]})})]})}],props:[{name:"children",type:"ReactNode",required:!0,description:"字段控件内容。"},{name:"label",type:"ReactNode",description:"字段名称。"},{name:"description",type:"ReactNode",description:"字段补充说明。"},{name:"error",type:"ReactNode",description:"错误提示；存在时展示错误状态。"},{name:"required",type:"boolean",defaultValue:"false",description:"展示必填标记。"},{name:"htmlFor",type:"string",description:"关联内部控件 id。"},{name:"size",type:'"sm" | "md"',defaultValue:'"md"',description:"字段文字尺寸。"},{name:"orientation",type:'"vertical" | "horizontal"',defaultValue:'"vertical"',description:"字段标签和控件的排列方式。"},{name:"controlClassName",type:"string",description:"控制层 className。"},{name:"labelClassName",type:"string",description:"标签 className。"}]});export{h as default};
