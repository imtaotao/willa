import{aW as e,x as o,ai as n,m as t,aY as r}from"./index-Clga5H6i.js";import{C as l}from"./index-DZ54Lrfm.js";import{M as a}from"./index-DDEcoS9X.js";import{d}from"./defineDoc-CXpq5YLG.js";import"./index-uClfydFv.js";const p="https://github.com/openai.png",m={display:"grid",gap:"1rem",width:"min(100%, 58rem)",border:"1px solid var(--willa-line)",borderRadius:"0.9rem",background:"var(--willa-panel-bg)",padding:"1rem"},g=()=>{const[s,i]=r.useState(!1),c=[{id:"copy",label:s?"已复制":"复制",icon:s?e.jsx(t,{}):e.jsx(o,{}),active:s,onClick:()=>{i(!0),window.setTimeout(()=>i(!1),600)}},{id:"regenerate",label:"重试",icon:e.jsx(n,{})},{id:"accept",label:"采纳",icon:e.jsx(t,{}),tone:"positive"}];return e.jsx("div",{style:m,children:e.jsxs(l,{role:"assistant",name:"Willa AI",avatarSrc:p,meta:"已生成",actions:e.jsx(a,{items:c}),children:[e.jsx("p",{children:"可以先按影响面、紧急程度和实现成本拆分。"}),e.jsx("p",{children:"优先处理阻塞登录的问题，其次是批量导出，最后再看主题配置。"})]})})},h=d({id:"message-actions",name:"MessageActions",category:"ai",packageName:"willa/MessageActions",description:"用于 AI 消息上的复制、重试、采纳和反馈等轻量操作。",imports:[{name:"MessageActions",from:"willa/MessageActions"}],css:"willa/MessageActions.css",demo:{name:"MessageActionsPreview",component:g},code:`
  ...
  `,sections:[{title:"文字标签",code:`
        ...
        />;
      `,content:e.jsx(a,{showLabels:!0,variant:"soft",items:[{id:"copy",label:"复制",icon:e.jsx(o,{})},{id:"retry",label:"重新生成",icon:e.jsx(n,{})},{id:"accept",label:"采纳",icon:e.jsx(t,{}),tone:"positive"}]})},{title:"状态",code:`
        <MessageActions
          showLabels
          items={[
            {
