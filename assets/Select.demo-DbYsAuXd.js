import{aZ as e}from"./index-AT3pq52c.js";import{S as t}from"./index-D5gCAaNk.js";import{d as i}from"./defineDoc-vm2MDznr.js";import"./index-UKsINT9t.js";import"./useSelectablePanel-C03BUpau.js";import"./floatingPanelParts-BA5Ji_Xf.js";import"./useFloatingPanel-BAHQZVP2.js";const a={display:"grid",gap:"0.9rem",maxWidth:"42rem"},l=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],r=i({id:"select",name:"Select",category:"form",packageName:"willa/Select",description:"用于单选下拉，适合表单、筛选和配置场景。",imports:[{name:"Select",from:"willa/Select"}],css:"willa/Select.css",demo:{name:"Select",component:t,props:{options:l,defaultValue:"balanced",width:"100%"}},code:`
