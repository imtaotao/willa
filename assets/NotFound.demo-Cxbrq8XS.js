import{ay as t,E as y,am as h,U as a,L as o,c as e,H as j}from"./index-vVHMmPWZ.js";/* empty css              *//* empty css              *//* empty css              */import{d as x}from"./defineDoc-CK669M_K.js";function i(s){const{title:r="404 页面不存在",description:l="你访问的内容可能已被移动、删除，或暂时不可用。",icon:d=t.jsx(v,{}),image:n,actions:c,footer:m,variant:u="soft",size:p="lg",align:f="center",className:g,children:N}=s;return t.jsx(y,{className:h("willa-not-found",g),icon:n?void 0:d,image:n,title:r,description:l,actions:c,footer:m,variant:u,size:p,align:f,children:N})}function v(){return t.jsxs("span",{className:"willa-not-found-badge","aria-hidden":"true",children:[t.jsx("span",{className:"willa-not-found-badge-icon",children:t.jsx(a,{})}),t.jsx("span",{className:"willa-not-found-badge-code",children:"404"})]})}const w={display:"grid",gap:"0.9rem",width:"min(100%, 56rem)"},b=x({id:"not-found",name:"NotFound",packageName:"willa/NotFound",description:"用于 404、资源不存在和搜索路径失效等场景的缺省页面。",imports:[{name:"NotFound",from:"willa/NotFound"},{name:"Button",from:"willa/Button"},{name:"Group",from:"willa/Group"}],css:"willa/NotFound.css",demo:{name:"NotFound",component:i,props:{actions:t.jsxs(o,{gap:"sm",justify:"center",children:[t.jsx(e,{size:"sm",variant:"solid",children:"返回首页"}),t.jsx(e,{size:"sm",variant:"ghost",children:"查看文档"})]})}},code:`
  ...
  `,sections:[{title:"默认 404",code:`
      ...
      `,content:t.jsx(i,{actions:t.jsxs(o,{gap:"sm",justify:"center",children:[t.jsx(e,{size:"sm",variant:"solid",children:"返回首页"}),t.jsx(e,{size:"sm",variant:"ghost",children:"联系支持"})]})})},{title:"资源不存在",code:`
        ...
        />;
      `,content:t.jsx(i,{icon:t.jsx(j,{}),title:"文档不存在",description:"这篇文档可能已被归档，或当前账号没有访问权限。",variant:"outline",footer:"检查链接是否完整，或回到文档列表重新选择。"})},{title:"自定义图片",code:`
        <NotFound
          image={
            <div
              style={{
