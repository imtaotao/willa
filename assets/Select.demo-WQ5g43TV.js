import{ah as e}from"./index-Bdj8Q3L_.js";import{S as t}from"./index-XnbSExbP.js";import{d as i}from"./defineDoc-ClbrtoXF.js";const l={display:"grid",gap:"0.9rem",maxWidth:"34rem"},a=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],d=i({id:"select",name:"Select",category:"form",packageName:"willa/Select",description:"用于单选下拉，适合表单、筛选和配置场景。",imports:[{name:"Select",from:"willa/Select"}],css:"willa/Select.css",demo:{name:"Select",component:t,props:{options:a,defaultValue:"balanced",width:"100%"}},code:`
