import{aY as e,aB as o,a_ as s,B as u}from"./index-CTZ1VNtq.js";import{C as t}from"./index-yk1U3S3U.js";/* empty css              */import{d as m}from"./defineDoc-DS9v3ENx.js";const n={display:"grid",justifyItems:"center"},d={width:"min(100%, 42rem)",border:"1px solid var(--willa-border)",borderRadius:"0.86rem",padding:"1rem"},c={display:"grid",gap:"0.82rem",justifyItems:"center"},p=[{value:"2026-06-16",endValue:"2026-06-18",label:"发布窗口",tone:"success"},{value:"2026-06-19",label:"风险复核",tone:"warning"},{value:"2026-06-19",label:"假期确认",tone:"info"},{value:"2026-06-24",label:"维护",tone:"info"}],v={"2026-06-16":[{label:"发布窗口",tone:"success"}],"2026-06-19":[{label:"风险复核",tone:"warning"},{label:"假期确认",tone:"info"}],"2026-06-24":[{label:"维护排期",tone:"info"}]},y=()=>{const[a,r]=s.useState("2026-06-19");return e.jsx("div",{style:n,children:e.jsx("div",{style:d,children:e.jsx(t,{mode:"day",value:a,markers:p,getMarker:(i,l)=>l.date&&l.date.getDay()===1?{value:i,label:"周会",tone:"neutral"}:null,onValueChange:r})})})},b=()=>{const[a,r]=s.useState(new Date(2026,5,1));return e.jsxs("div",{style:c,children:[e.jsxs(u,{tone:"info",children:["当前面板：",a.getFullYear()," 年 ",a.getMonth()+1," 月"]}),e.jsx("div",{style:d,children:e.jsx(t,{mode:"day",visibleDate:a,onVisibleDateChange:r})})]})},g=a=>{const r=v[a.value]??[],i=r.length>0?r:(a.markers??[]).map(l=>({label:l.label,tone:l.tone??"info"}));return e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"willa-calendar-day-label",children:a.label}),e.jsx("span",{style:{display:"grid",maxWidth:"100%",minHeight:"1.08rem",gap:"0.18rem",color:i.length>0?void 0:"transparent",overflow:"hidden",fontSize:"0.7rem",fontWeight:720,lineHeight:1.2,textOverflow:"ellipsis",whiteSpace:"nowrap"},children:i.length>0?i.map(l=>e.jsxs("span",{style:{display:"inline-grid",minWidth:0,gridTemplateColumns:"0.45rem minmax(0, 1fr)",alignItems:"center",gap:"0.3rem",color:l.tone==="success"?"var(--willa-calendar-marker-success-text)":l.tone==="warning"?"var(--willa-calendar-marker-warning-text)":l.tone==="neutral"?"var(--willa-calendar-marker-neutral-text)":"var(--willa-calendar-marker-text)",overflow:"hidden"},children:[e.jsx("span",{style:{width:"0.38rem",height:"0.38rem",borderRadius:"999px",background:"currentColor",opacity:.66}}),e.jsx(o,{content:l.label,delay:180,side:"top",children:e.jsx("span",{style:{minWidth:0,overflow:"hidden",textAlign:"left",textOverflow:"ellipsis"},children:l.label})})]},`${a.value}-${String(l.label)}`)):"占位"})]})},f=m({id:"calendar",name:"Calendar",category:"form",packageName:"willa/Calendar",description:"日期选择面板，用于 DatePicker 等输入入口里的日期、周、月份和年份选择。",imports:[{name:"Calendar",from:"willa/Calendar"},{name:"Badge",from:"willa/Badge"},{name:"Tooltip",from:"willa/Tooltip"}],css:"willa/Calendar.css",demo:{name:"CalendarPreview",component:y},code:`
  ...
  `,sections:[{title:"范围选择",code:`
      ...
      `,content:e.jsx("div",{style:n,children:e.jsx("div",{style:d,children:e.jsx(t,{defaultValue:"2026-06-19",renderCell:g})})})},{title:"自定义头部",code:`
        <div
          style={{
            width: "min(100%, 42rem)",
            border: "1px solid var(--willa-border)",
      ...
      `,content:e.jsx("div",{style:n,children:e.jsx("div",{style:d,children:e.jsx(t,{defaultValue:"2026-06-19",headerRender:({title:a,previous:r,next:i})=>e.jsxs("div",{className:"willa-calendar-header",children:[e.jsx("button",{className:"willa-calendar-nav",type:"button","aria-label":"上一个月",onClick:r,children:"上"}),e.jsxs("div",{className:"willa-calendar-title",children:["排期视图 · ",a]}),e.jsx("button",{className:"willa-calendar-nav",type:"button","aria-label":"下一个月",onClick:i,children:"下"})]})})})})},{title:"月份粒度",code:`
        <div
          style={{
            width: "min(100%, 42rem)",
            border: "1px solid var(--willa-border)",
