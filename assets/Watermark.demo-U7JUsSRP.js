import{l as e}from"./aidly.esm-bundler-DaTrP4tr.js";import{t}from"./Card-Dw_2SqSh.js";import{t as n}from"./Group-C-JhzSsC.js";import{t as r}from"./Stack-DwlHdG-i.js";import{a as i}from"./index-Coe6wwj0.js";import{t as a}from"./defineDoc-Cid5xIoZ.js";import"./style-D3eq1OTT.js";import{t as o}from"./Watermark-Bsb6v7Hz.js";var s=e(),c=`data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><rect x="4" y="4" width="56" height="56" rx="18" fill="%2382A3EC"/><path d="M20 18h9.4l7.1 19.8L43.6 18H52l-12.6 28h-6.6L20 18Z" fill="white"/></svg>`,l={width:`min(100%, 56rem)`,minHeight:`18rem`},u={width:`min(100%, 44rem)`,minHeight:`14rem`},d=a({id:`watermark`,name:`Watermark`,category:`content`,packageName:`willa/Watermark`,description:`用于页面、卡片、预览区和导出区域的文本或图片水印覆盖层。`,imports:[{name:`Watermark`,from:`willa/Watermark`}],css:`willa/Watermark.css`,demo:{name:`Watermark`,component:o,props:{content:[`Willa Components`,`Internal Preview`],gap:[88,72],offset:[16,20],children:(0,s.jsx)(t,{variant:`outline`,style:l,children:(0,s.jsxs)(r,{gap:`sm`,children:[(0,s.jsxs)(n,{justify:`between`,align:`center`,children:[(0,s.jsxs)(r,{gap:`xs`,children:[(0,s.jsx)(`strong`,{children:`组件预览草稿`}),(0,s.jsx)(`span`,{style:{color:`var(--willa-text-soft)`,fontSize:`0.92rem`},children:`当前页面包含未发布的布局和样式调整。`})]}),(0,s.jsx)(i,{tone:`info`,children:`仅内部可见`})]}),(0,s.jsx)(`p`,{style:{margin:0,color:`var(--willa-text)`},children:`这里适合放卡片、表格、文章内容或图片预览区。`})]})})}},code:`
  ...
  `,sections:[{title:`文字样式与密度`,code:`
      ...
      `,content:(0,s.jsx)(o,{content:[`Design Review`,`Preview Only`],width:184,height:96,gap:[56,48],rotate:-16,font:{color:`rgba(79, 117, 214, 0.18)`,fontSize:17,fontWeight:640,letterSpacing:1},children:(0,s.jsx)(t,{variant:`outline`,style:u,children:(0,s.jsxs)(r,{gap:`xs`,children:[(0,s.jsx)(`strong`,{children:`更高密度的审批面板`}),(0,s.jsx)(`span`,{style:{color:`var(--willa-text-soft)`,fontSize:`0.9rem`},children:`适合评审区、导出预览区和二次确认面板。`})]})})})},{title:`自定义字体颜色`,code:`
        <Watermark
      ...
      `,content:(0,s.jsx)(o,{content:[`Internal`,`Only`],width:168,height:92,gap:[72,60],rotate:-18,font:{color:`rgba(34, 197, 94, 0.18)`,fontSize:16,fontWeight:620,letterSpacing:.8},children:(0,s.jsx)(t,{variant:`outline`,style:u,children:(0,s.jsxs)(r,{gap:`xs`,children:[(0,s.jsx)(`strong`,{children:`可调色的文字水印`}),(0,s.jsx)(`span`,{style:{color:`var(--willa-text-soft)`,fontSize:`0.9rem`},children:`适合内部预览、评审稿和半透明提示层。`})]})})})},{title:`图片水印`,code:`
        const brandMark =
