import{b1 as i,aZ as e,V as a,a3 as n,A as s}from"./index-D1WL8Azw.js";import{S as t}from"./index-D-J9hUvy.js";/* empty css              */import{d as o}from"./defineDoc-D4e1n7NZ.js";const p=o({id:"statistic",name:"Statistic",category:"content",packageName:"willa/Statistic",description:"用于展示指标、趋势和轻量统计数据。",imports:[{name:"Statistic",from:"willa/Statistic"}],css:"willa/Statistic.css",demo:{name:"Statistic",component:t,props:{label:"本月调用量",value:"128.4K",description:"包含 API 与组件站点请求",trend:"up",trendLabel:"+12.8%",icon:e.jsx(s,{}),tone:"info"}},code:i(`
