import{aL as e,S as m,aa as t}from"./index-DNQF9iNw.js";import{B as r}from"./index-3LSK7fxt.js";import{d as c}from"./defineDoc-zHnHUJEc.js";const o=[{label:"首页",href:"#/"},{label:"基础组件",href:"#/button"},{label:"Breadcrumb"}],l=[{label:"Willa",href:"#/",icon:e.jsx(m,{})},{label:"文档",href:"#/mdx",icon:e.jsx(t,{})},{label:"导航层级"}],a={width:"min(100%, 44rem)",marginInline:"auto"},n=c({id:"breadcrumb",name:"Breadcrumb",packageName:"willa/Breadcrumb",description:"用于展示页面层级、返回路径和当前位置的导航组件。",imports:[{name:"Breadcrumb",from:"willa/Breadcrumb"}],css:"willa/Breadcrumb.css",demo:{name:"Breadcrumb",component:r,props:{style:a,items:o}},code:`
  ...
  `,sections:[{title:"带图标",code:`
        ...
        <Breadcrumb items={items} />;
      `,content:e.jsx("div",{style:a,children:e.jsx(r,{items:l})})},{title:"紧凑尺寸",code:`
        <Breadcrumb
          size="sm"
          items={[
            { label: "项目", href: "#/" },
        ...
        />;
      `,content:e.jsx("div",{style:a,children:e.jsx(r,{size:"sm",items:[{label:"项目",href:"#/"},{label:"设置",href:"#/form"},{label:"权限策略"}]})})},{title:"自定义分隔符",code:`
        <Breadcrumb
          separator="/"
          items={[
