import{af as t,O as o,d as a,x as n}from"./index-DscgVaJe.js";import{B as i}from"./index-Be-IG3zl.js";import{E as e}from"./index-DP7oAxiV.js";import{G as s}from"./index-CRmz2zFt.js";/* empty css              */import{d as r}from"./defineDoc-BNnDXU4q.js";import"./heading-CGFEtO8f.js";const p={display:"grid",gap:"0.9rem",width:"100%"},f=r({id:"empty-state",name:"EmptyState",packageName:"willa/EmptyState",description:"用于列表为空、搜索无结果和 AI 上下文缺失时的空状态提示。",imports:[{name:"EmptyState",from:"willa/EmptyState"},{name:"Button",from:"willa/Button"},{name:"Group",from:"willa/Group"}],css:"willa/EmptyState.css",demo:{name:"EmptyState",component:e,props:{icon:t.jsx(o,{}),title:"没有找到结果",description:"换一个关键词，或清空筛选条件后重新搜索。",actions:t.jsxs(s,{gap:"sm",justify:"center",children:[t.jsx(i,{size:"sm",variant:"solid",children:"清空筛选"}),t.jsx(i,{size:"sm",variant:"ghost",children:"新建内容"})]})}},code:`
