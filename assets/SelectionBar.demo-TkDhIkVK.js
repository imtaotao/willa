import{aX as e,an as n,h as t,av as c,aZ as l,G as i,c as r,aB as d}from"./index-CMTLjcZC.js";/* empty css              */import{d as u}from"./defineDoc-mP-k1rVE.js";const m=()=>{const[s,o]=l.useState(3),a=18;return e.jsx(n,{selectedCount:s,totalCount:a,description:"当前筛选结果中还有未选中的文件。",onSelectAll:()=>o(a),onClear:()=>o(0),actions:e.jsxs(e.Fragment,{children:[e.jsx(t,{size:"sm",variant:"soft",icon:e.jsx(i,{}),children:"下载"}),e.jsx(t,{size:"sm",variant:"outline",icon:e.jsx(r,{}),children:"归档"})]})})},S=u({id:"selection-bar",name:"SelectionBar",packageName:"willa/SelectionBar",description:"用于列表、表格、文件和卡片多选后的批量操作反馈。",imports:[{name:"Button",from:"willa/Button"},{name:"SelectionBar",from:"willa/SelectionBar"},{name:"Stack",from:"willa/Stack"}],css:"willa/SelectionBar.css",demo:{name:"SelectionBar",component:n,props:{selectedCount:3,totalCount:24,description:"已选项目会参与接下来的批量操作。",actions:e.jsxs(e.Fragment,{children:[e.jsx(t,{size:"sm",variant:"soft",icon:e.jsx(i,{}),children:"下载"}),e.jsx(t,{size:"sm",variant:"outline",icon:e.jsx(d,{}),children:"删除"})]}),onClear:()=>{}}},code:`
  ...
  `,sections:[{title:"全选和清空",code:`
      ...
      `,content:e.jsx(m,{})},{title:"紧凑模式",code:`
        <SelectionBar
          ...
          onClear={() => undefined}
        />;
      `,content:e.jsx(n,{compact:!0,selectedCount:2,label:"已选中 2 条评论",actions:e.jsx(t,{size:"sm",variant:"soft",children:"标记已读"}),onClear:()=>{}})},{title:"粘性操作区",code:`
        <SelectionBar
          sticky
          selectedCount={6}
          totalCount={42}
          ...
          onClear={() => undefined}
        />;
      `,content:e.jsx(n,{sticky:!0,selectedCount:6,totalCount:42,description:"适合表格顶部、文件列表顶部和卡片墙顶部。",actions:e.jsxs(e.Fragment,{children:[e.jsx(t,{size:"sm",variant:"soft",children:"移动到分组"}),e.jsx(t,{size:"sm",variant:"outline",children:"批量设置标签"})]}),onSelectAll:()=>{},onClear:()=>{}})},{title:"不同对齐方式",code:`
        <Stack gap="sm">
          <SelectionBar
            align="start"
            selectedCount={1}
