import{b1 as e}from"./index-Kfv3pNKk.js";import{S as t}from"./index-DJPEZtGe.js";import{d as i}from"./defineDoc-EZFsevgg.js";import"./index-CaAoZr5p.js";import"./useComboboxState-CrzCOQ0S.js";import"./floatingPanelParts-DFM041Mz.js";import"./useFloatingPanel-tNm78s6R.js";const a={display:"grid",gap:"0.9rem",maxWidth:"42rem"},l=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],u=i({id:"select",name:"Select",category:"form",packageName:"willa/Select",description:"用于单选下拉，适合表单、筛选和配置场景。",imports:[{name:"Select",from:"willa/Select"}],css:"willa/Select.css",demo:{name:"Select",component:t,props:{options:l,defaultValue:"balanced",width:"100%"}},code:`
