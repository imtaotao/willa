import{ak as d,ah as p,aj as l}from"./index-Bdj8Q3L_.js";function N(n){return{id:n.id,name:n.name,category:n.category??"content",packageName:n.packageName,description:n.description,preview:g(n.demo),code:n.code?d(n.code):A(n),props:n.props,sections:n.sections}}const g=n=>{const r=Array.isArray(n.children)?n.children.map((t,e)=>p.jsx(h,{element:t},`${t.name}-${e}`)):n.children;return l.createElement(n.component,n.props,r)},h=({element:n})=>p.jsx(p.Fragment,{children:g(n)}),A=n=>{const r=n.imports.map(t=>`import { ${t.name} } from "${t.from}";`).join(`
