import{ay as t,d as e}from"./index-DrRUehET.js";import{d as l}from"./defineDoc-CvDLWAkX.js";const o={display:"grid",gap:"0.85rem"},n=l({id:"callout",name:"Callout",packageName:"willa/Callout",description:"用于提示、警告、成功、建议和错误状态的上下文信息块。",imports:[{name:"Callout",from:"willa/Callout"}],css:"willa/Callout.css",demo:{name:"Callout",component:e,props:{tone:"tip",title:"单组件引入"},children:"从对应的 Willa 入口同时引入组件和 CSS。"},code:`
