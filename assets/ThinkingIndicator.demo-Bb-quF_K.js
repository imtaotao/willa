import{b3 as e,a7 as a,al as t}from"./index-BFdlIxUH.js";import{C as n}from"./index-D5H4z2Lz.js";import{T as i}from"./index-CXIlAusl.js";import{d as s}from"./defineDoc-CmN89srR.js";import"./index-B7IAO4j0.js";import"./cardCollapse-BG8gEjL8.js";const o="https://github.com/openai.png",l={display:"grid",gap:"1rem",width:"min(100%, 58rem)",border:"1px solid var(--willa-line)",borderRadius:"0.9rem",background:"var(--willa-panel-bg)",padding:"1rem"},r=()=>e.jsx("div",{style:l,children:e.jsx(n,{role:"assistant",name:"Willa AI",avatarSrc:o,meta:"处理中",children:e.jsx(i,{collapsible:!0,defaultCollapsed:!0,status:"searching",label:"正在检索上下文",description:"会先读取相关文档，再整理可执行建议。",summary:"AI 正在处理公开任务状态。",steps:["理解问题","检索资料","生成回答"],activeStep:1})})}),h=s({id:"thinking-indicator",name:"ThinkingIndicator",category:"ai",packageName:"willa/ThinkingIndicator",description:"用于展示 AI 正在思考、检索、读取或生成的公开任务状态，不展示模型内部思维链。",imports:[{name:"ThinkingIndicator",from:"willa/ThinkingIndicator"}],css:"willa/ThinkingIndicator.css",demo:{name:"ThinkingIndicatorPreview",component:r},code:`
