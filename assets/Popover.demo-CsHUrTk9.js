import{aK as r,as as K,aI as e,aJ as re,at as M,aw as se,B as U,e as p,U as z,L as le,X as ae}from"./index-D3fPsv2G.js";import{g as de}from"./dom-DvRKQOia.js";/* empty css              *//* empty css              */import{d as ce}from"./defineDoc-HKk9scXA.js";function f(n){const{trigger:o,children:s,title:i,description:d,footer:m,open:w,defaultOpen:R=!1,onOpenChange:v,side:y="bottom",align:x="start",offset:h=10,size:G="md",autoFocus:L=!0,closeOnOutsidePointerDown:O=!0,closeOnEscape:H=!0,showArrow:P=!0,ariaLabel:J,className:X,contentClassName:_}=n,j=r.useId(),T=i?`${j}-title`:void 0,F=d?`${j}-description`:void 0,W=w!==void 0,[Q,Y]=r.useState(R),g=w??Q,[Z,ee]=r.useState(),V=r.useRef(null),b=r.useRef(null),S=r.useRef(null),B=r.useCallback(t=>{W||Y(t),v==null||v(t)},[W,v]),k=r.useCallback(()=>{B(!1)},[B]),E=r.useCallback(()=>{const t=V.current,c=b.current;if(!t||!c||typeof window>"u")return;const l=t.getBoundingClientRect(),u=c.getBoundingClientRect(),a=pe({triggerRect:l,popoverRect:u,side:y,align:x,offset:P?h+6:h});ee({top:K(a.top,8,Math.max(8,window.innerHeight-u.height-8)),left:K(a.left,8,Math.max(8,window.innerWidth-u.width-8)),minWidth:Math.min(l.width,window.innerWidth-16)})},[x,h,P,y]);r.useEffect(()=>{if(!g||typeof window>"u")return;S.current=document.activeElement instanceof HTMLElement?document.activeElement:null,E();const t=window.requestAnimationFrame(E),c=window.setTimeout(()=>{if(!L)return;const a=b.current;if(!a)return;(de(a)[0]??a).focus()},0),l=a=>{var $,A;if(!O)return;const N=a.target;N instanceof Node&&(($=b.current)!=null&&$.contains(N)||(A=V.current)!=null&&A.contains(N)||k())},u=()=>E();return document.addEventListener("pointerdown",l),window.addEventListener("resize",u),window.addEventListener("scroll",u,!0),()=>{var a;window.cancelAnimationFrame(t),window.clearTimeout(c),document.removeEventListener("pointerdown",l),window.removeEventListener("resize",u),window.removeEventListener("scroll",u,!0),(a=S.current)==null||a.focus(),S.current=null}},[L,O,k,g,E]);const te=t=>{var c,l;(l=(c=o.props).onClick)==null||l.call(c,t),t.defaultPrevented||B(!g)},oe=t=>{var c,l;(l=(c=o.props).onKeyDown)==null||l.call(c,t),!t.defaultPrevented&&(t.key==="ArrowDown"||t.key==="Enter"||t.key===" ")&&(t.preventDefault(),B(!0))},ne=t=>{t.key==="Escape"&&H&&(t.stopPropagation(),k())},ie=()=>{if(!r.isValidElement(o))return null;const t=o;return r.cloneElement(t,{ref:se(t.props.ref,V),"aria-controls":g?j:void 0,"aria-expanded":g,"aria-haspopup":"dialog",onClick:te,onKeyDown:oe})};return e.jsxs("span",{className:M("willa-popover",X),children:[ie(),g&&typeof document<"u"?re.createPortal(e.jsxs("div",{ref:b,id:j,className:M("willa-popover-content",`willa-popover-content--${G}`,P&&`willa-popover-content--${y}`,_),style:ue(Z),role:"dialog","aria-label":i?void 0:J??"Popover","aria-labelledby":T,"aria-describedby":F,tabIndex:-1,onKeyDown:ne,children:[P?e.jsx("span",{className:"willa-popover-arrow","aria-hidden":"true"}):null,i||d?e.jsxs("header",{className:"willa-popover-header",children:[i?e.jsx("h2",{id:T,className:"willa-popover-title",children:i}):null,d?e.jsx("p",{id:F,className:"willa-popover-description",children:d}):null]}):null,s?e.jsx("div",{className:"willa-popover-body",children:s}):null,m?e.jsx("footer",{className:"willa-popover-footer",children:m}):null]}),document.body):null]})}const pe=n=>{const{triggerRect:o,popoverRect:s,side:i,align:d,offset:m}=n,w=o.left+o.width/2-s.width/2,R=o.top+o.height/2-s.height/2;if(i==="top"||i==="bottom"){const x=i==="top"?o.top-s.height-m:o.bottom+m,h=q(o.left,o.right,s.width,w,d);return{top:x,left:h}}const v=i==="left"?o.left-s.width-m:o.right+m;return{top:q(o.top,o.bottom,s.height,R,d),left:v}},q=(n,o,s,i,d)=>d==="start"?n:d==="end"?o-s:i,ue=n=>({top:n?`${n.top}px`:void 0,left:n?`${n.left}px`:void 0,minWidth:n?`${n.minWidth}px`:void 0,visibility:n?void 0:"hidden"}),me={display:"flex",flexWrap:"wrap",gap:"0.75rem",alignItems:"center"},C={display:"grid",gap:"0.7rem"},D={display:"grid",gap:"0.35rem"},I={color:"var(--willa-text-soft)",fontSize:"0.82rem"},ye=ce({id:"popover",name:"Popover",packageName:"willa/Popover",description:"用于承载可交互内容的轻量浮层，适合设置面板、筛选器和上下文信息。",imports:[{name:"Popover",from:"willa/Popover"},{name:"Button",from:"willa/Button"}],css:"willa/Popover.css",demo:{name:"Popover",component:f,props:{title:"生成设置",description:"调整回复长度和输出语气。",trigger:e.jsx(p,{icon:e.jsx(ae,{}),variant:"outline",children:"打开设置"}),children:e.jsxs("div",{style:C,children:[e.jsxs("div",{style:D,children:[e.jsx("span",{style:I,children:"模型"}),e.jsx(z,{defaultValue:"willa-ai-default",size:"sm"})]}),e.jsx(U,{tone:"info",children:"已启用上下文增强"})]})}},code:`
  ...
  `,sections:[{title:"基础浮层",code:`
      ...
      `,content:e.jsx(f,{title:"内容策略",description:"适合放少量说明和一组轻量操作，不适合承载完整流程。",trigger:e.jsx(p,{variant:"outline",children:"查看策略"}),children:e.jsxs("div",{style:C,children:[e.jsx(U,{tone:"info",children:"轻量交互"}),e.jsx("span",{children:"点击外部区域或按 Escape 可以关闭浮层。"})]})})},{title:"表单内容",code:`
        <Popover
          title="快速配置"
