import{an as e,P as a,Q as n,ap as l,T as r,z as d,O as p}from"./index-D1DxGs20.js";import{S as t}from"./index-CkdHHU4-.js";import{P as m}from"./index-Bds4VtCZ.js";import{d as c}from"./defineDoc-BreWiU-W.js";import"./index-C7lSDzNL.js";import"./index-Bruz1WA0.js";const g=[{id:"summarize",label:"总结这份文档",description:"输出重点和风险",icon:e.jsx(d,{})},{id:"search",label:"检索相关资料",description:"补充来源证据",icon:e.jsx(n,{})},{id:"plan",label:"拆成执行计划",description:"按优先级排序",icon:e.jsx(p,{})}],u=()=>{const[o,s]=l.useState("");return e.jsxs(r,{padding:"md",style:{width:"min(100%, 56rem)"},children:[e.jsx(t,{items:g,onSelect:i=>{s(String(i.label))}}),e.jsx(m,{value:o,placeholder:"选择一个建议，或直接输入问题...",minRows:2,maxRows:5,onChange:i=>s(i.currentTarget.value)})]})},x=c({id:"suggestion-chips",name:"SuggestionChips",category:"ai",packageName:"willa/SuggestionChips",description:"用于展示快捷提示词、推荐问题和 AI 任务入口。",imports:[{name:"SuggestionChips",from:"willa/SuggestionChips"},{name:"Panel",from:"willa/Panel"}],css:"willa/SuggestionChips.css",demo:{name:"SuggestionChipsPreview",component:u},code:`
