import{aO as e,aq as o,g as n,ao as b,aQ as m,ag as v,B as s,Q as g}from"./index-Bny0WqCC.js";/* empty css              */import{F as T}from"./index-CEi3t7xP.js";/* empty css              */import{S as h}from"./index-tjRvSRtE.js";/* empty css              */import{S as w}from"./index-Ks9vtVhg.js";import{d as f}from"./defineDoc-CxHxkwRA.js";import"./index-bW2jczHh.js";import"./useSelectablePanel-C9OQG5ix.js";import"./useFloatingPanel-CtlQGlhd.js";const r=[{key:"prompt-input",cells:[{key:"name",label:"组件",value:"PromptInput",width:"12rem",sortable:!0},{key:"owner",label:"归属",value:"AI"},{key:"status",label:"状态",value:"stable",render:e.jsx(s,{tone:"success",children:"稳定"})},{key:"coverage",label:"覆盖能力",value:"输入、提交、禁用、自动高度和辅助信息"}],expanded:"PromptInput 适合作为 AI 对话、智能搜索和生成任务的输入入口。",actions:e.jsx(n,{size:"sm",variant:"ghost",children:"查看"})},{key:"upload",tone:"warning",cells:[{key:"name",label:"组件",value:"Upload",width:"12rem",sortable:!0},{key:"owner",label:"归属",value:"Form"},{key:"status",label:"状态",value:"wip",render:e.jsx(s,{tone:"warning",children:"完善中"})},{key:"coverage",label:"覆盖能力",value:"拖拽、预览、上传进度和下载回退"}],expanded:"Upload 可以接入用户自己的上传逻辑，并展示上传进度。",actions:e.jsx(n,{size:"sm",variant:"ghost",children:"查看"})},{key:"code-block",selected:!0,cells:[{key:"name",label:"组件",value:"CodeBlock",width:"12rem",sortable:!0},{key:"owner",label:"归属",value:"Content"},{key:"status",label:"状态",value:"stable",render:e.jsx(s,{tone:"success",children:"稳定"})},{key:"coverage",label:"覆盖能力",value:"高亮、行号、复制、文件名和语言提示"}],expanded:"CodeBlock 是内容渲染和 AI 代码结果的基础展示组件。",actions:e.jsx(n,{size:"sm",variant:"ghost",children:"查看"})}],x=[{key:"mobile",cells:[{key:"task",label:"任务",value:"移动端校验"},{key:"owner",label:"负责人",value:"Design"},{key:"progress",label:"进度",value:"82%",align:"end"}]},{key:"theme",cells:[{key:"task",label:"任务",value:"主题变量整理"},{key:"owner",label:"负责人",value:"Frontend"},{key:"progress",label:"进度",value:"96%",align:"end"}]}],I=[{key:"feedback-summary",cells:[{key:"task",label:"任务",value:"产品反馈摘要生成",width:"12rem",render:e.jsxs(g,{as:"span",gap:"xs",inline:!0,wrap:!1,children:[e.jsx(s,{tone:"info",children:"AI"}),e.jsx("strong",{children:"产品反馈摘要生成"})]})},{key:"detail",label:"说明",value:"从近 128 条用户反馈中提取高频问题、风险提示和下一步可执行建议。",title:"从近 128 条用户反馈中提取高频问题、风险提示和下一步可执行建议。"},{key:"result",label:"结果",value:"已生成",render:e.jsx(s,{tone:"success",children:"已生成"}),align:"end"}],actions:e.jsx(n,{size:"sm",variant:"ghost",children:"复制"})},{key:"risk-check",cells:[{key:"task",label:"任务",value:"风险校验",width:"12rem",render:e.jsxs(g,{as:"span",gap:"xs",inline:!0,wrap:!1,children:[e.jsx(s,{tone:"warning",children:"审核"}),e.jsx("strong",{children:"风险校验"})]})},{key:"detail",label:"说明",value:"检查生成内容里是否包含敏感信息、缺少来源引用或需要人工确认的结论。",title:"检查生成内容里是否包含敏感信息、缺少来源引用或需要人工确认的结论。"},{key:"result",label:"结果",value:"需要复核",render:e.jsx(s,{tone:"warning",children:"需要复核"}),align:"end"}],actions:e.jsx(n,{size:"sm",variant:"ghost",children:"查看"})}],C=[{key:"prompt-config",cells:[{key:"name",label:"组件",value:"PromptInput",width:168,sortable:!0},{key:"scene",label:"场景",value:"AI 对话、信息检索、批量生成和任务录入"},{key:"detail",label:"说明",value:"支持自动高度、提交快捷键、辅助动作、loading 状态和多种输入约束。"},{key:"owner",label:"归属",value:"AI",align:"center"}],actions:e.jsx(n,{size:"sm",variant:"ghost",children:"查看"})},{key:"markdown-preview",cells:[{key:"name",label:"组件",value:"CodeBlock",width:168,sortable:!0},{key:"scene",label:"场景",value:"长文本预览、代码片段展示和复制"},{key:"detail",label:"说明",value:"适合在内容页、文档页和示例页里承载长描述，拖宽后能更完整地看到上下文。"},{key:"owner",label:"归属",value:"Content",align:"center"}],actions:e.jsx(n,{size:"sm",variant:"ghost",children:"查看"})},{key:"table-preview",cells:[{key:"name",label:"组件",value:"Table",width:168,sortable:!0},{key:"scene",label:"场景",value:"数据管理、结果列表、审阅队列和批量操作"},{key:"detail",label:"说明",value:"列宽可以通过拖拽手动调整，双击拖拽柄后会自动扩到当前内容所需宽度。"},{key:"owner",label:"归属",value:"Content",align:"center"}],actions:e.jsx(n,{size:"sm",variant:"ghost",children:"查看"})}],S=Array.from({length:16},(a,l)=>({key:`method-${l+1}`,cells:[{key:"name",label:"组件",value:["Table","FilterBar","SelectionBar","Tooltip"][l%4],width:160,fixed:"left"},{key:"owner",label:"归属",value:["Content","Form","Content","Content","AI","Widgets"][l%6],width:120},{key:"scene",label:"场景",value:["内容列表、批量管理和审阅队列","知识库索引和检索结果","图文素材管理和发布审核","生成结果回看和修订"][l%4],width:220},{key:"desc",label:"说明",value:"这是一段较长的说明文本，用来演示 Table 内部滚动容器的实例方法、横向滚动位置控制和列宽变化后的布局表现。",width:320},{key:"status",label:"状态",value:l%2===0?"stable":"wip",render:l%2===0?e.jsx(s,{tone:"success",children:"稳定"}):e.jsx(s,{tone:"warning",children:"完善中"}),align:"end",width:120},{key:"updated",label:"更新时间",value:`2026-06-${String(10+l).padStart(2,"0")}`,width:140,fixed:"right"}],actions:e.jsx(n,{size:"sm",variant:"ghost",children:"查看"})})),B=()=>e.jsx(b,{width:"100%",children:e.jsx(o,{caption:"拖拽表头右侧把手调整列宽，双击后自动适配内容宽度",items:C,resizableColumns:!0,stickyActions:!0,actionsWidth:"5.6rem"})}),j=()=>{const a=m.useRef(null),[l,i]=m.useState(!0);return e.jsxs(b,{gap:"md",width:"100%",children:[e.jsx(w,{checked:l,label:"固定表头",onChange:t=>i(t.currentTarget.checked)}),e.jsxs(g,{gap:"sm",wrap:!0,children:[e.jsx(n,{size:"sm",variant:"ghost",onClick:()=>{var t;return(t=a.current)==null?void 0:t.scrollToLeft("smooth")},children:"滚到最左"}),e.jsx(n,{size:"sm",variant:"ghost",onClick:()=>{var t;return(t=a.current)==null?void 0:t.scrollTo({left:760,behavior:"smooth"})},children:"滚到右侧"}),e.jsx(n,{size:"sm",variant:"ghost",onClick:()=>{var t;return(t=a.current)==null?void 0:t.scrollToTop("smooth")},children:"回到顶部"}),e.jsx(n,{size:"sm",variant:"ghost",onClick:()=>{var t;return(t=a.current)==null?void 0:t.scrollToBottom("smooth")},children:"到底部"})]}),e.jsx(o,{ref:a,caption:"固定列、操作列和实例方法控制内部滚动容器",items:S,resizableColumns:!0,stickyHeader:l,stickyActions:!0,actionsWidth:"5.6rem",style:{maxHeight:"20rem"}})]})},A=[{value:"all",label:"全部归属"},{value:"AI",label:"AI"},{value:"Form",label:"Form"},{value:"Content",label:"Content"}],R=[{value:"all",label:"全部状态"},{value:"stable",label:"稳定"},{value:"wip",label:"完善中"}],z=()=>{const[a,l]=m.useState(""),[i,t]=m.useState("all"),[p,d]=m.useState("all"),c=N(r,{keyword:a,owner:i,status:p}),u=[{id:"owner",width:"10rem",control:e.jsx(h,{value:i,options:A,width:"100%",onValueChange:t})},{id:"status",width:"10rem",control:e.jsx(h,{value:p,options:R,width:"100%",onValueChange:d})}];return e.jsx(b,{gap:"md",width:"min(100%, 72rem)",style:{marginInline:"auto"},children:e.jsx(o,{header:e.jsx(T,{search:e.jsx(v,{value:a,onValueChange:l,placeholder:"搜索组件、归属或能力",width:"100%"}),items:u,actions:e.jsx(n,{size:"sm",variant:"ghost",onClick:()=>{l(""),t("all"),d("all")},children:"重置"}),summary:`匹配 ${c.length} 个组件。`}),caption:"组件筛选结果",items:c,empty:"没有匹配的组件",stickyActions:!0,footer:`当前展示 ${c.length} / ${r.length} 个组件。`})})},N=(a,l)=>{const i=l.keyword.trim().toLowerCase();return a.filter(t=>{var u,k;const p=t.cells.map(V).join(" ").toLowerCase(),d=String(((u=t.cells.find(y=>y.key==="owner"))==null?void 0:u.value)??""),c=String(((k=t.cells.find(y=>y.key==="status"))==null?void 0:k.value)??"");return(!i||p.includes(i))&&(l.owner==="all"||d===l.owner)&&(l.status==="all"||c===l.status)})},V=a=>typeof a.value=="string"||typeof a.value=="number"?String(a.value):"",H=f({id:"table",name:"Table",packageName:"willa/Table",description:"通过 items 渲染表格和产品数据列表，支持自定义单元格、排序、选择、分页、展开行、右侧操作区、列宽调整和滚动控制。",imports:[{name:"Table",from:"willa/Table"},{name:"Stack",from:"willa/Stack"},{name:"Group",from:"willa/Group"}],css:"willa/Table.css",demo:{name:"Table",component:o,props:{caption:"组件能力覆盖表",items:r}},code:`
  ...
  `,sections:[{title:"搜索与筛选",code:`
      ...
      `,content:e.jsx(z,{})},{title:"基础表格",code:`
        const items = [
          {
            key: "prompt-input",
            cells: [
        ...
        />;
      `,content:e.jsx(o,{caption:"组件能力覆盖表",items:r,defaultSort:{key:"name",direction:"asc"}})},{title:"选择与固定操作列",code:`
        const items = [
          {
            key: "prompt-input",
            cells: [
        ...
        <Table
          ...
          actionsWidth="5.6rem"
        />;
      `,content:e.jsx(o,{caption:"横向滚动时保留操作入口",items:r,selectionMode:"multiple",selectionBar:!0,selectionBarDescription:"可以对当前筛选结果执行批量操作。",selectionBarActions:e.jsx(n,{size:"sm",variant:"soft",children:"批量导出"}),stickyActions:!0,actionsWidth:"5.6rem"})},{title:"列宽调整",code:`
        const items = [
          {
            key: "prompt-config",
            cells: [
      ...
      `,content:e.jsx(j,{})},{title:"分页与展开",code:`
        const items = [
          {
            key: "prompt-input",
            cells: [
        ...
        />;
      `,content:e.jsx(o,{caption:"分页后仍可展开查看详情",items:r,defaultExpandedKeys:["prompt-input"],pagination:{pageSize:2}})},{title:"自定义单元格",code:`
        const items = [
          {
      ...
      `,content:e.jsx(o,{caption:"自定义渲染和溢出提示",items:I,stickyActions:!0})},{title:"加载与空态",code:`
        <Stack gap="lg">
          <Table items={[]} loading loadingText="正在同步组件状态..." />
          <Table items={[]} empty="没有匹配的组件" />
        </Stack>;
      `,content:e.jsxs(b,{gap:"lg",children:[e.jsx(o,{items:[],loading:!0,loadingText:"正在同步组件状态..."}),e.jsx(o,{items:[],empty:"没有匹配的组件"})]})},{title:"紧凑尺寸",code:`
        const items = [
          {
            key: "mobile",
            cells: [
