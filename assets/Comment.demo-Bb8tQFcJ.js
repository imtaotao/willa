import{aD as t,B as i,O as n,e,h as m,j as r}from"./index-D5uFLOdF.js";import{C as a}from"./index-CIPgFliO.js";/* empty css              *//* empty css              */import{d as s}from"./defineDoc-Bhi9w6ym.js";import"./index-uZVKANNy.js";const o={display:"grid",gap:"0.8rem",width:"min(100%, 48rem)",margin:"0 auto"},v=s({id:"comment",name:"Comment",category:"content",packageName:"willa/Comment",description:"用于评论、批注、审核意见和讨论记录中的单条内容展示。",imports:[{name:"Comment",from:"willa/Comment"}],css:"willa/Comment.css",demo:{name:"Comment",component:a,props:{author:"Tao Tao",avatarSrc:"https://github.com/imtaotao.png",avatarName:"Tao Tao",meta:"刚刚",actions:t.jsx(e,{size:"sm",variant:"ghost",children:"回复"}),children:t.jsx("p",{children:"这里可以作为文章评论，也可以用于文档批注和产品审核意见。核心内容保持清晰， 操作区放轻量动作。"})}},code:`
