import{aY as e,an as t,a_ as l,B as d}from"./index-BKM6rV0u.js";import{d as o}from"./defineDoc-0qrN7MLj.js";const i={display:"grid",gap:"0.85rem",maxWidth:"44rem",marginInline:"auto"},c={display:"flex",flexWrap:"wrap",alignItems:"center",gap:"0.75rem",maxWidth:"44rem",marginInline:"auto"},p=()=>{const[n,s]=l.useState("组件文档"),[a,r]=l.useState("组件文档");return e.jsxs("div",{style:i,children:[e.jsx(t,{value:n,onValueChange:s,onSearch:r,onClear:()=>r(""),placeholder:"搜索组件、文档或示例",width:"100%"}),e.jsx(d,{tone:a?"info":"neutral",children:a?`已搜索：${a}`:"暂无搜索内容"})]})},h=o({id:"search-input",name:"SearchInput",category:"form",packageName:"willa/SearchInput",description:"带搜索图标、清除按钮和回车搜索语义的单行输入框。",imports:[{name:"SearchInput",from:"willa/SearchInput"}],css:"willa/SearchInput.css",demo:{name:"SearchInput",component:t,props:{placeholder:"搜索组件、文档或示例",width:"100%"}},code:`
