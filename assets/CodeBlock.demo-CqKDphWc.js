import{an as o,ak as e,m as d}from"./index-qn4eWa1o.js";import{d as t}from"./defineDoc-BS0X7wWk.js";const n="export function greet(name: string) {\n  return `Hello, ${name}`;\n}",c=t({id:"code-block",name:"CodeBlock",packageName:"willa/CodeBlock",description:"带语法高亮和复制操作的代码块。",imports:[{name:"CodeBlock",from:"willa/CodeBlock"}],css:"willa/CodeBlock.css",demo:{name:"CodeBlock",component:d,props:{code:n,language:"ts",showLineNumbers:!0,highlightLines:[2]}},code:o(`
