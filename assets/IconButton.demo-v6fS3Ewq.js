import{az as o,P as a,c as t,N as l,x as s,V as i,b as d,F as e,i as r,m as c,aa as u}from"./index-C7qrHHGg.js";import{d as p}from"./defineDoc-Clz3CsHg.js";const n={display:"flex",flexWrap:"wrap",gap:"0.75rem",alignItems:"center"},I=p({id:"icon-button",name:"IconButton",packageName:"willa/IconButton",description:"用于工具栏、卡片操作区和内联内容中的纯图标按钮。",imports:[{name:"IconButton",from:"willa/IconButton"}],css:"willa/IconButton.css",demo:{name:"IconButton",component:a,props:{ariaLabel:"分享文章",icon:o.jsx(u,{})}},code:`
