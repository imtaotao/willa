import{aY as t,B as i,V as n,i as e,l as m,n as r}from"./index-YXVa6-ur.js";import{C as a}from"./index-DOJGpCJ6.js";/* empty css              *//* empty css              *//* empty css              */import{d as s}from"./defineDoc-CUAjwIOK.js";import"./index-GTRNMoEs.js";const o={display:"grid",gap:"0.8rem",width:"min(100%, 48rem)",margin:"0 auto"},g=s({id:"comment",name:"Comment",category:"content",packageName:"willa/Comment",description:"用于评论、批注、审核意见和讨论记录中的单条内容展示。",imports:[{name:"Comment",from:"willa/Comment"}],css:"willa/Comment.css",demo:{name:"Comment",component:a,props:{author:"Tao Tao",avatarSrc:"https://github.com/imtaotao.png",avatarName:"Tao Tao",meta:"刚刚",actions:t.jsx(e,{size:"sm",variant:"ghost",children:"回复"}),children:t.jsx("p",{children:"这里可以作为文章评论，也可以用于文档批注和产品审核意见。核心内容保持清晰， 操作区放轻量动作。"})}},code:`
  ...
  `,sections:[{title:"审核意见",code:`
      ...
      `,content:t.jsx("div",{style:o,children:t.jsx(a,{size:"sm",author:"文档协作者",avatarName:"文档协作者",meta:"2 分钟前",actions:t.jsxs(n,{gap:"xs",children:[t.jsx(e,{size:"sm",variant:"ghost",icon:t.jsx(m,{}),children:"回复"}),t.jsx(e,{size:"sm",variant:"ghost",icon:t.jsx(r,{}),children:"解决"})]}),children:t.jsx("p",{children:"这个段落可以再补一个移动端截图，方便评审时核对。"})})})},{title:"评论流",code:`
        <div style={demoFrameStyle}>
          <Comment
            variant="feed"
            author="内容编辑"
