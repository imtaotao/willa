import{ag as e}from"./index-DcKe6ljB.js";import{D as a}from"./index-nMJJoc0t.js";import{d as n}from"./defineDoc-CU4WbHug.js";const o="data:text/plain;charset=utf-8,%E8%BF%99%E6%98%AF%20Willa%20Download%20%E7%BB%84%E4%BB%B6%E7%9A%84%E6%BC%94%E7%A4%BA%E6%96%87%E4%BB%B6%E3%80%82",t={display:"flex",minWidth:0,alignItems:"center",flexWrap:"wrap",gap:"0.75rem"},d=()=>e.jsxs("div",{style:t,children:[e.jsx(a,{href:o,name:"product-brief.txt",meta:"2 KB"}),e.jsx(a,{href:o,name:"feedback.csv",downloadName:"feedback.csv",variant:"button",size:"md"})]}),l=n({id:"download",name:"Download",packageName:"willa/Download",description:"用于附件、资料和导出结果的轻量下载入口。",imports:[{name:"Download",from:"willa/Download"}],css:"willa/Download.css",demo:{name:"DownloadPreview",component:d},code:`
  ...
  `,sections:[{title:"附件下载",code:`
      ...
      `,content:e.jsx(a,{href:o,name:"下载原始数据",meta:"CSV",variant:"plain"})}],props:[{name:"href",type:"string",required:!0,description:"下载地址。"},{name:"name",type:"ReactNode",required:!0,description:"下载入口主文案，通常是文件名或动作文案。"},{name:"meta",type:"ReactNode",description:"文件大小、格式或补充说明。"},{name:"downloadName",type:"string",description:"下载保存时使用的文件名；默认开启原生 download。"},{name:"variant",type:'"chip" | "button" | "plain"',description:"下载入口形态，默认 chip。"},{name:"size",type:'"sm" | "md"',description:"尺寸，默认 sm。"},{name:"icon",type:"ReactNode",description:"左侧图标。"},{name:"trailingIcon",type:"ReactNode",description:"右侧图标，默认下载图标。"},{name:"disabled",type:"boolean",description:"禁用下载入口。"}]});export{l as default};
