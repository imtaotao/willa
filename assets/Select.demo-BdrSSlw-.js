import{b0 as e}from"./index-DCMaJUkT.js";import{S as t}from"./index-C_Jgmx6j.js";import{d as i}from"./defineDoc-DjMM6lLu.js";import"./index-K5IGP0a2.js";import"./useComboboxState-Dxg9i-UJ.js";import"./floatingPanelParts-BwQQ5SAS.js";import"./useFloatingPanel-8YYVdFR1.js";const a={display:"grid",gap:"0.9rem",maxWidth:"42rem"},l=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],u=i({id:"select",name:"Select",category:"form",packageName:"willa/Select",description:"用于单选下拉，适合表单、筛选和配置场景。",imports:[{name:"Select",from:"willa/Select"}],css:"willa/Select.css",demo:{name:"Select",component:t,props:{options:l,defaultValue:"balanced",width:"100%"}},code:`
