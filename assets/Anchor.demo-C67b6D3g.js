import{b2 as e,b6 as i,a as t,aA as n}from"./index-Bh-5HAmX.js";import{d as r}from"./defineDoc-BhikfaCz.js";const o=[{id:"anchor-overview",title:"概览"},{id:"anchor-usage",title:"使用方式",children:[{id:"anchor-basic",title:"基础用法"},{id:"anchor-nested",title:"嵌套目录"}]},{id:"anchor-api",title:"API"}],c=()=>e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"14rem minmax(0, 1fr)",gap:"1rem",maxWidth:"48rem"},children:[e.jsx(t,{items:o,defaultActiveId:"anchor-overview"}),e.jsxs(n,{gap:"lg",children:[e.jsxs("section",{id:"anchor-overview",children:[e.jsx("h3",{children:"概览"}),e.jsx("p",{children:"Anchor 适合长文档、配置页和详情页目录。"})]}),e.jsxs("section",{id:"anchor-usage",children:[e.jsx("h3",{children:"使用方式"}),e.jsx("p",{children:"点击目录会滚动到对应区域，并同步 active 状态。"})]}),e.jsxs("section",{id:"anchor-basic",children:[e.jsx("h3",{children:"基础用法"}),e.jsx("p",{children:"默认使用 #id 定位，也可以给条目传 href。"})]}),e.jsxs("section",{id:"anchor-nested",children:[e.jsx("h3",{children:"嵌套目录"}),e.jsx("p",{children:"children 用于展示二级目录。"})]}),e.jsxs("section",{id:"anchor-api",children:[e.jsx("h3",{children:"API"}),e.jsx("p",{children:"支持受控 activeId、offsetTop 和点击回调。"})]})]})]}),a=[{id:"anchor-nav-ai",title:"PromptInput",meta:"提示词输入",description:"AI 输入、提交和上下文提示。"},{id:"anchor-nav-form",title:"DatePicker",meta:"日期选择器",description:"日期、范围和滚动选择。"},{id:"anchor-nav-layout",title:"Grid",meta:"网格布局",description:"响应式列和间距控制。"}],s=()=>e.jsx("div",{style:{width:"min(100%, 22rem)"},children:e.jsx(t,{items:a,defaultActiveId:"anchor-nav-ai",variant:"navigation"})}),p=r({id:"anchor",name:"Anchor",category:"content",packageName:"willa/Anchor",description:"用于长页面目录导航和锚点定位。",imports:[{name:"Anchor",from:"willa/Anchor"}],css:"willa/Anchor.css",demo:{name:"AnchorPreview",component:c},code:i(`
