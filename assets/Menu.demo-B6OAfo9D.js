import{aN as a,av as T,aL as t,aM as Y,aw as N,az as Z,g as m,D as E,T as ee,a4 as A,E as te,J as ne,ar as ie,N as oe,l as re}from"./index-CenWvRbQ.js";/* empty css              */import{d as ae}from"./defineDoc-YjbAJZXC.js";function c(o){const{items:s,trigger:d,open:D,defaultOpen:P=!1,onOpenChange:w,onSelect:x,size:V="md",side:k="bottom",align:R="start",offset:h=8,closeOnSelect:W=!0,ariaLabel:O="Menu",className:K,contentClassName:$}=o,C=a.useId(),L=D!==void 0,[q,U]=a.useState(P),l=D??q,[F,z]=a.useState(),M=a.useRef(null),j=a.useRef(null),B=a.useRef(null),b=a.useRef([]),G=a.useMemo(()=>s.filter(le),[s]),y=a.useCallback(e=>{L||U(e),w==null||w(e)},[L,w]),v=a.useCallback(()=>{const e=M.current;if(!e||typeof window>"u")return;const i=e.getBoundingClientRect(),n=j.current,r=(n==null?void 0:n.offsetWidth)??i.width,u=(n==null?void 0:n.offsetHeight)??0,p=k==="bottom"?i.bottom+h:i.top-u-h,f=ue(i,r,R);z({top:T(p,8,Math.max(8,window.innerHeight-u-8)),left:T(f,8,Math.max(8,window.innerWidth-r-8)),minWidth:Math.min(i.width,window.innerWidth-16)})},[R,h,k]),I=a.useCallback(()=>{y(!1)},[y]);a.useEffect(()=>{if(!l||typeof window>"u")return;B.current=document.activeElement instanceof HTMLElement?document.activeElement:null,v();const e=window.setTimeout(()=>{const r=H(b.current)[0];r==null||r.focus()},0),i=r=>{var p,f;const u=r.target;u instanceof Node&&((p=j.current)!=null&&p.contains(u)||(f=M.current)!=null&&f.contains(u)||I())},n=()=>v();return document.addEventListener("pointerdown",i),window.addEventListener("resize",n),window.addEventListener("scroll",n,!0),()=>{var r;window.clearTimeout(e),document.removeEventListener("pointerdown",i),window.removeEventListener("resize",n),window.removeEventListener("scroll",n,!0),(r=B.current)==null||r.focus(),B.current=null}},[I,l,v]),a.useEffect(()=>{l?v():z(void 0)},[l,v]);const J=e=>{var i,n;(n=(i=d.props).onClick)==null||n.call(i,e),e.defaultPrevented||y(!l)},_=e=>{var i,n;(n=(i=d.props).onKeyDown)==null||n.call(i,e),!e.defaultPrevented&&(e.key==="ArrowDown"||e.key==="Enter"||e.key===" ")&&(e.preventDefault(),y(!0))},Q=e=>{if(e.key==="Escape"){e.preventDefault(),I();return}const i=H(b.current);if(!i.length)return;const n=i.findIndex(f=>f===document.activeElement),r=i.length-1,u=n>=r?0:n+1,p=n<=0?r:n-1;e.key==="ArrowDown"&&(e.preventDefault(),i[u].focus()),e.key==="ArrowUp"&&(e.preventDefault(),i[p].focus()),e.key==="Home"&&(e.preventDefault(),i[0].focus()),e.key==="End"&&(e.preventDefault(),i[r].focus())},X=()=>{if(!a.isValidElement(d))return null;const e=d;return a.cloneElement(e,{ref:Z(e.props.ref,M),"aria-controls":l?C:void 0,"aria-expanded":l,"aria-haspopup":"menu",onClick:J,onKeyDown:_})};return b.current=[],t.jsxs("span",{className:N("willa-menu",K),children:[X(),l&&typeof document<"u"?Y.createPortal(t.jsxs("div",{ref:j,id:C,className:N("willa-menu-content",`willa-menu-content--${V}`,$),style:ce(F),role:"menu","aria-label":O,onKeyDown:Q,children:[s.map((e,i)=>e.type==="separator"?t.jsx("div",{className:"willa-menu-separator",role:"separator"},e.value??`separator-${i}`):t.jsxs("button",{ref:n=>{b.current[i]=n},className:N("willa-menu-item",e.danger&&"willa-menu-item--danger"),type:"button",role:"menuitem",disabled:e.disabled,onClick:()=>{var n;e.disabled||((n=e.onSelect)==null||n.call(e,e.value),x==null||x(e.value),W&&I())},children:[e.icon?t.jsx("span",{className:"willa-menu-item-icon","aria-hidden":"true",children:e.icon}):null,t.jsxs("span",{className:"willa-menu-item-content",children:[t.jsx("span",{className:"willa-menu-item-label",children:e.label}),e.description?t.jsx("span",{className:"willa-menu-item-description",children:e.description}):null]}),e.trailing?t.jsx("span",{className:"willa-menu-item-trailing",children:e.trailing}):null]},e.value)),G.length?null:t.jsx("div",{className:"willa-menu-empty",children:"暂无可选项"})]}),document.body):null]})}const se=o=>o.type!=="separator",le=o=>se(o)&&!o.disabled,H=o=>o.filter(s=>s!==null&&!s.disabled),ue=(o,s,d)=>d==="center"?o.left+o.width/2-s/2:d==="end"?o.right-s:o.left,ce=o=>({top:o?`${o.top}px`:void 0,left:o?`${o.left}px`:void 0,minWidth:o?`${o.minWidth}px`:void 0,visibility:o?void 0:"hidden"}),g=[{value:"edit",label:"编辑内容",icon:t.jsx(A,{})},{value:"export",label:"导出为 Markdown",icon:t.jsx(te,{}),trailing:"⌘E"},{value:"open",label:"打开外部链接",icon:t.jsx(ne,{})},{type:"separator"},{value:"delete",label:"删除记录",icon:t.jsx(ie,{}),danger:!0}],de=[{value:"draft",label:"生成草稿",description:"根据当前上下文补全文案。",icon:t.jsx(A,{})},{value:"settings",label:"调整生成参数",description:"切换模型、语气和输出长度。",icon:t.jsx(oe,{})},{value:"selected",label:"已选模式",description:"菜单项可以展示尾部状态。",trailing:t.jsx(re,{})}],S={display:"flex",flexWrap:"wrap",gap:"0.75rem",alignItems:"center"},ge=ae({id:"menu",name:"Menu",packageName:"willa/Menu",description:"用于更多操作、模式切换和 AI 产品中的轻量动作菜单。",imports:[{name:"Menu",from:"willa/Menu"},{name:"Button",from:"willa/Button"}],css:"willa/Menu.css",demo:{name:"Menu",component:c,props:{items:g,trigger:t.jsx(m,{variant:"outline",trailingIcon:t.jsx(E,{}),children:"更多操作"})}},code:`
  ...
  `,sections:[{title:"基础菜单",code:`
      ...
      `,content:t.jsxs("div",{style:S,children:[t.jsx(c,{items:g,trigger:t.jsx(m,{variant:"outline",trailingIcon:t.jsx(E,{}),children:"更多操作"})}),t.jsx(c,{items:g,size:"sm",trigger:t.jsx(ee,{ariaLabel:"打开操作菜单",icon:t.jsx(E,{}),variant:"outline"})})]})},{title:"描述和状态",code:`
      ...
      `,content:t.jsxs("div",{style:S,children:[t.jsx(c,{align:"start",items:g,trigger:t.jsx(m,{variant:"outline",children:"左对齐"})}),t.jsx(c,{align:"center",items:g,trigger:t.jsx(m,{variant:"outline",children:"居中"})}),t.jsx(c,{align:"end",items:g,trigger:t.jsx(m,{variant:"outline",children:"右对齐"})})]})},{title:"禁用项",code:`
        <Menu
          items={[
