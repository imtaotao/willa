import{an as e,a2 as a}from"./index-B_h_YYgH.js";import{d as t}from"./defineDoc-Bzp7FD3_.js";const r={display:"flex",alignItems:"center",color:"var(--willa-text-soft)",fontSize:"0.92rem",lineHeight:1.5},o=t({id:"separator",name:"Separator",category:"layout",packageName:"willa/Separator",description:"用于内容段落、文章区块和行内元信息之间的轻量分隔。",imports:[{name:"Separator",from:"willa/Separator"}],css:"willa/Separator.css",demo:{name:"Separator",component:a},code:`
  ...
  `,sections:[{title:"基础分隔",code:`
      ...
      `,content:e.jsx(a,{plain:!0,children:"仅作为轻量分组提示"})}],props:[{name:"orientation",type:'"horizontal" | "vertical"',description:"分隔方向。"},{name:"size",type:'"sm" | "md" | "lg"',description:"分隔组件的外部间距。"},{name:"align",type:'"start" | "center" | "end"',description:"横向带文案时的文案位置。"},{name:"variant",type:'"solid" | "dashed" | "dotted"',description:"线条样式。"},{name:"plain",type:"boolean",description:"是否弱化文案字重。"},{name:"decorative",type:"boolean",description:"是否作为纯视觉分隔，默认不暴露给辅助技术。"},{name:"className",type:"string",description:"可选的外层 className。"},{name:"children",type:"ReactNode",description:"横向分隔中间展示的可选文案。"}]});export{o as default};
