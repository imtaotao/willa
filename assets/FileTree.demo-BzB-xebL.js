import{aO as e,M as i,aR as n,aQ as o,Q as u,s as y}from"./index-BZo2zb5Z.js";import{F as d}from"./index-AttC70lr.js";/* empty css              */import{d as g}from"./defineDoc-CYk1gPEt.js";import"./index-CnXSn4Ts.js";const c=[{id:"agents",name:"AGENTS.md",meta:"仓库通用约定",selected:!0,icon:e.jsx(i,{})},{id:"services",name:"services",type:"folder",children:[{id:"payments",name:"payments",type:"folder",children:[{id:"payments-agents",name:"AGENTS.md",muted:!0,meta:"因为存在覆盖文件，所以会被忽略",icon:e.jsx(i,{})},{id:"payments-override",name:"AGENTS.override.md",selected:!0,meta:"payments 服务规则",icon:e.jsx(i,{})},{id:"payments-readme",name:"README.md",icon:e.jsx(i,{})},{id:"payments-long-report",name:"quarterly-payment-reconciliation-report-2026-final.md",meta:"finance / reconciliation / archived",icon:e.jsx(i,{})}]},{id:"search",name:"search",type:"folder",children:[{id:"search-readme",name:"README.md",icon:e.jsx(i,{})}]}]}],T=[{id:"prompts",name:"prompts",type:"folder",children:[{id:"system-prompt",name:"system.md",meta:"系统提示词"},{id:"rewrite-prompt",name:"rewrite.md",meta:"改写链路"}]},{id:"datasets",name:"datasets",type:"folder",children:[{id:"faq-dataset",name:"faq.jsonl",meta:"1.2 MB"},{id:"eval-dataset",name:"eval.csv",meta:"320 KB"}]},{id:"agent-config",name:"agent.config.ts",meta:"运行配置",selected:!0}],l=[{id:"agents",language:"md",code:n(`
      # AGENTS.md
    ...
    `)},{id:"search-readme",language:"md",code:n(`
      ...
      搜索服务负责索引构建、召回和排序配置。
    `)}],f={display:"grid",flex:"1 1 18rem",minWidth:0},F=()=>{const[r,a]=o.useState("agents"),t=o.useMemo(()=>p(c,r),[r]),m=l.find(s=>s.id===r)??l[0];return e.jsxs(u,{align:"stretch",gap:"0.85rem",style:{width:"100%"},children:[e.jsx(d,{items:t,collapsible:!0,resizable:!0,width:"min(100%, 16rem)",onFileClick:s=>{typeof s.id=="string"&&a(s.id)}}),e.jsx("div",{style:f,children:e.jsx(y,{children:e.jsx("code",{className:`language-${m.language}--meta-ln`,children:m.code})})})]})},p=(r,a)=>r.map(t=>t.children?{...t,selected:t.id===a,children:p(t.children,a)}:{...t,selected:t.id===a}),S=g({id:"file-tree",name:"FileTree",packageName:"willa/FileTree",description:"用于展示仓库目录、配置文件和资料层级的文件树组件。",imports:[{name:"FileTree",from:"willa/FileTree"}],css:"willa/FileTree.css",demo:{name:"FileTreeCodePreview",component:F},code:`
