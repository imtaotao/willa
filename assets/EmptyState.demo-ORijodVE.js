import{aX as t,H as i,T as a,h as e,a3 as o,k as n,O as s}from"./index-DHcJ9SEz.js";/* empty css              *//* empty css              *//* empty css              */import{d as r}from"./defineDoc-BO7YRFbH.js";const c={display:"grid",gap:"0.9rem",width:"min(100%, 56rem)"},y=r({id:"empty-state",name:"EmptyState",packageName:"willa/EmptyState",description:"用于列表为空、搜索无结果和 AI 上下文缺失时的空状态提示。",imports:[{name:"EmptyState",from:"willa/EmptyState"},{name:"Button",from:"willa/Button"},{name:"Group",from:"willa/Group"}],css:"willa/EmptyState.css",demo:{name:"EmptyState",component:i,props:{icon:t.jsx(o,{}),title:"没有找到结果",description:"换一个关键词，或清空筛选条件后重新搜索。",actions:t.jsxs(a,{gap:"sm",justify:"center",children:[t.jsx(e,{size:"sm",variant:"solid",children:"清空筛选"}),t.jsx(e,{size:"sm",variant:"ghost",children:"新建内容"})]})}},code:`
