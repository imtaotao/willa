import{au as i,ak as N}from"./index-VEztyUnl.js";import{d as K}from"./defineDoc-fv-G_8j9.js";const k={csv:"excel",doc:"word",docx:"word",gz:"archive",java:"code",js:"code",json:"code",md:"text",pdf:"pdf",ppt:"ppt",pptx:"ppt",py:"code",rar:"archive",ts:"code",tsx:"code",txt:"text",xls:"excel",xlsx:"excel",zip:"archive"};function a(e){if(E(e)){const{name:r,size:v,extension:l,tone:F,icon:j,className:C,href:y,target:c,rel:o,...w}=e,B=c==="_blank"&&!o?"noreferrer":o;return i.jsx("a",{...w,className:d({className:C,interactive:!0,tone:p({name:r,extension:l,tone:F})}),href:y,target:c,rel:B,children:m({name:r,size:v,extension:l,icon:j})})}const{name:n,size:s,extension:t,tone:z,icon:u,className:h,...g}=e;return i.jsx("div",{...g,className:d({className:h,interactive:!1,tone:p({name:n,extension:t,tone:z})}),children:m({name:n,size:s,extension:t,icon:u})})}const E=e=>typeof e.href=="string",d=e=>N("willa-file-card",`willa-file-card--${e.tone}`,e.interactive&&"willa-file-card--interactive",e.className),m=e=>{const n=f(e.extension??e.name);return i.jsxs(i.Fragment,{children:[i.jsx("span",{className:"willa-file-card-icon","aria-hidden":"true",children:e.icon??i.jsx("span",{className:"willa-file-card-icon-label",children:L(n)})}),i.jsxs("span",{className:"willa-file-card-content",children:[i.jsx("span",{className:"willa-file-card-name",title:e.name,children:e.name}),e.size?i.jsx("span",{className:"willa-file-card-meta",children:e.size}):null]})]})},p=e=>{if(e.tone)return e.tone;const n=f(e.extension??e.name);return k[n]??"neutral"},f=e=>{const n=e.trim().toLowerCase(),s=n.split(".").filter(Boolean);return(n.includes(".")?s[s.length-1]:n)??""},L=e=>e?e==="javascript"?"JS":e==="typescript"?"TS":e.slice(0,4).toUpperCase():"FILE",x={display:"grid",gap:"0.75rem",justifyItems:"center"},b={...x,gridTemplateColumns:"repeat(auto-fit, minmax(13.5rem, 1fr))",width:"min(100%, 56rem)"},R=[{name:"excel-has-long-long-long-file-name.xlsx",size:"1 KB"},{name:"word-file.docx",size:"1 KB"},{name:"pdf-file.pdf",size:"1 KB"},{name:"ppt-file.pptx",size:"1 KB"},{name:"zip-file.zip",size:"1 KB"},{name:"javascript-file.js",size:"1 KB"}],M=()=>i.jsx("div",{style:x,children:R.map(e=>i.jsx(a,{name:e.name,size:e.size},e.name))}),T=K({id:"file-card",name:"FileCard",packageName:"willa/FileCard",description:"用于文章、资料下载和附件列表中的文件卡片。",imports:[{name:"FileCard",from:"willa/FileCard"}],css:"willa/FileCard.css",demo:{name:"FileListPreview",component:M},code:`
  ...
  `,sections:[{title:"链接文件",code:`
      ...
      `,content:i.jsxs("div",{style:b,children:[i.jsx(a,{name:"README",extension:"md",size:"2 KB"}),i.jsx(a,{name:"dataset",extension:"csv",size:"24 KB"}),i.jsx(a,{name:"archive.backup",tone:"archive",size:"1.2 MB"})]})},{title:"自定义图标",code:`
        <FileCard
