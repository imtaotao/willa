import{aX as e,_ as i,h as t,aZ as c}from"./index-B_niY1JA.js";import{C as s}from"./index-DnNWNjaw.js";import{F as r,a as l}from"./index-DJTTvbPG.js";import{F as a}from"./index-CoDYwk6-.js";import{F as o}from"./index-BOBOpVW5.js";import{F as p}from"./index-nBR_CQ39.js";import{S as F}from"./index-BfLKi5_k.js";/* empty css              *//* empty css              */import{d as b}from"./defineDoc-D490Ta9i.js";import"./index-vE2VtFfQ.js";import"./useSelectablePanel-DW5wX6tf.js";import"./floatingPanelParts-DdYTfbAo.js";import"./useFloatingPanel-w33PjtNB.js";const f=[{value:"fast",label:"快速模式"},{value:"balanced",label:"均衡模式"},{value:"quality",label:"高质量模式"}],h=()=>{const[n,m]=c.useState(!1),d=u=>{u.preventDefault(),m(!0),window.setTimeout(()=>m(!1),900)};return e.jsx(r,{onSubmit:d,actions:e.jsxs(a,{children:[e.jsx(t,{variant:"ghost",children:"取消"}),e.jsx(t,{type:"submit",loading:n,children:"保存"})]}),children:e.jsxs(l,{title:"创建 AI 配置",description:"用于产品后台、模型配置和轻量提交场景。",children:[e.jsx(o,{label:"配置名称",required:!0,children:e.jsx(i,{name:"name",defaultValue:"内容生成助手",width:"100%"})}),e.jsx(o,{label:"默认模式",children:e.jsx(F,{name:"mode",defaultValue:"balanced",options:f,width:"100%"})}),e.jsx(s,{name:"search",defaultChecked:!0,label:"允许联网检索",description:"回答前可以读取公开资料。"})]})})},M=b({id:"form",name:"Form",category:"form",packageName:"willa/Form",description:"统一表单语义、表单级错误、提交状态和底部操作区。",imports:[{name:"Form",from:"willa/Form"}],css:"willa/Form.css",demo:{name:"FormPreview",component:h},code:`
