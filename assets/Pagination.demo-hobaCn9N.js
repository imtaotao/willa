import{aX as e,aZ as o,B as s}from"./index-BbKyouyj.js";import{P as a}from"./index-ByAtVUP3.js";/* empty css              */import{d as g}from"./defineDoc-DTfHMO5s.js";const l={display:"grid",gap:"0.75rem",justifyItems:"center"},p={display:"flex",flexWrap:"wrap",gap:"0.75rem",alignItems:"center"},r=()=>{const[t,n]=o.useState(4);return e.jsxs("div",{style:l,children:[e.jsxs(s,{tone:"info",children:["当前页：",t]}),e.jsx(a,{page:t,pageCount:12,onPageChange:n})]})},P=g({id:"pagination",name:"Pagination",packageName:"willa/Pagination",description:"用于文章列表、评论列表和搜索结果等分页内容的页码导航。",imports:[{name:"Pagination",from:"willa/Pagination"}],css:"willa/Pagination.css",demo:{name:"Pagination",component:a,props:{defaultPage:6,pageCount:20}},code:`
