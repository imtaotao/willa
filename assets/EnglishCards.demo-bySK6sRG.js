import{ai as i,af as e,_ as a}from"./index-BjJvZ1Rp.js";import{E as s}from"./index-CnlHHD5C.js";import{d as t}from"./defineDoc-B0NOwJKj.js";const n=[{word:"component",translation:"组件",explanation:"一个可复用的界面构建单元。",example:{text:"Each Willa component can be imported directly.",translation:"每个 Willa 组件都可以直接导入。"},tags:["ui","react"]}],o=["architecture","component","pragmatic"],r=()=>e.jsxs("div",{className:"docs-demo-stack",children:[e.jsxs("section",{className:"docs-demo-group",children:[e.jsx("div",{className:"docs-demo-title",children:"静态词条"}),e.jsx(s,{title:"词汇卡片",openApi:!1,items:n})]}),e.jsx(a,{className:"docs-demo-separator",size:"sm"}),e.jsxs("section",{className:"docs-demo-group",children:[e.jsx("div",{className:"docs-demo-title",children:"词典 API 查询"}),e.jsx(s,{title:"OpenAPI 词汇卡片",words:o,openApi:!0})]})]}),p=t({id:"english-cards",name:"EnglishCards",category:"widgets",packageName:"willa/EnglishCards",description:"展示翻译、例句和参考信息的单词卡片。",imports:[{name:"EnglishCards",from:"willa/EnglishCards"}],css:"willa/EnglishCards.css",demo:{name:"EnglishCardsPreview",component:r},code:i(`
