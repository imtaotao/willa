import{d as e,l as t,p as n}from"./aidly.esm-bundler-DaTrP4tr.js";import{H as r}from"./react-icons.esm-mVdwEXuX.js";import{t as i}from"./Button-O1aY2iqB.js";import"./style-B00R6KjV.js";import{t as a}from"./defineDoc-Cid5xIoZ.js";import{t as o}from"./style-DIU7lNfN.js";import"./PromptInput-BAo13jPI.js";var s=n(e(),1),c=t(),l={display:`grid`,gap:`1rem`,width:`min(100%, 56rem)`},u=[{id:`wang`,label:`王工`,value:`@wang `,role:`PM`},{id:`li`,label:`李工`,value:`@li `,role:`研发`},{id:`zhao`,label:`赵工`,value:`@zhao `,role:`运营`}],d=[{id:`doc-101`,label:`竞品分析材料`,value:`#doc-101 `,description:`文档`},{id:`sheet-202`,label:`用户反馈表`,value:`#sheet-202 `,description:`表格`}],f=[{id:`var-ctx`,label:`当前上下文`,value:`$ctx `},{id:`var-time`,label:`今天日期`,value:`$today `}],p=a({id:`prompt-input`,name:`PromptInput`,category:`ai`,packageName:`willa/PromptInput`,description:`用于 AI 对话、智能搜索和生成任务的提示词输入区域。`,imports:[{name:`PromptInput`,from:`willa/PromptInput`}],css:`willa/PromptInput.css`,demo:{name:`PromptInputPreview`,component:()=>{let[e,t]=(0,s.useState)(``),[n,r]=(0,s.useState)(`暂无提交内容`);return(0,c.jsxs)(`div`,{style:l,children:[(0,c.jsx)(o,{value:e,footer:`Enter 发送，Shift + Enter 换行`,placeholder:`让 AI 帮我整理这段会议纪要...`,onChange:e=>t(e.currentTarget.value),onSubmit:e=>{r(e),t(``)}}),(0,c.jsx)(`div`,{children:n})]})}},code:`
  ...
  `,sections:[{title:`基础输入`,code:`
      ...
      `,content:(0,c.jsx)(`div`,{style:l,children:(0,c.jsx)(o,{defaultValue:`请把下面的内容整理成三条行动项。`,footer:`支持多行提示词输入`,submitLabel:`生成`})})},{title:`工具操作`,code:`
        <div style={stackStyle}>
          <PromptInput
      ...
      `,content:(0,c.jsx)(`div`,{style:l,children:(0,c.jsx)(o,{placeholder:`输入你的产品需求或数据分析问题`,footer:`上下文已连接到当前文档`,actions:(0,c.jsx)(i,{size:`sm`,variant:`ghost`,icon:(0,c.jsx)(r,{}),children:`优化`})})})},{title:`提交状态`,code:`
        <div style={stackStyle}>
          <PromptInput
      ...
      `,content:(0,c.jsxs)(`div`,{style:l,children:[(0,c.jsx)(o,{defaultValue:`分析最近 7 天用户反馈里的高频问题。`,loading:!0,footer:`正在发送请求`}),(0,c.jsx)(o,{disabled:!0,placeholder:`当前会话不可输入`})]})},{title:`尺寸`,code:`
        <div style={stackStyle}>
      ...
      `,content:(0,c.jsxs)(`div`,{style:l,children:[(0,c.jsx)(o,{size:`md`,placeholder:`默认尺寸`}),(0,c.jsx)(o,{size:`lg`,minRows:4,maxRows:10,placeholder:`更适合长提示词和复杂任务描述`})]})},{title:`提及上下文`,code:`
        const mentionUsers = [
