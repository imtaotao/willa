import{ay as e,am as u,aA as h,L as i}from"./index-vVHMmPWZ.js";/* empty css              */import{d as j}from"./defineDoc-CK669M_K.js";function s(r){const{size:t="md",variant:c="surface",className:o,children:n,...l}=r;return e.jsx("kbd",{...l,className:u("willa-kbd",`willa-kbd--${t}`,`willa-kbd--${c}`,o),children:n})}function d(r){const{keys:t,size:c="md",variant:o="surface",separator:n="plus",ariaLabel:l,className:b,...m}=r,K=l??t.map(a=>typeof a=="string"||typeof a=="number"?a:"").filter(Boolean).join(" + ");return e.jsx("span",{...m,className:u("willa-kbd-shortcut",n==="none"&&"willa-kbd-shortcut--no-separator",b),"aria-label":K||void 0,children:t.map((a,p)=>e.jsxs(h.Fragment,{children:[p>0&&n==="plus"?e.jsx("span",{className:"willa-kbd-shortcut-separator","aria-hidden":"true",children:"+"}):null,e.jsx(s,{size:c,variant:o,children:a})]},x(a,p)))})}const x=(r,t)=>typeof r=="string"||typeof r=="number"?`${r}-${t}`:String(t);function f(){return e.jsxs("p",{children:["按 ",e.jsx(d,{keys:["⌘","K"]})," 打开命令面板，或按 ",e.jsx(s,{children:"Esc"})," ","关闭当前浮层。"]})}const S=j({id:"kbd",name:"Kbd",packageName:"willa/Kbd",description:"用于展示键盘按键、快捷键和命令提示的内联组件。",imports:[{name:"Kbd, KbdShortcut",from:"willa/Kbd"},{name:"Group",from:"willa/Group"}],css:"willa/Kbd.css",demo:{name:"KbdPreview",component:f},code:`
